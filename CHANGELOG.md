...
## 2026-05-22 — City 2048 추가 및 PST 대시보드 업데이트

- City 2048 게임 링크 및 Esther Only 버튼 하단 섹션 추가
- PST 대시보드 v186 5/21 데이터 반영 (2026-05-22)

---

## 2026-05-21 — PST 대시보드 v186 업데이트

- touch 57.7%, finish 53.6% (v180~186 합산) 수치 반영
- 대시보드 박스 v186 기준으로 전면 업데이트

---

## 2026-04-29~30 — 스트릭 미터 골드 A1 적용 카드 반영

- `streak_meter_gold` A1 적용 카드 인덱스에 반영 (entry_cost ×5%, 와카 회수율 4.1% → 7.7%)
- 칸반 링크 경로 오류(404) 수정 (2026-04-30)

---

## 2026-04-23 — SCJ 런칭 플래너 신규 추가

- `13_scj_launch_planner.html` 신규 생성 (Supabase 협업 연동 Gantt 플래너)
- 인덱스 카드 제목 → '플랫폼별 런칭 일정 안내'로 확정

---

## 2026-04-14 — Esther Only 섹션 복구

- workspace index 정식 소스에 Esther Only 섹션 복구 및 루트로 재동기화
- `reports/index.html` Esther Only 링크 경로 수정

---

## 2026-04-09 — 경쟁 앱 경제 분석 보고서 추가

- `economy_competitive_report.html` 신규 생성
- 수치 설계 섹션에 카드 추가 및 카드 순서 정비
