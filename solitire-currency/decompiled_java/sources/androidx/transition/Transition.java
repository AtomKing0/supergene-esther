...
public abstract class Transition implements Cloneable {
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.d
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z10, float f10, float f11) {
                    this.f1742a.lambda$ensureAnimation$0(dynamicAnimation, z10, f10, f11);
                }
            });
        }
    ...
    */
    void createAnimators(@androidx.annotation.NonNull android.view.ViewGroup r22, @androidx.annotation.NonNull androidx.transition.TransitionValuesMaps r23, @androidx.annotation.NonNull androidx.transition.TransitionValuesMaps r24, @androidx.annotation.NonNull java.util.ArrayList<androidx.transition.TransitionValues> r25, @androidx.annotation.NonNull java.util.ArrayList<androidx.transition.TransitionValues> r26) {
        /*
