...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i10, View view, ViewGroup viewGroup) {
        ...
        if (browserActionItem.getIconId() != 0) {
            ...
            final m<Bitmap> mVarLoadBitmap = BrowserServiceFileProvider.loadBitmap(this.mContext.getContentResolver(), browserActionItem.getIconUri());
            mVarLoadBitmap.addListener(new Runnable() { // from class: androidx.browser.browseractions.BrowserActionsFallbackMenuAdapter.1
                ...
                public void run() {
                    ...
                    if (TextUtils.equals(title, viewHolderItem.mText.getText())) {
                        try {
                            bitmap = (Bitmap) mVarLoadBitmap.get();
