...
final class CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1 extends l implements p<o0, d<? super k0>, Object> {
    ...
    CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1(CustomAudienceManagerFutures.Api33Ext4JavaImpl api33Ext4JavaImpl, JoinCustomAudienceRequest joinCustomAudienceRequest, d<? super CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            if (customAudienceManager.joinCustomAudience(joinCustomAudienceRequest, this) == objE) {
                return objE;
            }
        } else {
            if (i10 != 1) {
    ...
    public final Object mo4invoke(@NotNull o0 o0Var, @Nullable d<? super k0> dVar) {
        return ((CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1) create(o0Var, dVar)).invokeSuspend(k0.f35197a);
    }
}
