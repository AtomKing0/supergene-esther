...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return v8.i.f15837d + "resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal(this.weight) + v8.i.f15839e;
        }
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            return v8.i.f15837d + "; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal(this.weight) + v8.i.f15839e;
        }
