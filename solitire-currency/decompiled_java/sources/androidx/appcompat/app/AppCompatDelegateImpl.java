...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        LocaleListCompat localeListCompatCombineLocalesIfOverlayExists = i10 >= 24 ? LocaleOverlayHelper.combineLocalesIfOverlayExists(requestedAppLocales, configurationLocales) : requestedAppLocales.isEmpty() ? LocaleListCompat.getEmptyLocaleList() : LocaleListCompat.forLanguageTags(requestedAppLocales.get(0).toString());
