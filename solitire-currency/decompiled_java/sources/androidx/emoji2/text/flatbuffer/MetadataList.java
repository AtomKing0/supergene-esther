...
public final class MetadataList extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i10) {
            return metadataList.__assign(Table.__indirect(__element(i10), this.f932bb), this.f932bb);
        }
    }
    ...
    public MetadataItem list(MetadataItem metadataItem, int i10) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
            return metadataItem.__assign(__indirect(__vector(i__offset) + (i10 * 4)), this.f938bb);
        }
        return null;
    }
    ...
    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
            return vector.__assign(__vector(i__offset), 4, this.f938bb);
        }
        return null;
    }
}
