...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i10) {
            return metadataItem.__assign(Table.__indirect(__element(i10), this.f932bb), this.f932bb);
        }
    }
    ...
    public int codepoints(int i10) {
        ...
        if (i__offset != 0) {
            return this.f938bb.getInt(__vector(i__offset) + (i10 * 4));
        }
        return 0;
    }
    ...
    public short compatAdded() {
        ...
        if (i__offset != 0) {
            return this.f938bb.getShort(i__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (i__offset == 0 || this.f938bb.get(i__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public int id() {
        ...
        if (i__offset != 0) {
            return this.f938bb.getInt(i__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int i__offset = __offset(16);
        if (i__offset != 0) {
            return intVector.__assign(__vector(i__offset), this.f938bb);
        }
        return null;
    }
}
