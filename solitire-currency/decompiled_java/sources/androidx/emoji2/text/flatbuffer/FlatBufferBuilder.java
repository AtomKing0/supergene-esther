...
public class FlatBufferBuilder {
    ...
    public void clear() {
        this.space = this.f933bb.capacity();
        this.f933bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i10;
        byteBuffer.position(i10);
        this.utf8.encodeUtf8(charSequence, this.f933bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i10, int i11, int i12) {
        ...
        ByteBuffer byteBufferOrder = this.f933bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f933bb.capacity() - this.vtables[i14];
            int i15 = this.space;
            short s10 = this.f933bb.getShort(iCapacity);
            if (s10 == this.f933bb.getShort(i15)) {
                for (int i16 = 2; i16 < s10; i16 += 2) {
                    if (this.f933bb.getShort(iCapacity + i16) != this.f933bb.getShort(i15 + i16)) {
                        break;
                    }
                }
        ...
        if (i10 != 0) {
            int iCapacity2 = this.f933bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f933bb.putInt(iCapacity2, i10 - iOffset);
        } else {
    ...
    protected void finish(int i10, boolean z10) {
        ...
        addOffset(i10);
        if (z10) {
            addInt(this.f933bb.capacity() - this.space);
        }
        this.f933bb.position(this.space);
        this.finished = true;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f933bb = byteBuffer;
        byteBuffer.clear();
        this.f933bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f933bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
    ...
    public int offset() {
        return this.f933bb.capacity() - this.space;
    }
    ...
    public void required(int i10, int i11) {
        int iCapacity = this.f933bb.capacity() - i10;
        if (this.f933bb.getShort((iCapacity - this.f933bb.getInt(iCapacity)) + i11) != 0) {
            return;
        }
    ...
    public byte[] sizedByteArray(int i10, int i11) {
        ...
        this.f933bb.position(i10);
        this.f933bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f933bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f933bb.capacity());
    ...
    public FlatBufferBuilder(int i10, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f933bb = byteBufferFactory.newByteBuffer(i10);
        }
        this.utf8 = utf8;
        this.space = this.f933bb.capacity();
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f933bb.capacity() - this.space);
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f933bb;
        int i10 = this.space - iRemaining;
        this.space = i10;
        byteBuffer2.position(i10);
        this.f933bb.put(byteBuffer);
        return endVector();
    }
