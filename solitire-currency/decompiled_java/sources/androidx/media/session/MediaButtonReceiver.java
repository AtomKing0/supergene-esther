...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName componentName, long j10) {
        ...
        int iB = PlaybackStateCompat.b(j10);
        if (iB == 0) {
        ...
        intent.putExtra("android.intent.extra.KEY_EVENT", new KeyEvent(0, iB));
        int i10 = Build.VERSION.SDK_INT;
        intent.addFlags(268435456);
        return PendingIntent.getBroadcast(context, iB, intent, i10 >= 31 ? 33554432 : 0);
    }
}
