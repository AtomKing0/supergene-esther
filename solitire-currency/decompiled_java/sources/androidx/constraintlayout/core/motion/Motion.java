...
public class Motion implements TypedValues {
    ...
    public void buildPath(float[] fArr, int i10) {
        ...
        while (i11 < i10) {
            ...
            if (keyCycleOscillator != null) {
                fArr[i12] = fArr[i12] + keyCycleOscillator.get(f15);
            } else if (splineSet != null) {
                fArr[i12] = fArr[i12] + splineSet.get(f15);
            }
            if (keyCycleOscillator2 != null) {
                int i14 = i12 + 1;
                fArr[i14] = fArr[i14] + keyCycleOscillator2.get(f15);
            } else if (splineSet2 != null) {
                int i15 = i12 + 1;
                fArr[i15] = fArr[i15] + splineSet2.get(f15);
            }
            i11 = i13 + 1;
            f10 = 1.0f;
        }
    ...
    void getDpDt(float f10, float f11, float f12, float[] fArr) {
        ...
        if (curveFitArr == null) {
            ...
            float f13 = motionPaths.f810x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f14 = f13 - motionPaths2.f810x;
            float f15 = motionPaths.f811y - motionPaths2.f811y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f810x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f811y;
    }
    ...
    float getKeyFrameParameter(int i10, float f10, float f11) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f12 = motionPaths.f810x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = motionPaths2.f810x;
        float f14 = f12 - f13;
        float f15 = motionPaths.f811y;
        float f16 = motionPaths2.f811y;
        float f17 = f15 - f16;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f810x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f811y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f10, long j10, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f14 = motionPaths.f810x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f15 = f14 + ((motionPaths2.f810x - f14) * f13);
            float f16 = motionPaths.f811y;
            float f17 = f16 + ((motionPaths2.f811y - f16) * f13);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f810x + " y: " + this.mStartMotionPath.f811y + " end: x: " + this.mEndMotionPath.f810x + " y: " + this.mEndMotionPath.f811y;
    }
