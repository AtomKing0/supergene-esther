...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                String str3 = str2 + v8.i.f15837d + i10 + "] ";
    ...
    */
    ...
    public void getViewVelocity(View view, float f10, float f11, float[] fArr, int i10) {
        ...
        if ((i10 & 1) == 0) {
            motionController.getPostLayoutDvDp(interpolation, view.getWidth(), view.getHeight(), f10, f11, fArr);
        } else {
            motionController.getDpDt(interpolation, f10, f11, fArr);
        }
        if (i10 < 2) {
