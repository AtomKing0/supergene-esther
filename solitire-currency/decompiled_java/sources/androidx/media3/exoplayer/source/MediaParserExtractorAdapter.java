...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    ...
    @Deprecated
    public static final ProgressiveMediaExtractor.Factory FACTORY = new ProgressiveMediaExtractor.Factory() { // from class: androidx.media3.exoplayer.source.q
    ...
    public static /* synthetic */ ProgressiveMediaExtractor lambda$static$0(PlayerId playerId) {
        return new MediaParserExtractorAdapter(playerId, com.google.common.collect.a0.k());
    }
    ...
    public void seek(long j10, long j11) {
        ...
        this.mediaParser.seek((MediaParser.SeekPoint) (((MediaParser.SeekPoint) seekPoints.second).position == j10 ? seekPoints.second : seekPoints.first));
    }

    @Deprecated
    public MediaParserExtractorAdapter(PlayerId playerId) {
        this(playerId, com.google.common.collect.a0.k());
    }
