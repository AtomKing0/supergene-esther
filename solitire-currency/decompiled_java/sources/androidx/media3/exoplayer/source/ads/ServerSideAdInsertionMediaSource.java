...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private final i0<Pair<Long, Object>, SharedMediaPeriod> mediaPeriods = com.google.common.collect.g.C();
    private a0<Object, AdPlaybackState> adPlaybackStates = a0.k();
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        private final a0<Object, AdPlaybackState> adPlaybackStates;
        ...
        public ServerSideAdInsertionTimeline(Timeline timeline, a0<Object, AdPlaybackState> a0Var) {
            ...
            for (int i10 = 0; i10 < timeline.getPeriodCount(); i10++) {
                ...
                Assertions.checkState(a0Var.containsKey(Assertions.checkNotNull(period.uid)));
            }
    ...
    private static final class SharedMediaPeriod implements MediaPeriod.Callback {
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i11 = 0; i11 < trackGroup.length; i11++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z10 && (str = format.id) != null && str.equals(mediaLoadData.trackFormat.id))) {
                            break loop0;
                        }
                    }
                }
        ...
        public boolean canReuseMediaPeriod(MediaSource.MediaPeriodId mediaPeriodId, long j10) {
            MediaPeriodImpl mediaPeriodImpl = (MediaPeriodImpl) g0.d(this.mediaPeriods);
    ...
    private MediaPeriodImpl getMediaPeriodForEvent(@Nullable MediaSource.MediaPeriodId mediaPeriodId, @Nullable MediaLoadData mediaLoadData, boolean z10) {
        ...
        if (z10) {
            ...
            return sharedMediaPeriod.loadingPeriod != null ? sharedMediaPeriod.loadingPeriod : (MediaPeriodImpl) g0.d(sharedMediaPeriod.mediaPeriods);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setAdPlaybackStates$0(a0 a0Var, Timeline timeline) {
        ...
        this.adPlaybackStates = a0Var;
        refreshSourceInfo(new ServerSideAdInsertionTimeline(timeline, a0Var));
    }
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j10) {
        ...
        if (sharedMediaPeriod == null && ((sharedMediaPeriod = (SharedMediaPeriod) g0.e(this.mediaPeriods.get(pair), null)) == null || !sharedMediaPeriod.canReuseMediaPeriod(mediaPeriodId, j10))) {
    ...
    public void setAdPlaybackStates(final a0<Object, AdPlaybackState> a0Var, final Timeline timeline) {
        Assertions.checkArgument(!a0Var.isEmpty());
        Object objCheckNotNull = Assertions.checkNotNull(a0Var.values().a().get(0).adsId);
        i1<Map.Entry<Object, AdPlaybackState>> it = a0Var.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.g
                    ...
                    public final void run() {
                        this.f1489a.lambda$setAdPlaybackStates$0(a0Var, timeline);
                    }
                });
            }
        }
