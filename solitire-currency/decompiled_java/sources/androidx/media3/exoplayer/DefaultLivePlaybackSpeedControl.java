...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    private void adjustTargetLiveOffsetUs(long j10) {
        ...
        if (this.currentTargetLiveOffsetUs > j11) {
            ...
            this.currentTargetLiveOffsetUs = g5.g.c(j11, this.idealTargetLiveOffsetUs, this.currentTargetLiveOffsetUs - (((long) ((this.adjustedPlaybackSpeed - 1.0f) * fMsToUs)) + ((long) ((this.maxPlaybackSpeed - 1.0f) * fMsToUs))));
            return;
        }
