...
public final /* synthetic */ class a {
    ...
    @UnstableApi
    public static void A(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10) {
    }
    ...
    @UnstableApi
    public static void G(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, boolean z10) {
    }

    @UnstableApi
    @Deprecated
    public static void L(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, boolean z10) {
    }
    ...
    @UnstableApi
    public static void h0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, boolean z10) {
    }
    ...
    @UnstableApi
    public static void j0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10) {
    }
    ...
    @UnstableApi
    public static void y0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, float f10) {
    }

    @UnstableApi
    public static void D(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10, long j10) {
    }
    ...
    @UnstableApi
    public static void N(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, @Nullable MediaItem mediaItem, int i10) {
    }

    @UnstableApi
    public static void Q(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, boolean z10, int i10) {
    }

    @UnstableApi
    @Deprecated
    public static void X(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, boolean z10, int i10) {
    }
    ...
    @UnstableApi
    public static void i0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10, int i11) {
    }

    @UnstableApi
    @Deprecated
    public static void o0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, String str, long j10) {
    }

    @UnstableApi
    public static void t0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, long j10, int i10) {
    }

    @UnstableApi
    public static void u(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10, boolean z10) {
    }
    ...
    @UnstableApi
    public static void J(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z10) {
    }

    @UnstableApi
    @Deprecated
    public static void w0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10, int i11, int i12, float f10) {
    }

    @UnstableApi
    public static void a0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, int i10) {
    }
    ...
    @UnstableApi
    public static void p0(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, String str, long j10, long j11) {
    }

    @UnstableApi
    public static void q(AnalyticsListener analyticsListener, AnalyticsListener.EventTime eventTime, int i10, long j10, long j11) {
    }
}
