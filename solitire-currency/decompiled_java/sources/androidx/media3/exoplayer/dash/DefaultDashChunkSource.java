...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    protected static final class RepresentationSegmentIterator extends BaseMediaChunkIterator {
        ...
        public DataSpec getDataSpec() {
            ...
            return DashUtil.buildDataSpec(representationHolder.representation, representationHolder.selectedBaseUrl.url, segmentUrl, i10, a0.k());
        }
    }
    ...
    */
    ...
    protected Chunk newInitializationChunk(RepresentationHolder representationHolder, DataSource dataSource, Format format, int i10, @Nullable Object obj, @Nullable RangedUri rangedUri, @Nullable RangedUri rangedUri2, @Nullable CmcdData.Factory factory) {
        ...
        DataSpec dataSpecBuildDataSpec = DashUtil.buildDataSpec(representation, representationHolder.selectedBaseUrl.url, rangedUri, 0, a0.k());
        if (factory != null) {
    ...
    protected Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource, int i10, Format format, int i11, @Nullable Object obj, long j10, int i12, long j11, long j12, @Nullable CmcdData.Factory factory) {
        ...
        if (representationHolder.chunkExtractor == null) {
            ...
            DataSpec dataSpecBuildDataSpec = DashUtil.buildDataSpec(representation, representationHolder.selectedBaseUrl.url, segmentUrl, representationHolder.isSegmentAvailableAtFullNetworkSpeed(j10, j12) ? 0 : 8, a0.k());
            if (factory != null) {
        ...
        DataSpec dataSpecBuildDataSpec2 = DashUtil.buildDataSpec(representation, representationHolder.selectedBaseUrl.url, segmentUrl, representationHolder.isSegmentAvailableAtFullNetworkSpeed(j13, j12) ? 0 : 8, a0.k());
        if (factory != null) {
