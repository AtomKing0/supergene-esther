...
public final class DashMediaSource extends BaseMediaSource {
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i10, Timeline.Period period, boolean z10) {
            ...
            return period.set(z10 ? this.manifest.getPeriod(i10).id : null, z10 ? Integer.valueOf(this.firstPeriodId + i10) : null, 0, this.manifest.getPeriodDurationUs(i10), Util.msToUs(this.manifest.getPeriod(i10).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
    ...
    static final class Iso8601Parser implements ParsingLoadable.Parser<Long> {
        ...
        public Long parse(Uri uri, InputStream inputStream) throws IOException {
            String line = new BufferedReader(new InputStreamReader(inputStream, e5.e.f25140c)).readLine();
            try {
    ...
    private static long getIntervalUntilNextManifestRefreshMs(DashManifest dashManifest, long j10) {
        ...
        return f5.e.a(jMsToUs4, 1000L, RoundingMode.CEILING);
    }
