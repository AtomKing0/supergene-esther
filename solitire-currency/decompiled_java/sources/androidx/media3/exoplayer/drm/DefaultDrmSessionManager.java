...
public class DefaultDrmSessionManager implements DrmSessionManager {
        ...
        public void acquire(final Format format) {
            ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).post(new Runnable() { // from class: androidx.media3.exoplayer.drm.g
                ...
                public final void run() {
                    this.f1358a.lambda$acquire$0(format);
                }
            });
        }
    ...
    private class ProvisioningManagerImpl implements DefaultDrmSession.ProvisioningManager {
        ...
        public void onProvisionCompleted() {
            ...
            com.google.common.collect.y yVarM = com.google.common.collect.y.m(this.sessionsAwaitingProvisioning);
    ...
    class ReferenceCountListenerImpl implements DefaultDrmSession.ReferenceCountListener {
        ...
        public void onReferenceCountDecremented(final DefaultDrmSession defaultDrmSession, int i10) {
            if (i10 == 1 && DefaultDrmSessionManager.this.prepareCallsCount > 0 && DefaultDrmSessionManager.this.sessionKeepaliveMs != C.TIME_UNSET) {
    ...
    private DrmSession maybeAcquirePlaceholderSession(int i10, boolean z10) {
        ...
        if (defaultDrmSession == null) {
            DefaultDrmSession defaultDrmSessionCreateAndAcquireSessionWithRetry = createAndAcquireSessionWithRetry(com.google.common.collect.y.q(), true, null, z10);
    ...
    private void releaseAllKeepaliveSessions() {
        i1 it = com.google.common.collect.c0.m(this.keepaliveSessions).iterator();
        while (it.hasNext()) {
    ...
    private void releaseAllPreacquiredSessions() {
        i1 it = com.google.common.collect.c0.m(this.preacquiredSessionReferences).iterator();
        while (it.hasNext()) {
    ...
    private DefaultDrmSessionManager(UUID uuid, ExoMediaDrm.Provider provider, MediaDrmCallback mediaDrmCallback, HashMap<String, String> map, boolean z10, int[] iArr, boolean z11, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j10) {
        ...
        this.preacquiredSessionReferences = c1.h();
        this.keepaliveSessions = c1.h();
        this.sessionKeepaliveMs = j10;
    }
