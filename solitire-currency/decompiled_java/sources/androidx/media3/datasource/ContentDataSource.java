    ...
    public long open(DataSpec dataSpec) throws ContentDataSourceException {
        ...
        try {
            ...
            if ("content".equals(uriNormalizeScheme.getScheme())) {
                ...
                assetFileDescriptorOpenAssetFileDescriptor = this.resolver.openAssetFileDescriptor(uriNormalizeScheme, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
            }
