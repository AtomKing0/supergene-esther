...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    private UrlRequest.Builder buildRequestBuilder(DataSpec dataSpec, UrlRequest.Callback callback) throws IOException {
        ...
        if (dataSpec.httpBody != null && !map.containsKey(nb.K)) {
        ...
        try {
            ...
            try {
                ...
                if (iOException != null) {
                    ...
                    if (message == null || !e5.c.e(message).contains("err_cleartext_not_permitted")) {
                ...
                if (pVar != null && (firstHeader = getFirstHeader(asMap, nb.K)) != null && !pVar.apply(firstHeader)) {
