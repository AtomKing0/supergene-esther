...
public final class TrackSelectionDialogBuilder {
    ...
    private com.google.common.collect.a0<TrackGroup, TrackSelectionOverride> overrides;
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, List<Tracks.Group> list, DialogCallback dialogCallback) {
        ...
        this.trackGroups = com.google.common.collect.y.m(list);
        this.callback = dialogCallback;
        this.overrides = com.google.common.collect.a0.k();
    }
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.i0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                this.f1654a.lambda$setUpDialogView$1(trackSelectionView, dialogInterface, i10);
            }
        };
    }
    ...
    public TrackSelectionDialogBuilder setOverride(@Nullable TrackSelectionOverride trackSelectionOverride) {
        return setOverrides(trackSelectionOverride == null ? Collections.emptyMap() : com.google.common.collect.a0.l(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride));
    }

    public TrackSelectionDialogBuilder setOverrides(Map<TrackGroup, TrackSelectionOverride> map) {
        this.overrides = com.google.common.collect.a0.c(map);
        return this;
    }
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, final Player player, final int i10) {
        this.context = context;
        this.title = charSequence;
        com.google.common.collect.y<Tracks.Group> groups = (player.isCommandAvailable(30) ? player.getCurrentTracks() : Tracks.EMPTY).getGroups();
        ...
        this.callback = new DialogCallback() { // from class: androidx.media3.ui.h0
