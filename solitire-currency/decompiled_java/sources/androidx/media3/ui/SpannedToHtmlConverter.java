...
final class SpannedToHtmlConverter {
    ...
    static final class SpanInfo {
        ...
        private static final Comparator<SpanInfo> FOR_OPENING_TAGS = new Comparator() { // from class: androidx.media3.ui.d0
        ...
        private static final Comparator<SpanInfo> FOR_CLOSING_TAGS = new Comparator() { // from class: androidx.media3.ui.e0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    public static HtmlAndCss convert(@Nullable CharSequence charSequence, float f10) {
        if (charSequence == null) {
            return new HtmlAndCss("", com.google.common.collect.a0.k());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), com.google.common.collect.a0.k());
        }
        ...
        while (i10 < sparseArrayFindSpanTransitions.size()) {
            ...
            sb.append(escapeHtml(spanned.subSequence(i11, iKeyAt)));
        ...
        sb.append(escapeHtml(spanned.subSequence(i11, spanned.length())));
