...
public class PlayerNotificationManager {
    ...
    protected PlayerNotificationManager(Context context, String str, int i10, MediaDescriptionAdapter mediaDescriptionAdapter, @Nullable NotificationListener notificationListener, @Nullable CustomActionReceiver customActionReceiver, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, @Nullable String str2) {
        ...
        this.instanceId = i19;
        this.mainHandler = Util.createHandler(Looper.getMainLooper(), new Handler.Callback() { // from class: androidx.media3.ui.a0
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f1642a.handleMessage(message);
            }
        });
    ...
    private static PendingIntent createBroadcastIntent(String str, Context context, int i10) {
        ...
        return PendingIntent.getBroadcast(context, i10, intent, Util.SDK_INT >= 23 ? 201326592 : C.BUFFER_FLAG_FIRST_SAMPLE);
    }
