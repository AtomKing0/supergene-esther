...
public final class VorbisUtil {
    ...
    public static Metadata parseVorbisComments(List<String> list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            String[] strArrSplitAtFirst = Util.splitAtFirst(str, v8.i.f15833b);
    ...
    public static y<byte[]> parseVorbisCsdFromEsdsInitializationData(byte[] bArr) {
