...
public final class DtsUtil {
    ...
    private static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, 112, 128, PsExtractor.AUDIO_STREAM, 224, 256, RendererCapabilities.DECODER_SUPPORT_MASK, 448, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, IronSourceConstants.IS_AD_UNIT_CAPPED, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    private static void checkCrc(byte[] bArr, int i10) throws ParserException {
        int i11 = i10 - 2;
        if (((bArr[i10 - 1] & FIRST_BYTE_14B_LE) | ((bArr[i11] << 8) & 65535)) != Util.crc16(bArr, 0, i11, 65535)) {
    ...
    */
    ...
    public static Format parseDtsFormat(byte[] bArr, @Nullable String str, @Nullable String str2, int i10, @Nullable DrmInitData drmInitData) {
        ...
        return new Format.Builder().setId(str).setSampleMimeType(MimeTypes.AUDIO_DTS).setAverageBitrate(i13).setChannelCount(i11 + (normalizedFrame.readBits(2) > 0 ? 1 : 0)).setSampleRate(i12).setDrmInitData(drmInitData).setLanguage(str2).setRoleFlags(i10).build();
    }
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_EXPRESS, bits2, i12, bits4, jScaleLargeTimestamp, 0);
    }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_X, 2, i13, unsignedVarInt + unsignedVarInt2 + (atomicInteger.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j10, 0);
    }
