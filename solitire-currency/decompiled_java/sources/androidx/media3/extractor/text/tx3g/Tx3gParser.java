...
public final class Tx3gParser implements SubtitleParser {
    ...
    public /* synthetic */ Subtitle parseToLegacySubtitle(byte[] bArr, int i10, int i11) {
        return androidx.media3.extractor.text.e.b(this, bArr, i10, i11);
    }
    ...
    public void parse(byte[] bArr, int i10, int i11, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        ...
        if (subtitleText.isEmpty()) {
            consumer.accept(new CuesWithTiming(y.q(), C.TIME_UNSET, C.TIME_UNSET));
            return;
        }
        ...
        consumer.accept(new CuesWithTiming(y.r(new Cue.Builder().setText(spannableStringBuilder).setLine(fConstrainValue, 0).setLineAnchor(0).build()), C.TIME_UNSET, C.TIME_UNSET));
    }
}
