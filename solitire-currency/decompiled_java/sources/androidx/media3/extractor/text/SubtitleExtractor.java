...
public class SubtitleExtractor implements Extractor {
    ...
    private void parseAndWriteToOutput() throws IOException {
        try {
            long j10 = this.seekTimeUs;
            this.subtitleParser.parse(this.subtitleData, j10 != C.TIME_UNSET ? SubtitleParser.OutputOptions.cuesAfterThenRemainingCuesBefore(j10) : SubtitleParser.OutputOptions.allCues(), new Consumer() { // from class: androidx.media3.extractor.text.c
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    this.f1634a.lambda$parseAndWriteToOutput$0((CuesWithTiming) obj);
                }
            });
    ...
    private boolean skipInput(ExtractorInput extractorInput) throws IOException {
        return extractorInput.skip((extractorInput.getLength() > (-1L) ? 1 : (extractorInput.getLength() == (-1L) ? 0 : -1)) != 0 ? g5.e.d(extractorInput.getLength()) : 1024) == -1;
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (this.state == 1) {
            int iD = extractorInput.getLength() != -1 ? g5.e.d(extractorInput.getLength()) : 1024;
