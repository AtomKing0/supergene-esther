...
public final class TextInformationFrame extends Id3Frame {
    ...
    public void populateMediaMetadata(MediaMetadata.Builder builder) {
        ...
        try {
            switch (b10) {
                ...
                case 6:
                case 20:
                    String[] strArrSplit = Util.split(this.values.get(0), UnityAdsConstants.DefaultUrls.AD_ASSET_PATH);
    ...
    public TextInformationFrame(String str, @Nullable String str2, List<String> list) {
        ...
        y<String> yVarM = y.m(list);
        this.values = yVarM;
        this.value = yVarM.get(0);
    }

    @Deprecated
    public TextInformationFrame(String str, @Nullable String str2, String str3) {
        this(str, str2, y.r(str3));
    }

    private TextInformationFrame(Parcel parcel) {
        this((String) Assertions.checkNotNull(parcel.readString()), parcel.readString(), y.n((String[]) Assertions.checkNotNull(parcel.createStringArray())));
    }
}
