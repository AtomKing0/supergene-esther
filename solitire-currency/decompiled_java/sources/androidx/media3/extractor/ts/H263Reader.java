...
public final class H263Reader implements ElementaryStreamReader {
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i10, String str) {
        ...
        parsableBitArray.skipBit();
        parsableBitArray.skipBit();
        return new Format.Builder().setId(str).setSampleMimeType(MimeTypes.VIDEO_MP4V).setWidth(bits5).setHeight(bits6).setPixelWidthHeightRatio(f10).setInitializationData(Collections.singletonList(bArrCopyOf)).build();
    }
