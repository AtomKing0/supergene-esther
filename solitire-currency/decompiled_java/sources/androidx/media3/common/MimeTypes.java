...
public final class MimeTypes {
    ...
    public static String getMediaMimeType(@Nullable String str) {
        ...
        if (!strE.startsWith("mp4a")) {
            return strE.startsWith("mha1") ? AUDIO_MPEGH_MHA1 : strE.startsWith("mhm1") ? AUDIO_MPEGH_MHM1 : (strE.startsWith("ac-3") || strE.startsWith("dac3")) ? AUDIO_AC3 : (strE.startsWith("ec-3") || strE.startsWith("dec3")) ? AUDIO_E_AC3 : strE.startsWith(CODEC_E_AC3_JOC) ? AUDIO_E_AC3_JOC : (strE.startsWith("ac-4") || strE.startsWith("dac4")) ? AUDIO_AC4 : strE.startsWith("dtsc") ? AUDIO_DTS : strE.startsWith("dtse") ? AUDIO_DTS_EXPRESS : (strE.startsWith("dtsh") || strE.startsWith("dtsl")) ? AUDIO_DTS_HD : strE.startsWith("dtsx") ? AUDIO_DTS_X : strE.startsWith("opus") ? AUDIO_OPUS : strE.startsWith("vorbis") ? AUDIO_VORBIS : strE.startsWith("flac") ? AUDIO_FLAC : strE.startsWith("stpp") ? APPLICATION_TTML : strE.startsWith("wvtt") ? TEXT_VTT : strE.contains("cea708") ? APPLICATION_CEA708 : (strE.contains("eia608") || strE.contains("cea608")) ? APPLICATION_CEA608 : getCustomMimeTypeForCodec(strE);
        }
