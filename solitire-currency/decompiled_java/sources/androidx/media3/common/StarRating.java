...
public final class StarRating extends Rating {
    ...
    @UnstableApi
    @Deprecated
    public static final Bundleable.Creator<StarRating> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.z2
    ...
    public int hashCode() {
        return e5.k.b(Integer.valueOf(this.maxStars), Float.valueOf(this.starRating));
    }
