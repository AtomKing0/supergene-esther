...
public class PlaybackException extends Exception implements Bundleable {
    ...
    @UnstableApi
    @Deprecated
    public static final Bundleable.Creator<PlaybackException> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.d0
    ...
    */
    ...
    @UnstableApi
    protected PlaybackException(@Nullable String str, @Nullable Throwable th, int i10, long j10) {
        super(str, th);
        this.errorCode = i10;
