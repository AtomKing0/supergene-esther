...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    private final HashSet<com.google.common.util.concurrent.m<?>> pendingOperations;
    ...
    protected static final class MediaItemData {
        ...
        public final com.google.common.collect.y<PeriodData> periods;
        ...
        public static final class Builder {
            ...
            private com.google.common.collect.y<PeriodData> periods;
            ...
            public Builder setPeriods(List<PeriodData> list) {
                ...
                this.periods = com.google.common.collect.y.m(list);
                return this;
            }
            ...
            public Builder(Object obj) {
                ...
                this.periods = com.google.common.collect.y.q();
            }
        ...
        private MediaItemData(Builder builder) {
            ...
            com.google.common.collect.y<PeriodData> yVar = builder.periods;
            this.periods = yVar;
    ...
    private static final class PlaylistTimeline extends Timeline {
        ...
        private final com.google.common.collect.y<MediaItemData> playlist;
        ...
        public PlaylistTimeline(com.google.common.collect.y<MediaItemData> yVar) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                MediaItemData mediaItemData = yVar.get(i10);
            ...
            for (int i12 = 0; i12 < size; i12++) {
                MediaItemData mediaItemData2 = yVar.get(i12);
    ...
    protected static final class State {
        ...
        public final com.google.common.collect.y<MediaItemData> playlist;
        ...
        public static final class Builder {
            ...
            private com.google.common.collect.y<MediaItemData> playlist;
            ...
            public Builder setPlaylist(List<MediaItemData> list) {
                ...
                this.playlist = com.google.common.collect.y.m(list);
            ...
            public Builder() {
                ...
                this.playlist = com.google.common.collect.y.q();
        ...
        private State(Builder builder) {
            ...
            PositionSupplier positionSupplierB = builder.contentPositionMs != null ? (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != C.TIME_UNSET) ? y2.b(builder.contentPositionMs.longValue(), builder.playbackParameters.speed) : y2.a(builder.contentPositionMs.longValue()) : builder.contentPositionMsSupplier;
            PositionSupplier positionSupplierB2 = builder.adPositionMs != null ? (builder.currentAdGroupIndex != -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0) ? y2.b(builder.adPositionMs.longValue(), 1.0f) : y2.a(builder.adPositionMs.longValue()) : builder.adPositionMsSupplier;
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j10, List<MediaItemData> list, int i10, long j11, boolean z10) {
        ...
        if (z12 || z11 || j11 < positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(y2.a(j11)).setTotalBufferedDurationMs(PositionSupplier.ZERO);
        } else if (j11 == positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10);
            if (state.currentAdGroupIndex == -1 || !z10) {
                builder.setCurrentAd(-1, -1).setTotalBufferedDurationMs(y2.a(getContentBufferedPositionMsInternal(state) - positionOrDefaultInMediaItem));
            } else {
                builder.setTotalBufferedDurationMs(y2.a(state.adBufferedPositionMsSupplier.get() - state.adPositionMsSupplier.get()));
            }
        } else {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(y2.a(Math.max(getContentBufferedPositionMsInternal(state), j11))).setTotalBufferedDurationMs(y2.a(Math.max(0L, state.totalBufferedDurationMsSupplier.get() - (j11 - positionOrDefaultInMediaItem))));
        }
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new e5.u() { // from class: androidx.media3.common.j2
                @Override // e5.u
    ...
    private static Player.PositionInfo getPositionInfo(State state, boolean z10, Timeline.Window window, Timeline.Period period) {
        ...
        return new Player.PositionInfo(obj, currentMediaItemIndexInternal, mediaItem, obj2, i10, j10, contentPositionMsInternal, state.currentAdGroupIndex, state.currentAdIndexInAdGroup);
    }
    ...
    public static /* synthetic */ State lambda$stop$12(State state) {
        return state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(y2.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateStateForPendingOperation$62(com.google.common.util.concurrent.m mVar) {
        Util.castNonNull(this.state);
        this.pendingOperations.remove(mVar);
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i10, final long j10) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i10, j10), new e5.u() { // from class: androidx.media3.common.t2
                @Override // e5.u
                public final Object get() {
                    return this.f1070a.lambda$setMediaItemsInternal$2(list, state, i10, j10);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z10, boolean z11) {
        ...
        if (z14) {
            ...
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: androidx.media3.common.o0
        ...
        if (positionDiscontinuityReason != -1) {
            ...
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: androidx.media3.common.a1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (mediaItemTransitionReason != -1) {
            ...
            this.listeners.queueEvent(1, new ListenerSet.Event() { // from class: androidx.media3.common.m1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!Util.areEqual(state2.playerError, state.playerError)) {
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.common.o1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
            ...
            if (state.playerError != null) {
                this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.common.p1
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
        ...
        if (!state2.trackSelectionParameters.equals(state.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: androidx.media3.common.r1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new ListenerSet.Event() { // from class: androidx.media3.common.s1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.common.t1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.isLoading != state.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: androidx.media3.common.u1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || z13) {
            this.listeners.queueEvent(-1, new ListenerSet.Event() { // from class: androidx.media3.common.v1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z13) {
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: androidx.media3.common.p0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || state2.playWhenReadyChangeReason != state.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: androidx.media3.common.q0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: androidx.media3.common.r0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: androidx.media3.common.s0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.common.t0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.repeatMode != state.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.common.v0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.shuffleModeEnabled != state.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.common.w0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekBackIncrementMs != state.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: androidx.media3.common.x0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekForwardIncrementMs != state.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: androidx.media3.common.y0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.maxSeekToPreviousPositionMs != state.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: androidx.media3.common.z0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.audioAttributes.equals(state.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.common.b1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.videoSize.equals(state.videoSize)) {
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: androidx.media3.common.c1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.deviceInfo.equals(state.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: androidx.media3.common.d1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playlistMetadata.equals(state.playlistMetadata)) {
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: androidx.media3.common.e1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state.newlyRenderedFirstFrame) {
            this.listeners.queueEvent(26, new g1());
        }
        if (!state2.surfaceSize.equals(state.surfaceSize)) {
            this.listeners.queueEvent(24, new ListenerSet.Event() { // from class: androidx.media3.common.h1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.volume != state.volume) {
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: androidx.media3.common.i1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.deviceVolume != state.deviceVolume || state2.isDeviceMuted != state.isDeviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.common.j1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.currentCues.equals(state.currentCues)) {
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: androidx.media3.common.k1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != C.TIME_UNSET) {
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: androidx.media3.common.l1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.availableCommands.equals(state.availableCommands)) {
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.common.n1
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    private void updateStateForPendingOperation(com.google.common.util.concurrent.m<?> mVar, e5.u<State> uVar) {
        updateStateForPendingOperation(mVar, uVar, false, false);
    }
    ...
    public final void addMediaItems(int i10, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new e5.u() { // from class: androidx.media3.common.n2
            @Override // e5.u
            public final Object get() {
                return this.f1037a.lambda$addMediaItems$3(state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new e5.u() { // from class: androidx.media3.common.g2
                @Override // e5.u
                public final Object get() {
    ...
    protected com.google.common.util.concurrent.m<?> handleAddMediaItems(int i10, List<MediaItem> list) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    protected com.google.common.util.concurrent.m<?> handleClearVideoOutput(@Nullable Object obj) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VIDEO_SURFACE");
    }

    protected com.google.common.util.concurrent.m<?> handleDecreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    protected com.google.common.util.concurrent.m<?> handleIncreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    protected com.google.common.util.concurrent.m<?> handleMoveMediaItems(int i10, int i11, int i12) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    protected com.google.common.util.concurrent.m<?> handlePrepare() {
        throw new IllegalStateException("Missing implementation to handle COMMAND_PREPARE");
    }

    protected com.google.common.util.concurrent.m<?> handleRelease() {
        throw new IllegalStateException("Missing implementation to handle COMMAND_RELEASE");
    }

    protected com.google.common.util.concurrent.m<?> handleRemoveMediaItems(int i10, int i11) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    protected com.google.common.util.concurrent.m<?> handleReplaceMediaItems(int i10, int i11, List<MediaItem> list) {
        com.google.common.util.concurrent.m<?> mVarHandleAddMediaItems = handleAddMediaItems(i11, list);
        final com.google.common.util.concurrent.m<?> mVarHandleRemoveMediaItems = handleRemoveMediaItems(i10, i11);
        return Util.transformFutureAsync(mVarHandleAddMediaItems, new c() { // from class: androidx.media3.common.a2
            @Override // com.google.common.util.concurrent.c
            public final com.google.common.util.concurrent.m apply(Object obj) {
                return SimpleBasePlayer.lambda$handleReplaceMediaItems$31(mVarHandleRemoveMediaItems, obj);
            }
        });
    }

    protected com.google.common.util.concurrent.m<?> handleSeek(int i10, long j10, int i11) {
        throw new IllegalStateException("Missing implementation to handle one of the COMMAND_SEEK_*");
    }

    protected com.google.common.util.concurrent.m<?> handleSetAudioAttributes(AudioAttributes audioAttributes, boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_AUDIO_ATTRIBUTES");
    }

    protected com.google.common.util.concurrent.m<?> handleSetDeviceMuted(boolean z10, int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    protected com.google.common.util.concurrent.m<?> handleSetDeviceVolume(@IntRange(from = 0) int i10, int i11) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_DEVICE_VOLUME or COMMAND_SET_DEVICE_VOLUME_WITH_FLAGS");
    }

    protected com.google.common.util.concurrent.m<?> handleSetMediaItems(List<MediaItem> list, int i10, long j10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_MEDIA_ITEM(S)");
    }

    protected com.google.common.util.concurrent.m<?> handleSetPlayWhenReady(boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_PLAY_PAUSE");
    }

    protected com.google.common.util.concurrent.m<?> handleSetPlaybackParameters(PlaybackParameters playbackParameters) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_SPEED_AND_PITCH");
    }

    protected com.google.common.util.concurrent.m<?> handleSetPlaylistMetadata(MediaMetadata mediaMetadata) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_PLAYLIST_METADATA");
    }

    protected com.google.common.util.concurrent.m<?> handleSetRepeatMode(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_REPEAT_MODE");
    }

    protected com.google.common.util.concurrent.m<?> handleSetShuffleModeEnabled(boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_SHUFFLE_MODE");
    }

    protected com.google.common.util.concurrent.m<?> handleSetTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_TRACK_SELECTION_PARAMETERS");
    }

    protected com.google.common.util.concurrent.m<?> handleSetVideoOutput(Object obj) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VIDEO_SURFACE");
    }

    protected com.google.common.util.concurrent.m<?> handleSetVolume(@FloatRange(from = 0.0d, to = 1.0d) float f10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VOLUME");
    }

    protected com.google.common.util.concurrent.m<?> handleStop() {
    ...
    public final void increaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new e5.u() { // from class: androidx.media3.common.m2
                @Override // e5.u
                public final Object get() {
    ...
    public final void moveMediaItems(final int i10, int i11, int i12) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i10, iMin, iMin2), new e5.u() { // from class: androidx.media3.common.i2
            @Override // e5.u
            public final Object get() {
                return this.f1013a.lambda$moveMediaItems$4(state, i10, iMin, iMin2);
            }
        });
    }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new e5.u() { // from class: androidx.media3.common.k2
                @Override // e5.u
                public final Object get() {
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new e5.u() { // from class: androidx.media3.common.l2
                @Override // e5.u
                public final Object get() {
            ...
            this.state = this.state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(y2.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
        }
    }
    ...
    public final void removeMediaItems(final int i10, int i11) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i10, iMin), new e5.u() { // from class: androidx.media3.common.o2
            @Override // e5.u
            public final Object get() {
                return this.f1044a.lambda$removeMediaItems$6(state, i10, iMin);
            }
        });
    }
    ...
    public final void replaceMediaItems(final int i10, int i11, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i11, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i10, iMin, list), new e5.u() { // from class: androidx.media3.common.q1
            @Override // e5.u
            public final Object get() {
                return this.f1053a.lambda$replaceMediaItems$5(state, list, iMin, i10);
            }
        });
    }
    ...
    public final void seekTo(final int i10, final long j10, int i11, boolean z10) {
        ...
        if (state.playlist.isEmpty() || i10 < state.playlist.size()) {
            updateStateForPendingOperation(handleSeek(i10, j10, i11), new e5.u() { // from class: androidx.media3.common.u0
                @Override // e5.u
                public final Object get() {
                    return SimpleBasePlayer.lambda$seekTo$10(state, i10, j10);
                }
            }, true, z10);
        }
    }
    ...
    public final void setAudioAttributes(final AudioAttributes audioAttributes, boolean z10) {
        ...
        if (shouldHandleCommand(35)) {
            updateStateForPendingOperation(handleSetAudioAttributes(audioAttributes, z10), new e5.u() { // from class: androidx.media3.common.l0
                @Override // e5.u
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, 1), new e5.u() { // from class: androidx.media3.common.y1
                @Override // e5.u
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, 1), new e5.u() { // from class: androidx.media3.common.j0
                @Override // e5.u
                public final Object get() {
    ...
    public final void setPlayWhenReady(final boolean z10) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z10), new e5.u() { // from class: androidx.media3.common.x1
                @Override // e5.u
                public final Object get() {
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new e5.u() { // from class: androidx.media3.common.v2
                @Override // e5.u
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new e5.u() { // from class: androidx.media3.common.n0
                @Override // e5.u
                public final Object get() {
    ...
    public final void setRepeatMode(final int i10) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i10), new e5.u() { // from class: androidx.media3.common.z1
                @Override // e5.u
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z10) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z10), new e5.u() { // from class: androidx.media3.common.q2
                @Override // e5.u
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new e5.u() { // from class: androidx.media3.common.r2
                @Override // e5.u
                public final Object get() {
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new e5.u() { // from class: androidx.media3.common.u2
                    @Override // e5.u
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(@Nullable final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new e5.u() { // from class: androidx.media3.common.m0
                    @Override // e5.u
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(@Nullable final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new e5.u() { // from class: androidx.media3.common.p2
                    @Override // e5.u
                    public final Object get() {
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new e5.u() { // from class: androidx.media3.common.w1
                    @Override // e5.u
                    public final Object get() {
    ...
    public final void setVolume(final float f10) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f10), new e5.u() { // from class: androidx.media3.common.f2
                @Override // e5.u
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new e5.u() { // from class: androidx.media3.common.f1
                @Override // e5.u
                public final Object get() {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.e2
            @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f1004a.lambda$new$0((Player.Listener) obj, flagSet);
            }
        });
    }

    private void updateStateForPendingOperation(final com.google.common.util.concurrent.m<?> mVar, e5.u<State> uVar, boolean z10, boolean z11) {
        if (mVar.isDone() && this.pendingOperations.isEmpty()) {
            updateStateAndInformListeners(getState(), z10, z11);
            return;
        }
        this.pendingOperations.add(mVar);
        updateStateAndInformListeners(getPlaceholderState(uVar.get()), z10, z11);
        mVar.addListener(new Runnable() { // from class: androidx.media3.common.c2
            @Override // java.lang.Runnable
            public final void run() {
                this.f999a.lambda$updateStateForPendingOperation$62(mVar);
            }
        }, new Executor() { // from class: androidx.media3.common.d2
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                this.f1002a.postOrRunOnApplicationHandler(runnable);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume(int i10) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i10), new e5.u() { // from class: androidx.media3.common.b2
                @Override // e5.u
                public final Object get() {
    ...
    public final void increaseDeviceVolume(int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i10), new e5.u() { // from class: androidx.media3.common.k0
                @Override // e5.u
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10, int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, i10), new e5.u() { // from class: androidx.media3.common.h2
                @Override // e5.u
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10, int i11) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, i11), new e5.u() { // from class: androidx.media3.common.s2
                @Override // e5.u
                public final Object get() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ com.google.common.util.concurrent.m lambda$handleReplaceMediaItems$31(com.google.common.util.concurrent.m mVar, Object obj) throws Exception {
        return mVar;
    }
}
