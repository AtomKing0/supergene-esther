...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract m<Long> getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract m<WorkInfo> getWorkInfoById(@NonNull UUID uuid);

    @NonNull
    public abstract h<WorkInfo> getWorkInfoByIdFlow(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract m<List<WorkInfo>> getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract h<List<WorkInfo>> getWorkInfosByTagFlow(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract h<List<WorkInfo>> getWorkInfosFlow(@NonNull WorkQuery workQuery);

    @NonNull
    public abstract m<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str);

    @NonNull
    public abstract h<List<WorkInfo>> getWorkInfosForUniqueWorkFlow(@NonNull String str);
    ...
    @NonNull
    public abstract m<UpdateResult> updateWork(@NonNull WorkRequest workRequest);
