...
public class ProfileStoreImpl implements ProfileStore {
    ...
    public Profile getOrCreateProfile(@NonNull String str) {
        if (WebViewFeatureInternal.MULTI_PROFILE.isSupportedByWebView()) {
            return new ProfileImpl((ProfileBoundaryInterface) wa.a.a(ProfileBoundaryInterface.class, this.mProfileStoreImpl.getOrCreateProfile(str)));
        }
        throw WebViewFeatureInternal.getUnsupportedOperationException();
    }
    ...
    public Profile getProfile(@NonNull String str) {
        ...
        if (profile != null) {
            return new ProfileImpl((ProfileBoundaryInterface) wa.a.a(ProfileBoundaryInterface.class, profile));
        }
        return null;
    }
