...
final class SaversKt$TextGeometricTransformSaver$1 extends v implements p<SaverScope, TextGeometricTransform, Object> {
    ...
    public final Object mo4invoke(@NotNull SaverScope Saver, @NotNull TextGeometricTransform it) {
        t.i(Saver, "$this$Saver");
        t.i(it, "it");
        return kotlin.collections.v.f(Float.valueOf(it.getScaleX()), Float.valueOf(it.getSkewX()));
    }
}
