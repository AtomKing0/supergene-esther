...
public final class SizeKt$requiredWidth3ABfNKs$$inlined$debugInspectorInfo$1 extends v implements h9.l<InspectorInfo, k0> {
    final /* synthetic */ float $width$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SizeKt$requiredWidth3ABfNKs$$inlined$debugInspectorInfo$1(float f10) {
        super(1);
