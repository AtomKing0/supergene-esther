...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedWidthModifier(@NotNull WindowInsets insets, @NotNull h9.l<? super InspectorInfo, k0> inspectorInfo, @NotNull q<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> widthCalc) {
        super(inspectorInfo);
        t.i(insets, "insets");
        t.i(inspectorInfo, "inspectorInfo");
        t.i(widthCalc, "widthCalc");
        this.insets = insets;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return t.d(this.insets, derivedWidthModifier.insets) && t.d(this.widthCalc, derivedWidthModifier.widthCalc);
    }
    ...
    public MeasureResult mo23measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        if (iIntValue == 0) {
            return MeasureScope.CC.p(measure, 0, 0, null, DerivedWidthModifier$measure$1.INSTANCE, 4, null);
        }
        Placeable placeableMo2987measureBRTryo0 = measurable.mo2987measureBRTryo0(Constraints.m3632copyZbe2FdA$default(j10, iIntValue, iIntValue, 0, 0, 12, null));
        return MeasureScope.CC.p(measure, iIntValue, placeableMo2987measureBRTryo0.getHeight(), null, new DerivedWidthModifier$measure$2(placeableMo2987measureBRTryo0), 4, null);
    }
