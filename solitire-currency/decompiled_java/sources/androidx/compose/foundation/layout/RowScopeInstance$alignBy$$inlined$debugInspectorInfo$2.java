...
public final class RowScopeInstance$alignBy$$inlined$debugInspectorInfo$2 extends v implements h9.l<InspectorInfo, k0> {
    final /* synthetic */ h9.l $alignmentLineBlock$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RowScopeInstance$alignBy$$inlined$debugInspectorInfo$2(h9.l lVar) {
        super(1);
