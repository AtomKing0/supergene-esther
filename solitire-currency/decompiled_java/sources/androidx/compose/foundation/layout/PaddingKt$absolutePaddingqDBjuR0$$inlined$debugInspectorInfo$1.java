...
public final class PaddingKt$absolutePaddingqDBjuR0$$inlined$debugInspectorInfo$1 extends v implements h9.l<InspectorInfo, k0> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(TtmlNode.LEFT, Dp.m3671boximpl(this.$left$inlined));
        inspectorInfo.getProperties().set("top", Dp.m3671boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set(TtmlNode.RIGHT, Dp.m3671boximpl(this.$right$inlined));
