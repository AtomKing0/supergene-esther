...
final class LazySemanticsKt$lazyListSemantics$1$scrollToIndexAction$1 extends v implements l<Integer, Boolean> {
    ...
    static final class AnonymousClass2 extends kotlin.coroutines.jvm.internal.l implements p<o0, d<? super k0>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                int i11 = this.$index;
                this.label = 1;
                if (LazyListState.scrollToItem$default(lazyListState, i11, 0, this, 2, null) == objE) {
                    return objE;
                }
            } else {
                if (i10 != 1) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    LazySemanticsKt$lazyListSemantics$1$scrollToIndexAction$1(LazyListState lazyListState, o0 o0Var) {
        super(1);
        this.$state = lazyListState;
