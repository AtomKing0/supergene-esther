...
final class LazySemanticsKt$lazyListSemantics$1$1 extends v implements l<SemanticsPropertyReceiver, k0> {
    ...
    LazySemanticsKt$lazyListSemantics$1$1(l<Object, Integer> lVar, boolean z10, ScrollAxisRange scrollAxisRange, p<? super Float, ? super Float, Boolean> pVar, l<? super Integer, Boolean> lVar2, CollectionInfo collectionInfo) {
        super(1);
