...
final class ClickableKt$clickable$4$gesture$1 extends kotlin.coroutines.jvm.internal.l implements h9.p<PointerInputScope, z8.d<? super k0>, Object> {
    ...
    static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.l implements h9.q<PressGestureScope, Offset, z8.d<? super k0>, Object> {
        final /* synthetic */ State<h9.a<Boolean>> $delayPressInteraction;
        final /* synthetic */ boolean $enabled;
        final /* synthetic */ MutableInteractionSource $interactionSource;
        final /* synthetic */ MutableState<PressInteraction.Press> $pressedInteraction;
        ...
        AnonymousClass1(boolean z10, MutableInteractionSource mutableInteractionSource, MutableState<PressInteraction.Press> mutableState, State<? extends h9.a<Boolean>> state, z8.d<? super AnonymousClass1> dVar) {
            super(3, dVar);
            this.$enabled = z10;
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, z8.d<? super k0> dVar) {
            return m193invoked4ec7I(pressGestureScope, offset.m1377unboximpl(), dVar);
        }

        @Nullable
        /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m193invoked4ec7I(@NotNull PressGestureScope pressGestureScope, long j10, @Nullable z8.d<? super k0> dVar) {
    ...
    static final class AnonymousClass2 extends v implements h9.l<Offset, k0> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass2(boolean z10, State<? extends h9.a<k0>> state) {
            super(1);
            this.$enabled = z10;
        ...
        public /* bridge */ /* synthetic */ k0 invoke(Offset offset) {
            m194invokek4lQ0M(offset.m1377unboximpl());
            return k0.f35197a;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    ClickableKt$clickable$4$gesture$1(boolean z10, MutableInteractionSource mutableInteractionSource, MutableState<PressInteraction.Press> mutableState, State<? extends h9.a<Boolean>> state, State<? extends h9.a<k0>> state2, z8.d<? super ClickableKt$clickable$4$gesture$1> dVar) {
        super(2, dVar);
        this.$enabled = z10;
        this.$interactionSource = mutableInteractionSource;
        this.$pressedInteraction = mutableState;
    ...
    public final Object mo4invoke(@NotNull PointerInputScope pointerInputScope, @Nullable z8.d<? super k0> dVar) {
        return ((ClickableKt$clickable$4$gesture$1) create(pointerInputScope, dVar)).invokeSuspend(k0.f35197a);
    }
