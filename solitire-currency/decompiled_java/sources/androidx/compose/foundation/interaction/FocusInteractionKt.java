...
public final class FocusInteractionKt {
    ...
    static final class AnonymousClass1 extends l implements p<o0, d<? super k0>, Object> {
        ...
        public final d<k0> create(@Nullable Object obj, @NotNull d<?> dVar) {
            return new AnonymousClass1(this.$this_collectIsFocusedAsState, this.$isFocused, dVar);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                h<Interaction> interactions = this.$this_collectIsFocusedAsState.getInteractions();
                final MutableState<Boolean> mutableState = this.$isFocused;
                i<Interaction> iVar = new i<Interaction>() { // from class: androidx.compose.foundation.interaction.FocusInteractionKt.collectIsFocusedAsState.1.1
                    @Override // s9.i
