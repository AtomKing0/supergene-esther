...
final class ComposerImpl$insertMovableContentReferences$1$1$5$1$2 extends v implements q<Applier<?>, SlotWriter, RememberManager, k0> {
    ...
    ComposerImpl$insertMovableContentReferences$1$1$5$1$2(l0 l0Var, List<q<Applier<?>, SlotWriter, RememberManager, k0>> list) {
        super(3);
