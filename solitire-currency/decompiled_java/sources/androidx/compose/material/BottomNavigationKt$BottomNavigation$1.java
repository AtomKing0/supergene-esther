...
final class BottomNavigationKt$BottomNavigation$1 extends v implements p<Composer, Integer, k0> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ q<RowScope, Composer, Integer, k0> $content;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    BottomNavigationKt$BottomNavigation$1(q<? super RowScope, ? super Composer, ? super Integer, k0> qVar, int i10) {
        super(2);
        this.$content = qVar;
        this.$$dirty = i10;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i10) {
        ...
        Modifier modifierSelectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m426height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), BottomNavigationKt.BottomNavigationHeight));
        Arrangement.HorizontalOrVertical spaceBetween = Arrangement.INSTANCE.getSpaceBetween();
        q<RowScope, Composer, Integer, k0> qVar = this.$content;
        int i11 = ((this.$$dirty >> 3) & 7168) | 48;
        composer.startReplaceableGroup(693286680);
        int i12 = i11 >> 3;
        MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(spaceBetween, Alignment.Companion.getTop(), composer, (i12 & 112) | (i12 & 14));
