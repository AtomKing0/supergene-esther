...
final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1 extends v implements p<Composer, Integer, k0> {
    ...
    static final class AnonymousClass2 extends v implements l<IntSize, k0> {
        ...
        public /* bridge */ /* synthetic */ k0 invoke(IntSize intSize) {
            m1224invokeozmzZPI(intSize.m3837unboximpl());
            return k0.f35197a;
        }

        /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
        public final void m1224invokeozmzZPI(long j10) {
            this.$this_apply.m1226setPopupContentSizefhxjrPA(IntSize.m3825boximpl(j10));
    ...
    static final class AnonymousClass3 extends v implements p<Composer, Integer, k0> {
        ...
        public final void invoke(@Nullable Composer composer, int i10) {
            if ((i10 & 11) == 2 && composer.getSkipping()) {
                ...
                ExposedDropdownMenuPopupKt.m1222ExposedDropdownMenuPopup$lambda0(this.$currentContent$delegate).mo4invoke(composer, 0);
            }
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1(PopupLayout popupLayout, State<? extends p<? super Composer, ? super Integer, k0>> state) {
        super(2);
        this.$this_apply = popupLayout;
        this.$currentContent$delegate = state;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i10) {
        ...
        ExposedDropdownMenuPopupKt.C09601 c09601 = ExposedDropdownMenuPopupKt.C09601.INSTANCE;
