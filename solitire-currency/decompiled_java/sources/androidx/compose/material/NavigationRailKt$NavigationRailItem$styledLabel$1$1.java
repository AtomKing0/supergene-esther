...
final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends v implements p<Composer, Integer, k0> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ p<Composer, Integer, k0> $label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    NavigationRailKt$NavigationRailItem$styledLabel$1$1(p<? super Composer, ? super Integer, k0> pVar, int i10) {
        super(2);
        this.$label = pVar;
        this.$$dirty = i10;
    }
