...
final class TextFieldImplKt$CommonDecorationBox$3$drawBorder$1 extends v implements p<Composer, Integer, k0> {
    ...
    TextFieldImplKt$CommonDecorationBox$3$drawBorder$1(MutableState<Size> mutableState, PaddingValues paddingValues, p<? super Composer, ? super Integer, k0> pVar, int i10) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i10) {
        ...
        Modifier modifierM1086outlineCutout12SF9DM = OutlinedTextFieldKt.m1086outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, OutlinedTextFieldKt.BorderId), this.$labelSize.getValue().m1441unboximpl(), this.$contentPadding);
        p<Composer, Integer, k0> pVar = this.$border;
        int i11 = this.$$dirty1;
        ...
        q<SkippableUpdater<ComposeUiNode>, Composer, Integer, k0> qVarMaterializerOf = LayoutKt.materializerOf(modifierM1086outlineCutout12SF9DM);
        ...
        if (pVar != null) {
            pVar.mo4invoke(composer, Integer.valueOf((i11 >> 12) & 14));
        }
