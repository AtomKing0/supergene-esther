...
final class NavigationRailKt$NavigationRailItem$2$1 extends v implements q<Float, Composer, Integer, k0> {
    ...
    NavigationRailKt$NavigationRailItem$2$1(boolean z10, p<? super Composer, ? super Integer, k0> pVar, p<? super Composer, ? super Integer, k0> pVar2, int i10) {
        super(3);
