...
final class SwitchKt$SwitchImpl$3$1 extends v implements l<Density, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
        return IntOffset.m3782boximpl(m1165invokeBjo55l4(density));
    }

    /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
    public final long m1165invokeBjo55l4(@NotNull Density offset) {
        t.i(offset, "$this$offset");
        return IntOffsetKt.IntOffset(c.c(this.$thumbValue.getValue().floatValue()), 0);
    }
}
