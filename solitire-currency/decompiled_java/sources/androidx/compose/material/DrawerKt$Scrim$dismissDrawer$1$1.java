...
@f(c = "androidx.compose.material.DrawerKt$Scrim$dismissDrawer$1$1", f = "Drawer.kt", l = {664}, m = "invokeSuspend")
final class DrawerKt$Scrim$dismissDrawer$1$1 extends l implements p<PointerInputScope, d<? super k0>, Object> {
    final /* synthetic */ a<k0> $onClose;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: androidx.compose.material.DrawerKt$Scrim$dismissDrawer$1$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: Drawer.kt */
    static final class AnonymousClass1 extends v implements h9.l<Offset, k0> {
        ...
        public /* bridge */ /* synthetic */ k0 invoke(Offset offset) {
            m1011invokek4lQ0M(offset.m1377unboximpl());
            return k0.f35197a;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DrawerKt$Scrim$dismissDrawer$1$1(a<k0> aVar, d<? super DrawerKt$Scrim$dismissDrawer$1$1> dVar) {
        super(2, dVar);
        this.$onClose = aVar;
    }
    ...
    public final Object mo4invoke(@NotNull PointerInputScope pointerInputScope, @Nullable d<? super k0> dVar) {
        return ((DrawerKt$Scrim$dismissDrawer$1$1) create(pointerInputScope, dVar)).invokeSuspend(k0.f35197a);
    }
