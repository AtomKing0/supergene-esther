...
final class DrawerKt$ModalDrawer$1$2$2 extends v implements a<k0> {
    ...
    /* JADX INFO: compiled from: Drawer.kt */
    @f(c = "androidx.compose.material.DrawerKt$ModalDrawer$1$2$2$1", f = "Drawer.kt", l = {TypedValues.CycleType.TYPE_WAVE_SHAPE}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DrawerKt$ModalDrawer$1$2$2(boolean z10, DrawerState drawerState, o0 o0Var) {
        super(0);
