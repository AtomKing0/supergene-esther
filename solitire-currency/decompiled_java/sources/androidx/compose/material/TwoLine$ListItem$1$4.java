...
final class TwoLine$ListItem$1$4 extends v implements p<Composer, Integer, k0> {
    ...
    TwoLine$ListItem$1$4(float f10, p<? super Composer, ? super Integer, k0> pVar, int i10) {
        super(2);
        this.$minHeight = f10;
        this.$trailing = pVar;
        this.$$dirty = i10;
    ...
    public final void invoke(@Nullable Composer composer, int i10) {
        ...
        Modifier modifierM403paddingqDBjuR0$default = PaddingKt.m403paddingqDBjuR0$default(SizeKt.m428heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null), 0.0f, 0.0f, TwoLine.TrailingRightPadding, 0.0f, 11, null);
        Alignment center = Alignment.Companion.getCenter();
        p<Composer, Integer, k0> pVar = this.$trailing;
        int i11 = this.$$dirty;
        ...
        pVar.mo4invoke(composer, Integer.valueOf((i11 >> 15) & 14));
