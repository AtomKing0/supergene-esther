...
public abstract class Lifecycle {
    ...
    public static final void _get_currentStateFlow_$lambda$0(y mutableStateFlow, LifecycleOwner lifecycleOwner, Event event) {
        t.i(mutableStateFlow, "$mutableStateFlow");
    ...
    public m0<State> getCurrentStateFlow() {
        final y yVarA = o0.a(getCurrentState());
        addObserver(new LifecycleEventObserver() { // from class: androidx.lifecycle.g
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                Lifecycle._get_currentStateFlow_$lambda$0(yVarA, lifecycleOwner, event);
            }
        });
        return s9.j.c(yVarA);
    }
