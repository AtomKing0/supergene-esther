...
import com.facebook.ads.redexgen.core.AbstractC2000Sv;
import com.facebook.ads.redexgen.core.C2001Sw;
import com.facebook.ads.redexgen.core.C2361cu;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
     ...
     */
    public static synchronized void A04(C2361cu c2361cu, Class<? extends Activity> cls) {
        A02 = c2361cu;
        A01 = c2361cu.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c2361cu.A08().AAy(A01(208, 8, 61), AbstractC2000Sv.A02, new C2001Sw(A01(72, 80, 65)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c2361cu);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c2361cu.A08().AAy(A01(216, 3, 3), AbstractC2000Sv.A0d, new C2001Sw(A01(42, 30, 126)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (A02 != null && z10 && key != activityA00) {
            C2001Sw c2001Sw = new C2001Sw(A01(19, 23, 76), A01(203, 5, 97) + key + A01(12, 7, 1) + activityA00);
            c2001Sw.A05(1);
            A02.A08().AAy(A01(208, 8, 61), AbstractC2000Sv.A03, c2001Sw);
        }
        return key != null ? key : activityA00;
    }

    public static void A03(C2387dL c2387dL) {
        if (!U7.A1k(c2387dL) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        WC wc = new WC(c2387dL);
        synchronized (A07) {
            A07.add(wc);
        }
        XJ.A01.A01().postDelayed(wc, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
    }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C2001Sw c2001Sw = new C2001Sw(A01(TsExtractor.TS_STREAM_TYPE_AC4, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c2001Sw.A05(0);
            A02.A08().AAy(A01(208, 8, 61), AbstractC2000Sv.A03, c2001Sw);
        }
        A08.put(activity, 4);
