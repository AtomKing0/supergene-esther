...
public final class C1670Fy extends FrameLayout implements InterfaceC2119Xo {
    ...
    public int A02;
    public C2189a8 A03;
    public AbstractC1714Hr A04;
    public C2384dI A05;
    public boolean A06;
    public boolean A07;
    public boolean A08;
    public boolean A09;
    public final C2660hw A0A;
    public final R6 A0B;
    public final SF A0C;
    public final C2387dL A0D;
    public final US A0E;
    public final C2030Ua A0F;
    public final XC A0G;
    public final AbstractC2117Xm A0H;
    public final InterfaceC2118Xn A0I;
    public final YY A0J;
    public final ArrayList<C2332cR> A0K;
    ...
    static {
        ...
        A0O = (int) (AbstractC2090Wl.A02 * 48.0f);
        A0P = (int) (AbstractC2090Wl.A02 * 64.0f);
    }

    public C1670Fy(C2387dL c2387dL, YY yy, US us, C2660hw c2660hw, SF sf, InterfaceC2118Xn interfaceC2118Xn) {
        ...
        this.A0A = c2660hw;
        this.A0C = sf;
        this.A0I = interfaceC2118Xn;
        this.A0F = new C2030Ua(this.A0A.A1x(0).A25(), this.A0E);
        this.A0G = new XC(this);
        this.A0G.A05(XB.A02);
        this.A05 = new C2384dI(this.A0D, this.A0J, this.A0A.A1A(), interfaceC2118Xn);
        this.A0H = A05();
        if (this.A0A.A1U()) {
    ...
    */
    private int A00() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1670Fy.A00():int");
    }

    private int A01(int i10) {
        if (this.A0A.A26()) {
            C2660hw c2660hw = this.A0A;
            String[] strArr = A0M;
    ...
    public static /* synthetic */ int A02(C1670Fy c1670Fy, int i10) {
        int i11 = c1670Fy.A01 + i10;
        c1670Fy.A01 = i11;
        return i11;
    }

    private AbstractC2117Xm A05() {
        AbstractC2117Xm c1869Nr;
        if (!this.A0A.A1U()) {
            c1869Nr = new FullScreenAdToolbar(this.A0D, this.A0I, this.A0F, 2, -1, false);
        } else {
            c1869Nr = new C1869Nr(this.A0D, this.A0I, this.A0F, 2);
        }
        c1869Nr.setFullscreen(true);
        c1869Nr.setToolbarListener(new C1671Fz(this));
        return c1869Nr;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private com.facebook.ads.redexgen.core.AbstractC1714Hr A0A(boolean r33, int r34) {
        /*
            Method dump skipped, instruction units count: 476
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1670Fy.A0A(boolean, int):com.facebook.ads.redexgen.X.Hr");
    }
    ...
    private void A0D() {
        if (this.A00 > 0 && !TextUtils.isEmpty(this.A0A.A1x(this.A00 - 1).A25())) {
            ...
            C2172Zp c2172ZpA03 = new C2172Zp().A03(this.A04 != null ? this.A04.getAdViewabilityChecker() : null);
            AbstractC1714Hr abstractC1714Hr = this.A04;
            String[] strArr = A0M;
            ...
            us.AAt(strA25, c2172ZpA03.A02(abstractC1714Hr != null ? this.A04.getTouchDataRecorder() : null).A05());
        }
    }
    ...
    public void A0E() {
        if (this.A0H.getToolbarActionMode() == 8) {
            AbstractC2117Xm abstractC2117Xm = this.A0H;
            String[] strArr = A0M;
            ...
            abstractC2117Xm.setToolbarActionMode(2);
        }
        int i10 = this.A00 - 1;
        if (this.A0A.A27(i10)) {
            AbstractC2662hy abstractC2662hyA1x = this.A0A.A1x(i10);
            AbstractC2117Xm abstractC2117Xm2 = this.A0H;
            String[] strArr3 = A0M;
            ...
            abstractC2117Xm2.setProgressSpinnerInvisible(!abstractC2662hyA1x.A2J());
            abstractC2662hyA1x.A2B(false);
            abstractC2662hyA1x.A20().A0M(-1);
        }
    }
    ...
    private void A0F() {
        this.A0D.A0F().A4o();
        this.A07 = true;
        this.A03 = new C2189a8(this.A0D, this.A0A, this.A0E, this.A0I, this.A0H.getToolbarHeight(), this.A02);
        C2332cR c2332cR = null;
        Iterator<C2332cR> it = this.A0K.iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            C2332cR next = it.next();
            if (next.A00 == C2332cR.A06) {
                c2332cR = next;
                break;
            }
        }
        if (c2332cR != null) {
            A0L(this.A03, c2332cR);
        } else {
        ...
        XP.A0H(this.A03);
        XP.A0E(IronSourceConstants.RV_API_HAS_AVAILABILITY_FALSE, this.A03);
    ...
    private void A0L(ViewGroup viewGroup, C2332cR c2332cR) {
        if (c2332cR.A00 == C2332cR.A06 && c2332cR.A03 != null) {
            AbstractC2208aR.A00(this.A0D, viewGroup, c2332cR.A03);
        } else {
            int i10 = c2332cR.A01;
            String[] strArr = A0M;
            if (strArr[0].length() == strArr[1].length()) {
        ...
        this.A0H.setFullscreen(c2332cR.A05);
        this.A0H.A0A(c2332cR.A02, c2332cR.A04);
    }

    private void A0M(AbstractC2662hy abstractC2662hy) {
        if (this.A0H instanceof FullScreenAdToolbar) {
            if (A0Z(abstractC2662hy) && this.A02 == 2) {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(abstractC2662hy.A23());
            } else {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(null);
            }
        }
    ...
    */
    public void A0U(boolean r7) {
        /*
            ...
            if (r0 != 0) goto La5
            boolean r5 = r6.A0Y()
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C1670Fy.A0M
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        Lad:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1670Fy.A0U(boolean):void");
    }
    ...
    public void A0V(boolean z10, int i10) {
        ...
        if (!A0W()) {
            ...
            AbstractC2662hy abstractC2662hyA1x = this.A0A.A1x(this.A00);
            String[] strArr3 = A0M;
            if (strArr3[6].length() != strArr3[3].length()) {
                String[] strArr4 = A0M;
                strArr4[0] = "SeXhCWKDArfU2xbUHE";
                strArr4[1] = "icHjaKCGoPIgSTYVXjnx";
                boolean isLoaded = sjA01.AAD(abstractC2662hyA1x.A25(), this.A0A.A1y());
                if (!isLoaded) {
                    this.A0D.A0F().A4m();
                    A0K(2);
                    return;
                }
                AbstractC1714Hr abstractC1714HrA0A = A0A(z10, i10);
                this.A04 = abstractC1714HrA0A;
                AbstractC1714Hr abstractC1714Hr = this.A04;
                boolean isLoaded2 = this.A09;
                abstractC1714Hr.A1F(isLoaded2);
                setupToolbarForAd(abstractC1714HrA0A);
    ...
    public static boolean A0Z(AbstractC2662hy abstractC2662hy) {
    ...
    public AbstractC1714Hr getContentView() {
        return this.A04;
    }
    ...
    private void setupToolbarForAd(AbstractC1714Hr abstractC1714Hr) {
        if (this.A0H == null) {
            return;
        }
        this.A06 = true;
        ...
        if (this.A0H instanceof FullScreenAdToolbar) {
            ((FullScreenAdToolbar) this.A0H).A0D(this.A0D, abstractC2662hyA1x.A1t());
            ((FullScreenAdToolbar) this.A0H).A0C(abstractC2662hyA1x.A23(), abstractC2662hyA1x.A25(), iA01);
        } else if (this.A0H instanceof C1869Nr) {
            ((C1869Nr) this.A0H).setInitialUnskippableSeconds(iA01);
        }
        C2332cR fullScreenAdStyle = abstractC1714Hr.getFullScreenAdStyle();
        A0L(abstractC1714Hr, fullScreenAdStyle);
        this.A0K.add(fullScreenAdStyle);
        this.A0H.setToolbarActionMessage(A0B(4, 3, 90) + (this.A00 + 1) + A0B(0, 4, 21) + this.A0A.A1u());
        if (this.A08) {
            this.A0H.setToolbarActionMode(1);
        }
        A0M(abstractC2662hyA1x);
    }
}
