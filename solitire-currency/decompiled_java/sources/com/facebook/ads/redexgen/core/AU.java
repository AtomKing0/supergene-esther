...
public class AU {
    ...
    public AO A02(boolean z10, C2659hv c2659hv, EnumC2656hq enumC2656hq, String str) throws Exception {
        Set<AO> set;
        if (this.A02.A0I(z10, c2659hv) && AV.A0G(str, c2659hv)) {
            ...
            if (set != null) {
                synchronized (set) {
                    if (!set.isEmpty()) {
                        ...
                        AO ret = it.next();
                        it.remove();
                        this.A02.A03().A0A(z10, str, enumC2656hq, ret.hashCode());
                        return ret;
                    }
                }
            }
        ...
        try {
            C2654ho c2654hoA05 = this.A02.A03().A05(z10, str, enumC2656hq);
            AO aoA03 = A03(z10, str);
            this.A02.A03().A06(c2654hoA05, aoA03.hashCode());
            return aoA03;
        } catch (Exception e10) {
    ...
    public AO A03(boolean z10, String str) throws Exception {
        ...
        return new C2931mf(MediaCodec.createByCodecName(str));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: A07, reason: merged with bridge method [inline-methods] */
    public void A0B(EnumC2656hq enumC2656hq) {
        String strA04;
        String str;
        AV av;
        Set<AO> set;
        for (AS as : this.A01) {
            try {
                try {
                    if (!as.A05) {
                        A08(as.A01, enumC2656hq, Boolean.valueOf(as.A04), as.A00);
                    } else {
                        try {
                            try {
    ...
    private void A08(C2659hv c2659hv, EnumC2656hq enumC2656hq, Boolean bool, AO ao) {
        try {
            if (!c2659hv.A0Q || (!bool.booleanValue() && !c2659hv.A0P)) {
                ao.stop();
            }
        } finally {
            this.A02.A03().A08(enumC2656hq, ao.hashCode());
            ao.AGr();
            this.A02.A03().A07(enumC2656hq, ao.hashCode());
        }
    }
    ...
    */
    public void A0A(boolean r24, com.facebook.ads.redexgen.core.C2659hv r25, final com.facebook.ads.redexgen.core.EnumC2656hq r26, java.lang.String r27, com.facebook.ads.redexgen.core.AO r28) throws java.lang.Throwable {
        /*
