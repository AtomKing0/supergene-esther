...
public final class C7L<NativeViewabilityLogger> implements InterfaceC2699id {
    ...
    public US A05;
    public V4 A06;
    public InterfaceC2164Zh A08;
    public C1783Ki A09;
    public C5G A0A;
    public AbstractC2459eW A0B;
    public C2460eX A0C;
    public String A0E;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.7L != com.facebook.ads.internal.adapters.FacebookBannerAdapter<NativeViewabilityLogger> */
    public void A0C(int i10, TF tf) {
        C2695iZ c2695iZ = new C2695iZ(this);
        this.A0A = new C5G(this.A04, this.A05, c2695iZ, this.A03, A08(0, 31, 79), 2, this.A07);
        this.A0B = new C2690iU(this);
        this.A0C = new C2460eX(this.A0A, tf.A04(), tf.A09(), true, new WeakReference(this.A0B), this.A04);
    ...
    private void A0F(TF tf, JSONObject jSONObject, V4 v42) {
        this.A0G = false;
        final C2676iG c2676iGA00 = C2676iG.A00(this.A04, jSONObject);
        this.A0E = c2676iGA00.A7G();
        if (ML.A06(this.A04, c2676iGA00, this.A05)) {
            this.A04.A0F().A4u();
            this.A00.ADj(this, V1.A00(AdErrorType.NO_FILL));
            return;
        }
        this.A08 = new AbstractC1794Kt() { // from class: com.facebook.ads.redexgen.X.7M
        ...
        this.A09 = new C1783Ki(this.A04, (WeakReference<InterfaceC2164Zh>) new WeakReference(this.A08), tf.A04(), A7G());
        this.A09.A0L(tf.A07(), tf.A08());
        MS impressionHelper = new C2689iT(this);
        this.A02 = new C2674iE(this.A04, this.A05, this.A09, this.A09.getViewabilityChecker(), impressionHelper, v42);
        this.A02.A0A(c2676iGA00);
        this.A09.loadDataWithBaseURL(AbstractC2167Zk.A01(AdInternalSettings.getUrlPrefix()), c2676iGA00.A04(), A08(31, 9, 19), A08(40, 5, 12), null);
        this.A0F = true;
        A0A();
    }
    ...
    */
    private void A0G(com.facebook.ads.redexgen.core.V4 r11, com.facebook.ads.redexgen.core.TF r12) {
        ...
        L53:
            ...
            boolean r0 = com.facebook.ads.redexgen.core.C1959Rf.A0A(r0)
            if (r0 == 0) goto L7c
            r0 = 1
        L60:
            if (r0 != 0) goto L7e
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.7L != com.facebook.ads.internal.adapters.FacebookBannerAdapter<NativeViewabilityLogger> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC2699id
