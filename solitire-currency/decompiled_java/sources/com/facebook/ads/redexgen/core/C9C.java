...
public abstract class C9C extends Timeline {
    ...
    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3035oN A0I(int i10, C3035oN c3035oN, boolean z10) {
        return this.A00.A0I(i10, c3035oN, z10);
    }

    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3033oL A0L(int i10, C3033oL c3033oL, long j10) {
        return this.A00.A0L(i10, c3033oL, j10);
    }
