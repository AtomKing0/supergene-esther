...
public abstract class AbstractC2641hY {
    ...
    public static void A03(C2659hv c2659hv, MediaFormat mediaFormat) {
        ...
        try {
            if (C2639hW.A02()) {
                if (c2659hv.A0O && !C2639hW.A03(mediaFormat.getInteger(A01(232, 5, 12)), mediaFormat.getInteger(A01(113, 6, 85)))) {
                    return;
                }
                long j10 = c2659hv.A00;
                if (j10 > 0) {
                    mediaFormat.setLong(A01(195, 37, 115), j10);
                    AbstractC2570gL.A01(strA012, A01(82, 31, 98), Long.valueOf(j10));
                }
                mediaFormat.setInteger(A01(156, 39, 109), 1);
                AbstractC2570gL.A00(strA012, A01(53, 29, 39));
            }
        } catch (ClassCastException e10) {
            AbstractC2570gL.A02(strA012, strA01, e10);
        } catch (NullPointerException e11) {
            AbstractC2570gL.A02(strA012, strA01, e11);
        }
    }

    public static boolean A04(C2659hv c2659hv, int i10, int i11, int i12, int i13) {
        if (c2659hv.A01 && c2659hv.A0O && C2639hW.A03(i10, i11) != C2639hW.A03(i12, i13)) {
            return true;
        }
        return false;
    }
