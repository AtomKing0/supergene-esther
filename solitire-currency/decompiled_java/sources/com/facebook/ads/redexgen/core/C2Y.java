...
public final class C2Y extends AbstractC1594Da {
    ...
    public final AbstractC2010Tf<DO> A00;

    public C2Y(C2387dL c2387dL) {
        this(c2387dL, null);
    }

    public C2Y(C2387dL c2387dL, AttributeSet attributeSet) {
        this(c2387dL, attributeSet, 0);
    }

    public C2Y(C2387dL c2387dL, AttributeSet attributeSet, int i10) {
        super(c2387dL, attributeSet, i10);
        this.A00 = new C1591Cx(this);
