...
public final class C13171r implements InterfaceC1557Bn, f7 {
    ...
    public final SQ A00;
    public final InterfaceC1986Sh A01;
    public final InterfaceC2466ed A02;
    public final InterfaceC2496f8 A03;
    public final C2504fG A04;
    public final InterfaceC2505fH A05;
    public final String A06;
    public final Map<EnumC2492f3, By> A09 = new HashMap();
    public final Map<EnumC2492f3, AbstractC13251z> A08 = new HashMap();
    public final List<InterfaceC2509fL> A07 = new ArrayList();
    ...
    private void A04() throws Throwable {
        ...
        synchronized (this) {
            for (By by : this.A09.values()) {
                if (by.AAV()) {
                    map.put(by, EnumC2512fO.A05);
                } else {
                    map.put(by, EnumC2512fO.A04);
                }
            }
            new AtomicReference();
            new AtomicReference();
            Iterator<AbstractC13251z> it = this.A08.values().iterator();
            while (it.hasNext()) {
                it.next();
                InterfaceC2491f2 interfaceC2491f2 = null;
                if (interfaceC2491f2.AAV()) {
                    throw new NullPointerException(A01(349, 20, 51));
                }
            }
            Iterator<InterfaceC2509fL> it2 = this.A07.iterator();
            if (it2.hasNext()) {
                it2.next();
        ...
        String.format(Locale.US, A01(TsExtractor.TS_PACKET_SIZE, 33, 57), this.A06, jSONObjectA03.toString(2));
        this.A02.AGE(this.A06, (A01(327, 8, 121) + URLEncoder.encode(jSONObjectA03.toString())).getBytes(), new C1554Bk(this, atomicReference, atomicReference2, countDownLatch));
        ...
        synchronized (this) {
            ...
            Set<InterfaceC2508fK> setA02 = A02((JSONObject) atomicReference.get());
            HashMap map5 = new HashMap();
            HashMap map6 = new HashMap();
            Iterator<InterfaceC2508fK> it3 = setA02.iterator();
            while (it3.hasNext()) {
                it3.next().A45(map5, map6);
            }
            this.A03.A6T(A00((JSONObject) atomicReference.get()));
            Iterator<InterfaceC2509fL> it4 = this.A07.iterator();
            if (it4.hasNext()) {
                it4.next();
    ...
    private synchronized void A08(Throwable th) {
        Iterator<InterfaceC2509fL> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            new HashMap();
            new HashMap();
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1557Bn
    public final synchronized InterfaceC2491f2 A5M(EnumC2492f3 enumC2492f3) {
        if (enumC2492f3.A03() != EnumC2494f5.A04) {
            throw new IllegalArgumentException(A01(47, 59, 101));
        }
        if (this.A09.containsKey(enumC2492f3)) {
            return this.A09.get(enumC2492f3);
        }
        By by = new By(enumC2492f3);
        this.A09.put(enumC2492f3, by);
        Iterator<InterfaceC2509fL> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            throw new NullPointerException(A01(377, 24, 120));
        }
        String.format(Locale.US, A01(153, 35, 123), enumC2492f3);
        return by;
    }
    ...
    public C13171r(SQ sq, InterfaceC1986Sh interfaceC1986Sh, InterfaceC2466ed interfaceC2466ed, String str, InterfaceC2505fH interfaceC2505fH, C2504fG c2504fG, InterfaceC2495f6 interfaceC2495f6) {
        this.A00 = sq;
        this.A01 = interfaceC1986Sh;
        this.A02 = interfaceC2466ed;
        this.A06 = str;
        this.A05 = interfaceC2505fH;
        this.A04 = c2504fG;
        this.A03 = interfaceC2495f6.A56(this);
    }
    ...
    private Set<InterfaceC2508fK> A02(JSONObject jSONObject) throws JSONException {
        ...
        while (true) {
            ...
            if (zHasNext) {
                ...
                switch (C2507fJ.A01[EnumC2513fP.A00(jSONObject2.getString(next.A87().A04())).ordinal()]) {
                    case 1:
                        ...
                        hashSet.add(new AbstractC1552Bi(next, fingerprint, responseObject) { // from class: com.facebook.ads.redexgen.X.1u
                            public final JSONObject A00;
                            public final JSONObject A01;

                            {
                                EnumC2513fP enumC2513fP = EnumC2513fP.A03;
                                this.A00 = fingerprint;
                                this.A01 = responseObject;
                            }

                            @Override // com.facebook.ads.redexgen.core.AbstractC1552Bi, com.facebook.ads.redexgen.core.InterfaceC2508fK
                            public final void A45(Map<InterfaceC2491f2, EnumC2513fP> map, Map<SyncModifiableBundle, EnumC2500fC> map2) {
                        ...
                        break;
                    case 2:
                        hashSet.add(new AbstractC1552Bi(next) { // from class: com.facebook.ads.redexgen.X.1t
                            {
                                EnumC2513fP enumC2513fP = EnumC2513fP.A04;
                            }
                        });
                        break;
                    default:
                ...
                Iterator<AbstractC13251z> it2 = this.A08.values().iterator();
                while (it2.hasNext()) {
                    it2.next();
                    final AbstractC13251z abstractC13251z = null;
                    switch (C2507fJ.A00[EnumC2500fC.A00(jSONObject2.getString(abstractC13251z.A87().A04())).ordinal()]) {
                        case 1:
                            hashSet.add(new AbstractC1553Bj(abstractC13251z) { // from class: com.facebook.ads.redexgen.X.1v
                                {
                                    EnumC2500fC enumC2500fC = EnumC2500fC.A03;
                                }
                            });
                            break;
                        case 2:
                            hashSet.add(new AbstractC1553Bj(abstractC13251z) { // from class: com.facebook.ads.redexgen.X.1s
                                ...
                                {
                                    EnumC2500fC enumC2500fC = EnumC2500fC.A04;
                                }

                                @Override // com.facebook.ads.redexgen.core.AbstractC1553Bj, com.facebook.ads.redexgen.core.InterfaceC2508fK
                                public final void A45(Map<InterfaceC2491f2, EnumC2513fP> map, Map<SyncModifiableBundle, EnumC2500fC> map2) {
    ...
    private JSONObject A03(Map<InterfaceC2491f2, EnumC2512fO> map, Map<SyncModifiableBundle, EnumC2499fB> map2, Map<SyncModifiableBundle, JSONObject> clientBundleData, Map<SyncModifiableBundle, JSONObject> clientBundleFingerprint) throws JSONException {
        String strA01;
        JSONObject syncRequest = new JSONObject();
        for (Map.Entry<InterfaceC2491f2, EnumC2512fO> entry : map.entrySet()) {
            syncRequest.put(entry.getKey().A87().A04(), entry.getValue().A03());
        }
        for (Map.Entry<SyncModifiableBundle, EnumC2499fB> entry2 : map2.entrySet()) {
            entry2.getKey();
            InterfaceC2491f2 interfaceC2491f2 = null;
            String strA04 = interfaceC2491f2.A87().A04();
        ...
        Iterator<Map.Entry<InterfaceC2491f2, EnumC2512fO>> it = map.entrySet().iterator();
        while (true) {
            boolean zHasNext = it.hasNext();
            ...
            Map.Entry<InterfaceC2491f2, EnumC2512fO> next = it.next();
            if (next.getValue() == EnumC2512fO.A05) {
                JSONObject updateData = new JSONObject();
                InterfaceC2491f2 key = next.getKey();
                ...
                EnumC2492f3 enumC2492f3A87 = key.A87();
                String[] strArr2 = A0B;
                if (strArr2[7].length() != strArr2[2].length()) {
                    String[] strArr3 = A0B;
                    strArr3[1] = "cfjTgROdu8b";
                    strArr3[3] = "qIs";
                    jSONObject.put(enumC2492f3A87.A04(), updateData);
                } else {
                    A0B[4] = "vaTQWmMwm";
                    jSONObject.put(enumC2492f3A87.A04(), updateData);
                }
        ...
        for (Map.Entry<SyncModifiableBundle, EnumC2499fB> entry3 : map2.entrySet()) {
            JSONObject updateData2 = new JSONObject();
            InterfaceC2491f2 key2 = entry3.getKey();
            JSONObject request2 = clientBundleFingerprint.get(entry3.getKey());
            updateData2.put(strA01, request2);
            if (entry3.getValue() == EnumC2499fB.A05) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1557Bn, com.facebook.ads.redexgen.core.SW
