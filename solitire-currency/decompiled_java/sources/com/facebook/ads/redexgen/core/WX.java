...
public abstract class WX {
    ...
    public static void A05(C2361cu c2361cu, InterfaceC2100Wv interfaceC2100Wv, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        boolean isPackageInstalled = A08(c2361cu.getPackageManager(), str);
        if (isPackageInstalled) {
            interfaceC2100Wv.AEQ(str);
            return;
        }
        A03.add(str);
        A02.removeCallbacksAndMessages(null);
        A02.postDelayed(new WW(new int[]{0}, str, c2361cu, interfaceC2100Wv), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.core.C2361cu r6, java.lang.String r7) {
        /*
        ...
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.Nk r1 = com.facebook.ads.redexgen.core.AbstractC1863Nl.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
    ...
    public static void A07(C2361cu c2361cu, String str, InterfaceC2100Wv interfaceC2100Wv) {
        boolean isWithinFB = c2361cu.getPackageName().equals(A01(30, 19, 75)) || c2361cu.getPackageName().equals(A01(49, 22, 66));
        if (isWithinFB) {
            A05(c2361cu, interfaceC2100Wv, str);
        } else {
            AbstractC1863Nl.A00(c2361cu).A0A(str, interfaceC2100Wv, 4);
        }
    }
