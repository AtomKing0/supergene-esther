...
public abstract class C9D {
    ...
    static {
        ...
        A05 = new int[]{1, 10, 100, 1000, 10000, 100000, PlaybackException.CUSTOM_ERROR_CODE_BASE, 10000000, 100000000, 1000000000};
    ...
    */
    public static int A00(int r6, int r7, java.math.RoundingMode r8) {
        /*
            com.facebook.ads.redexgen.core.AbstractC2729jA.A04(r8)
            if (r7 == 0) goto L65
            int r5 = r6 / r7
            int r0 = r7 * r5
            int r4 = r6 - r0
        ...
        Le:
            ...
            r2 = 1
            r3 = r3 | r2
            int[] r1 = com.facebook.ads.redexgen.core.C13503a.A00
            int r0 = r8.ordinal()
            r0 = r1[r0]
            switch(r0) {
                case 1: goto L59;
