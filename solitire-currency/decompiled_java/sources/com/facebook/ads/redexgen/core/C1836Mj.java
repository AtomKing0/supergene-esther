...
public final class C1836Mj extends BroadcastReceiver {
    ...
    public C1836Mj(AnonymousClass64 anonymousClass64, Context context) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof DL) {
                    ...
                    this.A01.A0h(EnumC2403db.A04, 1);
                    return;
                }
                if (serializableExtra instanceof DT) {
                    ...
                    if (serializableExtra instanceof C13533d) {
                        if (this.A01.getListener() != null) {
