...
public final class R5 {
    ...
    private C1803Lc A06() {
        ...
        LY ly = new LY();
        return new C1803Lc(this.A02, this.A03, new C2546fw(this.A01), anonymousClass77A02, null, ly, A0K(ly, anonymousClass77A02));
    }
    ...
    private C1803Lc A07() {
        ...
        LX lx = new LX();
        return new C1803Lc(this.A02, this.A03, new C6P(this.A01), anonymousClass73A03, anonymousClass73A03.A1A(), lx, A0K(lx, anonymousClass73A03));
    }
    ...
    public R5(R0 r02, Intent intent, US us, C2387dL c2387dL) {
        this.A01 = r02;
        this.A00 = intent;
        this.A03 = us;
        this.A02 = c2387dL;
    ...
    private AbstractC2662hy A00() {
        int i10 = Build.VERSION.SDK_INT;
        String strA0L = A0L(68, 18, 41);
        if (i10 >= 33) {
            return (AbstractC2662hy) this.A00.getSerializableExtra(strA0L, AbstractC2662hy.class);
        }
        ...
        return (AbstractC2662hy) intent.getSerializableExtra(strA0L);
    }
    ...
    private C2660hw A01() {
        ...
        if (i10 >= 33) {
            return (C2660hw) this.A00.getSerializableExtra(strA0L, C2660hw.class);
        }
        return (C2660hw) this.A00.getSerializableExtra(strA0L);
    }
    ...
    private InterfaceC2119Xo A05() {
        if (U7.A2o(this.A02)) {
            ...
            return new C6H(r02, c2387dL, us, c2546fw, stringExtra2, i10);
        }
        return new OD(this.A01, this.A02, this.A03, new C2546fw(this.A01));
    }

    private final C1802Lb A08() {
        return new C1802Lb(this.A02, this.A01);
    }

    private LZ A09(RelativeLayout relativeLayout) {
        LZ lz = new LZ(this.A02, new C2545fv(this), this.A03, new C2546fw(this.A01));
    ...
    private C5K A0A() {
        ...
        return new C5K(this.A02, this.A03, new C2546fw(this.A01), anonymousClass77A02, new LY(), 1);
    }
    ...
    private C5K A0B() {
        ...
        return new C5K(this.A02, this.A03, new C2546fw(this.A01), anonymousClass73A03, new LX(), 0);
    }

    private IG A0C() {
        C2298bt c2298btA02;
        AbstractC2662hy abstractC2662hyA00 = A00();
        if (abstractC2662hyA00 == null || (c2298btA02 = AbstractC2299bu.A02(abstractC2662hyA00.A17())) == null) {
            return null;
        }
        return new IG(this.A02, new C2546fw(this.A01), c2298btA02, abstractC2662hyA00.A25());
    }

    private C1670Fy A0D(EnumC2057Vb enumC2057Vb) {
        YY lx;
        InterfaceC2118Xn c6p;
        C2660hw c2660hwA01 = A01();
        if (c2660hwA01 == null) {
            return null;
        }
        if (enumC2057Vb == EnumC2057Vb.A04) {
            lx = new LY();
            c6p = new C2546fw(this.A01);
        } else {
            lx = new LX();
            c6p = new C6P(this.A01);
        }
        return new C1670Fy(this.A02, lx, this.A03, c2660hwA01, new SF(this.A02), c6p);
    }

    private C4H A0E() {
        AnonymousClass77 anonymousClass77A02 = A02();
        if (anonymousClass77A02 != null) {
            return new C4H(this.A02, new LY(), this.A03, anonymousClass77A02, new SF(this.A02), new C2546fw(this.A01));
        }
        if (A05[1].charAt(5) != 'X') {
            throw new RuntimeException();
        }
    ...
    private C13673r A0F() {
        ...
        return new C13673r(this.A02, new LY(), this.A03, anonymousClass77A02, new SF(this.A02), new C2546fw(this.A01));
    }
    ...
    private C13673r A0G() {
        ...
        return new C13673r(this.A02, new LX(), this.A03, anonymousClass73A03, new SF(this.A02), new C6P(this.A01));
    }
    ...
    private C13663q A0I() {
        ...
        return new C13663q(this.A02, this.A03, new SF(this.A02), new C2546fw(this.A01), dataBundle);
    }
    ...
    private C2366cz A0K(YY yy, AbstractC2662hy abstractC2662hy) {
        ...
        return new C2366cz(this.A02, abstractC2662hy, nbA07, this.A03, null, map);
    }

    public final InterfaceC2119Xo A0N(EnumC2057Vb enumC2057Vb, RelativeLayout relativeLayout) {
        if (enumC2057Vb == null) {
            return null;
        }
        switch (R4.A00[enumC2057Vb.ordinal()]) {
            case 1:
