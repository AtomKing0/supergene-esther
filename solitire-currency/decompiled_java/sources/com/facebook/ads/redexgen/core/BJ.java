...
public abstract class BJ extends AbstractC2693iX<String> {
    ...
    public BJ(C2736jH splitter, CharSequence toSplit) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2693iX
