...
public final class C2870lf implements EU, C5H {
    public int A00;
    public int A01;
    ...
    public C2870lf(Context context, Map<Integer, Long> initialBitrateEstimates, int i10, C3T c3t, boolean z10) {
        this.A0E = MetaExoPlayerCustomizedCollections.A04(initialBitrateEstimates);
        this.A0C = new ES();
        this.A0D = new C1640Eu(i10);
        this.A0B = c3t;
        this.A0F = z10;
        if (context != null) {
    ...
    public final synchronized void ACg(InterfaceC2999nl interfaceC2999nl, AnonymousClass56 anonymousClass56, boolean z10, int i10) {
    ...
    @Override // com.facebook.ads.redexgen.core.C5H
    public final synchronized void AFW(InterfaceC2999nl interfaceC2999nl, AnonymousClass56 anonymousClass56, boolean z10) {
        if (A04(anonymousClass56, z10)) {
            C3M.A08(this.A03 > 0);
            ...
            this.A08 += this.A06;
            if (i10 > 0) {
                C1640Eu c1640Eu = this.A0D;
                int sampleElapsedTimeMs = (int) Math.sqrt(this.A06);
                c1640Eu.A07(sampleElapsedTimeMs, (this.A06 * 8000.0f) / i10);
                if (this.A09 >= ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS || this.A08 >= 524288) {
    ...
    @Override // com.facebook.ads.redexgen.core.C5H
    public final synchronized void AFX(@MetaExoPlayerCustomization InterfaceC2999nl interfaceC2999nl, AnonymousClass56 anonymousClass56, boolean z10, boolean z11) {
        if (A04(anonymousClass56, z10)) {
            if (this.A03 == 0) {
