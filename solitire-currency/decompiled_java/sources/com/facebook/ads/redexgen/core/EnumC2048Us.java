...
public enum EnumC2048Us {
    A06(-1, 100, 1, 0),
    A07(-1, 120, 2, 1),
    A08(-1, AnimationConstants.DefaultDurationMillis, 3, 2),
    A09(-1, 400, 4, 3),
    A0A(-1, 50, 5, 4),
    A0B(-1, -1, 6, 5);
    ...
    EnumC2048Us(int i10, int i11, int i12, int i13) {
        this.A03 = i10;
        this.A01 = i11;
        this.A02 = i12;
        this.A00 = i13;
    ...
    @Nullable
    public static EnumC2048Us A00(int i10) {
        for (EnumC2048Us enumC2048Us : values()) {
            if (enumC2048Us.A00 == i10) {
                return enumC2048Us;
            }
        }
        return null;
