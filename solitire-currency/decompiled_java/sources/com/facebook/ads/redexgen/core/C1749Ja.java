...
public final class C1749Ja {
    ...
    public C1749Ja(String str, int i10, Integer num, Integer num2, float f10, boolean z10, boolean z11, boolean z12, boolean z13, int i11) {
        this.A05 = str;
        this.A01 = i10;
        this.A04 = num;
        this.A03 = num2;
    ...
    public static C1749Ja A04(String str, JW jw) {
        int iA01;
        Integer numA05;
        Integer numA052;
        float fA00;
        ...
        if (length != i10) {
            AnonymousClass44.A07(strA062, AbstractC13764a.A0n(A06(157, 69, 114), Integer.valueOf(jw.A05), Integer.valueOf(strArrSplit.length), str));
            return null;
        }
        try {
            ...
            return new C1749Ja(strTrim, iA01, numA05, numA052, fA00, jw.A01 != -1 && A0A(strArrSplit[jw.A01].trim()), jw.A04 != -1 && A0A(strArrSplit[jw.A04].trim()), jw.A0A != -1 && A0A(strArrSplit[jw.A0A].trim()), jw.A09 != -1 && A0A(strArrSplit[jw.A09].trim()), jw.A02 != -1 ? A02(strArrSplit[jw.A02].trim()) : -1);
        } catch (RuntimeException e10) {
            AnonymousClass44.A0A(strA062, A06(226, 35, 80) + str + A06(2, 1, 8), e10);
            return null;
        }
    }
