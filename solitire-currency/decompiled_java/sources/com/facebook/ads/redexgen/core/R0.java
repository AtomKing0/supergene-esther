...
public final class R0 implements AudienceNetworkActivityApi, Repairable {
    ...
    public EnumC2057Vb A07;
    public InterfaceC2119Xo A08;
    public AbstractC2134Yd A09;
    public C2363cw A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final RA A0G;
    public final RJ A0H;
    public final C1956Rc A0I;
    public final C2387dL A0J;
    ...
    public R0(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        this.A0I = new C1956Rc(this.A0J, this.A0E);
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            this.A07 = (EnumC2057Vb) bundleA03.getSerializable(strA01);
            return;
        }
        this.A01 = intent.getIntExtra(strA013, -1);
        this.A0B = intent.getStringExtra(strA012);
        this.A07 = (EnumC2057Vb) intent.getSerializableExtra(strA01);
    ...
    public final void A0D(String str, N9 n92) {
        ...
        AbstractC2134Yd abstractC2134Yd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC2134Yd == null) {
            this.A09 = AbstractC2135Ye.A02(this.A0J, this.A0J.A0A(), str, n92, this.A08, new C2546fw(this));
    ...
    public final void A0E(String str, C2008Td c2008Td) {
        this.A0G.A08(str, c2008Td, this.A0B);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            C2030Ua.A02(UZ.A0K, map, this.A08 == null ? A01(0, 0, 15) : this.A08.getCurrentClientToken(), this.A0J.A0A());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C2387dL c2387dLA04 = WB.A04(this.A05);
        if (c2387dLA04 != null) {
            C2387dL startAdContext = this.A0J;
            startAdContext.A0M(c2387dLA04);
        }
        A03(this.A05, bundle);
        C2387dL startAdContext2 = this.A0J;
        ...
        C2387dL startAdContext3 = this.A0J;
        US usA0A = startAdContext3.A0A();
        C2387dL startAdContext4 = this.A0J;
        this.A08 = new R5(this, intent, usA0A, startAdContext4).A0N(this.A07, this.A06);
        if (this.A08 == null) {
            C2387dL startAdContext5 = this.A0J;
            startAdContext5.A08().AAy(A01(58, 11, 105), AbstractC2000Sv.A0A, new C2001Sw(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onPause() {
        ...
        if (this.A08 != null) {
            this.A08.AEV(false);
            if (!this.A0E.isFinishing()) {
                C2030Ua.A02(UZ.A0E, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
                this.A0D = true;
            }
        }
    }
    ...
    public final void onResume() {
        ...
        this.A04 = System.currentTimeMillis();
        if (this.A08 != null) {
            InterfaceC2119Xo interfaceC2119Xo = this.A08;
            if (A0M[5].charAt(17) != 'w') {
                throw new RuntimeException();
            }
            A0M[6] = "WHwDulcP2dZca7YA0PmotSPySBaz7ZXD";
            interfaceC2119Xo.AF0(false);
            if (this.A0D) {
                C2030Ua.A02(UZ.A0F, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            }
        }
    }
    ...
    public final void onStart() {
        ...
        if (this.A01 != -1) {
            AbstractC2113Xi.A02(this.A0E, this.A01, this.A0J);
        }
    }
