...
public class C3050od extends Exception implements C1S {
    public final int A00;
    public final long A01;
    public static final String A03 = AbstractC13764a.A0h(0);
    public static final String A04 = AbstractC13764a.A0h(1);
    public static final String A07 = AbstractC13764a.A0h(2);
    public static final String A05 = AbstractC13764a.A0h(3);
    public static final String A06 = AbstractC13764a.A0h(4);
    public static final C1R<C3050od> A02 = new C1R() { // from class: com.facebook.ads.redexgen.X.oe
        @Override // com.facebook.ads.redexgen.core.C1R
        public final C1S A6X(Bundle bundle) {
            return new C3050od(bundle);
        }
    };

    public C3050od(Bundle bundle) {
        this(bundle.getString(A07), A09(bundle), bundle.getInt(A03, 1000), bundle.getLong(A04, SystemClock.elapsedRealtime()));
    }

    public C3050od(String str, Throwable th, int i10, long j10) {
        super(str, th);
        this.A00 = i10;
        this.A01 = j10;
    }
    ...
    public static Throwable A09(Bundle bundle) {
        ...
        try {
            Class<?> cls = Class.forName(string, true, C3050od.class.getClassLoader());
