...
public final class BT {
    ...
    public final BQ A0C;
    public final InterfaceC2919mT A0D;
    public final InterfaceC1560Br A0E;
    ...
    public BT(Context context, InterfaceC13884m interfaceC13884m, InterfaceC1814Ln interfaceC1814Ln, InterfaceC13984w interfaceC13984w, Executor executor) {
        this(context, new C9H(interfaceC13884m), new C2928mc(new C2717ix().A06(interfaceC1814Ln).A05(interfaceC13984w), executor));
    }

    public BT(Context context, InterfaceC2919mT interfaceC2919mT, InterfaceC1551Bh interfaceC1551Bh) {
        this.A0A = context.getApplicationContext();
        this.A0D = interfaceC2919mT;
        this.A01 = 3;
        this.A02 = 5;
        this.A07 = true;
        this.A06 = Collections.emptyList();
        this.A0F = new CopyOnWriteArraySet<>();
        Handler handlerA0b = AbstractC13764a.A0b(new Handler.Callback() { // from class: com.facebook.ads.redexgen.X.BM
        ...
        handlerThread.start();
        this.A0C = new BQ(handlerThread, interfaceC2919mT, interfaceC1551Bh, handlerA0b, this.A01, this.A02, this.A07);
        InterfaceC1560Br requirementsListener = new InterfaceC1560Br() { // from class: com.facebook.ads.redexgen.X.mb
            @Override // com.facebook.ads.redexgen.core.InterfaceC1560Br
            public final void AEz(C1564Bv c1564Bv, int i10) {
                this.A00.A07(c1564Bv, i10);
            }
        };
        this.A0E = requirementsListener;
        this.A05 = new C1564Bv(context, requirementsListener, A0I);
    ...
    public void A07(C1564Bv c1564Bv, int i10) {
        Requirements requirementsA0A = c1564Bv.A0A();
        if (this.A03 != i10) {
            this.A03 = i10;
            this.A04++;
