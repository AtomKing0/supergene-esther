...
public final class C2046Uq implements NativeAdRatingApi {
    ...
    public C2046Uq(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    public static C2046Uq A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C2046Uq(dOptDouble, dOptDouble2);
    }
