...
public final class C1783Ki extends AbstractC2161Ze {
    ...
    public final C2387dL A09;
    public final WeakReference<InterfaceC2164Zh> A0A;
    ...
    static {
        A04();
        A0H = C1783Ki.class.getSimpleName();
    }

    public C1783Ki(C2387dL c2387dL, WeakReference<InterfaceC2164Zh> weakReference, int i10, String str) {
        this(c2387dL, weakReference, i10, false);
        if (U7.A1u(c2387dL)) {
            c2387dL.A02().A0B().AK3(this, str == null ? A02(0, 0, 91) : str, false, true);
            this.A06 = true;
        }
    }

    public C1783Ki(C2387dL c2387dL, WeakReference<InterfaceC2164Zh> weakReference, int i10, boolean z10) {
        super(c2387dL);
        ...
        this.A02 = new C1795Ku(this);
        this.A03 = new C2460eX(this, i10, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0G());
        setWebViewClient(A0H());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        addJavascriptInterface(new C2163Zg(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A02(0, 9, 46));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2161Ze
    ...
    public final WebViewClient A0H() {
        return new C2166Zj(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0K() {
        this.A09.A0F().AK5();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C1789Ko(this.A03));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2161Ze, android.webkit.WebView
