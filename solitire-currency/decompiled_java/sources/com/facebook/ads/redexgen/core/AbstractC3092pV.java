...
public abstract class AbstractC3092pV<F, T> implements Iterator<T> {
    ...
    public AbstractC3092pV(Iterator<? extends F> backingIterator) {
        this.A00 = (Iterator) AbstractC2729jA.A04(backingIterator);
    }
