...
public class RunnableC1933Qf implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C14346g A06;
    public Interpolator A00 = C14346g.A1A;
    ...
    public RunnableC1933Qf(C14346g c14346g) {
        this.A06 = c14346g;
        this.A01 = new OverScroller(c14346g.getContext(), C14346g.A1A);
    }
    ...
    private int A01(int i10, int i11, int i12, int i13) {
        ...
        C14346g c14346g = this.A06;
        int width = duration != 0 ? c14346g.getWidth() : c14346g.getHeight();
    ...
    public final void run() {
        ...
        this.A06.A1K();
        OverScroller overScroller = this.A01;
        AbstractC1929Qb abstractC1929Qb = this.A06.A06.A02;
        if (overScroller.computeScrollOffset()) {
            ...
            if (this.A06.A04 != null) {
                ...
                if (vresult != 0) {
                    QO qo = this.A06.A06;
                    QW qw = this.A06.A0r;
                    C14346g c14346g2 = this.A06;
                    if (A08[4].charAt(19) != '9') {
                        A08[4] = "aF9lT9JucYAVgVWisB0rNkK4be7J2iGb";
                        iA1f = qo.A1f(vresult, qw, c14346g2.A0s);
                        i10 = vresult - iA1f;
                    } else {
                        iA1f = qo.A1f(vresult, qw, c14346g2.A0s);
                        i10 = vresult - iA1f;
                ...
                this.A06.A1N();
                this.A06.A1p(false);
                if (abstractC1929Qb != null && !abstractC1929Qb.A0E() && abstractC1929Qb.A0F()) {
                    int x10 = this.A06.A0s.A03();
                    if (x10 == 0) {
                        abstractC1929Qb.A09();
                    } else if (abstractC1929Qb.A07() >= x10) {
                        abstractC1929Qb.A0A(x10 - 1);
                        abstractC1929Qb.A04(vresult - i10, velX - i11);
                    } else {
                        int y10 = vresult - i10;
                        if (A08[4].charAt(19) != 57) {
                            String[] strArr4 = A08;
                            ...
                            abstractC1929Qb.A04(y10, velX - i11);
                        } else {
                            abstractC1929Qb.A04(y10, velX - i11);
                        }
                    }
            ...
            if (this.A06.getOverScrollMode() != 2) {
                C14346g c14346g3 = this.A06;
                String[] strArr5 = A08;
                if (strArr5[7].charAt(6) != strArr5[0].charAt(6)) {
                    throw new RuntimeException();
                }
                A08[6] = "k";
                c14346g3.A1b(vresult, velX);
            }
            int dy = iA1f;
            int hresult = iA1g;
            ...
            if (iA1f != 0 || iA1g != 0) {
                C14346g c14346g4 = this.A06;
                if (A08[6].length() != 25) {
                    A08[3] = "MhQkdHLAPY6K0mrvY0I8ZqPtgRA1J8Gx";
                    c14346g4.A1d(iA1f, iA1g);
                } else {
        ...
        if (abstractC1929Qb != null) {
            if (abstractC1929Qb.A0E()) {
                abstractC1929Qb.A04(0, 0);
            }
            if (!this.A05) {
                abstractC1929Qb.A09();
            }
