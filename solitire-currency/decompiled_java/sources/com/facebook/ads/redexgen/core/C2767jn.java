...
public final class C2767jn implements KJ {
    ...
    */
    public static com.facebook.ads.redexgen.core.C3064or A00(java.lang.String r22, com.facebook.ads.redexgen.core.KS r23, com.facebook.ads.redexgen.core.KS r24, com.facebook.ads.redexgen.core.KS r25) {
        /*
            Method dump skipped, instruction units count: 720
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2767jn.A00(java.lang.String, com.facebook.ads.redexgen.X.KS, com.facebook.ads.redexgen.X.KS, com.facebook.ads.redexgen.X.KS):com.facebook.ads.redexgen.X.or");
    }
    ...
    private void A04(long j10, int i10, int i11, long j11) {
        ...
        if (ks.A04(i11)) {
            this.A06.A0j(this.A08.A01, AbstractC1688Gq.A02(this.A08.A01, this.A08.A00));
            this.A06.A0g(5);
            this.A0C.A02(j11, this.A06);
        }
        if (this.A0A.A04(i11)) {
            this.A06.A0j(this.A0A.A01, AbstractC1688Gq.A02(this.A0A.A01, this.A0A.A00));
            this.A06.A0g(5);
            this.A0C.A02(j11, this.A06);
        }
    }
    ...
    public static void A06(C1690Gs c1690Gs) {
    ...
    public static void A07(C1690Gs c1690Gs) {
        ...
        for (int stRpsIdx = 0; stRpsIdx < iA04; stRpsIdx++) {
            ...
            if (zA0A) {
                ...
                int previousNumDeltaPocs = c1690Gs.A04();
    ...
    public final void A52(C4J c4j) {
        ...
        while (c4j.A07() > 0) {
            ...
            h12.AI7(c4j, offset2);
            while (limit < iA0A) {
                int iA04 = AbstractC1688Gq.A04(bArrA0l, limit, iA0A, this.A0D);
                if (iA04 == iA0A) {
                    A08(bArrA0l, limit, iA0A);
                    return;
                }
                int bytesWrittenPastPosition = AbstractC1688Gq.A00(bArrA0l, iA04);
                int i10 = iA04 - limit;
                if (A0F[7].charAt(7) != 'e') {
                    throw new RuntimeException();
                }
    ...
    public final void A5U(GY gy, C1779Ke c1779Ke) {
        c1779Ke.A05();
        this.A04 = c1779Ke.A04();
        this.A02 = gy.AJh(c1779Ke.A03(), 2);
        this.A03 = new KR(this.A02);
        this.A0C.A03(gy, c1779Ke);
    }
