...
public final class KI extends OE {
    ...
    public final US A04;
    public final XH A05;
    public final InterfaceC2118Xn A06;
    ...
    private void A02() {
        ...
        new KZ(c2201aK, this.A03).A05(A0D, A0D).A07(this.A02.A23().A01());
        ...
        layoutParams2.addRule(3, c2201aK.getId());
        ...
        C2203aM c2203aM = new C2203aM(this.A03, A0B, 5, A0A, -1);
        c2203aM.setGravity(16);
        linearLayout.addView(c2203aM, new LinearLayout.LayoutParams(-2, -1));
        ...
        if (TextUtils.isEmpty(this.A02.A20().A0I().A0B())) {
            ...
            c2203aM.setRating(Float.parseFloat(this.A02.A20().A0I().A0B()));
    ...
    public KI(C2387dL c2387dL, AbstractC2662hy abstractC2662hy, US us, InterfaceC2118Xn interfaceC2118Xn) {
        super(c2387dL);
        this.A05 = new XH();
        this.A03 = c2387dL;
        this.A02 = abstractC2662hy;
        this.A04 = us;
        this.A06 = interfaceC2118Xn;
        this.A05.A05();
        setRadius(20.0f);
        setMaxCardElevation(75.0f);
        this.A01 = new RelativeLayout(c2387dL);
        AbstractC2208aR.A00(c2387dL, this.A01, abstractC2662hy.A20().A0H().A08());
    ...
    private void A01() {
        KE ke = new KE(this.A03, EnumC2409dh.A04.A03(), this.A02.A1z().A01(), this.A02.A20().A0J().A06(), this.A04, this.A06, null, this.A05, this.A02.A21());
