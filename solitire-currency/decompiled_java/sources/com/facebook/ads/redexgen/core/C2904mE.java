...
public final class C2904mE implements H1 {
    ...
    public final C1577Cj A0V;
    public final C1579Cl A0W = new C1579Cl();
    public int A01 = 1000;
    ...
    public C1697Gz[] A0S = new C1697Gz[this.A01];
    public final D2<C1580Cm> A0X = new D2<>(new C3X() { // from class: com.facebook.ads.redexgen.X.mF
     ...
     */
    private synchronized int A03(C6N c6n, C2986nY c2986nY, boolean z10, boolean z11, C1579Cl c1579Cl) {
        c2986nY.A04 = false;
        if (!A0K()) {
            if (!z11 && !this.A0G) {
                ...
                A0H((C3064or) C3M.A01(this.A0D), c6n);
                return -5;
            }
            c2986nY.A02(4);
            return -4;
        }
        C3064or c3064or = this.A0X.A01(A0O()).A00;
        if (z10 || c3064or != this.A0B) {
            A0H(c3064or, c6n);
            return -5;
        }
        ...
        c2986nY.A02(this.A0N[iA00]);
        c2986nY.A01 = this.A0R[iA00];
        if (c2986nY.A01 < this.A09) {
            c2986nY.A00(Integer.MIN_VALUE);
        }
        c1579Cl.A00 = this.A0O[iA00];
        c1579Cl.A01 = this.A0Q[iA00];
        c1579Cl.A02 = this.A0S[iA00];
        return -4;
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private synchronized void A0G(long j10, int i10, long j11, int i11, C1697Gz c1697Gz) {
        if (this.A02 > 0) {
        ...
        this.A0O[iA002] = i11;
        this.A0N[iA002] = i10;
        this.A0S[iA002] = c1697Gz;
        this.A0P[iA002] = this.A05;
        if (this.A0X.A06() || !this.A0X.A00().A00.equals(this.A0D)) {
            this.A0X.A05(A0P(), new C1580Cm((C3064or) C3M.A01(this.A0D), this.A0U != null ? this.A0U.AGJ(this.A0T, this.A0D) : C9T.A00));
        }
        this.A02++;
        if (this.A02 == this.A01) {
            ...
            C1697Gz[] c1697GzArr = new C1697Gz[i12];
            ...
            System.arraycopy(this.A0S, this.A04, c1697GzArr, 0, i13);
            ...
            System.arraycopy(this.A0S, 0, c1697GzArr, i13, i14);
    ...
    public final /* synthetic */ int AI5(AnonymousClass20 anonymousClass20, int i10, boolean z10) {
        return AbstractC1696Gy.A00(this, anonymousClass20, i10, z10);
    }

    @Override // com.facebook.ads.redexgen.core.H1
    public final /* synthetic */ void AI7(C4J c4j, int i10) {
        AbstractC1696Gy.A01(this, c4j, i10);
    }
    ...
    public C2904mE(EO eo, C9U c9u, C9P c9p) {
        this.A0U = c9u;
        this.A0T = c9p;
        this.A0V = new C1577Cj(eo);
    }
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L27:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2904mE.A01(int, int, long, boolean):int");
    }
    ...
    */
    private int A02(long r6) {
        ...
        La:
            ...
            if (r3 != r0) goto La
            int r3 = r5.A01
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2904mE.A0Z
            r0 = 5
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L42:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2904mE.A02(long):int");
    }
    ...
    */
    private long A07(int r8) {
        ...
        L71:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2904mE.A07(int):long");
    }
    ...
    private final C3064or A0A(C3064or c3064or) {
        if (this.A08 != 0 && c3064or.A0M != Long.MAX_VALUE) {
            return c3064or.A07().A0s(c3064or.A0M + this.A08).A14();
        }
        return c3064or;
    }

    public static C2904mE A0B(EO eo, C9U c9u, C9P c9p) {
        return new C2904mE(eo, (C9U) C3M.A01(c9u), (C9P) C3M.A01(c9p));
    }
    ...
    private void A0H(C3064or c3064or, C6N c6n) {
        C3064or c3064orA08;
        boolean z10 = this.A0B == null;
        DrmInitData newDrmInitData = z10 ? null : this.A0B.A0O;
        this.A0B = c3064or;
        DrmInitData oldDrmInitData = c3064or.A0O;
        if (this.A0U != null) {
            c3064orA08 = c3064or.A08(this.A0U.A7O(c3064or));
        } else {
            c3064orA08 = c3064or;
        }
        c6n.A00 = c3064orA08;
        ...
        if (!z10) {
            boolean zA1E = AbstractC13764a.A1E(newDrmInitData, oldDrmInitData);
            String[] strArr = A0Z;
        ...
        C9G c9g = this.A0E;
        this.A0E = this.A0U.A34(this.A0T, c3064or);
        c6n.A01 = this.A0E;
        if (c9g != null) {
            c9g.AGs(this.A0T);
        }
    ...
    private synchronized boolean A0N(C3064or c3064or) {
        this.A0L = false;
        if (AbstractC13764a.A1E(c3064or, this.A0D)) {
            return false;
        }
        if (!this.A0X.A06() && this.A0X.A00().A00.equals(c3064or)) {
            this.A0D = this.A0X.A00().A00;
        } else {
            this.A0D = c3064or;
        }
        this.A0J = AbstractC13312h.A0G(this.A0D.A0W, this.A0D.A0R);
        this.A0H = false;
        return true;
    }
    ...
    public final int A0R(C6N c6n, C2986nY c2986nY, int i10, boolean z10) {
        int iA03 = A03(c6n, c2986nY, (i10 & 2) != 0, z10, this.A0W);
        if (iA03 == -4 && !c2986nY.A05()) {
            int result = i10 & 1;
            boolean z11 = result != 0;
            int result2 = i10 & 4;
            if (result2 == 0) {
                if (z11) {
                    this.A0V.A0E(c2986nY, this.A0W);
                } else {
                    this.A0V.A0F(c2986nY, this.A0W);
                }
            }
            if (!z11) {
    ...
    public final synchronized C3064or A0U() {
    ...
    */
    public final synchronized void A0a(int r3) {
        ...
        L17:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2904mE.A0a(int):void");
    }
    ...
    public final void A0d(InterfaceC1581Cn interfaceC1581Cn) {
        this.A0F = interfaceC1581Cn;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.H1
    public final void A6W(C3064or c3064or) {
        C3064or c3064orA0A = A0A(c3064or);
        this.A0K = false;
        this.A0C = c3064or;
        boolean upstreamFormatChanged = A0N(c3064orA0A);
        if (this.A0F != null && upstreamFormatChanged) {
            this.A0F.AFb(c3064orA0A);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void AIA(long r16, int r18, int r19, int r20, com.facebook.ads.redexgen.core.C1697Gz r21) {
        /*
            r15 = this;
            r10 = r18
            r8 = r16
        ...
        L97:
            ...
            long r11 = r0.A09()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2904mE.A0Z
            r0 = 1
            r1 = r1[r0]
            r0 = 24
            char r1 = r1.charAt(r0)
        ...
        Lad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2904mE.AIA(long, int, int, int, com.facebook.ads.redexgen.X.Gz):void");
    }
