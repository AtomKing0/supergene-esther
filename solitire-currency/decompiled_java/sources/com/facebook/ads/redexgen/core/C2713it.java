...
public class C2713it implements M5 {
    ...
    private void A05(HashMap<String, M4> map) throws IOException {
        try {
            ...
            if (this.A06) {
                ...
                ((SecureRandom) AbstractC13764a.A0f(this.A03)).nextBytes(bArr);
                dataOutputStream.write(bArr);
                try {
                    ((Cipher) AbstractC13764a.A0f(this.A04)).init(1, (Key) AbstractC13764a.A0f(this.A05), new IvParameterSpec(bArr));
    ...
    private boolean A06(HashMap<String, M4> map, SparseArray<String> sparseArray) {
        ...
        try {
            ...
            if (i10 < 0 || i10 > 2) {
                AbstractC13764a.A10(dataInputStream);
                return false;
            }
            if ((dataInputStream.readInt() & 1) != 0) {
                ...
                try {
                    this.A04.init(2, (Key) AbstractC13764a.A0f(this.A05), new IvParameterSpec(bArr));
    ...
    public C2713it(File file, byte[] bArr, boolean z10) {
    ...
    private M4 A01(int i10, DataInputStream dataInputStream) throws IOException {
        ...
        if (i10 >= 2) {
            c2712isA02 = M6.A02(dataInputStream);
        } else {
            long length = dataInputStream.readLong();
            M9 m92 = new M9();
            M9.A00(m92, length);
            c2712isA02 = C2712is.A03.A05(m92);
        }
        return new M4(i11, utf, c2712isA02);
    }
