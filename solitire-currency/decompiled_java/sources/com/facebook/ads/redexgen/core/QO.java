...
public abstract class QO {
    ...
    public int A0C;
    public int A0D;
    public final InterfaceC1937Qj A0G = new C2555g6(this);
    public final InterfaceC1937Qj A0H = new C2554g5(this);
    public C1939Ql A04 = new C1939Ql(this.A0G);
    public C1939Ql A05 = new C1939Ql(this.A0H);
    ...
    public abstract int A1f(int i10, QW qw, C1931Qd c1931Qd);

    public abstract int A1g(int i10, QW qw, C1931Qd c1931Qd);

    public abstract int A1h(C1931Qd c1931Qd);

    public abstract int A1i(C1931Qd c1931Qd);

    public abstract int A1j(C1931Qd c1931Qd);

    public abstract int A1k(C1931Qd c1931Qd);

    public abstract int A1l(C1931Qd c1931Qd);

    public abstract int A1m(C1931Qd c1931Qd);

    public abstract Parcelable A1n();

    public abstract View A1p(View view, int i10, QW qw, C1931Qd c1931Qd);

    public abstract QP A1q();

    public abstract void A1r(int i10);

    public abstract void A1s(int i10, int i11, C1931Qd c1931Qd, QM qm);

    public abstract void A1t(int i10, QM qm);

    public abstract void A1u(Parcelable parcelable);

    public abstract void A1w(QW qw, C1931Qd c1931Qd);

    public abstract void A1z(C14346g c14346g, C1931Qd c1931Qd, int i10);
    ...
    private final int A08(QW qw, C1931Qd c1931Qd) {
        return 0;
    }
    ...
    private final void A0H(View view, int i10, QP qp) {
        ...
        if (abstractC1934QgA0F.A0g()) {
            this.A03.A0t.A09(abstractC1934QgA0F);
        } else {
            this.A03.A0t.A0A(abstractC1934QgA0F);
        }
        this.A01.A0H(view, i10, qp, abstractC1934QgA0F.A0g());
    }

    private void A0I(View view, int i10, boolean z10) {
        AbstractC1934Qg abstractC1934QgA0F = C14346g.A0F(view);
        if (z10 || abstractC1934QgA0F.A0g()) {
            this.A03.A0t.A09(abstractC1934QgA0F);
        } else {
            this.A03.A0t.A0A(abstractC1934QgA0F);
        }
        QP qp = (QP) view.getLayoutParams();
        if (abstractC1934QgA0F.A0m() || abstractC1934QgA0F.A0h()) {
            if (abstractC1934QgA0F.A0h()) {
                abstractC1934QgA0F.A0Y();
            } else {
                abstractC1934QgA0F.A0U();
            }
            this.A01.A0H(view, i10, view.getLayoutParams(), false);
        } else {
            ViewParent parent = view.getParent();
            C14346g c14346g = this.A03;
            ...
            if (parent == c14346g) {
                ...
                qp.A01 = true;
                AbstractC1929Qb abstractC1929Qb = this.A02;
                if (A0J[4].charAt(12) == 'v') {
                    throw new RuntimeException();
                }
                A0J[6] = "si9YLNjLFs";
                if (abstractC1929Qb != null && this.A02.A0F()) {
                    this.A02.A0C(view);
                }
            }
        }
        if (qp.A02) {
            View view2 = abstractC1934QgA0F.A0H;
            if (A0J[1].length() != 8) {
                throw new RuntimeException();
            }
            A0J[1] = "bg493IDm";
    ...
    private void A0L(QW qw, int i10, View view) {
        ...
        if (abstractC1934QgA0F.A0f()) {
            boolean zA0g = abstractC1934QgA0F.A0g();
            if (A0J[3].charAt(19) == 'k') {
                throw new RuntimeException();
            }
            String[] strArr = A0J;
            ...
            if (!zA0g && !this.A03.A04.A0M()) {
                A0C(i10);
                qw.A0X(abstractC1934QgA0F);
                return;
            }
        }
        A0B(i10);
        qw.A0S(view);
        this.A03.A0t.A0C(abstractC1934QgA0F);
    }

    private final void A0M(QW qw, C1931Qd c1931Qd, AccessibilityEvent accessibilityEvent) {
    ...
    */
    private final void A0N(com.facebook.ads.redexgen.core.QW r6, com.facebook.ads.redexgen.core.C1931Qd r7, com.facebook.ads.redexgen.core.PS r8) {
        /*
            r5 = this;
    ...
    public void A0O(AbstractC1929Qb abstractC1929Qb) {
        if (this.A02 == abstractC1929Qb) {
            this.A02 = null;
        }
    }
    ...
    private final boolean A0R(QW qw, C1931Qd c1931Qd) {
        return false;
    }

    private final boolean A0S(QW qw, C1931Qd c1931Qd, int i10, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
    ...
    private final boolean A0T(QW qw, C1931Qd c1931Qd, View view, int i10, Bundle bundle) {
        return false;
    }

    private boolean A0U(C14346g c14346g, int i10, int i11) {
        View focusedChild = c14346g.getFocusedChild();
    ...
    @Deprecated
    private final boolean A0V(C14346g c14346g, View view, View view2) {
        return A0P() || c14346g.A1s();
    }
    ...
    public int A0s(QW qw, C1931Qd c1931Qd) {
    ...
    public int A0t(QW qw, C1931Qd c1931Qd) {
    ...
    public final void A1E(View view, PS ps) {
        ...
        if (abstractC1934QgA0F != null) {
            ...
            A0J[1] = "uJMRqraa";
            if (!zA0g && !this.A01.A0K(abstractC1934QgA0F.A0H)) {
    ...
    public final void A1G(View view, boolean z10, Rect rect) {
        ...
        if (c14346g != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
    ...
    public final void A1I(QW qw) {
        ...
        for (int i10 = iA0E - 1; i10 >= 0; i10--) {
            ...
            AbstractC1934Qg abstractC1934QgA0F = C14346g.A0F(viewA0F);
            if (!abstractC1934QgA0F.A0l()) {
                abstractC1934QgA0F.A0d(false);
                if (abstractC1934QgA0F.A0i()) {
                    this.A03.removeDetachedView(viewA0F, false);
                }
                if (this.A03.A05 != null) {
                    this.A03.A05.A0L(abstractC1934QgA0F);
                }
                abstractC1934QgA0F.A0d(true);
                qw.A0R(viewA0F);
            }
        }
        qw.A0L();
    ...
    public final void A1K(QW qw) {
        for (int iA0Y = A0Y() - 1; iA0Y >= 0; iA0Y--) {
            if (!C14346g.A0F(A0v(iA0Y)).A0l()) {
                A16(iA0Y, qw);
            }
        }
    }

    public void A1L(QW qw, C1931Qd c1931Qd, int i10, int i11) {
        this.A03.A1c(i10, i11);
    }

    public void A1M(QW qw, C1931Qd c1931Qd, View view, PS ps) {
        PQ itemInfo = PQ.A00(A23() ? A0r(view) : 0, 1, A22() ? A0r(view) : 0, 1, false, false);
        ps.A0Q(itemInfo);
    }

    public final void A1N(AbstractC1929Qb abstractC1929Qb) {
        if (this.A02 != null) {
            AbstractC1929Qb abstractC1929Qb2 = this.A02;
            if (A0J[4].charAt(12) == 'v') {
                throw new RuntimeException();
            }
            A0J[6] = RequestConfiguration.MAX_AD_CONTENT_RATING_G;
            if (abstractC1929Qb != abstractC1929Qb2 && this.A02.A0F()) {
                AbstractC1929Qb abstractC1929Qb3 = this.A02;
                if (A0J[6].length() != 15) {
                    A0J[3] = "jdqDA9lv9LoPYcF6nkiuFYbBQf2p3Jna";
                    abstractC1929Qb3.A09();
                } else {
                    String[] strArr = A0J;
        ...
        this.A02 = abstractC1929Qb;
        this.A02.A0D(this.A03, this);
    }

    public void A1O(C14346g c14346g) {
    }

    public final void A1P(C14346g c14346g) {
        this.A07 = true;
    }

    public final void A1Q(C14346g c14346g) {
        A13(View.MeasureSpec.makeMeasureSpec(c14346g.getWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(c14346g.getHeight(), 1073741824));
    }

    public final void A1R(C14346g c14346g) {
        if (c14346g == null) {
            this.A03 = null;
            this.A01 = null;
            this.A0C = 0;
            ...
            this.A03 = c14346g;
            this.A01 = c14346g.A01;
            this.A0C = c14346g.getWidth();
            this.A0A = c14346g.getHeight();
        }
        this.A0D = 1073741824;
        this.A0B = 1073741824;
    }

    public final void A1S(C14346g c14346g, QW qw) {
        this.A07 = false;
        A1y(c14346g, qw);
    }
    ...
    public final boolean A1b(C14346g c14346g, View view, Rect rect, boolean z10) {
        return A1c(c14346g, view, rect, z10, false);
    }

    public final boolean A1c(C14346g c14346g, View view, Rect rect, boolean z10, boolean z11) {
        int[] scrollAmount = A0W(view, rect);
        int i10 = scrollAmount[0];
        int i11 = scrollAmount[1];
        if ((z11 && !A0U(c14346g, i10, i11)) || (i10 == 0 && i11 == 0)) {
            return false;
        }
        if (z10) {
            c14346g.scrollBy(i10, i11);
        } else {
            c14346g.A1e(i10, i11);
        }
        return true;
    ...
    public final boolean A1d(C14346g c14346g, C1931Qd c1931Qd, View view, View view2) {
        return A0V(c14346g, view, view2);
    }

    public final boolean A1e(C14346g c14346g, ArrayList<View> views, int i10, int i11) {
        return false;
    }
    ...
    public View A1o(int i10) {
        ...
        for (int i11 = 0; i11 < iA0Y; i11++) {
            View child = A0v(i11);
            AbstractC1934Qg abstractC1934QgA0F = C14346g.A0F(child);
            if (abstractC1934QgA0F != null) {
                int childCount = abstractC1934QgA0F.A0O();
                if (childCount == i10 && !abstractC1934QgA0F.A0l() && (this.A03.A0s.A07() || !abstractC1934QgA0F.A0g())) {
                    return child;
                }
            }
        }
    ...
    public void A1x(C1931Qd c1931Qd) {
    }

    public void A1y(C14346g c14346g, QW qw) {
    }
