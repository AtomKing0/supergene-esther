...
public final class C1983Se {
    ...
    public C1983Se(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C1983Se(String[] strArr, Integer num, Integer num2) {
    ...
    public static C1983Se A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                return new C1983Se(linkedHashSet, numValueOf, numValueOf2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C1983Se)) {
            return false;
        }
        C1983Se c1983Se = (C1983Se) obj;
        if (this.A00 == c1983Se.A00 || (this.A00 != null && this.A00.equals(c1983Se.A00))) {
            return (this.A01 == c1983Se.A01 || (this.A01 != null && this.A01.equals(c1983Se.A01))) && this.A03.equals(c1983Se.A03);
        }
        return false;
    }

    public final int hashCode() {
        return (this.A03.hashCode() * 131) + ((this.A00 == null ? -1 : this.A00.intValue()) * 137) + ((this.A01 != null ? this.A01.intValue() : -1) * TsExtractor.TS_STREAM_TYPE_DTS_UHD);
    }
}
