...
public abstract class AbstractC2032Uc {
    ...
    public static List<String> A02(C2387dL c2387dL, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e10) {
                c2387dL.A08().AAy(A00(39, 17, 76), AbstractC2000Sv.A1C, new C2001Sw(e10));
            }
        }
        return arrayList;
    }

    public static void A04(View view, C2030Ua c2030Ua, UZ uz) {
        view.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC2031Ub(c2030Ua, uz));
    }

    public static void A05(C2387dL c2387dL, String str, long j10) {
        US adEventManager = c2387dL.A0A();
        C2030Ua c2030Ua = new C2030Ua(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), XG.A07(j10));
        map.put(A00(12, 12, 71), XG.A05(j10));
        c2030Ua.A04(UZ.A0D, map);
    }

    public static void A06(C2387dL c2387dL, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c2387dL, jSONObjectOptJSONObject, A02(c2387dL, jSONArrayOptJSONArray), j10, null);
            return;
        }
        ...
        A07(c2387dL, jSONObjectOptJSONObject, A03.get(str), j10, str);
    }

    public static void A07(C2387dL c2387dL, JSONObject jSONObject, List<String> list, long j10, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c2387dL, clientToken, j10);
        }
    }
