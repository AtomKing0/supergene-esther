...
public final class C2124Xt extends AdNativeComponentView {
    ...
    public final C2047Ur A06;
    public final C1801La A07;
    ...
    public static final int A09 = ((int) AbstractC2090Wl.A02) * 500;
    public static final int A0H = (int) (AbstractC2090Wl.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC2090Wl.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC2090Wl.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC2090Wl.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC2090Wl.A02 * 4.0f);
    public static final int A0C = (int) AbstractC2090Wl.A02;
    public static final int A0F = (int) (AbstractC2090Wl.A02 * 4.0f);
    public static final int A0A = (int) (((double) AbstractC2090Wl.A02) * 0.5d);

    public C2124Xt(C2387dL c2387dL, C2047Ur c2047Ur) {
        super(c2387dL);
        this.A06 = c2047Ur;
        this.A05 = new TextView(c2387dL);
        this.A04 = new TextView(c2387dL);
        this.A03 = new TextView(c2387dL);
        this.A02 = new RelativeLayout(c2387dL);
        this.A00 = new LinearLayout(c2387dL);
        this.A01 = new RelativeLayout(c2387dL);
        this.A07 = new C1801La(c2387dL);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        EnumC2095Wq.A04(this.A07, EnumC2095Wq.A0B);
        XP.A0I(this.A07);
    }
    ...
    */
    public final void onMeasure(int r3, int r4) {
        /*
            r2 = this;
            float r0 = com.facebook.ads.redexgen.core.AbstractC2090Wl.A02
            int r1 = (int) r0
        ...
        L22:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2124Xt.onMeasure(int, int):void");
    }
