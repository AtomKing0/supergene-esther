...
public final class C1953Qz implements AdViewApi {
    ...
    public C1953Qz(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        this.A00 = -1L;
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            NT nt = new NT(str, WV.A05(this.A0B), AdPlacementType.BANNER, WV.A04(adSize), 1, new C2619hB());
            nt.A06(this.A05);
            nt.A07(this.A06);
            this.A03 = new AnonymousClass72(this.A0A, nt);
            this.A03.A0S(new C2540fq(this));
            return;
        }
        throw new IllegalArgumentException(A01(100, 6, 115));
    }

    public C1953Qz(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws V2 {
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        if (this.A06 != null && (c2363cwA01 = AbstractC2362cv.A01(this.A0A, this.A06)) != null) {
            ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
            relativeLayout.addView(c2363cwA01, new RelativeLayout.LayoutParams(layoutParams.width, layoutParams.height));
        }
    }
    ...
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        ...
        A03(((C2036Ug) adViewLoadConfig).A00());
    }
