...
public class ViewOnClickListenerC2330cP implements View.OnClickListener {
    ...
    public ViewOnClickListenerC2330cP(C4K c4k) {
        this.A00 = c4k;
    }
        ...
        try {
            if (this.A00.A0O instanceof C7P) {
                if (!this.A00.A0B) {
                    ...
                    long jA0n = ((AbstractC1714Hr) this.A00).A06.A0n();
                    if (A01[1].length() != 7) {
                    ...
                    if (jA0n >= 0) {
                        this.A00.A0M.postDelayed(this.A00.A0h, ((AbstractC1714Hr) this.A00).A06.A0n());
                    }
                }
