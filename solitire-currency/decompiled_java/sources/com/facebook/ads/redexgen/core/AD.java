...
public abstract class AD extends AbstractC3121q8 {
    ...
    public static int A02(int value, int min, int max) {
        AbstractC2729jA.A0G(min <= max, A09(16, 47, 91), min, max);
        return Math.min(Math.max(value, min), max);
    }

    public static int A03(long value) {
        int i10 = (int) value;
        AbstractC2729jA.A0H(((long) i10) == value, A09(0, 16, 43), value);
        return i10;
    }
    ...
    public static List<Integer> A0A(int... backingArray) {
        ...
        return new C3122q9(backingArray);
    }

    public static int[] A0C(Collection<? extends Number> collection) {
        if (collection instanceof C3122q9) {
            return ((C3122q9) collection).A04();
        }
        ...
        for (int i10 = 0; i10 < length; i10++) {
            int len2 = ((Number) AbstractC2729jA.A04(array[i10])).intValue();
            iArr[i10] = len2;
        }
        return iArr;
    }
