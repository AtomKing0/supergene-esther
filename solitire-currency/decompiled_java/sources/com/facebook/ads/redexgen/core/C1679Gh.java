...
public final class C1679Gh {
     ...
     */
    public final C1679Gh A0A(List<PictureFrame> list) {
        return new C1679Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(new Metadata(list)));
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 15 out of bounds for length 14
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final C1679Gh A0B(List<String> list) {
        return new C1679Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(H8.A02(list)));
    }
    ...
    public C1679Gh(int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j10, C1678Gg c1678Gg, Metadata metadata) {
        this.A05 = i10;
        this.A03 = i11;
        this.A06 = i12;
        this.A04 = i13;
    ...
    public C1679Gh(byte[] bArr, int i10) {
    ...
    public final long A07(long j10) {
        long sampleNumber = AbstractC13764a.A0T((((long) this.A07) * j10) / 1000000, 0L, this.A09 - 1);
        return sampleNumber;
    }

    public final C3064or A08(byte[] bArr, Metadata metadata) {
        bArr[4] = -128;
    ...
    public final C1679Gh A09(C1678Gg c1678Gg) {
        return new C1679Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, c1678Gg, this.A0B);
    }
}
