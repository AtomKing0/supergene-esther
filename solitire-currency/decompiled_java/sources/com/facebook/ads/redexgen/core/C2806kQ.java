...
public final class C2806kQ extends AbstractC1748Iz {
    ...
    public final long A09(C4J c4j) {
        return A06(AbstractC1689Gr.A05(c4j.A0l()));
    }
    ...
    public final boolean A0C(C4J c4j, long j10, C1747Iy c1747Iy) throws C13322i {
        if (A03(c4j, A04)) {
            byte[] headerBytes = Arrays.copyOf(c4j.A0l(), c4j.A0A());
            int iA01 = AbstractC1689Gr.A01(headerBytes);
            List<byte[]> listA06 = AbstractC1689Gr.A06(headerBytes);
            if (c1747Iy.A00 != null) {
                return true;
            }
            c1747Iy.A00 = new C2D().A11(A00(0, 10, 33)).A0b(iA01).A0m(OpusUtil.SAMPLE_RATE).A12(listA06).A14();
            return true;
        }
        if (A03(c4j, A03)) {
            C3M.A02(c1747Iy.A00);
            ...
            c1747Iy.A00 = c2dA07.A0v(metadataA02.A04(c1747Iy.A00.A0P)).A14();
            return true;
        }
        C3M.A02(c1747Iy.A00);
        return false;
