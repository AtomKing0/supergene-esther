...
public final class C14848i extends AbstractC2834l4 {
    ...
    public static final InterfaceC1700Hc A03;
    public final InterfaceC1700Hc A00;
    ...
    public static ApicFrame A04(C4J c4j, int i10, int i11) {
        ...
        String strA0J = A0J(TypedValues.CycleType.TYPE_VISIBILITY, 6, 90);
        if (i11 == 2) {
            iA02 = 2;
            strA01 = strA0J + AbstractC2694iY.A01(new String(bArr, 0, 3, AbstractC2696ia.A01));
            if (A0J(418, 9, 47).equals(strA01)) {
                strA01 = A0J(c3.a.b.f11499h, 10, 122);
            }
        } else {
            iA02 = A02(bArr, 0);
            strA01 = AbstractC2694iY.A01(new String(bArr, 0, iA02, AbstractC2696ia.A01));
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 20 out of bounds for length 19
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static ChapterFrame A06(C4J c4j, int i10, int i11, boolean z10, int i12, InterfaceC1700Hc interfaceC1700Hc) {
        int iA09 = c4j.A09();
        int iA02 = A02(c4j.A0l(), iA09);
        String str = new String(c4j.A0l(), iA09, iA02 - iA09, AbstractC2696ia.A01);
        c4j.A0f(iA02 + 1);
        int iA0C = c4j.A0C();
        int iA0C2 = c4j.A0C();
        long jA0Q = c4j.A0Q();
        ...
        while (true) {
            ...
            Id3Frame id3FrameA0B = A0B(i11, c4j, z10, i12, interfaceC1700Hc);
            if (id3FrameA0B != null) {
    ...
    public static GeobFrame A09(C4J c4j, int i10) {
        ...
        c4j.A0k(bArr, 0, i10 - 1);
        int iA02 = A02(bArr, 0);
        String str = new String(bArr, 0, iA02, AbstractC2696ia.A01);
        int i11 = iA02 + 1;
    ...
    static {
        A0N();
        A03 = new InterfaceC1700Hc() { // from class: com.facebook.ads.redexgen.X.ky
            @Override // com.facebook.ads.redexgen.core.InterfaceC1700Hc
            public final boolean A6I(int i10, int i11, int i12, int i13, int i14) {
                return C14848i.A0O(i10, i11, i12, i13, i14);
            }
        };
    }
    ...
    public C14848i(InterfaceC1700Hc interfaceC1700Hc) {
        this.A00 = interfaceC1700Hc;
    }
    ...
    */
    public static int A01(com.facebook.ads.redexgen.core.C4J r8, int r9) {
        ...
        L9:
            ...
            int r0 = r9 - r0
            int r3 = r0 + (-2)
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C14848i.A02
            r0 = 1
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L54:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14848i.A01(com.facebook.ads.redexgen.X.4J, int):int");
    }
    ...
    */
    public static int A02(byte[] r1, int r2) {
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14848i.A02(byte[], int):int");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L23:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14848i.A03(byte[], int, int):int");
    }
    ...
    public static ChapterTocFrame A07(C4J c4j, int i10, int i11, boolean z10, int elementIdEndIndex, InterfaceC1700Hc interfaceC1700Hc) {
        int iA09 = c4j.A09();
        int iA02 = A02(c4j.A0l(), iA09);
        String str = new String(c4j.A0l(), iA09, iA02 - iA09, AbstractC2696ia.A01);
        c4j.A0f(iA02 + 1);
        ...
        for (int i12 = 0; i12 < iA0I; i12++) {
            ...
            strArr[i12] = new String(c4j.A0l(), startIndex, elementIdEndIndex2, AbstractC2696ia.A01);
            c4j.A0f(iA022 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i13 = iA09 + i10;
        while (c4j.A09() < i13) {
            Id3Frame id3FrameA0B = A0B(i11, c4j, z10, elementIdEndIndex, interfaceC1700Hc);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
    ...
    public static C1701Hd A0A(C4J c4j) {
        int iA07 = c4j.A07();
        ...
        return new C1701Hd(iA0I, z10, iA0H);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.Id3Frame A0B(int r21, com.facebook.ads.redexgen.core.C4J r22, boolean r23, int r24, com.facebook.ads.redexgen.core.InterfaceC1700Hc r25) {
        /*
            Method dump skipped, instruction units count: 632
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14848i.A0B(int, com.facebook.ads.redexgen.X.4J, boolean, int, com.facebook.ads.redexgen.X.Hc):com.facebook.ads.androidx.media3.extractor.metadata.id3.Id3Frame");
    }
    ...
    public static PrivFrame A0D(C4J c4j, int i10) {
        ...
        c4j.A0k(bArr, 0, i10);
        int iA02 = A02(bArr, 0);
        return new PrivFrame(new String(bArr, 0, iA02, AbstractC2696ia.A01), A0Q(bArr, iA02 + 1, bArr.length));
    }
    ...
    public static UrlLinkFrame A0G(C4J c4j, int i10) {
        ...
        String description = A0L(bArr, descriptionEndIndex, A02(bArr, descriptionEndIndex), AbstractC2696ia.A01);
    ...
    public static UrlLinkFrame A0H(C4J c4j, int i10, String str) {
        byte[] bArr = new byte[i10];
        c4j.A0k(bArr, 0, i10);
        return new UrlLinkFrame(str, null, new String(bArr, 0, A02(bArr, 0), AbstractC2696ia.A01));
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Am != com.google.common.collect.ImmutableList<java.lang.String> */
    public static AbstractC1531Am<String> A0I(byte[] bArr, int i10, int i11) {
        int length = bArr.length;
        String strA0J = A0J(0, 0, 108);
        if (i11 >= length) {
            return AbstractC1531Am.A04(strA0J);
        }
        ...
        while (i11 < valueEndIndex) {
            ...
            c13071hA01.A04(new String(bArr, i11, valueStartIndex, A0M(i10)));
            i11 = valueEndIndex + A00(i10);
            valueEndIndex = A03(bArr, i11, i10);
        }
        AbstractC1531Am<String> abstractC1531AmA05 = c13071hA01.A05();
        return abstractC1531AmA05.isEmpty() ? AbstractC1531Am.A04(strA0J) : abstractC1531AmA05;
    }
    ...
    public static Charset A0M(int i10) {
        switch (i10) {
            case 1:
                return AbstractC2696ia.A03;
            case 2:
                return AbstractC2696ia.A04;
            case 3:
                return AbstractC2696ia.A06;
            default:
                Charset charset = AbstractC2696ia.A01;
                if (A02[5].charAt(22) == 'F') {
                    throw new RuntimeException();
                }
    ...
    */
    public static boolean A0P(com.facebook.ads.redexgen.core.C4J r18, int r19, int r20, boolean r21) throws java.lang.Throwable {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14848i.A0P(com.facebook.ads.redexgen.X.4J, int, int, boolean):boolean");
    }

    public static byte[] A0Q(byte[] bArr, int i10, int i11) {
        if (i11 <= i10) {
            return AbstractC13764a.A07;
        }
        return Arrays.copyOfRange(bArr, i10, i11);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2834l4
    public final Metadata A0R(C14928z c14928z, ByteBuffer byteBuffer) {
    ...
    public final Metadata A0S(byte[] bArr, int i10) {
        ...
        C1701Hd c1701HdA0A = A0A(c4j);
        if (c1701HdA0A == null) {
            return null;
        }
        int startPosition = c4j.A09();
        int frameHeaderSize = c1701HdA0A.A01 == 2 ? 6 : 10;
        int iA01 = c1701HdA0A.A00;
        if (c1701HdA0A.A02) {
            iA01 = A01(c4j, c1701HdA0A.A00);
        }
        c4j.A0e(startPosition + iA01);
        boolean z10 = false;
        if (!A0P(c4j, c1701HdA0A.A01, frameHeaderSize, false)) {
            if (c1701HdA0A.A01 == 4 && A0P(c4j, 4, frameHeaderSize, true)) {
                z10 = true;
            } else {
                AnonymousClass44.A07(A0J(170, 10, 14), A0J(88, 45, 57) + c1701HdA0A.A01);
                return null;
            }
        }
        while (c4j.A07() >= frameHeaderSize) {
            Id3Frame id3FrameA0B = A0B(c1701HdA0A.A01, c4j, z10, frameHeaderSize, this.A00);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
