...
public final class C1803Lc extends RelativeLayout implements InterfaceC2119Xo {
    ...
    public boolean A0G;
    public boolean A0H;
    public final AbstractC2662hy A0I;
    public final NB A0J;
    public final R6 A0K;
    public final C2387dL A0L;
    public final US A0M;
    public final C2030Ua A0N;
    public final C2084Wd A0O;
    public final XC A0P;
    public final InterfaceC2118Xn A0Q;
    public final YY A0R;
    public final InterfaceC2198aH A0S;
    public final C2199aI A0T;
    public final C2371d4 A0U;
    public final AtomicBoolean A0V;
    public final AtomicBoolean A0W;
    public final boolean A0X;
    public final boolean A0Y;
    public final boolean A0Z;
    public final AbstractC2117Xm A0a;
    ...
    static {
        A0N();
        A0o = (int) (AbstractC2090Wl.A02 * 64.0f);
        A0g = (int) (AbstractC2090Wl.A02 * 16.0f);
        A0p = (int) (AbstractC2090Wl.A02 * 12.0f);
        A0e = (int) (AbstractC2090Wl.A02 * 10.0f);
        A0q = new RelativeLayout.LayoutParams(-1, -1);
        A0h = (int) (AbstractC2090Wl.A02 * 48.0f);
        A0i = (int) (AbstractC2090Wl.A02 * 16.0f);
        A0n = (int) (AbstractC2090Wl.A02 * 14.0f);
        A0l = (int) (AbstractC2090Wl.A02 * 12.0f);
        A0m = OP.A02(-1, 77);
        A0d = (int) (AbstractC2090Wl.A02 * 8.0f);
        A0j = (int) (AbstractC2090Wl.A02 * 20.0f);
        A0k = (int) (AbstractC2090Wl.A02 * 13.0f);
        A0f = (int) (AbstractC2090Wl.A02 * 8.0f);
    }

    public C1803Lc(C2387dL c2387dL, US us, InterfaceC2118Xn interfaceC2118Xn, AbstractC2662hy abstractC2662hy, String str, YY yy, C2366cz c2366cz) {
        this(c2387dL, us, interfaceC2118Xn, abstractC2662hy, str, yy, false, c2366cz);
    }

    public C1803Lc(C2387dL c2387dL, US us, InterfaceC2118Xn interfaceC2118Xn, AbstractC2662hy abstractC2662hy, String str, YY yy, boolean z10, C2366cz c2366cz) {
        int iA08;
        super(c2387dL);
        String strA0D = A0D(0, 0, 113);
        this.A0A = strA0D;
        this.A09 = strA0D;
        this.A0K = new C1821Lu(this);
        ...
        this.A0Z = z10;
        this.A0L = c2387dL;
        this.A0Q = interfaceC2118Xn;
        this.A0M = us;
        this.A0I = abstractC2662hy;
        this.A0J = abstractC2662hy.A20().A0H().A07();
        this.A0N = new C2030Ua(this.A0I.A25(), this.A0M);
        this.A0R = yy;
        this.A08 = new C2384dI(c2387dL, this.A0R, str, this.A0Q);
        if (abstractC2662hy.A20().A0H().A07() != null) {
            this.A0D = abstractC2662hy.A20().A0H().A07().A0N();
            this.A0A = abstractC2662hy.A20().A0H().A07().A0H();
            this.A09 = abstractC2662hy.A20().A0H().A07().A0G();
        }
        ...
        C1821Lu c1821Lu = null;
        this.A0O = new C2084Wd(iA08, new C1805Le(this, c1821Lu));
        this.A0X = U7.A0o(this.A0L);
        this.A0a = A07();
        if (this.A0J.A0P()) {
            this.A0a.A06();
        }
        this.A0U = new C2371d4(this.A0L, this.A0M, this.A0I);
        AbstractC2208aR.A00(c2387dL, this, abstractC2662hy.A20().A0H().A08());
        this.A0P = new XC(this);
        this.A0P.A05(XB.A02);
        if (U7.A2D(this.A0L)) {
            this.A0a.setProgressSpinnerInvisible(true);
        }
        C1804Ld c1804Ld = new C1804Ld(this, c1821Lu);
        if (c2366cz == null) {
            HashMap map = new HashMap();
            map.put(A0D(56, 9, 90), this.A0R.A8d());
            this.A07 = new C2366cz(this.A0L, this.A0I, this.A0J, this.A0M, c1804Ld, map);
        } else {
            this.A07 = c2366cz;
            this.A07.setPlayableAdsViewListener(c1804Ld);
        }
        A0K();
        this.A0Q.A3x(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0S = new C1818Lr(this);
        this.A0T = new C2199aI(this.A0L, this.A0a, this.A0I, (E1) null, this.A0Q, this.A0S, this.A06, this.A01, this.A07);
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C1806Lf(this));
    ...
    private C2207aQ A0B() {
        C2387dL c2387dL = this.A0L;
        C1850My c1850MyA01 = this.A0I.A1z().A01();
        ...
        C2207aQ c2207aQ = new C2207aQ(c2387dL, c1850MyA01, true, i10, !z10 ? 14 : 13, 0);
        c2207aQ.A04(this.A0I.A20().A0I().A0F(), this.A0I.A20().A0I().A0E(), null, false, true);
        TextView descriptionTv = c2207aQ.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c2207aQ.getTitleTextView();
    ...
    private void A0G() {
        ...
        C2201aK c2201aK = new C2201aK(this.A0L);
        XP.A0K(c2201aK, 0);
        XP.A0I(c2201aK);
        new KZ(c2201aK, this.A0L).A05(A0h, A0h).A07(this.A0I.A23().A01());
        ...
        C2203aM c2203aM = new C2203aM(this.A0L, !this.A0D ? A0n : A0l, 5, A0m, -1);
        ...
        linearLayout.addView(c2203aM, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c2201aK.getId());
        ...
        if (this.A02 != null) {
            ...
            this.A02.addView(c2201aK, layoutParams);
        }
        ...
        c2203aM.setRating(Float.parseFloat(this.A0I.A20().A0I().A0B()));
        ...
        if (!this.A0D) {
            ...
            strA01 = AbstractC2099Wu.A01(Integer.parseInt(this.A0I.A20().A0I().A08()));
        }
        sb.append(strA01);
    ...
    public void A0I() {
        ...
        if (this.A0I.A20().A0S()) {
            this.A08.A05();
            this.A0Q.A4c(this.A0R.A6d(), new C13533d(0, 0));
        }
    }

    private void A0J() {
        C2338cX c2338cXA0F = new C2336cV(this.A0L, this.A0I.A20().A0I(), this.A0I.A23()).A0A(this.A0I.A1z().A01()).A0D(this.A0J.A0J()).A0C(this.A0J.A0E()).A09(2000).A0E(this.A0D).A0B(this.A0A).A0F();
        AbstractC2032Uc.A04(c2338cXA0F, this.A0N, UZ.A0U);
        addView(c2338cXA0F, A0q);
        c2338cXA0F.A04(new C1816Lp(this));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0L() {
        new C2030Ua(this.A0I.A25(), this.A0M).A04(UZ.A0z, null);
        this.A0V.set(true);
        XP.A0R(this);
        XP.A0F(this.A07);
        ...
        XP.A0J(this.A06);
        Pair<EnumC2370d3, View> pairA03 = this.A0U.A03(this.A06);
        this.A00 = (View) pairA03.second;
        switch (YE.A00[((EnumC2370d3) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0D) {
                    ...
                    addView(new C2331cQ(this.A0L, this.A0I.A23(), this.A0I.A20().A0I(), A09(), this.A09, new YC(this)), new RelativeLayout.LayoutParams(-1, -1));
                    removeView(this.A0a);
                }
                break;
            case 2:
    ...
    public void A0M() {
        ...
        AbstractC2117Xm abstractC2117Xm = this.A0a;
        if (A0c[3].length() == 2) {
            throw new RuntimeException();
        }
        String[] strArr = A0c;
        ...
        abstractC2117Xm.setVisibility(0);
        this.A07.setVisibility(0);
        if (this.A01 != null) {
            this.A01.setVisibility(0);
        }
        if (this.A06 != null && this.A0I.A1w() > 0 && this.A05 == null) {
            this.A05 = new C2084Wd(this.A0I.A1w(), new C1807Lg(this));
            this.A05.A07();
        }
        this.A0O.A07();
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            if (!TextUtils.isEmpty(this.A0I.A25())) {
                this.A0M.AAt(this.A0I.A25(), new C2172Zp().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0O.A06();
