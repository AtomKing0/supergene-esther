...
public class C2414dm extends AbstractRunnableC2074Vt {
    ...
    public C2414dm(SF sf, ArrayList arrayList, S8 s82, S7 s72, ArrayList arrayList2) {
        this.A02 = sf;
        this.A03 = arrayList;
        this.A01 = s82;
        this.A00 = s72;
    ...
    public final void A07() {
        ...
        if (this.A02.A04 instanceof C2387dL) {
            C2387dL c2387dL = (C2387dL) this.A02.A04;
            if (this.A01.A00 == -1) {
                ...
                if (strArr[6].length() == strArr[7].length()) {
                    ...
                    if (z10) {
                        c2387dL.A0F().A4h(XG.A01(this.A02.A00));
                    } else {
                        c2387dL.A0F().A4f(XG.A01(this.A02.A00));
                    }
                }
            ...
            c2387dL.A0F().A4g(XG.A01(this.A02.A00), this.A01.A00);
        }
        this.A02.A02.post(new C2415dn(this, atomicBooleanA0D));
        SF.A0D(this.A04);
    }
}
