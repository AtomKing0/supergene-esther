...
public final class C14486u {
    ...
    public Map<Integer, C14476t> A00 = new HashMap();
            ...
            try {
                if (!str.isEmpty()) {
                    ...
                    for (int jitter = 0; jitter < jSONArray.length(); jitter++) {
                        ...
                        this.A00.put(Integer.valueOf(i10), new C14476t(this, samplingRate, position, jSONObject.getInt(A00(25, 12, 94))));
                    }
                }
