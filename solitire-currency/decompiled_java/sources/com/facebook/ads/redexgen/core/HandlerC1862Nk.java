...
public final class HandlerC1862Nk extends Handler {
    ...
    public InterfaceC2100Wv A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final LH A06;
    public final C2361cu A07;
    public final AbstractRunnableC2074Vt A08;
    ...
    public HandlerC1862Nk(C2361cu c2361cu) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ServiceConnectionC1861Nj(this);
        this.A07 = c2361cu;
        this.A05 = new Messenger(this);
        LL funnelModule = c2361cu.A00(c2361cu);
        if (funnelModule != null) {
            this.A06 = funnelModule.ABn();
        } else {
            this.A06 = new C2723j3();
        }
        this.A08 = new C2598gp(this);
    }
    ...
    public void A07(Messenger messenger) {
        ...
        messageObtain.setData(AbstractC1871Nt.A00(this.A07));
        try {
    ...
    public final void A0A(String str, InterfaceC2100Wv interfaceC2100Wv, int i10) {
        if (this.A02) {
            this.A06.AHd(i10);
            this.A01 = interfaceC2100Wv;
    ...
    public final void A0B(boolean z10) {
        this.A06.AHa();
        this.A02 = C1860Ni.A04(this.A07, z10, this.A03);
        if (this.A02) {
