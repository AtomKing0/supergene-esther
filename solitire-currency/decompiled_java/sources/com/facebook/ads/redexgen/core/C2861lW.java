...
public final class C2861lW implements FT, DisplayManager.DisplayListener {
    ...
    public C2861lW(DisplayManager displayManager) {
    ...
    public final void AGn(FS fs) {
        this.A00 = fs;
        this.A01.registerDisplayListener(this, AbstractC13764a.A0Y());
        fs.ACz(A00());
    }
