...
public final class VM implements InterfaceC1870Ns {
    ...
    public final InterfaceC1854Nc A03(String str) {
    ...
    public final void A06() {
        ...
        while (true) {
            ...
            if (zHasNext) {
                InterfaceC1854Nc interfaceC1854Nc = it.next().getValue().A00;
                if (interfaceC1854Nc != null) {
                    interfaceC1854Nc.destroy();
                }
                it.remove();
            } else {
                return;
