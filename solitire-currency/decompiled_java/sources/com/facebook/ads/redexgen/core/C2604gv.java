...
public final class C2604gv implements SN {
    public long A00;
    ...
    public C2604gv(C2387dL c2387dL, InterstitialAd interstitialAd, String str) {
        this(c2387dL, interstitialAd, str, new C2619hB());
    }

    public C2604gv(C2387dL c2387dL, InterstitialAd interstitialAd, String str, TL tl) {
        this.A0A = c2387dL;
        this.A0B = str;
