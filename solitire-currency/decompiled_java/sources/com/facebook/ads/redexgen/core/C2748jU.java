...
public final class C2748jU implements InterfaceC1784Kj {
    ...
    public final boolean AI9(InterfaceC2853lN interfaceC2853lN, long j10) throws IOException {
        ...
        while (true) {
            ...
            int iAI5 = this.A06.AI5(interfaceC2853lN, (int) Math.min(this.A03 - this.A00, j11), true);
            if (iAI5 == -1) {
                j11 = 0;
            } else {
                this.A00 += iAI5;
        ...
        if (i11 > 0) {
            long jA0U = this.A02 + AbstractC13764a.A0U(this.A01, 1000000L, this.A07.A04);
            int i12 = i11 * i10;
    ...
    public C2748jU(GY gy, H1 h12, C1786Kl c1786Kl, String str, int i10) throws C13322i {
        this.A05 = gy;
        this.A06 = h12;
        this.A07 = c1786Kl;
        int i11 = (c1786Kl.A05 * c1786Kl.A01) / 8;
        int bytesPerFrame = c1786Kl.A02;
        if (bytesPerFrame == i11) {
            int bytesPerFrame2 = c1786Kl.A04;
            int constantBitrate = bytesPerFrame2 * i11 * 8;
            int bytesPerFrame3 = c1786Kl.A04;
            ...
            int bytesPerFrame5 = c1786Kl.A05;
            C2D c2dA0b = c2dA0h.A0b(bytesPerFrame5);
            int bytesPerFrame6 = c1786Kl.A04;
        ...
        int bytesPerFrame7 = c1786Kl.A02;
        throw C13322i.A01(sbAppend.append(bytesPerFrame7).toString(), null);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1784Kj
    public final void AA0(int i10, long j10) {
        this.A05.AIN(new C2746jS(this.A07, 1, i10, j10));
