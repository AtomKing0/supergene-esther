...
public abstract class KC {
    ...
    public static long A01(String str) throws NumberFormatException {
        long j10 = 0;
        String[] subparts = AbstractC13764a.A1P(str, A02(56, 2, 34));
        for (String str2 : AbstractC13764a.A1O(subparts[0], A02(1, 1, 81))) {
            long j11 = 60 * j10;
            if (A01[0].length() != 27) {
    ...
    public static void A04(C4J c4j) throws C13322i {
        int iA09 = c4j.A09();
        if (A05(c4j)) {
            return;
        }
        c4j.A0f(iA09);
        throw C13322i.A01(A02(2, 21, 114) + c4j.A0T(), null);
    }
