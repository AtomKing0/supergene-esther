...
public class RunnableC2185a2 implements Runnable {
    public static byte[] A01;
    public final /* synthetic */ C14185q A00;
    ...
    public RunnableC2185a2(C14185q c14185q) {
        this.A00 = c14185q;
    }
    ...
    public final void run() throws Throwable {
        ...
        try {
            ...
            ObjectAnimator duration = ObjectAnimator.ofFloat(((AbstractC2178Zv) this.A00).A09, strA00, 1.0f, 0.0f).setDuration(100L);
            duration.addListener(new C2184a1(this));
            duration.start();
        } catch (Throwable th) {
