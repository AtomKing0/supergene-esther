...
public final class MetaExoPlayerUpgradeConfig {
    ...
    public static final Map<EnumC2663i2, Boolean> A02;
    public static final Map<EnumC2664i3, Integer> A03;
    public static final Map<EnumC2665i4, Long> A04;
    ...
    static {
        ...
        A02 = new EnumMap(EnumC2663i2.class);
        A03 = new EnumMap(EnumC2664i3.class);
        A04 = new EnumMap(EnumC2665i4.class);
        for (EnumC2663i2 enumC2663i2 : EnumC2663i2.valuesCustom()) {
            A02.put(enumC2663i2, false);
        }
        for (EnumC2664i3 enumC2664i3 : EnumC2664i3.valuesCustom()) {
            A03.put(enumC2664i3, -1);
        }
        for (EnumC2665i4 id : EnumC2665i4.values()) {
            A04.put(id, -1L);
        }
        A02.put(EnumC2663i2.A0V, true);
        A02.put(EnumC2663i2.A0Q, true);
        A02.put(EnumC2663i2.A1f, true);
        A03.put(EnumC2664i3.A05, 100);
    }

    @JvmStatic
    public static final int A00(EnumC2664i3 enumC2664i3) {
        C3078p6.A09(enumC2664i3, A01(24, 17, 40));
        Integer num = A03.get(enumC2664i3);
        if (num != null) {
            return num.intValue();
        }
    ...
    @JvmStatic
    public static final boolean A03(EnumC2663i2 enumC2663i2) {
        C3078p6.A09(enumC2663i2, A01(24, 17, 40));
        return C3078p6.A0C(true, A02.get(enumC2663i2));
    }
}
