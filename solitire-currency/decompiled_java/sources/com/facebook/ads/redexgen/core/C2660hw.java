...
public final class C2660hw extends AbstractC1840Mo implements Serializable {
    ...
    public int A02;
    public int A03;
    public final List<AbstractC2662hy> A0A;
    ...
    public C2660hw(List<AbstractC2662hy> list) {
        this.A0A = list;
    }

    public static C2660hw A00(JSONObject jSONObject, C2387dL c2387dL) throws JSONException {
        return A01(jSONObject, c2387dL, false);
    }

    public static C2660hw A01(JSONObject jSONObject, C2387dL c2387dL, boolean z10) throws JSONException {
        JSONArray jSONArray = jSONObject.getJSONArray(A02(0, 3, 25));
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            if (z10) {
                arrayList.add(AnonymousClass77.A00(jSONArray.getJSONObject(i10), c2387dL));
            } else {
                arrayList.add(AnonymousClass73.A00(jSONArray.getJSONObject(i10), c2387dL));
            }
        }
        C2660hw c2660hw = new C2660hw(arrayList);
        JSONObject chainingParams = jSONObject.getJSONObject(A02(3, 12, 51));
        c2660hw.A04 = chainingParams.toString();
        c2660hw.A01 = chainingParams.optInt(A02(15, 17, 87), arrayList.size());
        c2660hw.A03 = chainingParams.optInt(A02(32, 24, 112), 0);
        c2660hw.A02 = chainingParams.optInt(A02(100, 24, 46), 0);
        c2660hw.A00 = chainingParams.optInt(A02(56, 19, 15), 2);
        c2660hw.A1K(chainingParams);
        c2660hw.A07 = chainingParams.optBoolean(A02(174, 16, 91), false);
        c2660hw.A06 = chainingParams.optBoolean(A02(146, 28, 22), false);
        c2660hw.A05 = chainingParams.optBoolean(A02(124, 22, 58), false);
        JSONArray jSONArrayOptJSONArray = chainingParams.optJSONArray(A02(75, 25, 12));
        if (jSONArrayOptJSONArray != null) {
            for (int i11 = 0; i11 < jSONArrayOptJSONArray.length(); i11++) {
                c2660hw.A09.add(Integer.valueOf(jSONArrayOptJSONArray.optInt(i11, 0)));
            }
        }
        return c2660hw;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC1840Mo
    ...
    public final AbstractC2662hy A1w() {
        if (!this.A0A.isEmpty()) {
    ...
    public final AbstractC2662hy A1x(int i10) {
    ...
    public final String A20() {
        AbstractC2662hy firstAdDataBundle = A1w();
