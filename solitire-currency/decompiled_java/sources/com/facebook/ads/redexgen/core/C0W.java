...
public class C0W<E> extends AbstractC13131n<E> {
    public final AbstractC1531Am<E> A00;
    ...
    public C0W(AbstractC1531Am<E> list, final int index) {
        ...
        new AF<E>(size, index) { // from class: com.facebook.ads.redexgen.X.1n
            ...
            {
                AbstractC2729jA.A01(index, size);
                this.A01 = size;
                this.A00 = index;
            }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0W != com.google.common.collect.ImmutableList$Itr<E> */
    @Override // com.facebook.ads.redexgen.core.AbstractC13131n
