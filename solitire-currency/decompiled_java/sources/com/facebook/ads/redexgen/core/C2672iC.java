...
public final class C2672iC extends MR {
    ...
    public EnumC1829Mc A03;
    public EnumC1830Md A04;
    public EnumC2048Us A05;
    public String A06;
    public WeakReference<C2547fx> A07;
    ...
    public C2672iC(C2387dL c2387dL, MS ms, C2460eX c2460eX, C2683iN c2683iN) {
        super(c2387dL, ms, c2460eX);
        this.A03 = EnumC1829Mc.A03;
        this.A04 = null;
        this.A0F = c2683iN;
    }
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C2530fg)) {
            C2530fg c2530fg = (C2530fg) this.A02.getNativeAdLayoutApi();
            if (c2530fg.A05()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean zA04 = c2530fg.A04();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A01 != null) {
            map.put(A01(98, 4, 80), String.valueOf((int) (this.A01.getWidth() / AbstractC2090Wl.A02)));
            map.put(A01(94, 4, 124), String.valueOf((int) (this.A01.getHeight() / AbstractC2090Wl.A02)));
        }
        if (this.A04 != null) {
    ...
    public final void A0C(EnumC1829Mc enumC1829Mc) {
        this.A03 = enumC1829Mc;
    }

    public final void A0D(EnumC1830Md enumC1830Md) {
        this.A04 = enumC1830Md;
    }

    public final void A0E(EnumC2048Us enumC2048Us) {
        this.A05 = enumC2048Us;
    }
    ...
    public final void A0G(WeakReference<C2547fx> weakReference) {
