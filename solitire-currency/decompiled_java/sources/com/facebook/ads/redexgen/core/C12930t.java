...
public final class C12930t extends C14637j implements Comparable<C12930t> {
    ...
    public final int compareTo(C12930t c12930t) {
        if (A05() != c12930t.A05()) {
            return A05() ? 1 : -1;
        }
        long j10 = this.A01 - c12930t.A01;
        if (j10 == 0) {
            long j11 = this.A00;
            long delta = c12930t.A00;
            j10 = j11 - delta;
            if (j10 == 0) {
                return 0;
            }
