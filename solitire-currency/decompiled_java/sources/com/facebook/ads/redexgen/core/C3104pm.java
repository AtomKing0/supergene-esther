...
public final class C3104pm {
    ...
    public InterfaceC3106pp A00;
    public boolean A01;
    public final Rect A02;
    public final Rect A03;
    public final Handler A04;
    public final InterfaceC2569gK A05;
    public final InterfaceC3114px A06;
    ...
    public final List<C3111pu<?, ?>> A0D;

    public C3104pm(ViewpointQeConfig viewpointQeConfig, InterfaceC3114px interfaceC3114px, InterfaceC2569gK interfaceC2569gK, A6 a62, ViewpointRegistry viewpointRegistry, Handler handler) {
        this(viewpointQeConfig, interfaceC3114px, interfaceC2569gK, a62, viewpointRegistry, handler, 100);
    }

    public C3104pm(ViewpointQeConfig viewpointQeConfig, InterfaceC3114px interfaceC3114px, InterfaceC2569gK interfaceC2569gK, A6 a62, ViewpointRegistry viewpointRegistry, Handler handler, int i10) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        ...
        this.A06 = interfaceC3114px;
        this.A05 = interfaceC2569gK;
        this.A09 = a62;
        this.A08 = viewpointRegistry;
        this.A04 = handler;
        this.A0A = new RunnableC3105pn(this, i10, new Exception());
    }
        ...
        if (this.A0C.isEmpty()) {
            if (this.A0D.isEmpty()) {
                ...
                for (final DspViewableNode dspViewableNode : this.A0C) {
                    if (this.A07.A00) {
                        this.A08.A09(dspViewableNode, new InterfaceC15149v() { // from class: com.facebook.ads.redexgen.X.1I
                            @Override // com.facebook.ads.redexgen.core.InterfaceC15149v
                            public final Object AAB(Object obj) {
                                return this.A00.A0B(dspViewableNode, (C3111pu) obj);
                            }
                        });
                    } else {
    ...
    private void A07(DspViewableNode dspViewableNode, C3111pu<?, ?> c3111pu) {
        for (Rect rect : this.A0B) {
            Rect containerRect = this.A03;
            if (dspViewableNode.A9Q(containerRect, this.A02, rect) && c3111pu != C3111pu.A0B) {
                A6 a62 = this.A09;
                Rect rect2 = this.A03;
                Rect rect3 = this.A02;
                ...
                strArr2[1] = "vG";
                strArr2[7] = "kB";
                a62.A3y(c3111pu, rect2, rect3, viewpointQeConfig.A01);
            }
        }
    }
    ...
    public final /* synthetic */ C3087pL A0B(DspViewableNode dspViewableNode, C3111pu c3111pu) {
        A07(dspViewableNode, c3111pu);
        return null;
    }
    ...
    public final void A0E(InterfaceC3108pr interfaceC3108pr) {
        this.A09.AJA(interfaceC3108pr);
    }

    public final void A0F(InterfaceC3106pp interfaceC3106pp) {
        this.A00 = interfaceC3106pp;
    }
}
