...
public abstract class AbstractC2012Th {
    ...
    public static InterfaceC2013Tj A00(C2361cu c2361cu) {
        try {
            return new C2070Vp(c2361cu);
        } catch (IOException e10) {
            c2361cu.A08().AAy(A02(0, 15, 104), AbstractC2000Sv.A2K, new C2001Sw(e10));
            return new W8();
        }
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [com.facebook.ads.redexgen.X.6J] */
    public static C6J A01(C2361cu c2361cu) {
        return new WO(c2361cu) { // from class: com.facebook.ads.redexgen.X.6J
            ...
            private JSONArray A01(Cursor cursor) throws JSONException {
                ...
                while (cursor.moveToNext()) {
                    ...
                    jSONObject.put(A00(54, 2, 12), cursor.getString(C2360ct.A04.A00));
                    jSONObject.put(A00(82, 8, 79), cursor.getString(C2360ct.A09.A00));
                    jSONObject.put(A00(90, 4, 58), cursor.getString(C2360ct.A0A.A00));
                    jSONObject.put(A00(78, 4, 94), XG.A03(cursor.getDouble(C2360ct.A08.A00)));
                    jSONObject.put(A00(66, 12, 26), XG.A03(cursor.getDouble(C2360ct.A07.A00)));
                    jSONObject.put(A00(56, 10, 44), cursor.getString(C2360ct.A06.A00));
                    String string = cursor.getString(C2360ct.A03.A00);
                    jSONObject.put(A00(50, 4, 100), string != null ? new JSONObject(string) : new JSONObject());
                    jSONObject.put(A00(43, 7, 94), cursor.getString(C2360ct.A02.A00));
            ...
            public static JSONObject A03(Cursor cursor) throws JSONException {
                JSONObject jSONObject = new JSONObject();
                while (cursor.moveToNext()) {
                    jSONObject.put(cursor.getString(C2359cs.A03.A00), cursor.getString(C2359cs.A02.A00));
                }
                return jSONObject;
            }
            ...
            public final String A7x(String str) {
                ...
                if (cursorA0D != null) {
                    ...
                    if (zMoveToNext && cursorA0D.getCount() > 0) {
                        String eventType2 = C2360ct.A0A.A01;
            ...
            public final void AKL(UP up, AbstractC2011Tg<String> abstractC2011Tg) {
                this.A02.A0G(up.A08(), up.A05().A00, up.A06().toString(), up.A04(), up.A03(), up.A07(), up.A09(), abstractC2011Tg);
            }
        };
    }
}
