...
public final class C1770Jv {
    ...
    public static void A0A(C4J c4j, C1774Jz c1774Jz, StringBuilder sb) {
        A09(c4j);
        String strA03 = A03(c4j, sb);
        String strA01 = A01(0, 0, 111);
        if (strA01.equals(strA03)) {
    ...
    private void A0B(C1774Jz c1774Jz, String str) {
        ...
        if (iIndexOf != -1) {
            ...
            if (matcher.matches()) {
                c1774Jz.A0N((String) C3M.A01(matcher.group(1)));
            }
            str = str.substring(0, iIndexOf);
        }
        String[] strArrA1O = AbstractC13764a.A1O(str, A01(47, 2, 9));
        String str2 = strArrA1O[0];
        int iIndexOf2 = str2.indexOf(35);
        if (iIndexOf2 != -1) {
            c1774Jz.A0M(str2.substring(0, iIndexOf2));
            int voiceStartIndex = iIndexOf2 + 1;
            c1774Jz.A0L(str2.substring(voiceStartIndex));
        } else {
            c1774Jz.A0M(str2);
        }
        ...
        if (voiceStartIndex2 > 1) {
            ...
            c1774Jz.A0O((String[]) AbstractC13764a.A1J(strArrA1O, 1, voiceStartIndex3));
        }
    }
    ...
    */
    public static void A0C(java.lang.String r6, com.facebook.ads.redexgen.core.C1774Jz r7) {
        /*
            Method dump skipped, instruction units count: 228
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1770Jv.A0C(java.lang.String, com.facebook.ads.redexgen.X.Jz):void");
    }
    ...
    public final List<C1774Jz> A0F(C4J c4j) {
        String selector;
        ...
        while (true) {
            ...
            C1774Jz c1774Jz = new C1774Jz();
            A0B(c1774Jz, selector2);
            String strA04 = null;
            boolean z10 = false;
            while (true) {
                ...
                if (!z10) {
                    this.A00.A0f(iA092);
                    A0A(this.A00, c1774Jz, this.A01);
                }
            }
            if (selector.equals(strA04)) {
                arrayList.add(c1774Jz);
            }
        }
    }
}
