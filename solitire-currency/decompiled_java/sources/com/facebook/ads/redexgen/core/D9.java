...
public final class D9 implements InterfaceC2404dc {
    ...
    public final DR A09 = new DR() { // from class: com.facebook.ads.redexgen.X.3P
        ...
        public final void A03(C3Y c3y) {
            ...
            if (this.A00.A0G(EnumC2428e1.A04)) {
                this.A00.A03();
    ...
    public final DM A0B = new DM() { // from class: com.facebook.ads.redexgen.X.3J
        ...
        public final void A03(C3Q c3q) {
            if (this.A00.A04 || !this.A00.A0G(EnumC2428e1.A04)) {
                return;
            }
            this.A00.A03();
            this.A00.A06(true, false);
    ...
    public final List<InterfaceC2429e2> A0D = new ArrayList();
    public int A00 = 2000;
    ...
    public void A03() {
        ...
        Iterator<InterfaceC2429e2> it = this.A0D.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0G(EnumC2428e1 enumC2428e1) {
        Iterator<InterfaceC2429e2> it = this.A0D.iterator();
        while (it.hasNext()) {
            if (it.next().A93() != enumC2428e1) {
                return false;
            }
        }
        return true;
    ...
    public final void A0L(InterfaceC2429e2 interfaceC2429e2) {
        this.A0D.add(interfaceC2429e2);
    }
