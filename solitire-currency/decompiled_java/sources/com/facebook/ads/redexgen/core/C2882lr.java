...
public class C2882lr<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public final /* synthetic */ C2886lv A00;
    ...
    public C2882lr(final C2886lv this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean remove(@CheckForNull Object o10) {
        ...
        Map.Entry entry = (Map.Entry) o10;
        if (this.A00.A0p() || (iA06 = AbstractC2889ly.A06(entry.getKey(), entry.getValue(), (iA00 = this.A00.A00()), this.A00.A0C(), this.A00.A0T(), this.A00.A0V(), this.A00.A0W())) == -1) {
            return false;
        }
