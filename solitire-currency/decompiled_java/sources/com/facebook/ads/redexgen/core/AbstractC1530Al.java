...
public abstract class AbstractC1530Al<E> extends AbstractC2926ma<E> implements Set<E> {
    ...
    @CheckForNull
    @LazyInit
    public transient AbstractC1531Am<E> A00;
    ...
    public AbstractC1531Am<E> A0J() {
        AbstractC1531Am<E> abstractC1531Am = this.A00;
        if (abstractC1531Am != null) {
            return abstractC1531Am;
        }
        AbstractC1531Am<E> abstractC1531AmA0M = A0M();
        this.A00 = abstractC1531AmA0M;
        return abstractC1531AmA0M;
    }

    /* JADX INFO: renamed from: A0N */
    public abstract AbstractC3098pg<E> iterator();
    ...
    public static int A03(int setSize) {
        ...
        AbstractC2729jA.A0E(iMax < 1073741824, A0B(18, 20, 20));
        return 1073741824;
    }

    public static <E> AbstractC1530Al<E> A04(int n10, Object... elements) {
        ...
        switch (n10) {
            ...
            default:
                ...
                for (int j10 = 0; j10 < n10; j10++) {
                    Object objA00 = AbstractC3039oR.A00(objArrCopyOf[j10], j10);
                    int iHashCode = objA00.hashCode();
                    int tableSize = AbstractC2920mU.A00(iHashCode);
                    while (true) {
    ...
    public static <E> AbstractC1530Al<E> A05(E e12, E e22) {
        return A04(2, e12, e22);
    }

    public static <E> AbstractC1530Al<E> A06(E e12, E e22, E e32) {
    ...
    public static <E> AbstractC1530Al<E> A07(Collection<? extends E> elements) {
        if ((elements instanceof AbstractC1530Al) && !(elements instanceof SortedSet)) {
            AbstractC1530Al<E> abstractC1530Al = (AbstractC1530Al) elements;
            if (!abstractC1530Al.A0K()) {
    ...
    public static <E> AbstractC1530Al<E> A08(E[] elements) {
    ...
    public static <E> AbstractC1530Al<E> A09() {
        return C1W.A05;
    }

    public static <E> AbstractC1530Al<E> A0A(E element) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Al != com.google.common.collect.ImmutableSet<E> */
    public AbstractC1531Am<E> A0M() {
        return AbstractC1531Am.A06(toArray());
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        ...
        if ((object instanceof AbstractC1530Al) && A0O() && ((AbstractC1530Al) object).A0O() && hashCode() != object.hashCode()) {
            return false;
        }
        return AbstractC3067ou.A09(this, object);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Al != com.google.common.collect.ImmutableSet<E> */
    @Override // java.util.Collection, java.util.Set
    public int hashCode() {
        return AbstractC3067ou.A00(this);
    }
