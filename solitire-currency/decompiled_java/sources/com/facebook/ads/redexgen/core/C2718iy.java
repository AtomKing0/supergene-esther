...
public final class C2718iy implements InterfaceC13964u {
    ...
    public final InterfaceC1814Ln A09;
    ...
    public C2718iy(InterfaceC1814Ln interfaceC1814Ln, long j10, int i10) {
        C3M.A0A(j10 > 0 || j10 == -1, A00(115, 48, 72));
        if (j10 != -1 && j10 < 2097152) {
            AnonymousClass44.A07(A00(0, 13, 24), A00(13, 102, 75));
        }
        this.A09 = (InterfaceC1814Ln) C3M.A01(interfaceC1814Ln);
    ...
    private void A01() throws IOException {
        ...
        try {
            this.A06.flush();
            AbstractC13764a.A10(this.A06);
            this.A06 = null;
            File file = (File) AbstractC13764a.A0f(this.A05);
            this.A05 = null;
            String[] strArr = A0B;
            ...
            AbstractC13764a.A10(this.A06);
            this.A06 = null;
            File fileToCommit = (File) AbstractC13764a.A0f(this.A05);
            this.A05 = null;
            if (0 != 0) {
    ...
    private void A03(AnonymousClass56 anonymousClass56) throws IOException {
        this.A05 = this.A09.AJN((String) AbstractC13764a.A0f(anonymousClass56.A08), anonymousClass56.A04 + this.A00, anonymousClass56.A03 != -1 ? Math.min(anonymousClass56.A03 - this.A00, this.A01) : -1L);
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC13964u
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC13964u
    public final void write(byte[] bArr, int i10, int i11) throws C2720j0 {
        ...
        while (i12 < i11) {
            try {
                ...
                ((OutputStream) AbstractC13764a.A0f(this.A06)).write(bArr, i10 + i12, iMin);
                i12 += iMin;
                this.A02 += (long) iMin;
                this.A00 += (long) iMin;
            } catch (IOException e10) {
