...
public final class JQ {
    ...
    public static JI A04(C4I c4i, int i10) {
        ...
        while (i12 > 0) {
            ...
            iArr[iA046] = A00(255 - (iA044 & 255), AbstractC13764a.A07((int) (((double) iA04) + (((double) (iA042 - 128)) * 1.402d)), 0, 255), AbstractC13764a.A07((int) ((((double) iA04) - (((double) (iA043 - 128)) * 0.34414d)) - (((double) (iA042 - 128)) * 0.71414d)), 0, 255), AbstractC13764a.A07((int) (((double) iA04) + (((double) (iA043 - 128)) * 1.772d)), 0, 255));
            i11 = 8;
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 25 out of bounds for length 23
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final List<C3015o2> A0I(byte[] bArr, int i10) {
    ...
    */
    ...
    public static JK A06(C4I c4i) {
        ...
        boolean zA0H = c4i.A0H();
        c4i.A09(1);
        byte[] bottomFieldData = AbstractC13764a.A07;
        byte[] bArr = AbstractC13764a.A07;
