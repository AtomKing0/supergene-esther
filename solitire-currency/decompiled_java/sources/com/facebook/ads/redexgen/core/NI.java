...
public abstract class NI extends RelativeLayout implements InterfaceC2119Xo {
    ...
    public final AbstractC2117Xm A0E;
    ...
    public NI(C2387dL c2387dL, US us, InterfaceC2118Xn interfaceC2118Xn, AbstractC2662hy abstractC2662hy) {
        super(c2387dL);
        this.A07 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0D = new C2030Ua(this.A0A.A25(), this.A0C);
    ...
    private void A0Q() {
        ...
        if (A0b() && this.A02 == null) {
            this.A04 = true;
            this.A02 = new C2336cV(this.A0B, this.A0A.A20().A0I(), this.A0A.A23()).A0A(this.A0A.A1z().A01()).A0F();
            AbstractC2032Uc.A04(this.A02, this.A0D, UZ.A0U);
    ...
    private void A0S(C1850My c1850My, boolean z10) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, this.A0E.getToolbarHeight());
        layoutParams.addRule(10);
        this.A0E.A0A(c1850My, KE.A05(this.A0A));
        addView(this.A0E, layoutParams);
    }

    public final void A0V() {
        if (this.A00 == null || !(this.A00 instanceof AbstractC2221ae)) {
            return;
        }
        if (A0c()) {
            ((AbstractC2221ae) this.A00).A1F();
        } else {
            ((AbstractC2221ae) this.A00).A1E();
        }
    }

    public final void A0X(int i10) {
        this.A01 = new C2084Wd(i10, new NJ(this, i10));
        this.A03 = true;
        A0V();
        this.A01.A07();
    }
    ...
    public final void A0Y(View view, boolean z10, int i10) {
        ...
        C1850My c1850MyA0M = A0M(i10);
        A0S(c1850MyA0M, z10);
        XP.A0K(this, c1850MyA0M.A08(false));
        if (this.A09 != null) {
            A0Q();
            if (z10) {
                this.A08.A05(XB.A03);
    ...
    public final void A0Z(R0 r02) {
        ...
        C1841Mp c1841MpA20 = null;
        C1841Mp adInfo = this.A0A.A20();
        if (adInfo != null) {
            C1841Mp adInfo2 = this.A0A.A20();
            if (adInfo2 != null) {
                c1841MpA20 = this.A0A.A20();
            }
        }
        this.A0E.setPageDetails(this.A0A.A23(), this.A0A.A25(), c1841MpA20 != null ? c1841MpA20.A0H().A04() : 0, this.A0A.A24());
    ...
    public InterfaceC2118Xn getAudienceNetworkListener() {
        return this.A09;
    }
