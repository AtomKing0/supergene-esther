...
public final class C2446eJ {
    public static InterfaceC13884m A06;
    public static BT A07;
    public static InterfaceC1814Ln A08;
    public static C2446eJ A09;
    ...
    public boolean A00;
    public final C2361cu A04;
    public final Handler A01 = new Handler(Looper.getMainLooper());
    public final SparseArray<C2444eH> A02 = new SparseArray<>();
    public final Runnable A05 = new RunnableC2443eG(this);
    ...
    public C2446eJ(C2361cu c2361cu, BT bt) {
        this.A04 = c2361cu;
        if (bt != null) {
            A07 = bt;
            bt.A0F(this.A03);
    ...
    public static synchronized InterfaceC13884m A01(Context context) {
        if (A06 == null) {
            A06 = new C3002no(context);
        }
        return A06;
    }

    private C15029j A02() {
        return new C15029j().A01(A08(135, 3, 65)).A00(null);
    }
    ...
    public static synchronized InterfaceC1814Ln A04(Context context) {
        if (A08 == null) {
            A08 = new C2711ir(new File(A07(context), A08(121, 14, 26)), new C7R(U7.A0T(context)));
        }
        return A08;
    }

    public static C2717ix A05(C2998nk c2998nk, InterfaceC1814Ln interfaceC1814Ln) {
        return new C2717ix().A06(interfaceC1814Ln).A05(c2998nk).A04(new C2992ne()).A03(2);
    }

    public static synchronized C2446eJ A06(C2361cu c2361cu) {
        if (A09 == null) {
            A09 = new C2446eJ(c2361cu, null);
        }
        return A09;
    }
    ...
    public static String A09(C2361cu c2361cu, Uri uri) {
        try {
            if (!U7.A1r(c2361cu)) {
                return null;
            }
            ...
            c2361cu.A08().AAy(A08(138, 5, 50), AbstractC2000Sv.A0u, new C2001Sw(e10));
            return null;
        }
    }
    ...
    */
    public void A0A() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2446eJ.A0A():void");
    }
    ...
    public final InterfaceC13984w A0H(Context context) {
        return A05(new C2998nk(context, (C5H) null, A02()), A04(context));
    }

    public final void A0I(Uri uri, InterfaceC2445eI interfaceC2445eI, long j10) {
        ...
        this.A02.put(downloadRequestA05.A02.hashCode(), new C2444eH(interfaceC2445eI, j10, zA0J, null));
        A0B();
    }
