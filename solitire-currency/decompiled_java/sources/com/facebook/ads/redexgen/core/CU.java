...
public final class CU implements InterfaceC2429e2 {
    ...
    private ValueAnimator A00(View view, int i10, int i11) {
        ...
        valueAnimatorOfInt.addUpdateListener(new C2438eB(this, view));
    ...
    public void A08(boolean z10) {
        if (z10) {
            ...
            this.A00.addListener(new C2437eA(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z10) {
        ...
        if (z10) {
            ...
            this.A00.addListener(new C2436e9(this));
            this.A00.start();
            return;
        }
