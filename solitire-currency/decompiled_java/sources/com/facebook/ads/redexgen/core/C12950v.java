...
public final class C12950v extends AbstractC14617h {
    ...
    public int A03;
    public long A05;
    public List<C3015o2> A07;
    public List<C3015o2> A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    static {
        ...
        A0N = new int[]{174, 176, PsExtractor.PRIVATE_STREAM_1, 191, 8482, 162, 163, 9834, 224, 32, 232, 226, 234, 238, 244, 251};
        A0O = new int[]{193, 201, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_NEW_GROUP_ADDED, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, PsExtractor.AUDIO_STREAM, 194, 199, 200, 202, 203, 235, 206, 207, 239, 212, 217, 249, 219, 171, 187};
    ...
    public C12950v(String str, int i10, long j10) {
    ...
    private List<C3015o2> A07() {
        int iMin = 2;
        int size = this.A0H.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i10 = 0; i10 < size; i10++) {
            C3015o2 c3015o2A08 = this.A0H.get(i10).A08(Integer.MIN_VALUE);
            arrayList.add(c3015o2A08);
            if (c3015o2A08 != null) {
                int positionAnchor = c3015o2A08.A08;
                iMin = Math.min(iMin, positionAnchor);
            }
        }
        List<Cue> displayCues = new ArrayList<>(size);
        for (int i11 = 0; i11 < size; i11++) {
            C3015o2 c3015o2 = (C3015o2) arrayList.get(i11);
            if (c3015o2 != null) {
                int cueBuilderCount = c3015o2.A08;
                if (cueBuilderCount != iMin) {
                    c3015o2 = (C3015o2) C3M.A01(this.A0H.get(i11).A08(iMin));
                }
                displayCues.add(c3015o2);
            }
        }
        return displayCues;
    }
    ...
    */
    private void A0E(int r3) {
        ...
        L34:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C12950v.A0E(int):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC14617h
    /* JADX INFO: renamed from: A0W */
    public final /* bridge */ /* synthetic */ C14637j A5j() throws C2802kM {
        return super.A5j();
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC14617h, com.facebook.ads.redexgen.core.C5O
    /* JADX INFO: renamed from: A0X, reason: merged with bridge method [inline-methods] */
    public final AbstractC14627i A5l() throws C2802kM {
        AbstractC14627i abstractC14627iA0Y;
        AbstractC14627i outputBuffer = super.A5l();
        if (outputBuffer != null) {
            return outputBuffer;
        }
        if (A0G() && (abstractC14627iA0Y = A0Y()) != null) {
            this.A07 = Collections.emptyList();
            this.A05 = C.TIME_UNSET;
            abstractC14627iA0Y.A0C(A0V(), A0Z(), Long.MAX_VALUE);
            return abstractC14627iA0Y;
        }
        return null;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC14617h
    public final C2798kI A0Z() {
        this.A08 = this.A07;
        return new C2798kI((List) C3M.A01(this.A07));
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC14617h
    /* JADX INFO: renamed from: A0a */
    public final /* bridge */ /* synthetic */ void AGZ(C14637j c14637j) throws C2802kM {
        super.AGZ(c14637j);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC14617h
    public final void A0b(C14637j c14637j) {
        ByteBuffer subtitleData = (ByteBuffer) C3M.A01(c14637j.A02);
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC14617h, com.facebook.ads.redexgen.core.InterfaceC2803kN
