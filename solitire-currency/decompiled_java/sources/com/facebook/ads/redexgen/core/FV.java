...
public final class FV {
    ...
    public static FT A01(Context context) {
        C2861lW c2861lWA01 = null;
        if (context == null) {
            return null;
        }
        Context applicationContext = context.getApplicationContext();
        if (AbstractC13764a.A02 >= 17) {
            c2861lWA01 = C2861lW.A01(applicationContext);
        }
        if (c2861lWA01 == null) {
            return C2862lX.A00(applicationContext);
        }
        return c2861lWA01;
    }

    private void A03() {
        if (AbstractC13764a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE || this.A03 == 0.0f) {
            return;
        }
        this.A03 = 0.0f;
    ...
    */
    ...
    private void A09(boolean z10) {
        if (AbstractC13764a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE) {
            return;
        }
        float f10 = 0.0f;
