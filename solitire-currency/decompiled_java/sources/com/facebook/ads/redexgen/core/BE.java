...
public class BE<V> extends AbstractC13081i<K, V>.WrappedCollection implements List<V> {
    ...
    public final boolean addAll(int index, Collection<? extends V> c10) {
        ...
        if (zAddAll) {
            AbstractC13081i.A02(this.A00, A02().size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public BE(@ParametricNullness final AbstractC13081i this$0, @CheckForNull Object key, List delegate, C2797kH ancestor) {
