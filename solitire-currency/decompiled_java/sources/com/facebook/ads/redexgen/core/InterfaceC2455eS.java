...
public interface InterfaceC2455eS {
    void A9V();
    ...
    void AJM(EnumC2403db enumC2403db, int i10);
    ...
    EnumC2403db getStartReason();

    EnumC2457eU getState();
    ...
    void setVideoStateChangeListener(InterfaceC2458eV interfaceC2458eV);
