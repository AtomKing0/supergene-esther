...
public final class M6 {
    ...
    public M6(InterfaceC13884m interfaceC13884m, File file, byte[] bArr, boolean z10, boolean z11) {
        C3M.A08((interfaceC13884m == null && file == null) ? false : true);
        this.A05 = new HashMap<>();
        this.A02 = new SparseArray<>();
        this.A04 = new SparseBooleanArray();
        this.A03 = new SparseBooleanArray();
        C2714iu c2714iu = interfaceC13884m != null ? new C2714iu(interfaceC13884m) : null;
        M5 databaseStorage = file != null ? new C2713it(new File(file, A04(42, 24, 47)), bArr, z10) : null;
        if (c2714iu == null || (databaseStorage != null && z11)) {
            M5 legacyStorage = (M5) AbstractC13764a.A0f(databaseStorage);
    ...
    public static C2712is A02(DataInputStream dataInputStream) throws IOException {
        ...
        for (int nextBytesToRead = 0; nextBytesToRead < i10; nextBytesToRead++) {
            ...
            if (bytesRead >= 0) {
                ...
                byte[] bArrCopyOf = AbstractC13764a.A07;
    ...
    public static void A08(C2712is c2712is, DataOutputStream dataOutputStream) throws IOException {
        Set<Map.Entry<String, byte[]>> setA06 = c2712is.A06();
    ...
    public final C2712is A0E(String str) {
        M4 cachedContent = A0C(str);
        return cachedContent != null ? cachedContent.A03() : C2712is.A03;
    }
    ...
    public final void A0H() {
        AbstractC3098pg abstractC3098pgA0N = AbstractC1530Al.A07(this.A05.keySet()).A0N();
        while (true) {
            boolean zHasNext = abstractC3098pgA0N.hasNext();
            String[] strArr = A07;
            ...
            if (zHasNext) {
                A0K((String) abstractC3098pgA0N.next());
            } else {
                return;
            }
        }
