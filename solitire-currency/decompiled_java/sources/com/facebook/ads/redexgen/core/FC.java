...
public final class FC {
    ...
    public Handler A04;
    public Pair<Long, C3064or> A05;
    public Pair<Surface, C4N> A06;
    public CopyOnWriteArrayList<InterfaceC13553f> A08;
    public boolean A0A;
    public boolean A0B;
    ...
    public final ArrayDeque<Pair<Long, C3064or>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = C.TIME_UNSET;
    public C3017o4 A07 = C3017o4.A06;
    ...
    public static boolean A04(long j10) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A1s)) {
            return j10 > 50000;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC2664i3.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC2664i3.A07);
    ...
    public final MediaFormat A06(MediaFormat mediaFormat) {
        if (AbstractC13764a.A02 >= 29 && this.A0C.A0q.getApplicationContext().getApplicationInfo().targetSdkVersion >= 29) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.facebook.ads.redexgen.core.C3064or) r30.A05.second, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x0127, code lost:
        ...
        r30.A03 = androidx.media3.common.C.TIME_UNSET;
     */
    ...
    */
    ...
    public final void A0D(C3064or c3064or) {
        C3M.A01(null);
        final int i10 = c3064or.A0L;
        final int i11 = c3064or.A0A;
    ...
    public final void A0E(String str) {
        this.A00 = AbstractC13764a.A09(this.A0C.A0q, str, false);
    }

    public final void A0F(List<InterfaceC13553f> list) {
        if (this.A08 == null) {
    ...
    public final boolean A0J(C3064or c3064or, long j10) throws C9Y {
        C3M.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        ...
        this.A04 = AbstractC13764a.A0Y();
        this.A0C.A26(c3064or.A0N);
        try {
            if (!C0O.A0h() && c3064or.A0F != 0) {
                CopyOnWriteArrayList<InterfaceC13553f> copyOnWriteArrayList = this.A08;
                FB.A00(c3064or.A0F);
            ...
            new ExecutorC14858l(handler);
            new C2864lZ(this, c3064or);
            throw new NullPointerException(A01(16, 6, 36));
        } catch (Exception e10) {
            throw this.A0C.A1S(e10, c3064or, 7000);
        }
    }

    public final boolean A0K(C3064or c3064or, long j10, boolean z10) {
        C3M.A02(null);
        C3M.A08(this.A00 != -1);
