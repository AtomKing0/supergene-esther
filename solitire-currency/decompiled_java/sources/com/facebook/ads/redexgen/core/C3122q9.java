...
public class C3122q9 extends AbstractList<Integer> implements RandomAccess, Serializable {
    ...
    public C3122q9(int[] array) {
        this(array, 0, array.length);
    }

    public C3122q9(int[] array, int start, int end) {
        this.A02 = array;
        this.A01 = start;
        this.A00 = end;
    }
    ...
    public final Integer get(int index) {
        AbstractC2729jA.A00(index, size());
    ...
    public final Integer set(int index, Integer element) {
        ...
        int oldValue = ((Integer) AbstractC2729jA.A04(element)).intValue();
        iArr[i11] = oldValue;
    ...
    public final boolean equals(@CheckForNull Object object) {
        ...
        boolean z10 = object instanceof C3122q9;
        if (A04[2].length() != 24) {
            throw new RuntimeException();
        }
        A04[2] = "hkNtVJfoNZugUfjtOIkeX8Ri";
        if (z10) {
            C3122q9 c3122q9 = (C3122q9) object;
            int size = size();
            if (c3122q9.size() != size) {
                return false;
            }
            for (int i10 = 0; i10 < size; i10++) {
                int size2 = this.A02[this.A01 + i10];
                if (size2 != c3122q9.A02[c3122q9.A01 + i10]) {
                    return false;
                }
            }
            return true;
    ...
    */
    public final int hashCode() {
        ...
        L15:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3122q9.hashCode():int");
    }
    ...
    public final List<Integer> subList(int fromIndex, int toIndex) {
        ...
        return new C3122q9(this.A02, this.A01 + fromIndex, this.A01 + toIndex);
    }
