...
public final class VJ implements UR {
    ...
    public final C2361cu A06;
    public final UQ A07;
    public final InterfaceC2466ed A08;
    ...
    public VJ(C2361cu c2361cu, UQ uq) {
        this.A07 = uq;
        this.A06 = c2361cu;
        this.A04 = (ConnectivityManager) c2361cu.getSystemService(A03(293, 12, 115));
        this.A08 = C2484ev.A01(c2361cu);
        this.A03 = U9.A0K(c2361cu);
        this.A02 = U9.A0J(c2361cu);
    }
    ...
    public final void A0B() throws Exception {
        try {
            ...
            c2480er.put(A03(315, 7, 6), jSONObjectA5D.toString());
            InterfaceC2465ec interfaceC2465ecAGD = this.A08.AGD(this.A06.A05().A7y(), c2480er.A08());
            String strA6v = interfaceC2465ecAGD != null ? interfaceC2465ecAGD.A6v() : null;
            if (!TextUtils.isEmpty(strA6v) && interfaceC2465ecAGD != null) {
                if (interfaceC2465ecAGD.A94() != 200) {
                    if (this.A06.A05().AAF()) {
                        String responseBody = A0F;
                        Log.e(responseBody, A03(138, 48, 30) + interfaceC2465ecAGD.A94() + A03(3, 1, 55));
                    }
                    if (interfaceC2465ecAGD.A94() == 413 && U7.A2R(this.A06)) {
                        this.A07.AEr();
                        A05();
                        return;
                    } else {
