...
public final class C14697p {
    ...
    public static final C14697p A04;
    public static final C14697p A05;

    @MetaExoPlayerCustomization(type = {"FEATURE_LOGIC"}, value = "Prevent throwing when building the map")
    public static final AbstractC2935mj<Integer, Integer> A06;
    ...
    static {
        A06();
        A04 = new C14697p(new int[]{2}, 8);
        A05 = new C14697p(new int[]{2, 5, 6}, 8);
        A06 = new C2933mh().A05(5, 6).A05(17, 6).A05(7, 6).A05(18, 6).A05(6, 8).A05(8, 8).A05(14, 8).A07();
    }

    public C14697p(int[] iArr, int i10) {
        if (iArr != null) {
    ...
    */
    public static int A00(int r4) {
        ...
        Lb:
            ...
            java.lang.String r0 = com.facebook.ads.redexgen.core.AbstractC13764a.A03
            ...
            r4 = 2
        L26:
            int r0 = com.facebook.ads.redexgen.core.AbstractC13764a.A01(r4)
            return r0
        L2b:
            r0 = 3
            if (r4 == r0) goto L65
            r3 = 4
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C14697p.A03
            r0 = 1
            r1 = r1[r0]
            r0 = 21
            ...
            r0 = 49
            if (r1 == r0) goto L6d
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C14697p.A03
        ...
        L6d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14697p.A00(int):int");
    }

    public static int A01(int i10, int i11) {
        if (AbstractC13764a.A02 >= 29) {
            return C14687o.A00(i10, i11);
        }
    ...
    public static C14697p A02(Context context) {
        Intent intent = context.registerReceiver(null, new IntentFilter(A05(68, 36, 113)));
        return A03(context, intent);
    }

    public static C14697p A03(Context context, Intent intent) {
        if (A07() && Settings.Global.getInt(context.getContentResolver(), A05(206, 31, 58), 0) == 1) {
            return A05;
        }
        if (AbstractC13764a.A02 >= 29 && (AbstractC13764a.A18(context) || AbstractC13764a.A17(context))) {
            return new C14697p(C14687o.A01(), 8);
        }
        if (intent == null || intent.getIntExtra(A05(104, 36, 91), 0) == 0) {
            return A04;
        }
        return new C14697p(intent.getIntArrayExtra(A05(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 29, 55)), intent.getIntExtra(A05(169, 37, 84), 8));
    }

    public static boolean A07() {
        if (AbstractC13764a.A02 >= 17) {
            if (A05(21, 6, 52).equals(AbstractC13764a.A05) || A05(61, 6, 7).equals(AbstractC13764a.A05)) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final android.util.Pair<java.lang.Integer, java.lang.Integer> A09(com.facebook.ads.redexgen.core.C3064or r9) {
        /*
            r8 = this;
            ...
            int r4 = com.facebook.ads.redexgen.core.AbstractC13312h.A03(r1, r0)
            com.facebook.ads.redexgen.X.mj<java.lang.Integer, java.lang.Integer> r1 = com.facebook.ads.redexgen.core.C14697p.A06
        ...
        La6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14697p.A09(com.facebook.ads.redexgen.X.or):android.util.Pair");
    }
    ...
    public final boolean A0B(C3064or c3064or) {
        return A09(c3064or) != null;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C14697p)) {
            return false;
        }
        C14697p c14697p = (C14697p) obj;
        return Arrays.equals(this.A01, c14697p.A01) && this.A00 == c14697p.A00;
    }
