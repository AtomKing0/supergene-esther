...
public abstract class AbstractC2883ls<T> implements Iterator<T> {
    public int A00;
    public int A01;
    public int A02;
    public final /* synthetic */ C2886lv A03;
    ...
    public AbstractC2883ls(final C2886lv this$0) {
        this.A03 = this$0;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ls != com.google.common.collect.CompactHashMap<K, V>$Itr<T> */
    public /* synthetic */ AbstractC2883ls(C2886lv c2886lv, B9 b92) {
        this(c2886lv);
    }
    ...
    public final void remove() {
        A01();
        AbstractC2876ll.A04(this.A02 >= 0);
        A02();
