...
public final class AnonymousClass92 extends AbstractC2873li {
    ...
    public static final AbstractC3043oV<Integer> A09;
    public static final AbstractC3043oV<Integer> A0A;
    public C3070oy A00;
    ...
    */
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 7 out of bounds for length 6
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static void A0N(C2901mA c2901mA, C3023oA c3023oA, Map<Integer, C3025oC> map) {
        C3025oC c3025oC;
        for (int i10 = 0; i10 < c2901mA.A01; i10++) {
            C3025oC c3025oC2 = c3023oA.A0G.get(c2901mA.A05(i10));
            if (c3025oC2 != null && ((c3025oC = map.get(Integer.valueOf(c3025oC2.A01()))) == null || (c3025oC.A01.isEmpty() && !c3025oC2.A01.isEmpty()))) {
                map.put(Integer.valueOf(c3025oC2.A01()), c3025oC2);
            }
        }
    }
    ...
    static {
        A0M();
        A09 = AbstractC3043oV.A04(new Comparator() { // from class: com.facebook.ads.redexgen.X.Dx
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return AnonymousClass92.A05((Integer) obj, (Integer) obj2);
            }
        });
        A0A = AbstractC3043oV.A04(new Comparator() { // from class: com.facebook.ads.redexgen.X.Dy
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    public AnonymousClass92() {
        this(AnonymousClass93.A0J, new C2896m5());
    }
    ...
    @Deprecated
    public AnonymousClass92(C3023oA c3023oA, EA ea2) {
        this(c3023oA, ea2, null);
    }

    public AnonymousClass92(C3023oA c3023oA, EA ea2, Context context) {
        this.A05 = new Object();
        this.A03 = context != null ? context.getApplicationContext() : null;
        this.A04 = ea2;
        if (c3023oA instanceof AnonymousClass93) {
            this.A01 = (AnonymousClass93) c3023oA;
        } else {
            AnonymousClass93 defaultParameters = context == null ? AnonymousClass93.A0J : AnonymousClass93.A02(context);
            this.A01 = defaultParameters.A0P().A0u(c3023oA).A0p();
        }
        this.A00 = C3070oy.A07;
        this.A06 = context != null && AbstractC13764a.A18(context);
        if (!this.A06 && context != null && AbstractC13764a.A02 >= 32) {
    ...
    public static int A02(C3064or c3064or, String str, boolean z10) {
        String strA0K;
        if (TextUtils.isEmpty(str)) {
            String strA0K2 = A0K(str);
            strA0K = A0K(c3064or.A0V);
            if (strA0K != null) {
            }
            if (z10) {
                return 0;
        ...
        if (strArr[6].length() != strArr[3].length()) {
            ...
            String str3 = AbstractC13764a.A1P(strA0K, strA0J)[0];
            String formatMainLanguage = AbstractC13764a.A1P(strA0K22, strA0J)[0];
            String[] strArr3 = A08;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int A03(com.facebook.ads.redexgen.core.C3030oH r8, int r9, int r10, boolean r11) {
        /*
    ...
    */
    ...
    public static Point A09(boolean z10, int tempViewportWidth, int i10, int i11, int i12) {
        ...
        if (i11 * i10 >= i12 * tempViewportWidth) {
            return new Point(tempViewportWidth, AbstractC13764a.A05(tempViewportWidth * i12, i11));
        }
        return new Point(AbstractC13764a.A05(i10 * i11, i12), i10);
    }
    ...
    private final Pair<E9, Integer> A0B(EC ec, int[][][] iArr, final AnonymousClass93 anonymousClass93, final String str) throws C9Y {
        return A0A(3, ec, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m0
            ...
            public final List A57(int i10, C3030oH c3030oH, int[] iArr2) {
                return C2878ln.A02(i10, c3030oH, anonymousClass93, iArr2, str);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Dw
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C2878ln.A01((List) obj, (List) obj2);
            }
        });
    }
    ...
    private final Pair<E9, Integer> A0C(EC ec, int[][][] iArr, int[] iArr2, final AnonymousClass93 anonymousClass93) throws C9Y {
        ...
        while (true) {
            if (i10 < ec.A02()) {
                if (2 == ec.A03(i10) && ec.A07(i10).A01 > 0) {
                    z10 = true;
                    break;
                }
                i10++;
        ...
        return A0A(1, ec, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m1
            @Override // com.facebook.ads.redexgen.core.E4
            public final List A57(int i11, C3030oH c3030oH, int[] iArr3) {
                return this.A01.A0e(anonymousClass93, z10, i11, c3030oH, iArr3);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Dv
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C2890lz.A02((List) obj, (List) obj2);
            }
        });
    }
    ...
    private final Pair<E9, Integer> A0D(EC ec, int[][][] iArr, final int[] iArr2, final AnonymousClass93 anonymousClass93, final String str) throws C9Y {
        return A0A(2, ec, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m3
            @Override // com.facebook.ads.redexgen.core.E4
            public final List A57(int i10, C3030oH c3030oH, int[] iArr3) {
                return C2875lk.A06(i10, c3030oH, anonymousClass93, iArr3, str, iArr2[i10]);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Du
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C2875lk.A05((List) obj, (List) obj2);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final com.facebook.ads.redexgen.core.E9 A0E(int r13, com.facebook.ads.redexgen.core.C2901mA r14, int[][] r15, com.facebook.ads.redexgen.core.AnonymousClass93 r16) throws com.facebook.ads.redexgen.core.C9Y {
        /*
            r12 = this;
            r7 = 0
            r11 = 0
    ...
    public void A0L() {
        ...
        synchronized (this.A05) {
            z10 = this.A01.A08 && !this.A06 && AbstractC13764a.A02 >= 32 && this.A02 != null && this.A02.A06();
        }
        if (z10) {
            A01();
        }
    ...
    public static void A0P(EC ec, C3023oA c3023oA, E9[] e9Arr) {
        E9 e92;
        int iA02 = ec.A02();
        HashMap map = new HashMap();
        for (int i10 = 0; i10 < iA02; i10++) {
            A0N(ec.A07(i10), c3023oA, map);
        }
        A0N(ec.A06(), c3023oA, map);
        for (int i11 = 0; i11 < iA02; i11++) {
            int rendererCount = ec.A03(i11);
            C3025oC c3025oC = (C3025oC) map.get(Integer.valueOf(rendererCount));
            if (c3025oC != null) {
                boolean zIsEmpty = c3025oC.A01.isEmpty();
                if (A08[7].charAt(4) == 'r') {
                    throw new RuntimeException();
                }
                A08[4] = "YbaSeo";
                if (!zIsEmpty && ec.A07(i11).A04(c3025oC.A00) != -1) {
                    e92 = new E9(c3025oC.A00, AD.A0C(c3025oC.A01));
                } else {
                    e92 = null;
                }
                e9Arr[i11] = e92;
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0R(com.facebook.ads.redexgen.core.EC r11, int[][][] r12, com.facebook.ads.redexgen.core.C7G[] r13, com.facebook.ads.redexgen.core.InterfaceC2874lj[] r14) {
        /*
            r9 = -1
            r8 = -1
            r10 = 1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0T(C3064or c3064or) {
        boolean z10;
        synchronized (this.A05) {
            z10 = !this.A01.A08 || this.A06 || c3064or.A06 <= 2 || (A0U(c3064or) && (AbstractC13764a.A02 < 32 || this.A02 == null || !this.A02.A06())) || (AbstractC13764a.A02 >= 32 && this.A02 != null && this.A02.A06() && this.A02.A04() && this.A02.A05() && this.A02.A07(this.A00, c3064or));
        }
        return z10;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0U(com.facebook.ads.redexgen.core.C3064or r6) {
        /*
    ...
    public static boolean A0W(int[][] iArr, C2901mA c2901mA, InterfaceC2874lj interfaceC2874lj) {
        if (interfaceC2874lj == null) {
            return false;
        }
        int iA04 = c2901mA.A04(interfaceC2874lj.A9D());
        for (int i10 = 0; i10 < interfaceC2874lj.length(); i10++) {
            int trackGroupIndex = AnonymousClass76.A05(iArr[iA04][interfaceC2874lj.A89(i10)]);
    ...
    private final E9[] A0X(EC ec, int[][][] iArr, int[] iArr2, AnonymousClass93 anonymousClass93) throws C9Y {
        ...
        if (pairA0C == null) {
            ...
            C3030oH c3030oH = ((E9) pairA0C.first).A01;
            int rendererCount2 = ((E9) pairA0C.first).A02[0];
            str = c3030oH.A08(rendererCount2).A0V;
        }
        ...
        for (int i10 = 0; i10 < iA02; i10++) {
            ...
            if (i11 != 2 && i11 != 1) {
                ...
                if (i11 != 3) {
                    e9Arr[i10] = A0E(i11, ec.A07(i10), iArr[i10], anonymousClass93);
                }
            }
        }
        return e9Arr;
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2873li
    @MetaExoPlayerCustomization(type = {"MERGED"}, value = "final removed in D35162315")
    public final Pair<C7G[], InterfaceC2874lj[]> A0d(EC ec, int[][][] iArr, int[] iArr2, C2911mL c2911mL, Timeline timeline) throws Throwable {
        AnonymousClass93 anonymousClass93;
        synchronized (this.A05) {
            try {
                anonymousClass93 = this.A01;
                if (anonymousClass93.A08 && AbstractC13764a.A02 >= 32 && this.A02 != null) {
        ...
        InterfaceC2874lj[] interfaceC2874ljArrA5T = this.A04.A5T(e9ArrA0X, A00(), c2911mL, timeline);
        C7G[] c7gArr = new C7G[iA02];
        for (int i10 = 0; i10 < iA02; i10++) {
            c7gArr[i10] = !(anonymousClass93.A0R(i10) || anonymousClass93.A0H.contains(Integer.valueOf(ec.A03(i10)))) && (ec.A03(i10) == -2 || interfaceC2874ljArrA5T[i10] != null) ? C7G.A01 : null;
        }
        if (anonymousClass93.A0D) {
            A0R(ec, iArr, c7gArr, interfaceC2874ljArrA5T);
        }
        return Pair.create(c7gArr, interfaceC2874ljArrA5T);
    }

    public final /* synthetic */ AbstractC1531Am A0e(AnonymousClass93 anonymousClass93, boolean z10, int i10, C3030oH c3030oH, int[] iArr) {
        return C2890lz.A03(i10, c3030oH, anonymousClass93, iArr, z10, new InterfaceC2730jB() { // from class: com.facebook.ads.redexgen.X.m2
            @Override // com.facebook.ads.redexgen.core.InterfaceC2730jB
            public final boolean A44(Object obj) {
                return this.A00.A0T((C3064or) obj);
            }
        });
    }
}
