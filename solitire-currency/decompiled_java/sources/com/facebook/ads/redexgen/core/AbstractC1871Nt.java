...
public abstract class AbstractC1871Nt {
    ...
    public static Bundle A01(SQ sq) {
        ...
        bundle.putBoolean(A06(54, 13, 2), C2091Wm.A05(sq));
        return bundle;
    }

    public static Bundle A02(String str, C2604gv c2604gv) {
        Bundle bundle = new Bundle();
        A08(bundle, c2604gv.A05());
        bundle.putString(A06(451, 17, 16), c2604gv.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2604gv.A07());
        bundle.putString(A06(366, 19, 0), c2604gv.A08());
        bundle.putString(A06(c3.a.b.f11495d, 22, 98), c2604gv.A09());
        bundle.putString(A06(385, 19, 96), AbstractC1867Np.A01(c2604gv.A0B()));
        RewardData rewardDataA03 = c2604gv.A03();
        if (rewardDataA03 != null) {
            AbstractC1872Nu.A00(bundle, rewardDataA03);
        }
        C2387dL c2387dLA05 = c2604gv.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(123, 19, 81), A01(c2387dLA05));
        return bundle;
    }

    public static Bundle A03(String str, C2595gm c2595gm) {
        Bundle bundle = new Bundle();
        A08(bundle, c2595gm.A0B);
        bundle.putString(A06(451, 17, 16), c2595gm.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2595gm.A05);
        bundle.putString(A06(366, 19, 0), c2595gm.A06);
        bundle.putString(A06(c3.a.b.f11495d, 22, 98), c2595gm.A07);
        AdExperienceType adExperienceType = c2595gm.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), AbstractC1866No.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c2595gm.A08);
        RewardData rewardData = c2595gm.A03;
        if (rewardData != null) {
            AbstractC1872Nu.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(123, 19, 81), A01(c2595gm.A0B));
        return bundle;
    }

    public static C2604gv A04(C2387dL c2387dL, Bundle bundle, String str) {
        ...
        String placement3 = A06(c3.a.b.f11495d, 22, 98);
        ...
        C2604gv c2604gv = new C2604gv(c2387dL, null, string, new C2599gq(str, string4, bundle2));
        c2604gv.A0I(string3);
        c2604gv.A0H(string2);
        c2604gv.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c2604gv.A0K(AbstractC1867Np.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = AbstractC1872Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c2604gv.A0F(rewardDataA01);
        }
        return c2604gv;
    }

    public static C2595gm A05(C2387dL c2387dL, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        String rvPlacement4 = A06(c3.a.b.f11495d, 22, 98);
        ...
        C2595gm c2595gm = new C2595gm(c2387dL, string, null, new C2599gq(str, string4, bundle2));
        c2595gm.A06 = adExperienceType;
        c2595gm.A05 = string2;
        c2595gm.A08 = z10;
        c2595gm.A02 = AbstractC1866No.A00(string3);
        c2595gm.A07 = mediationData;
        RewardData rewardDataA01 = AbstractC1872Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c2595gm.A03 = rewardDataA01;
        }
        return c2595gm;
    }
    ...
    public static void A08(Bundle bundle, SQ sq) {
        ...
        boolean zAAK = false;
        boolean isForcedFunnelLogging = sq instanceof C2387dL;
        if (isForcedFunnelLogging) {
            zAAK = ((C2387dL) sq).A0F().AAK();
        }
        boolean isForcedFunnelLogging2 = C1994Sp.A0I(sq);
