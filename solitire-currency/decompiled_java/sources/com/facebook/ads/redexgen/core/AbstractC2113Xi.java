...
public abstract class AbstractC2113Xi {
    ...
    public static void A02(Activity activity, int i10, C2387dL c2387dL) {
        try {
            activity.setRequestedOrientation(i10);
        } catch (IllegalStateException e10) {
            c2387dL.A08().ABR(A00(0, 7, 51), AbstractC2000Sv.A0H, new C2001Sw(e10));
        }
    }
}
