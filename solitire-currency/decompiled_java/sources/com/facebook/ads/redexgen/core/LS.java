...
public final class LS extends AbstractC2134Yd {
    ...
    static {
        ...
        A07 = (int) (AbstractC2090Wl.A02 * 10.0f);
        A06 = (int) (AbstractC2090Wl.A02 * 44.0f);
    }

    public LS(C2387dL c2387dL, US us, String str) {
    ...
    public final void A0N() {
        ...
        this.A00.setOnClickListener(new ViewOnClickListenerC2153Yw(this));
        this.A00.setContentDescription(A00(4, 18, 29));
        C2138Yh c2138Yh = new C2138Yh(this.A04);
        c2138Yh.setData(this.A03.A0H(), XX.HIDE_AD);
        c2138Yh.setOnClickListener(new ViewOnClickListenerC2154Yx(this, c2138Yh));
        C2138Yh c2138Yh2 = new C2138Yh(this.A04);
        c2138Yh2.setData(this.A03.A0L(), XX.REPORT_AD);
        c2138Yh2.setOnClickListener(new ViewOnClickListenerC2155Yy(this, c2138Yh2));
        C2138Yh c2138Yh3 = new C2138Yh(this.A04);
        c2138Yh3.setData(this.A03.A0M(), XX.AD_CHOICES_ICON);
        c2138Yh3.setOnClickListener(new ViewOnClickListenerC2156Yz(this, c2138Yh3));
        ...
        linearLayout.addView(c2138Yh, menuParams);
        linearLayout.addView(c2138Yh2, menuParams);
        linearLayout.addView(c2138Yh3, menuParams);
    }
    ...
    public final void A0P(O6 o62, O4 o42) {
        ...
        C2132Yb c2132YbA0I = new C2132Yb(this.A04, this.A0B).A0I(strA0H);
        String title = this.A03.A0D();
        C2132Yb c2132YbA0H = c2132YbA0I.A0H(title);
        String title2 = o62.A04();
        C2133Yc adHiddenView = c2132YbA0H.A0F(title2).A0K(false).A0E(xx).A0D(i10).A0L(false).A0J(false).A0M();
    ...
    public final void A0Q(O6 o62, O4 o42) {
        ...
        C2152Yv c2152Yv = new C2152Yv(this.A04, o62, this.A0B, isReportFlow ? XX.REPORT_AD : XX.HIDE_AD);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, 0);
        layoutParams.gravity = 17;
        layoutParams.weight = 1.0f;
        ...
        this.A01.removeAllViews();
        this.A01.addView(this.A00);
        this.A01.addView(c2152Yv, layoutParams);
    }
