...
public abstract class AnonymousClass14 extends C9Z {
    ...
    public final C2986nY A0q;
    public final C2986nY A0r;
    public final C6N A0s;
    public final C9U A0t;
    public final InterfaceC1536Ar A0u;
    public final ArrayDeque<C1519Aa> A0v;
    public final List<Long> A0w;
    public final boolean A0x;
    public final boolean A0y;
    public final boolean A0z;
    public final MediaCodecRendererMetaParameters A10;
    public final C2659hv A11;
    ...
    public abstract int A1g(AO ao, AR ar, C3064or c3064or, C3064or c3064or2);

    public abstract int A1h(InterfaceC1536Ar interfaceC1536Ar, C9U c9u, C3064or c3064or) throws C1540Av;

    public abstract List<AR> A1l(InterfaceC1536Ar interfaceC1536Ar, C3064or c3064or, boolean z10) throws C1540Av;

    public abstract void A1u(C2986nY c2986nY);

    public abstract void A1v(@MetaExoPlayerCustomization AO ao, MediaFormat mediaFormat) throws C9Y;

    public abstract void A1w(AR ar, AO ao, C3064or c3064or, MediaCrypto mediaCrypto) throws C1540Av;
    ...
    public AnonymousClass14(int i10, C2659hv c2659hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC1536Ar interfaceC1536Ar, C9U c9u, boolean z10, boolean z11, int i11, int i12) {
        super(i10);
        this.A09 = C.TIME_UNSET;
        this.A08 = C.TIME_UNSET;
        this.A0m = false;
        this.A0k = false;
        C3M.A08(AbstractC13764a.A02 >= 16);
        this.A11 = (C2659hv) C3M.A01(c2659hv);
        this.A10 = (MediaCodecRendererMetaParameters) C3M.A01(mediaCodecRendererMetaParameters);
        this.A0u = (InterfaceC1536Ar) C3M.A01(interfaceC1536Ar);
        this.A0t = c9u;
        this.A0z = z10;
        this.A0x = z11;
        this.A0o = i11;
        this.A0n = i12;
        this.A0q = new C2986nY(0);
        this.A0r = C2986nY.A02();
        this.A0s = new C6N();
        ...
        this.A0y = MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A1r);
        this.A12 = MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A1c);
    }
    ...
    */
    ...
    private List<AR> A10(boolean z10) throws C1540Av {
        ...
        if (listA1l.isEmpty() && this.A0l && (alternativeMimeType = C1543Ay.A0P(this.A0i)) != null) {
    ...
    private void A16(AR ar, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            new C2940mo().A00();
            aoA0K = AV.A02().A0K(A22(), this.A11, this.A10.getA00(), EnumC2656hq.A05, str);
            try {
                this.A0K = str;
                C4S.A00();
    ...
    private void A17(AR ar, AR ar2, MediaCrypto mediaCrypto) throws Exception {
        int iA00 = MetaExoPlayerUpgradeConfig.A00(EnumC2664i3.A06);
        if (iA00 >= 0) {
            try {
                A16(ar2, mediaCrypto);
                return;
    ...
    private void A18(C1519Aa c1519Aa) {
        this.A0J = c1519Aa;
        if (c1519Aa.A02 != C.TIME_UNSET) {
            this.A0a = true;
        }
    }
    ...
    private boolean A1A() throws C9Y {
        ...
        if (this.A0g) {
            ...
            boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A10);
        ...
        if (this.A0q.A05()) {
            ...
            try {
                ...
                C3064or c3064or = this.A0i;
                int adaptiveReconfigurationBytes = e10.getErrorCode();
                throw A1S(e10, c3064or, AbstractC13764a.A02(adaptiveReconfigurationBytes));
            }
        }
        ...
        if (bufferEncrypted4 && !skipIfSampleTooLarge) {
            AbstractC1688Gq.A0G(this.A0q.A02);
        ...
        try {
            ...
            C3064or c3064or2 = this.A0i;
            int adaptiveReconfigurationBytes2 = e11.getErrorCode();
            throw A1S(e11, c3064or2, AbstractC13764a.A02(adaptiveReconfigurationBytes2));
        }
    }
    ...
    */
        ...
        if (!this.A0M.isEmpty()) {
            ...
            do {
                ...
                try {
                    ...
                    AnonymousClass44.A0A(A0x(220, 18, 67), A0x(156, 30, 18) + arPeekFirst2, e11);
    ...
    public static boolean A1G(C3064or c3064or) {
        return c3064or.A07 == 0 || c3064or.A07 == 2;
    }

    public static boolean A1H(AR ar) {
        String str = ar.A03;
        if (AbstractC13764a.A02 <= 17) {
    ...
    */
    public static boolean A1I(java.lang.String r6) {
        ...
        L34:
            ...
            r0 = 19
            if (r1 > r0) goto L96
            java.lang.String r3 = com.facebook.ads.redexgen.core.AbstractC13764a.A03
    ...
    public static boolean A1J(String str) {
        return AbstractC13764a.A02 == 21 && A0x(519, 22, 41).equals(str);
    }

    public static boolean A1K(String str) {
        if (AbstractC13764a.A02 >= 18 && (AbstractC13764a.A02 != 18 || (!A0x(382, 15, 68).equals(str) && !A0x(397, 22, 77).equals(str)))) {
            if (AbstractC13764a.A02 == 19 && AbstractC13764a.A06.startsWith(A0x(667, 7, 124))) {
    ...
    public static boolean A1L(String str, C3064or c3064or) {
        return AbstractC13764a.A02 < 21 && c3064or.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C3064or c3064or) {
        return AbstractC13764a.A02 <= 18 && c3064or.A06 == 1 && A0x(281, 25, 33).equals(str);
    }
    ...
    private boolean A1N(boolean z10) throws C9Y {
        ...
        throw A1S(c9eA7s, c3064or, drmSessionState);
    }
    ...
    public void A1b(boolean z10, boolean z11) throws C9Y {
        this.A0j = new C14085g();
        this.A0h = 0L;
    }

    @Override // com.facebook.ads.redexgen.core.C9Z
    public void A1c(C3064or[] c3064orArr, long j10, long j11) throws C9Y {
    }
    ...
    public void A1n() {
        ...
        if (this.A0G != null) {
            this.A0j.A03++;
            try {
                AV.A02().A0L(A22(), this.A11, this.A10.getA00(), EnumC2656hq.A05, this.A0K, this.A0G);
                this.A0G = null;
                C9G c9g = this.A0E;
                String[] strArr = A14;
                if (strArr[6].length() == strArr[5].length()) {
    ...
    public void A1r(C3064or c3064or) {
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void A1s(com.facebook.ads.redexgen.core.C3064or r9) throws com.facebook.ads.redexgen.core.C9Y {
        /*
    ...
    public void A1t(C3064or c3064or) throws C9Y {
    }

    public void A1z(String str, C3064or c3064or) throws C9Y {
        A1t(c3064or);
    }
    ...
    public final boolean A24(C3064or c3064or) {
        if (c3064or == null || !this.A0m || !A0x(838, 10, 89).equalsIgnoreCase(c3064or.A0W)) {
            return false;
        }
        return true;
    }
    ...
    public boolean AAV() {
        if (this.A0i == null) {
            super.A0B = EnumC2640hX.A07;
        } else if (this.A0g) {
            super.A0B = EnumC2640hX.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC2640hX.A06;
        }
        if (this.A0i != null) {
        ...
        if (this.A0G != null) {
            try {
                try {
                    ...
                    if (!A19()) {
                        throw A1S(e10, this.A0i, PlaybackException.ERROR_CODE_DECODING_FAILED);
                    }
                }
            } finally {
                C4S.A00();
    ...
    public final int AJb(C3064or c3064or) throws C9Y {
        try {
            return A1h(this.A0u, this.A0t, c3064or);
        } catch (C1540Av e10) {
            throw A1S(e10, c3064or, 4002);
        }
    }
