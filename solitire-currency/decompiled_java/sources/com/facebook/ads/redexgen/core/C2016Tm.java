...
public final class C2016Tm {
    ...
    public C2016Tm(int i10, int i11) {
        if (i10 < -1) {
    ...
    public final int A04(C2016Tm c2016Tm) {
        if (this.A00 != c2016Tm.A00) {
            return this.A00 - c2016Tm.A00;
        }
        return this.A01 - c2016Tm.A01;
    }

    public final C2016Tm A05(int i10) {
        if (this.A01 + i10 >= 0) {
            return new C2016Tm(this.A00, this.A01 + i10);
        }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C2016Tm)) {
            return false;
        }
        C2016Tm c2016Tm = (C2016Tm) obj;
        return c2016Tm.A00 == this.A00 && c2016Tm.A01 == this.A01;
    }
