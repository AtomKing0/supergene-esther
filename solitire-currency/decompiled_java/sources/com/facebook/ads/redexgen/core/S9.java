...
public class S9 extends AbstractC2459eW {
    ...
    public S9(C1930Qc c1930Qc, View view, boolean z10, C2683iN c2683iN) {
        this.A02 = c1930Qc;
        this.A00 = view;
        this.A03 = z10;
        this.A01 = c2683iN;
    ...
    public final void A03() {
        ...
        if (U7.A2B(this.A02.A12()) && (this.A00 instanceof AdNativeComponentView)) {
            ...
            if ((adContentsView instanceof C2400dY) && !((C2400dY) adContentsView).A05()) {
                this.A02.A0R.A0T();
                this.A02.A0e.A08();
                return;
            }
        ...
        if (this.A03) {
            ...
            C1930Qc.A0f(drawable, imageView);
        }
        ...
        if (this.A02.A0V != null && this.A02.A0V.get() != null) {
            ((AbstractC2459eW) this.A02.A0V.get()).A03();
        }
        if (this.A02.A0f.A07()) {
            this.A02.A0e.A04();
            return;
        ...
        if (this.A02.A09 != null && this.A02.A04 != null) {
            ...
            if (view != null) {
                ...
                this.A02.A09.A0D(AbstractC2135Ye.A00(this.A02.A07));
