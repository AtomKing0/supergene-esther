...
public final class WB {
    ...
    public static final Set<C2387dL> A06;
    ...
    public static int A00(C2387dL c2387dL, Intent intent) throws W9 {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c2387dL.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c2387dL.startActivity(intentA01);
            return 2;
    ...
    public static C2387dL A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C2387dL c2387dL : A06) {
                String adId = c2387dL.A0F().getId();
    ...
    public static AdActivityIntent A05(C2387dL c2387dL) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c2387dL.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c2387dL.A0F().getId());
        A06.add(c2387dL);
    ...
    public static void A0B(C2387dL c2387dL, AdActivityIntent adActivityIntent) throws W9 {
        Context launchContext;
        Context applicationContext = c2387dL.getApplicationContext();
        if (U7.A2V(c2387dL) && (launchContext = c2387dL.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c2387dL, adActivityIntent)) {
                    c2387dL.A0F().AHS();
                    return;
                }
                return;
    ...
    public static boolean A0D(C2387dL c2387dL, Intent intent) throws W9 {
        A07.get();
        return A0F(c2387dL, intent, null);
    }

    public static boolean A0E(C2387dL c2387dL, Intent intent) throws W9 {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c2387dL.A08().AAy(A07(90, 8, 57), AbstractC2000Sv.A07, new C2001Sw(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C2387dL c2387dL, Intent intent, WK wk) throws W9 {
        if (A0C(intent, U7.A0Z(c2387dL))) {
            return false;
        }
        Context context = c2387dL;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c2387dL.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (wk != null && !A0C(intent, U7.A0b(c2387dL))) {
                c2387dL.A0C();
                try {
                    ...
                    c2387dL.A08().AAy(A07(90, 8, 57), AbstractC2000Sv.A08, new C2001Sw(e11));
                    return false;
                }
            }
            try {
    ...
    public static boolean A0G(C2387dL c2387dL, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c2387dL, uri, str, null);
    }

    public static boolean A0H(C2387dL c2387dL, Uri uri, String str, WM wm) throws ActivityNotFoundException {
        if (wm == null || c2387dL.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C2387dL c2387dL, AdActivityIntent adActivityIntent) throws W9 {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c2387dL.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
