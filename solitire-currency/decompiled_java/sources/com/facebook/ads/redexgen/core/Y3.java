...
public abstract class Y3 extends RelativeLayout {
    ...
    public static final int A05 = (int) (AbstractC2090Wl.A02 * 40.0f);
    public static final int A03 = (int) (AbstractC2090Wl.A02 * 24.0f);

    public abstract int getMediaViewId();

    public Y3(C2387dL c2387dL, View.OnClickListener onClickListener) {
        super(c2387dL);
        this.A00 = true;
        this.A01 = c2387dL;
