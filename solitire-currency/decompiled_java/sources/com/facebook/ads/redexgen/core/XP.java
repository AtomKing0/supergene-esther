...
public abstract class XP {
     ...
     */
    public static boolean A0e(C2387dL c2387dL, ME me, Map<String, String> map) {
        String str = map.get(A0B(84, 21, 11));
        boolean z10 = str != null && str.equals(Boolean.TRUE.toString());
        if (z10 && (A0d(c2387dL, me) || A0b(me, map))) {
            return true;
        }
    ...
    public static int A01(int i10) {
        return (int) TypedValue.applyDimension(2, i10, AbstractC2090Wl.A04);
    }
    ...
    */
    ...
    public static void A0D(int i10, View view) {
        ...
        scaleAnimation.setAnimationListener(new C1894Os(view, scaleAnimation2));
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0Y(java.util.Map<java.lang.String, java.lang.String> r5, com.facebook.ads.redexgen.core.AbstractC2662hy r6) {
        /*
    ...
    public static boolean A0d(C2387dL c2387dL, ME me) {
        return me == ME.A08 && U7.A2o(c2387dL);
    }
}
