...
public abstract class EnumC2489f0 {
    ...
    public static final /* synthetic */ EnumC2489f0[] A02;
    public static final EnumC2489f0 A03;
    public static final EnumC2489f0 A04;
    public static final EnumC2489f0 A05;
    public static final EnumC2489f0 A06;
    public static final EnumC2489f0 A07;
    public static final EnumC2489f0 A08;
    ...
    static {
        ...
        final int i10 = 0;
        A03 = new EnumC2489f0(strA02, i10) { // from class: com.facebook.ads.redexgen.X.C5
            @Override // com.facebook.ads.redexgen.core.EnumC2489f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i11) {
                return AbstractC2490f1.A00(jSONArray.optJSONArray(i11), jSONArray2.optJSONArray(i11));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2490f1.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA022 = A02(5, 7, 74);
        final int i11 = 1;
        A04 = new EnumC2489f0(strA022, i11) { // from class: com.facebook.ads.redexgen.X.C4
            @Override // com.facebook.ads.redexgen.core.EnumC2489f0
        ...
        final int i12 = 2;
        A05 = new EnumC2489f0(strA023, i12) { // from class: com.facebook.ads.redexgen.X.C3
        ...
        final int i13 = 3;
        A06 = new EnumC2489f0(strA024, i13) { // from class: com.facebook.ads.redexgen.X.C2
        ...
        final int i14 = 4;
        A07 = new EnumC2489f0(strA025, i14) { // from class: com.facebook.ads.redexgen.X.C1
            @Override // com.facebook.ads.redexgen.core.EnumC2489f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i15) {
                return AbstractC2490f1.A02(jSONArray.optJSONObject(i15), jSONArray2.optJSONObject(i15));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC2489f0
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2490f1.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA026 = A02(27, 6, 50);
        final int i15 = 5;
        A08 = new EnumC2489f0(strA026, i15) { // from class: com.facebook.ads.redexgen.X.Bz
            @Override // com.facebook.ads.redexgen.core.EnumC2489f0
    ...
    public EnumC2489f0(String str, int i10) {
    }

    public static EnumC2489f0 A00(JSONArray jSONArray, int i10) {
        for (EnumC2489f0 type : values()) {
    ...
    public static EnumC2489f0 A01(JSONObject jSONObject, String str) {
        for (EnumC2489f0 type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC2489f0[] A04() {
        return new EnumC2489f0[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC2489f0 valueOf(String str) {
        return (EnumC2489f0) Enum.valueOf(EnumC2489f0.class, str);
    }

    public static EnumC2489f0[] values() {
        return (EnumC2489f0[]) A02.clone();
    }
}
