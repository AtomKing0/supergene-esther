...
public final class C2817kb implements GX {
    ...
    public static final InterfaceC1673Gb A0g;
    public static final C3064or A0h;
    ...
    public final H1 A0U;
    public final HO A0V;
    public final C1735Im A0W;
    public final ArrayDeque<C2825kj> A0X;
    public final ArrayDeque<IU> A0Y;
    public final List<C3064or> A0Z;
    ...
    */
    public static int A00(com.facebook.ads.redexgen.core.IV r25, int r26, long r27, int r29, com.facebook.ads.redexgen.core.C4J r30, int r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2817kb.A00(com.facebook.ads.redexgen.X.IV, int, long, int, com.facebook.ads.redexgen.X.4J, int):int");
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Pair<Long, C2858lT> A04(C4J c4j, long j10) throws C13322i {
        long jA0R;
        long jA0R2;
        c4j.A0f(8);
        ...
        for (int i10 = 0; i10 < iA0M; i10++) {
            ...
            if ((Integer.MIN_VALUE & iA0C) != 0) {
                throw new C13322i(A0B(634, 28, 93));
            }
            long jA0Q2 = c4j.A0Q();
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0J(C4J c4j, C4J c4j2, String str, C1737Io c1737Io) throws C13322i {
        c4j.A0f(8);
        int iA0C = c4j.A0C();
        ...
        if (c4j.A0C() != 1) {
            throw new C13322i(A0B(50, 39, 69));
        }
        c4j2.A0f(8);
        int iA0C2 = c4j2.A0C();
        ...
        if (iA012 == 1) {
            if (c4j2.A0Q() == 0) {
                throw new C13322i(A0B(662, 55, 94));
            }
        } else if (iA012 >= 2) {
            c4j2.A0g(4);
        }
        if (c4j2.A0Q() != 1) {
            throw new C13322i(A0B(89, 39, 111));
        }
        c4j2.A0g(1);
        int iA0I = c4j2.A0I();
        ...
        if (z10) {
            ...
            c1737Io.A08 = true;
            c1737Io.A07 = new C1736In(z10, str, iA0I2, bArr, i10, i11, bArr2);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void A0R(com.facebook.ads.redexgen.core.C2825kj r17) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            Method dump skipped, instruction units count: 392
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2817kb.A0R(com.facebook.ads.redexgen.X.kj):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0T(com.facebook.ads.redexgen.core.C2825kj r9, android.util.SparseArray<com.facebook.ads.redexgen.core.IV> r10, int r11, byte[] r12, boolean r13) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            Method dump skipped, instruction units count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2817kb.A0T(com.facebook.ads.redexgen.X.kj, android.util.SparseArray, int, byte[], boolean):void");
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0W(C1736In c1736In, C4J c4j, C1737Io c1737Io) throws C13322i {
        int i10 = c1736In.A00;
        c4j.A0f(8);
        ...
        int iA0L = c4j.A0L();
        if (iA0L != c1737Io.A00) {
            throw new C13322i(A0B(308, 17, 45) + iA0L + A0B(0, 2, 27) + c1737Io.A00);
        }
        int i11 = 0;
        if (iA0I == 0) {
    ...
    static {
        A0E();
        A0g = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.kf
    ...
    public C2817kb(int i10) {
        this(i10, null);
    }

    public C2817kb(int i10, C4R c4r) {
        this(i10, c4r, null, null);
    }

    public C2817kb(int i10, C4R c4r, C1735Im c1735Im, DrmInitData drmInitData) {
        this(i10, c4r, c1735Im, drmInitData, Collections.emptyList());
    }

    public C2817kb(int i10, C4R c4r, C1735Im c1735Im, DrmInitData drmInitData, List<C3064or> list) {
        this(i10, c4r, c1735Im, drmInitData, list, null, false, false, false);
    }

    public C2817kb(int i10, C4R c4r, C1735Im c1735Im, DrmInitData drmInitData, List<C3064or> list, H1 h12, boolean z10, boolean z11, boolean z12) {
        this.A0A = C.TIME_UNSET;
        this.A0M = (c1735Im != null ? 8 : 0) | i10;
        this.A0T = c4r;
        this.A0W = c1735Im;
        ...
        this.A0V = new HO();
        this.A0O = new C4J(16);
        this.A0R = new C4J(AbstractC1688Gq.A03);
        this.A0Q = new C4J(5);
        this.A0P = new C4J();
    ...
    public static DrmInitData A05(List<C2824ki> list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            C2824ki c2824ki2 = c2824ki;
            int leafChildrenSize2 = ((II) c2824ki2).A00;
            if (leafChildrenSize2 == 1886614376) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                byte[] bArr = c2824ki2.A00.A00;
                UUID uuidA02 = AbstractC1728If.A02(bArr);
                if (uuidA02 == null) {
    ...
    private final C1735Im A0A(C1735Im c1735Im) {
        return c1735Im;
    }
    ...
    */
    private void A0D() {
        ...
        L17:
            ...
            int r5 = r3 + 1
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2817kb.A0f
            r0 = 7
            r1 = r1[r0]
            r0 = 29
            ...
            r0 = 48
            if (r1 == r0) goto L66
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2817kb.A0f
        ...
        L5a:
            if (r2 >= r3) goto L6c
            r1 = r4[r2]
            com.facebook.ads.redexgen.X.or r0 = com.facebook.ads.redexgen.core.C2817kb.A0h
            r1.A6W(r0)
            int r2 = r2 + 1
            goto L5a
        L66:
        ...
        La2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2817kb.A0D():void");
    }
    ...
    private void A0G(long j10) throws C13322i {
    ...
    public static void A0H(C4J c4j, int i10, C1737Io c1737Io) throws C13322i {
        c4j.A0f(i10 + 8);
        int fullAtom = c4j.A0C();
        ...
        if (fullAtom2 == 0) {
            ...
            if (sampleCount == fullAtom4) {
                ...
                c1737Io.A02(fullAtom5);
                c1737Io.A04(c4j);
                return;
            }
            StringBuilder sbAppend = new StringBuilder().append(A0B(308, 17, 45)).append(sampleCount).append(A0B(0, 2, 27));
            int fullAtom6 = c1737Io.A00;
            throw new C13322i(sbAppend.append(fullAtom6).toString());
        }
        throw new C13322i(A0B(399, 56, 17));
    }

    public static void A0K(C4J c4j, C1737Io c1737Io) throws C13322i {
        c4j.A0f(8);
        int flags = c4j.A0C();
        ...
        throw new C13322i(A0B(605, 29, 113) + iA0L);
    }

    public static void A0L(C4J c4j, C1737Io c1737Io) throws C13322i {
        A0H(c4j, 0, c1737Io);
    }

    public static void A0M(C4J c4j, C1737Io c1737Io, byte[] bArr) throws C13322i {
        c4j.A0f(8);
        c4j.A0k(bArr, 0, 16);
    ...
    private void A0N(InterfaceC2853lN interfaceC2853lN) throws IOException {
        int i10 = ((int) this.A07) - this.A00;
        if (this.A0E != null) {
            interfaceC2853lN.readFully(this.A0E.A00, 8, i10);
            A0V(new C2824ki(this.A01, this.A0E), interfaceC2853lN);
        } else {
            interfaceC2853lN.AJJ(i10);
        }
        A0G(interfaceC2853lN.A8f());
    }

    private void A0O(InterfaceC2853lN interfaceC2853lN) throws IOException {
        IV ivValueAt = null;
        long j10 = Long.MAX_VALUE;
        ...
        while (true) {
            if (i10 < size) {
                ...
                C1737Io c1737Io = nextTrackBundle.A07;
                if (c1737Io.A0A) {
                    long nextDataOffset = c1737Io.A03;
                    String[] strArr = A0f;
                    if (strArr[3].length() == strArr[6].length()) {
                        break;
                    }
                ...
                if (ivValueAt != null) {
                    ...
                    if (iA8f >= 0) {
                        ...
                        ivValueAt.A07.A05(interfaceC2853lN);
                        return;
                    }
                    throw new C13322i(A0B(325, 39, 126));
                }
                if (A0f[4].length() == 23) {
    ...
    private void A0P(C2825kj c2825kj) throws C13322i {
        if (((II) c2825kj).A00 == 1836019574) {
            A0R(c2825kj);
        } else if (((II) c2825kj).A00 == 1836019558) {
            A0Q(c2825kj);
        } else {
            if (this.A0X.isEmpty()) {
                return;
            }
            this.A0X.peek().A08(c2825kj);
        }
    }

    private void A0Q(C2825kj c2825kj) throws C13322i {
        A0S(c2825kj, this.A0D, this.A0M, this.A0d, this.A0c);
        DrmInitData drmInitDataA05 = this.A0N != null ? null : A05(c2825kj.A02);
    ...
    public static void A0S(C2825kj c2825kj, SparseArray<IV> sparseArray, int i10, byte[] bArr, boolean z10) throws C13322i {
    ...
    public static void A0U(C2825kj c2825kj, IV iv, long j10, int i10) {
        int i11 = 0;
        int i12 = 0;
        List<C2824ki> list = c2825kj.A02;
        int size = list.size();
        int i13 = 0;
        while (true) {
            String[] strArr = A0f;
            ...
            if (i13 < size) {
                C2824ki c2824ki = list.get(i13);
                if (((II) c2824ki).A00 == 1953658222) {
                    C4J trunData = c2824ki.A00;
                    trunData.A0f(12);
                ...
                for (int i15 = 0; i15 < size; i15++) {
                    C2824ki c2824ki2 = list.get(i15);
                    if (((II) c2824ki2).A00 == 1953658222) {
                        trunStartPosition = A00(iv, i14, j10, i10, c2824ki2.A00, trunStartPosition);
                        i14++;
                    }
                }
                return;
    ...
    private void A0V(C2824ki c2824ki, InterfaceC2853lN interfaceC2853lN) throws C13322i {
        Uri uriA9H;
        if (!this.A0X.isEmpty()) {
            this.A0X.peek().A09(c2824ki);
            return;
        }
        if (((II) c2824ki).A00 == 1936286840) {
            Pair<Long, C2858lT> pairA04 = A04(c2824ki.A00, interfaceC2853lN.A8f());
            this.A0C = ((Long) pairA04.first).longValue();
            this.A0F.AIN((InterfaceC1694Gw) pairA04.second);
            if (A0f[2].length() != 2) {
                throw new RuntimeException();
            }
            A0f[2] = "jw";
        ...
        if (((II) c2824ki).A00 != 1701671783 || (uriA9H = interfaceC2853lN.A9H()) == null) {
            return;
        }
        A0I(c2824ki.A00, uriA9H);
    }
    ...
    private boolean A0Z(InterfaceC2853lN interfaceC2853lN) throws IOException {
        if (this.A00 == 0) {
            if (!interfaceC2853lN.AGh(this.A0O.A00, 0, 8, true)) {
                return false;
            }
            this.A00 = 8;
            this.A0O.A0f(0);
        ...
        if (this.A07 == 1) {
            interfaceC2853lN.readFully(this.A0O.A00, 8, 8);
        ...
        if (this.A07 >= this.A00) {
            ...
            if (this.A01 == 1836019558) {
                int size = this.A0D.size();
                for (int i10 = 0; i10 < size; i10++) {
                    C1737Io c1737Io = this.A0D.valueAt(i10).A07;
                    c1737Io.A02 = jA8f2;
                    c1737Io.A03 = jA8f2;
                    c1737Io.A04 = jA8f2;
                }
            ...
            if (this.A01 == 1835295092) {
                ...
                if (!this.A0H) {
                    this.A0F.AIN(new C2848lI(this.A08, jA8f2));
                    this.A0H = true;
                }
                this.A02 = 2;
                return true;
            ...
            if (zA0X) {
                ...
                this.A0X.push(new C2825kj(this.A01, jA8f3));
                if (this.A07 == this.A00) {
                    A0G(jA8f3);
                } else {
                    A0C();
                ...
                if (this.A00 != 8) {
                    throw new C13322i(A0B(208, 51, 94));
                }
                if (this.A07 <= 2147483647L) {
                    ...
                    throw new C13322i(A0B(259, 49, 17));
                }
            } else if (this.A07 <= 2147483647L) {
                this.A0E = null;
                this.A02 = 1;
            } else {
                throw new C13322i(A0B(497, 53, 12));
            }
            return true;
        }
        throw new C13322i(A0B(2, 48, 125));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0a(com.facebook.ads.redexgen.core.InterfaceC2853lN r19) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 790
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2817kb.A0a(com.facebook.ads.redexgen.X.lN):boolean");
    }
        ...
        while (true) {
            ...
            switch (i10) {
                case 0:
                    ...
                    break;
                case 1:
                    A0N(interfaceC2853lN);
                    break;
                case 2:
                    A0O(interfaceC2853lN);
                    break;
                default:
                    if (A0a(interfaceC2853lN)) {
                        return 0;
                    }
                    break;
            }
