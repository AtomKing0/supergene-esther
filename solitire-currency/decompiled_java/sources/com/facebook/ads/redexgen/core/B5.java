...
public final class B5<K, V> extends AbstractC2799kJ<K, V> {
    public int A00;

    @ParametricNullness
    public final K A01;
    public final /* synthetic */ C2886lv A02;
    ...
    public final V getValue() {
        ...
        if (mapA0h != null) {
            return (V) AbstractC3038oQ.A01(mapA0h.get(this.A01));
        }
        A00();
        return this.A00 == -1 ? (V) AbstractC3038oQ.A00() : (V) this.A02.A0F(this.A00);
    }
    ...
    public final V setValue(@ParametricNullness V v10) {
        Map<K, V> mapA0h = this.A02.A0h();
        if (mapA0h != null) {
            return (V) AbstractC3038oQ.A01(mapA0h.put(this.A01, v10));
        }
        A00();
        if (this.A00 == -1) {
            this.A02.put(this.A01, v10);
            return (V) AbstractC3038oQ.A00();
        }
    ...
    public B5(C2886lv c2886lv, int i10) {
        this.A02 = c2886lv;
        this.A01 = (K) c2886lv.A0E(i10);
        this.A00 = i10;
    }
