...
public final class C2838l8 implements GX {
    ...
    public static final InterfaceC1673Gb A0H = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.l9
    ...
    public final C2837l7 A0F = new C2837l7();
    public int A01 = 1;
    ...
    private C4J A01(InterfaceC2853lN interfaceC2853lN) throws IOException {
        ...
        interfaceC2853lN.readFully(this.A0D.A0l(), 0, this.A02);
        return this.A0D;
    }
    ...
    private void A02() {
        if (!this.A0A) {
            this.A06.AIN(new C2848lI(C.TIME_UNSET));
            this.A0A = true;
        }
    }

    private void A03(InterfaceC2853lN interfaceC2853lN) throws IOException {
        interfaceC2853lN.AJJ(this.A00);
        this.A00 = 0;
        this.A01 = 3;
    }

    @RequiresNonNull({"extractorOutput"})
    private boolean A04(InterfaceC2853lN interfaceC2853lN) throws IOException {
        if (!interfaceC2853lN.AGh(this.A0B.A0l(), 0, 9, true)) {
            return false;
        }
        this.A0B.A0f(0);
        C4J c4j = this.A0B;
        ...
        if (z10 && this.A07 == null) {
            this.A07 = new C2840lA(this.A06.AJh(8, 1));
        }
        if (hasAudio && this.A08 == null) {
            this.A08 = new C2835l5(this.A06.AJh(9, 2));
        }
        this.A06.A6G();
    ...
    */
    private boolean A05(com.facebook.ads.redexgen.core.InterfaceC2853lN r12) throws java.io.IOException {
        /*
            r11 = this;
            r10 = 1
            r9 = 0
        ...
        L23:
            ...
            if (r0 != 0) goto L5b
            long r3 = r11.A05
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2838l8.A0G
            r0 = 5
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        Lb6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2838l8.A05(com.facebook.ads.redexgen.X.lN):boolean");
    }

    private boolean A06(InterfaceC2853lN interfaceC2853lN) throws IOException {
        if (!interfaceC2853lN.AGh(this.A0E.A0l(), 0, 11, true)) {
            return false;
        }
        this.A0E.A0f(0);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int AGb(com.facebook.ads.redexgen.core.InterfaceC2853lN r6, com.facebook.ads.redexgen.core.C1691Gt r7) throws java.io.IOException {
        /*
            r5 = this;
        ...
        L11:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2838l8.A0G
            r0 = 6
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
        ...
        L79:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2838l8.AGb(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    public final boolean AJL(InterfaceC2853lN interfaceC2853lN) throws IOException {
        interfaceC2853lN.AG9(this.A0C.A0l(), 0, 3);
        this.A0C.A0f(0);
        if (this.A0C.A0K() != 4607062) {
            return false;
        }
        interfaceC2853lN.AG9(this.A0C.A0l(), 0, 2);
        this.A0C.A0f(0);
        if ((this.A0C.A0M() & 250) != 0) {
            return false;
        }
        interfaceC2853lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
        int dataOffset = this.A0C.A0C();
        interfaceC2853lN.AI1();
        interfaceC2853lN.A3z(dataOffset);
        interfaceC2853lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
