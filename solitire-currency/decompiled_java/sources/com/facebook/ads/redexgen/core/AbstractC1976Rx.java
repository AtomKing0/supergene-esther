...
public abstract class AbstractC1976Rx {
     ...
     */
    public static C1969Rp A02(SQ sq) {
        Object objA00;
        Method methodA02;
        Object objA002;
        Method methodA022 = AbstractC1977Ry.A02(A00, A04(257, 29, 2), Context.class);
        if (methodA022 == null || (objA00 = AbstractC1977Ry.A00(null, methodA022, sq)) == null || ((Integer) objA00).intValue() != 0 || (methodA02 = AbstractC1977Ry.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (objA002 = AbstractC1977Ry.A00(null, methodA02, sq)) == null) {
            return null;
        }
        Method methodA01 = AbstractC1977Ry.A01(objA002.getClass(), A04(252, 5, 124), new Class[0]);
        Method methodA012 = AbstractC1977Ry.A01(objA002.getClass(), A04(286, 24, 126), new Class[0]);
        if (methodA01 == null || methodA012 == null) {
            return null;
        }
        String str = (String) AbstractC1977Ry.A00(objA002, methodA01, new Object[0]);
        Boolean bool = (Boolean) AbstractC1977Ry.A00(objA002, methodA012, new Object[0]);
        if (str != null) {
            return new C1969Rp(str, bool != null && bool.booleanValue(), EnumC1968Ro.A06);
        }
        return null;
    }
    ...
    static {
        A05();
        A03 = C1969Rp.class.getSimpleName();
        A00 = A04(173, 52, 12);
    }
    ...
    */
    public static com.facebook.ads.redexgen.core.C1969Rp A00(com.facebook.ads.redexgen.core.SQ r5) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.AbstractC1976Rx.A02
            r0 = 5
            r1 = r1[r0]
            r0 = 3
            ...
            throw r0
        L2c:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC1976Rx.A02
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1976Rx.A00(com.facebook.ads.redexgen.X.SQ):com.facebook.ads.redexgen.X.Rp");
    }

    public static C1969Rp A01(SQ sq) {
        SU adId = sq.A05().A8p();
        if (adId != null) {
            return new C1969Rp(adId.getId(), adId.AAO(), EnumC1968Ro.A02);
        }
        return null;
    }

    /* JADX WARN: Type inference failed for: r0v9, types: [com.facebook.ads.internal.attribution.GmsAttributionProvider$GoogleAdInfo] */
    public static C1969Rp A03(SQ sq) {
        ServiceConnectionC1975Rw serviceConnectionC1975Rw = new ServiceConnectionC1975Rw();
        Intent intent = new Intent(A04(122, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (sq.bindService(intent, serviceConnectionC1975Rw, 1)) {
            try {
                final IBinder iBinderA02 = serviceConnectionC1975Rw.A02();
                ...
                return new C1969Rp(r02.A02(), r02.A03(), EnumC1968Ro.A07);
            } catch (Throwable th) {
                try {
                    sq.A08().AAy(A04(225, 7, 73), AbstractC2000Sv.A1Q, new C2001Sw(th));
                } finally {
                    sq.unbindService(serviceConnectionC1975Rw);
                }
            }
        }
        return null;
