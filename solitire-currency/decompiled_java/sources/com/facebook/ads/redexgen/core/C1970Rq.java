...
public final class C1970Rq {
    ...
    public C1970Rq(SQ sq) {
        this.A00 = sq.getSharedPreferences(ProcessUtils.getProcessSpecificName(A00(33, 21, 4), sq), 0);
    }

    public final C1969Rp A02() {
        SharedPreferences sharedPreferences = this.A00;
        String strA00 = A00(0, 13, 55);
        if (sharedPreferences.contains(strA00)) {
            return new C1969Rp(this.A00.getString(strA00, A00(0, 0, 75)), this.A00.getBoolean(A00(54, 15, 96), false), EnumC1968Ro.A08, this.A00.getLong(A00(26, 7, 65), -1L));
        }
        return C1969Rp.A00();
    }
    ...
    public final void A04(C1969Rp c1969Rp) {
        SharedPreferences.Editor editorEdit = this.A00.edit();
        editorEdit.putString(A00(0, 13, 55), c1969Rp.A03());
        editorEdit.putBoolean(A00(54, 15, 96), c1969Rp.A04());
        editorEdit.putLong(A00(26, 7, 65), c1969Rp.A01());
        editorEdit.apply();
    }
