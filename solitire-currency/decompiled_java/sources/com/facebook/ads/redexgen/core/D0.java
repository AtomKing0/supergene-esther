...
public final class D0 extends ImageView implements InterfaceC2404dc {
    ...
    static {
        A06();
        A08 = (int) (AbstractC2090Wl.A02 * 40.0f);
        A07 = (int) (AbstractC2090Wl.A02 * 10.0f);
    }

    public D0(C2387dL c2387dL, C2030Ua c2030Ua) {
        super(c2387dL);
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC2421du(this));
    }
    ...
    public final void AJk(E1 e12) {
        if (this.A00 != null) {
            C2009Te<AbstractC2010Tf, C2008Td> eventBus = this.A00.getEventBus();
            DE de = this.A04;
            String[] strArr = A06;
