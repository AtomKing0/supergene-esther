...
public final class C2515fR {
    ...
    public final InterfaceC1963Rj A00;
    public final SF A01;
    ...
    static {
        A02();
        A04 = C2515fR.class.getSimpleName();
    }

    public C2515fR(InterfaceC1963Rj interfaceC1963Rj, C2361cu c2361cu) {
        this.A00 = interfaceC1963Rj;
        this.A00.A3s(new C2517fT(this));
        this.A01 = new SF(c2361cu);
        A01();
    }
    ...
    public void A01() {
        if (BuildConfigApi.isDebug()) {
            ...
            InterfaceC1963Rj interfaceC1963Rj = this.A00;
            if (A03[2].charAt(7) != 'V') {
            ...
            String.format(locale, A00(0, 20, 44), Integer.valueOf(interfaceC1963Rj.A6p().size()));
        }
        for (InterfaceC1966Rm interfaceC1966Rm : this.A00.A6p()) {
            switch (C1962Ri.A00[interfaceC1966Rm.A9G().ordinal()]) {
                case 1:
                    A04(interfaceC1966Rm.getUrl());
                    break;
                case 2:
                    A06(interfaceC1966Rm.getUrl());
                    break;
                case 3:
                    A05(interfaceC1966Rm.getUrl());
                    break;
            }
        }
        this.A01.A0X(new C2516fS(this), new S8(A00(81, 36, 123), A00(125, 7, 50)));
    }
