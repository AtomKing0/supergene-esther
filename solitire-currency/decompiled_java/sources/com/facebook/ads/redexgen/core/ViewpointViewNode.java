...
public final class ViewpointViewNode implements DspViewableNode {
    ...
    public static final C3096pe A03;
    public static final WeakHashMap<View, ViewpointViewNode> A04;
    public final WeakReference<View> A00;

    public /* synthetic */ ViewpointViewNode(View view, AbstractC3079p7 abstractC3079p7) {
        this(view);
    }
    ...
    public final boolean A9Q(Rect rect, Rect rect2, Rect rect3) {
        C3078p6.A09(rect, A01(13, 20, 52));
        C3078p6.A09(rect2, A01(0, 13, 81));
        C3078p6.A09(rect3, A01(33, 12, 85));
        View view = this.A00.get();
        if (view == null) {
            return false;
        }
        return AbstractC3095pd.A00(view, rect, rect2, rect3);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other != null) {
            ...
            return C3078p6.A0C(cls, getClass()) && (view = this.A00.get()) != null && view == ((ViewpointViewNode) other).A00.get();
        }
        return false;
    }
