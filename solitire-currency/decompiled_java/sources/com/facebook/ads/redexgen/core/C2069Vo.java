...
public final class C2069Vo implements UQ {
    ...
    static {
        A01();
        A04 = C2069Vo.class.getSimpleName();
    }

    public C2069Vo(C2361cu c2361cu, C2070Vp c2070Vp) {
        this.A00 = c2361cu;
        this.A01 = c2070Vp;
    }
    ...
    private void A02(Set<String> eventsToRetry, Set<String> eventsToDelete) {
        ...
        if (iA0B > 0) {
            this.A00.A08().AAy(A00(c3.a.b.f11496e, 15, 38), AbstractC2000Sv.A10, new C2001Sw(A00(28, 44, 75) + iA0B));
        }
    }
    ...
    public final JSONObject A5D() {
        ...
        if (U9.A0P(this.A00) && (jSONArrayA04 = C2002Sx.A04(this.A00, (iA08 = U9.A08(this.A00)))) != null) {
    ...
    public final void AD0(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            try {
                ...
                if (C2002Sx.A0I(string)) {
                    C2002Sx.A0B(this.A00, string);
                } else {
                    hashSet.add(string);
                }
            } catch (JSONException e10) {
