...
public final class C7B extends AbstractC2670iA {
    ...
    public long A00;
    public InterfaceC1834Mh A01;
    public C1835Mi A02;
    public AbstractC1840Mo A03;
    public C2387dL A04;
    public EnumC2057Vb A05;
    public C2298bt A06;
    public String A07;
    public String A08;
    public String A09;
    ...
    public void A0C(final C2387dL c2387dL, final C2660hw c2660hw, final int i10) {
        if (i10 >= c2660hw.A1u()) {
            return;
        }
        final AnonymousClass73 anonymousClass73 = (AnonymousClass73) c2660hw.A1x(i10);
        A0D = new SF(c2387dL);
        A0D.A0e(new C2030Ua(anonymousClass73.A25(), c2387dL.A0A()));
        NS.A02(c2387dL, A0D, anonymousClass73);
        final boolean z10 = i10 == 0;
        A0D.A0X(new AbstractC2637hU(z10) { // from class: com.facebook.ads.redexgen.X.7C
            @Override // com.facebook.ads.redexgen.core.AbstractC2637hU
            ...
            public final void A01(boolean z11) {
                C7B.A0D = null;
                if (z11) {
                    c2387dL.A01().AIU(anonymousClass73.A25(), c2660hw.A1y());
                }
                if (i10 == 0) {
                    this.A01.A0C.set(true);
                    this.A01.A01.AF4(this.A01);
                }
                this.A01.A0C(c2387dL, c2660hw, i10 + 1);
            }
        }, new S8(anonymousClass73.A17(), A05(152, 14, 119), i10));
    }

    private void A0D(boolean z10) {
        if (this.A05 == EnumC2057Vb.A0F) {
            A0F(z10);
            return;
        }
        if (this.A05 == EnumC2057Vb.A0H) {
            A0G(z10);
        } else if (this.A05 == EnumC2057Vb.A0G) {
            A0E(z10);
        } else {
            A0G(z10);
        }
    ...
    private void A0E(boolean z10) {
        ...
        boolean z11 = U7.A2A(this.A04) && C1959Rf.A0A(this.A03.A1C());
        if (z11) {
            C1959Rf unifiedAssetsLoader = new C1959Rf(sf, this.A03.A1C(), this.A03.A0v(), this.A03.A17(), z11, new C2678iI(this));
            sf.A0e(new C2030Ua(((AbstractC2662hy) this.A03).A25(), this.A04.A0A()));
            unifiedAssetsLoader.A0B();
            return;
        }
        NR.A02(this.A04, (AbstractC2662hy) this.A03, z10, new C2677iH(this));
    }
    ...
    private void A0F(boolean z10) {
        ...
        sf.A0X(new C2682iM(this), new S8(this.A03.A17(), A05(152, 14, 119)));
    }
    ...
    private void A0G(boolean z10) {
        ...
        if (this.A03.A1T()) {
            ...
            for (int i10 = 0; i10 < c2660hw.A1u(); i10++) {
                if (TextUtils.isEmpty(c2660hw.A1x(i10).A20().A0H().A09())) {
                    this.A01.AF7(this, AdError.INTERNAL_ERROR);
                    return;
                }
            }
            A0C(this.A04, c2660hw, 0);
            return;
        }
        SF sf = new SF(this.A04);
        sf.A0e(new C2030Ua(((AbstractC2662hy) this.A03).A25(), this.A04.A0A()));
        if (U7.A2A(this.A04) && C1959Rf.A0A(this.A03.A1C())) {
            z11 = true;
        }
        boolean zA1Y = this.A03.A1Y();
        if (z11) {
            C1959Rf unifiedAssetsLoader = new C1959Rf(sf, this.A03.A1C(), this.A03.A0v(), this.A03.A17(), z11, new C2680iK(this, zA1Y));
            unifiedAssetsLoader.A0B();
            return;
        }
        AnonymousClass73 anonymousClass73 = (AnonymousClass73) this.A03;
        if (TextUtils.isEmpty(anonymousClass73.A20().A0H().A09())) {
            if (this.A05 == EnumC2057Vb.A0I) {
                this.A04.A0F().ADm();
            }
            this.A01.AF7(this, AdError.INTERNAL_ERROR);
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2670iA
    ...
    public final boolean A0J() {
        ...
        String strA03 = C2384dI.A03(super.A02, this.A0B, this.A07);
        ...
        try {
            ...
            this.A04.A08().AAy(A05(23, 11, 50), AbstractC2000Sv.A01, new C2001Sw(cause2));
            return true;
        }
    }

    public final void A0K(C2387dL c2387dL, InterfaceC1834Mh interfaceC1834Mh, NU nu, boolean z10, String str, String str2) {
        String strA05;
        this.A0C.set(false);
        this.A04 = c2387dL;
        this.A01 = interfaceC1834Mh;
        this.A0A = nu.A02();
        this.A00 = nu.A00();
        this.A09 = str2;
        if (this.A0A != null) {
        ...
        strA05 = A05(0, 0, 100);
        this.A07 = strA05;
        this.A03 = AbstractC1840Mo.A03(nu.A03(), this.A04);
        this.A03.A1H(str);
        this.A03.A1D(nu.A01().A06());
        if (this.A03.A1T()) {
            this.A08 = ((C2660hw) this.A03).A20();
        } else {
            this.A08 = ((AbstractC2662hy) this.A03).A25();
        }
        if (this.A03.A1Y()) {
            this.A05 = EnumC2057Vb.A08;
            if (this.A03.A1P()) {
            ...
            switch (this.A03.A0l()) {
                case 0:
                    this.A05 = EnumC2057Vb.A0H;
                    this.A04.A0F().AJ9(LT.A0D);
                    break;
                case 1:
                    this.A05 = EnumC2057Vb.A0G;
                    this.A04.A0F().AJ9(LT.A0C);
                    break;
                case 2:
                    this.A05 = EnumC2057Vb.A05;
                    this.A04.A0F().AJ9(LT.A05);
                    break;
                case 3:
                    this.A05 = EnumC2057Vb.A0F;
                    this.A04.A0F().AJ9(LT.A04);
                    break;
                case 4:
                    this.A05 = EnumC2057Vb.A0I;
                    this.A04.A0F().AJ9(LT.A0E);
                    break;
            }
        }
        if (U7.A0v(c2387dL)) {
            AbstractC1840Mo abstractC1840Mo = this.A03;
            String[] strArr3 = A0F;
            if (strArr3[4].charAt(19) != strArr3[0].charAt(19)) {
                ...
                if (abstractC1840Mo.A1T()) {
                    C2660hw c2660hw = (C2660hw) this.A03;
                    for (int iA1u = c2660hw.A1u() - 1; iA1u >= 0; iA1u--) {
                        AbstractC2662hy abstractC2662hyA1x = c2660hw.A1x(iA1u);
                        if (ML.A06(this.A04, ML.A01(c2387dL, abstractC2662hyA1x.A1C(), abstractC2662hyA1x.A25()), c2387dL.A0A())) {
                            this.A04.A0F().A4u();
                            c2660hw.A22(iA1u);
                            return;
                        }
                ...
                } else if (ML.A06(this.A04, ML.A01(c2387dL, nu.A03(), ((AbstractC2662hy) this.A03).A25()), c2387dL.A0A())) {
                    this.A04.A0F().A4u();
                    this.A01.AF7(this, AdError.NO_FILL);
                    return;
                }
        ...
        this.A02 = new C1835Mi(this.A0B, this, interfaceC1834Mh);
        A07();
        A0D(z10);
    }
