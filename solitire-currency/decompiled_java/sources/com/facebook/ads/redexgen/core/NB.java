...
public final class NB implements Serializable {
    ...
    public static final EnumC2176Zt A0L;
    ...
    public NB(String str, String str2, int i10, String str3, String str4, EnumC2176Zt enumC2176Zt, int i11, boolean z10, boolean z11, NC nc, boolean z12, String str5, boolean z13, boolean z14, int i12, String str6, String str7, boolean z15) {
        if (z12) {
    ...
    public static NB A01(JSONObject jSONObject) {
        ...
        String precachingMethodStr2 = A03(c3.a.b.f11501j, 3, 112);
        ...
        EnumC2176Zt enumC2176ZtA02 = A02(jSONObjectOptJSONObject);
        ...
        return new NB(strOptString, strOptString2, iA00, strA05, strA04, enumC2176ZtA02, iOptInt, z10, zOptBoolean2, ncA00, zOptBoolean3, strOptString3, zOptBoolean, zOptBoolean4, iOptInt2, strOptString4, strOptString5, jSONObjectOptJSONObject.optBoolean(precachingMethodStr9, false));
    }

    public static EnumC2176Zt A02(JSONObject jSONObject) {
        int orientation = jSONObject.optInt(A03(229, 11, 36), A0L.A04());
        return EnumC2176Zt.A00(orientation);
    }
