...
public final class C2033Ud {
     ...
     */
    public static void A06(SQ sq, InterfaceC2466ed interfaceC2466ed, Map<String, ?> map) throws JSONException {
        HashMap map2 = new HashMap();
        map2.put(A01(93, 7, 67), A01(13, 1, 40));
        A0A(sq, map2);
        HashMap map3 = new HashMap();
        map3.put(A01(TsExtractor.TS_PACKET_SIZE, 7, 36), A01(157, 14, 115));
        ...
        A0A(sq, map3);
        TP tpA09 = sq.A09();
        JSONObject jSONObjectA05 = C2002Sx.A05(new C2004Sz(tpA09.A01(), tpA09.A02(), map3));
        ...
        c2480er.put(A01(171, 7, 40), jSONObject2.toString());
        interfaceC2466ed.AGE(sq.A05().A7y(), c2480er.A08(), new V7(sq));
    }
    ...
    static {
        A04();
        A01 = C2033Ud.class.getSimpleName();
