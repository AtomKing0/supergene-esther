...
public class C2727j8 implements LH {
    ...
    public C2727j8(C2725j6 c2725j6) {
        this(c2725j6, UUID.randomUUID().toString());
    }

    public C2727j8(C2725j6 c2725j6, String str) {
    ...
    public final void AAw(int code, String message) throws Throwable {
        if (AbstractC2066Vl.A02(this) || code < 11000 || code > 11099) {
            return;
        }
        try {
            A02(code, message);
    ...
    public final void AK6(int code, String message) throws Throwable {
        if (AbstractC2066Vl.A02(this) || code < 12000 || code > 12099) {
            return;
        }
        try {
            A02(code, message);
