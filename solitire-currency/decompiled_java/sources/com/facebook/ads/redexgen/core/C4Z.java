...
public final class C4Z extends AbstractC1714Hr {
    ...
    public final MH A0V;
    public final C2387dL A0W;
    public final C2030Ua A0X;
    public final AbstractC2117Xm A0Y;
    public final InterfaceC2334cT A0Z;
    public final EG A0a;
    public final E1 A0b;
    public final C13583i A0c;
    public final DX A0d;
    public final DV A0e;
    public final DR A0f;
    public final DP A0g;
    ...
    static {
        A0X();
        A0q = (int) (AbstractC2090Wl.A02 * 4.0f);
        A0r = (int) (AbstractC2090Wl.A02 * 8.0f);
        A0s = OP.A02(-1, 77);
        A0w = (int) (AbstractC2090Wl.A02 * 26.0f);
        A0x = (int) (AbstractC2090Wl.A02 * 12.0f);
        A0u = (int) (AbstractC2090Wl.A02 * 12.0f);
        A0v = (int) (AbstractC2090Wl.A02 * 44.0f);
        A0t = (int) (AbstractC2090Wl.A02 * 8.0f);
    }

    public C4Z(C2387dL c2387dL, US us, AbstractC2117Xm abstractC2117Xm, AbstractC2662hy abstractC2662hy, SF sf, YY yy, int i10, InterfaceC2118Xn interfaceC2118Xn, C2030Ua c2030Ua, int i11, boolean z10, boolean z11, InterfaceC2334cT interfaceC2334cT, int i12, int i13) {
        C1850My c1850MyA00;
        ...
        this.A02 = 0;
        this.A0R = true;
        this.A0l = new RunnableC2320cF(this);
        this.A0L = false;
        this.A0T = false;
        this.A01 = 0.0f;
        ...
        this.A0d = new DX() { // from class: com.facebook.ads.redexgen.X.4d
            ...
            public final void A03(C13533d c13533d) {
                ...
                this.A00.A0b.A0h(EnumC2403db.A02, 28);
            }
        };
        this.A0e = new C13774b(this);
        this.A0Y = abstractC2117Xm;
        this.A0U = i12;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A09 = (InputMethodManager) c2387dL.getSystemService(A0L(12, 12, 28));
        this.A0V = MI.A01(c2387dL, us, abstractC2662hy.A25(), WQ.A00(abstractC2662hy.A20().A0J().A05()), new HashMap(), false, true, abstractC2662hy.A21());
        this.A0W = c2387dL;
        this.A0X = c2030Ua;
        this.A0j = new D1(this.A0W, this.A0X);
        this.A0k = new C1590Cw(this.A0W, -1);
        this.A0Z = interfaceC2334cT;
        if (i11 == 1) {
        ...
        this.A0c = new C13583i(c2387dL, us, this.A0b, abstractC2662hy.A25());
        A0U();
        ...
        A0O();
        A0N();
        C2387dL c2387dL2 = this.A0W;
        String videoUrl2 = abstractC2662hy.A20().A0H().A08();
        AbstractC2208aR.A00(c2387dL2, this, videoUrl2);
        setupLayoutConfiguration(false);
        A0T();
        A0S();
        postDelayed(new HA(this), 1000L);
        if (U7.A1u(this.A0W)) {
            InterfaceC2034Ue interfaceC2034UeA0B = this.A0W.A0B();
            E1 e12 = this.A0b;
            String videoUrl3 = super.A06.A25();
            interfaceC2034UeA0B.AK2(e12, videoUrl3, true);
        }
        if (U7.A1v(this.A0W)) {
        ...
        A0Y(abstractC2662hy.A20());
        this.A0m = super.A06.A1e();
        this.A0n = super.A06.A1p();
        c2387dL.A0F().ABe(this.A0m, this.A0n, true);
    }
    ...
    private void A0O() {
        ...
        layoutParams.setMargins(0, AbstractC2117Xm.A00, A0t, 0);
    ...
    private void A0T() {
        View view = this.A0b;
        if (super.A06.A1W()) {
            view.setOnClickListener(new ViewOnClickListenerC2322cH(this));
        }
        XP.A0H(view);
        XP.A0I(view);
        ...
        XP.A0I(mMediaView3);
        this.A0H = new C2262bJ(this.A0W, null, super.A06, super.A08, super.A0B, super.A0D, super.A0A, getColors(), new HH(this));
        ...
        A0M();
        if (U7.A17(this.A0W)) {
            this.A0B.setOnClickListener(new ViewOnClickListenerC2314c9(this));
            View mMediaView6 = this.A0Y;
            if (mMediaView6 != null) {
                this.A0Y.setCTAClickListener(new ViewOnClickListenerC2315cA(this));
            }
        }
    }
    ...
    private void A0U() {
        ...
        if (!TextUtils.isEmpty(super.A06.A20().A0H().A08())) {
            C13392p c13392p = new C13392p(this.A0W);
            this.A0b.A0i(c13392p);
    ...
    private void A0Y(C1841Mp c1841Mp) {
        double dA00 = AbstractC2212aV.A00(c1841Mp);
        String strA0E = c1841Mp.A0I().A0E();
    ...
    public void A0f(C3Q c3q) {
        if (this.A0b.getState() == EnumC2457eU.A02 && U7.A1Z(this.A0W)) {
    ...
    public void A0g(String str) {
        ...
        this.A0G = lj;
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC2316cB(this));
    ...
    public void A0j(boolean z10) {
        ...
        duration.addUpdateListener(new C2318cD(this));
        ...
        animatorSet.addListener(new C2319cE(this, z10));
        if (this.A0n) {
    ...
    public final void A1E() {
        ...
        this.A0b.A0h(EnumC2403db.A02, 20);
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new C2084Wd(iA02, new HE(this)).A07();
                return;
            }
        }
    ...
    public final void A1H(boolean z10) {
        if (this.A0b.getState() != EnumC2457eU.A06) {
            EnumC2403db enumC2403db = this.A0I;
            String[] strArr = A0p;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    private void setUpBrowserControls(LJ lj) {
        ...
        this.A0E.setOnTouchListener(new ViewOnTouchListenerC2317cC(this));
