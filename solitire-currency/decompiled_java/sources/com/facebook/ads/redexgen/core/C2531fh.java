...
public final class C2531fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A07() {
        EnumC2095Wq.A04(this.A03, EnumC2095Wq.A0B);
        EnumC2095Wq.A04(this.A09, EnumC2095Wq.A0B);
        EnumC2095Wq.A04(this.A05, EnumC2095Wq.A0B);
        EnumC2095Wq.A04(this.A01, EnumC2095Wq.A0B);
    }
    ...
    private void A0A(View view, C1930Qc c1930Qc) {
        if (this.A0B != null) {
        ...
        String strA1D = c1930Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC2362cv.A01(this.A07, strA1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C2387dL c2387dL, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2387dL, attributeSet, i10, i11));
        A0H(new C2168Zl(c2387dL, attributeSet, i10, i11));
        this.A08 = new C0L(c2387dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2387dL, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C2387dL c2387dL, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2387dL, attributeSet, i10));
        A0H(new C2168Zl(c2387dL, attributeSet, i10));
        this.A08 = new C0L(c2387dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2387dL, attributeSet, i10));
        A07();
    }

    private final void A0E(C2387dL c2387dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2387dL, attributeSet));
        A0H(new C2168Zl(c2387dL, attributeSet));
        this.A08 = new C0L(c2387dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2387dL, attributeSet));
        A07();
    }

    private final void A0F(C2387dL c2387dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2387dL));
        A0H(new C2168Zl(c2387dL));
        this.A08 = new C0L(c2387dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2387dL));
        A07();
    }

    private void A0G(C1930Qc c1930Qc, boolean z10, C2045Up c2045Up) {
        KZ kzA04 = new KZ(this.A02, this.A07).A04();
        if (z10) {
            kzA04.A06(new C2538fo(this, c1930Qc));
        }
        kzA04.A07(c2045Up.getUrl());
    }

    private void A0H(C2168Zl c2168Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c2168Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c2168Zl, layoutParams);
            this.A09 = c2168Zl;
            return;
        }
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2531fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C2387dL c2387dLA12 = ((C1930Qc) nativeAdBaseApi).A12();
        C2387dL adObjectContext = this.A07;
        adObjectContext.A0L(c2387dLA12);
        c2387dLA12.A0O(this);
        this.A0D = true;
        C1930Qc c1930QcA0L = C1930Qc.A0L(nativeAdBaseApi);
        c1930QcA0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C2159Zc) {
                ((C2159Zc) this.A01).A04();
            } else {
                ((C14346g) this.A01).setAdapter(null);
            }
        }
        this.A02.setVisibility(0);
        bringChildToFront(this.A02);
        this.A00 = this.A02;
        C2045Up adIcon = c1930QcA0L.getAdIcon();
        if (adIcon != null) {
            SF sfA11 = c1930QcA0L.A11();
            if (A0F[1].charAt(7) == 'A') {
                throw new RuntimeException();
            }
            String[] strArr = A0F;
            ...
            if (bitmapA0N != null) {
                ...
                if (z10) {
                    this.A03.post(new C2539fp(this, c1930QcA0L));
                }
            } else {
                A0G(c1930QcA0L, z10, adIcon);
            }
        } else {
            QQ qqA16 = c1930QcA0L.A16();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c2387dLA12.A0F().A3F(c1930QcA0L.A0y(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (qqA16 != null) {
                qqA16.ADB(V1.A00(adErrorType));
            }
            Log.e(A04(46, 17, 121), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C2387dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC2000Sv.A0W, new C2001Sw(A04(PsExtractor.AUDIO_STREAM, 23, 42)));
            }
        }
        A0A(this.A02, c1930QcA0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2531fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2531fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2531fh.getMediaWidth():int");
    }
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C2532fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C2531fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
