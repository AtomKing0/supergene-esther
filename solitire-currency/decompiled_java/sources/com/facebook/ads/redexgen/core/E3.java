...
public class E3 {
    ...
    public final void A03(AnonymousClass92 anonymousClass92, Looper looper) {
        ...
        spatializer.addOnSpatializerStateChangedListener(new ExecutorC14858l(handler), this.A00);
    }
    ...
    public final boolean A07(C3070oy c3070oy, C3064or c3064or) {
        int i10;
        if (A01(5, 14, 28).equals(c3064or.A0W) && c3064or.A06 == 16) {
            i10 = 12;
        } else {
            i10 = c3064or.A06;
        }
        AudioFormat.Builder encoding = new AudioFormat.Builder().setEncoding(2);
        int linearChannelCount = AbstractC13764a.A01(i10);
        AudioFormat.Builder channelMask = encoding.setChannelMask(linearChannelCount);
        if (c3064or.A0G != -1) {
            int linearChannelCount2 = c3064or.A0G;
            channelMask.setSampleRate(linearChannelCount2);
        }
        Spatializer spatializer = this.A02;
        AudioAttributes audioAttributes = c3070oy.A01().A00;
