...
public final class C2298bt {
    ...
    public InterfaceC2287bi A02;
    public InterfaceC2296br A03;
    public InterfaceC2297bs A04;
    public C2460eX A05;
    public final int A08;
    public final AbstractC2662hy A09;
    public final SF A0A;
    public final C2387dL A0B;
    public final US A0C;
    public final C2030Ua A0D;
    public final C2285bg A0E;
    public final I5 A0F;
    public final C2306c1 A0G;
    public final C2307c2 A0H;
    public final LinkedList<C2295bq> A0J = new LinkedList<>();
    ...
    public final void A0i(Map<String, String> map) {
            ...
            try {
                ...
                for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                    ...
                    if (string != null && string2 != null && string3 != null) {
                        C2617h9 c2617h9 = new C2617h9(this.A09.A25(), Long.parseLong(string), Long.parseLong(string2), Long.parseLong(string3));
                        c2617h9.A06(Long.parseLong(string4));
                        arrayList.add(c2617h9);
                    }
                }
                String strA01 = C2616h8.A01(arrayList);
                ...
                this.A0B.A08().AAy(A0A(274, 14, 14), 3600, new C2001Sw(e10));
            }
        }
        ...
        this.A0C.AAx(this.A09.A25(), new C2172Zp(map).A03(this.A05).A05());
    }
    ...
    public C2298bt(C2387dL c2387dL, AbstractC2662hy abstractC2662hy, US us, int i10) {
        this.A0B = c2387dL;
        this.A0C = us;
        this.A09 = abstractC2662hy;
        this.A08 = i10;
        this.A0F = new I5(this, c2387dL);
        this.A0A = new SF(this.A0B);
        this.A0D = new C2030Ua(abstractC2662hy.A25(), us);
        this.A0E = new C2285bg(abstractC2662hy.A17(), abstractC2662hy.A20().A0H().A09(), i10);
        this.A0H = AbstractC2308c3.A00(this.A0B, abstractC2662hy.A1C(), this.A0A, this.A0D, this.A0E, A0H());
        this.A0G = new C2306c1(this.A0B, this, us, this.A0E, this.A0I, abstractC2662hy.A25());
    }
    ...
    private void A0C() {
        A0F(new C2295bq(A0A(288, 22, 4), new String[]{this.A0I, A0A(1, 6, 67)}));
        ...
        A0F(new C2295bq(A0A(310, 26, 76), new String[]{strReplace, assets}));
    }
    ...
    public synchronized void A0E() {
        if (this.A06) {
            while (!this.A0J.isEmpty()) {
                C2295bq c2295bqPoll = this.A0J.poll();
                if (c2295bqPoll != null) {
                    this.A0F.A0I(String.format(Locale.US, c2295bqPoll.A00, c2295bqPoll.A02));
                    if (c2295bqPoll.A01) {
                        this.A0D.A04(UZ.A0L, null);
                        this.A0B.A0F().A5x(c2295bqPoll.A00);
                    }
                }
            }
        }
    ...
    private synchronized void A0F(C2295bq c2295bq) {
        this.A0J.offer(c2295bq);
        A0E();
    }
    ...
    private boolean A0I() {
        return U7.A2s(this.A0B, C2442eF.A03());
    }

    public final C2030Ua A0K() {
        return this.A0D;
    }
    ...
    public final C2285bg A0M() {
        return this.A0E;
    }

    public final InterfaceC2287bi A0N() {
        return this.A02;
    }
    ...
    public final void A0P() {
        A0F(new C2295bq(A0A(23, 26, 91), new String[]{this.A0I}));
    }

    public final void A0Q() {
        A0F(new C2295bq(A0A(49, 25, 66), new String[]{this.A0I}));
    }
    ...
    public final void A0T() {
        A0F(new C2295bq(A0A(121, 23, 37), new String[]{this.A0I}));
    }

    public final void A0U() {
        A0F(new C2295bq(A0A(168, 27, 109), new String[]{this.A0I}));
    }

    public final void A0V() {
        A0F(new C2295bq(A0A(195, 22, 6), new String[]{this.A0I}));
    }

    public final void A0W() {
        A0F(new C2295bq(A0A(c3.a.b.f11495d, 22, 4), new String[]{this.A0I}));
    }
    ...
    public final void A0X() {
        ...
        try {
            ...
            jSONObject.put(url2, AbstractC2299bu.A00());
    ...
    public final void A0Y() {
        A0F(new C2295bq(A0A(144, 24, 60), new String[]{this.A0I}));
    }
    ...
    public final void A0a(InterfaceC2287bi interfaceC2287bi) {
        this.A02 = interfaceC2287bi;
    }

    public final void A0b(InterfaceC2296br interfaceC2296br) {
        this.A03 = interfaceC2296br;
    }

    public final void A0c(InterfaceC2297bs interfaceC2297bs) {
        this.A04 = interfaceC2297bs;
    }
    ...
    public final void A0e(C2460eX c2460eX) {
        this.A05 = c2460eX;
    }

    public final void A0f(String str) {
        A0F(new C2295bq(A0A(247, 27, 117), new String[]{this.A0I, str}));
    }

    public final void A0g(String str, String str2) {
        A0F(new C2295bq(A0A(217, 30, 7), new String[]{this.A0I, str, str2}));
    }

    public final void A0h(String str, JSONObject jSONObject) {
        A0F(new C2295bq(A0A(375, 29, 48), new String[]{this.A0I, str, jSONObject.toString()}, false));
    }
    ...
    public final void A0j(JSONObject jSONObject) {
        ...
        String assets = this.A0I;
        A0F(new C2295bq(A0A(336, 26, 54), new String[]{strReplace, assets}));
    }
