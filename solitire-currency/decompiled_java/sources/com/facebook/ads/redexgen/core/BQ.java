...
public final class BQ extends Handler {
    ...
    public final InterfaceC1551Bh A09;
    public final InterfaceC2919mT A0A;
    public final ArrayList<B8> A0B;
    public final HashMap<String, C2924mY> A0C;
    ...
    public BQ(HandlerThread handlerThread, InterfaceC2919mT interfaceC2919mT, InterfaceC1551Bh interfaceC1551Bh, Handler handler, int i10, int i11, boolean z10) {
        super(handlerThread.getLooper());
        this.A08 = handlerThread;
        this.A0A = interfaceC2919mT;
        this.A09 = interfaceC1551Bh;
        this.A07 = handler;
        this.A02 = i10;
        this.A03 = i11;
        this.A05 = z10;
    ...
    public static int A00(B8 b82, B8 b83) {
        return AbstractC13764a.A08(b82.A05, b83.A05);
    }
    ...
    */
    ...
    private B8 A03(B8 b82) {
        ...
        try {
            ...
            AnonymousClass44.A08(A08(2, 15, 106), A08(Sdk$SDKError.b.STALE_CACHED_RESPONSE_VALUE, 23, 46), e10);
        }
    ...
    private C2924mY A07(C2924mY c2924mY, B8 b82) {
        if (c2924mY == null) {
            if (A0U() && this.A01 < this.A02) {
                B8 b8A04 = A04(b82, 2, 0);
                C2924mY c2924mY2 = new C2924mY(b8A04.A07, this.A09.A5E(b8A04.A07), b8A04.A00, false, this.A03, this);
                this.A0C.put(b8A04.A07.A02, c2924mY2);
                int i10 = this.A01;
                this.A01 = i10 + 1;
                if (i10 == 0) {
    ...
    private void A09() {
        Iterator<C2924mY> it = this.A0C.values().iterator();
        while (it.hasNext()) {
            it.next().A05(true);
        }
        try {
    ...
    private void A0A() {
        ...
        try {
            C2929md c2929mdA7j = this.A0A.A7j(3, 4);
            while (c2929mdA7j.A01()) {
                try {
                    arrayList.add(c2929mdA7j.A00());
                } finally {
                }
            }
            if (c2929mdA7j != null) {
        ...
        while (true) {
            ...
            if (i11 < size) {
                ...
                try {
                    ...
                    AnonymousClass44.A08(strA08, A08(Sdk$SDKError.b.STALE_CACHED_RESPONSE_VALUE, 23, 46), e10);
                }
    ...
    */
    private void A0B() {
        ...
        L2:
            ...
            com.facebook.ads.redexgen.X.mY r1 = (com.facebook.ads.redexgen.core.C2924mY) r1
            int r0 = r2.A02
            switch(r0) {
                case 0: goto L38;
                case 1: goto L34;
        ...
        L3c:
            if (r1 == 0) goto L46
            boolean r0 = com.facebook.ads.redexgen.core.C2924mY.A03(r1)
            if (r0 != 0) goto L46
            int r4 = r4 + 1
        L46:
            int r3 = r3 + 1
    ...
    */
    ...
    private void A0E(int i10) {
        this.A04 = i10;
        C2929md c2929mdA7j = null;
        try {
            try {
                this.A0A.AIe();
                c2929mdA7j = this.A0A.A7j(0, 1, 2, 5, 7);
                while (c2929mdA7j.A01()) {
                    this.A0B.add(c2929mdA7j.A00());
                }
            } catch (IOException e10) {
                AnonymousClass44.A08(A08(2, 15, 106), A08(67, 21, 14), e10);
                this.A0B.clear();
            }
            AbstractC13764a.A10(c2929mdA7j);
    ...
    private void A0L(C2924mY c2924mY) {
        String str = c2924mY.A04.A02;
        this.A0C.remove(str);
        boolean z10 = c2924mY.A06;
        if (z10) {
            this.A06 = false;
        } else {
            int i10 = this.A01 - 1;
        ...
        Exception finalException = c2924mY.A01;
        if (finalException != null) {
            StringBuilder sb = new StringBuilder();
            String downloadId = A08(246, 13, 86);
            StringBuilder sbAppend = sb.append(downloadId).append(c2924mY.A04);
    ...
    private void A0M(C2924mY c2924mY) {
        if (c2924mY == null) {
            return;
        }
        C3M.A08(!c2924mY.A06);
    ...
    private void A0N(C2924mY c2924mY, long j10) {
        B8 b82 = (B8) C3M.A01(A06(c2924mY.A04.A02, false));
    ...
    private void A0O(C2924mY c2924mY, B8 b82) {
        if (c2924mY == null) {
            ...
            C2924mY c2924mY2 = new C2924mY(b82.A07, this.A09.A5E(b82.A07), b82.A00, true, this.A03, this);
            this.A0C.put(b82.A07.A02, c2924mY2);
            this.A06 = true;
            c2924mY2.start();
            return;
        }
    ...
    private void A0P(C2924mY c2924mY, B8 b82, int i10) {
        C3M.A08(!c2924mY.A06);
        if (!A0U() || i10 >= this.A02) {
            A04(b82, 0, 0);
            c2924mY.A05(false);
        ...
        try {
            switch (message.what) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    A0L((C2924mY) message.obj);
                    z10 = false;
                    break;
                case 10:
                    A0N((C2924mY) message.obj, AbstractC13764a.A0N(message.arg1, message.arg2));
                    return;
                case 11:
                    A0C();
                    return;
