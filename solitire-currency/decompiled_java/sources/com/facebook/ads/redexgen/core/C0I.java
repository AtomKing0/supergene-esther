...
public final class C0I<K> extends AbstractC13081i<K, V>.SortedKeySet implements NavigableSet<K> {
    ...
    public C0I(final AbstractC13081i this$0, NavigableMap<K, Collection<V>> subMap) {
        super(this$0, subMap);
        this.A00 = this$0;
    }
    ...
    public final K pollFirst() {
        return (K) AbstractC2973nL.A05(iterator());
    }
    ...
    public final K pollLast() {
        return (K) AbstractC2973nL.A05(descendingIterator());
    }
