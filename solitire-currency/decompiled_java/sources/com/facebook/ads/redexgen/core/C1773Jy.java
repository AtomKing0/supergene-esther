...
public final class C1773Jy extends AbstractC2178Zv {
    ...
    private void A04() {
        ...
        XP.A0I(this.A05);
        this.A05.setLayoutParams(AbstractC2178Zv.A0B);
    ...
    static {
        A09();
        A0U = OP.A02(-1, 77);
        A0O = (int) (AbstractC2090Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2090Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2090Wl.A02 * 26.0f);
        A0N = (int) (AbstractC2090Wl.A02 * 144.0f);
        A0M = (int) (AbstractC2090Wl.A02 * 48.0f);
        A0Q = (int) (AbstractC2090Wl.A02 * 16.0f);
        A0V = (int) (AbstractC2090Wl.A02 * 14.0f);
        A0R = (int) (OE.A08 * 21.0f);
        A0S = (int) (OE.A08 * 12.0f);
        A0T = (int) (OE.A08 * 10.0f);
    }

    public C1773Jy(C2387dL c2387dL, KE ke, int i10, boolean z10, C1850My c1850My, boolean z11, String str, US us, InterfaceC2118Xn interfaceC2118Xn, C2460eX c2460eX, XH xh, N3 n32, boolean z12, String str2, boolean z13) {
        super(c2387dL, ke, i10, c1850My, z11, str, us, interfaceC2118Xn, c2460eX, xh, n32, z12, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C2203aM(this.A0H, A0V, 5, A0U, -1);
    ...
    public C1773Jy(C2387dL c2387dL, KE ke, int i10, boolean z10, C1850My c1850My, boolean z11, String str, US us, InterfaceC2118Xn interfaceC2118Xn, C2460eX c2460eX, XH xh, AbstractC2662hy abstractC2662hy) {
        this(c2387dL, ke, i10, z10, c1850My, false, str, us, interfaceC2118Xn, c2460eX, xh, abstractC2662hy.A21(), abstractC2662hy.A1c(), abstractC2662hy.A0x(), abstractC2662hy.A1k());
    }
    ...
    private final void A0B() {
        super.A06.setLayoutParams(AbstractC2178Zv.A0B);
        A04();
        A03();
        if (!super.A03) {
            A02();
