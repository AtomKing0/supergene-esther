...
import com.facebook.ads.redexgen.core.AbstractC1531Am;
import com.facebook.ads.redexgen.core.C13071h;
import com.facebook.ads.redexgen.core.C15059m;
...
import com.facebook.ads.redexgen.core.C3033oL;
import com.facebook.ads.redexgen.core.C3035oN;
...
public abstract class Timeline implements C1S {
    ...
    public static final String A05 = AbstractC13764a.A0h(0);
    public static final String A03 = AbstractC13764a.A0h(1);
    public static final String A04 = AbstractC13764a.A0h(2);
    ...
    public abstract C3035oN A0I(int i10, C3035oN c3035oN, boolean z10);

    public abstract C3033oL A0L(int i10, C3033oL c3033oL, long j10);
    ...
    public static C15059m A02(Bundle bundle) {
        final AbstractC1531Am abstractC1531AmA04 = A04(C3033oL.A0J, C3R.A00(bundle, A05));
        final AbstractC1531Am abstractC1531AmA042 = A04(C3035oN.A08, C3R.A00(bundle, A03));
        final int[] intArray = bundle.getIntArray(A04);
        if (intArray == null) {
            intArray = A05(abstractC1531AmA04.size());
        }
        ImmutableList<Window> windows = new Timeline(abstractC1531AmA04, abstractC1531AmA042, intArray) { // from class: com.facebook.ads.redexgen.X.9m
            ...
            public final AbstractC1531Am<C3035oN> A00;
            public final AbstractC1531Am<C3033oL> A01;
            ...
            /* JADX WARN: Incorrect condition in loop: B:7:0x001b */
            {
                ...
                L28:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15059m.<init>(com.facebook.ads.redexgen.X.Am, com.facebook.ads.redexgen.X.Am, int[]):void");
            }
            ...
            @Override // com.facebook.ads.androidx.media3.common.Timeline
            public final C3035oN A0I(int i10, C3035oN p10, boolean z10) {
                C3035oN p11 = this.A00.get(i10);
            ...
            @Override // com.facebook.ads.androidx.media3.common.Timeline
            public final C3033oL A0L(int i10, C3033oL c3033oL, long j10) {
                C3033oL c3033oL2 = this.A01.get(i10);
                c3033oL.A07(c3033oL2.A0C, c3033oL2.A09, c3033oL2.A0A, c3033oL2.A06, c3033oL2.A07, c3033oL2.A04, c3033oL2.A0G, c3033oL2.A0D, c3033oL2.A08, c3033oL2.A02, c3033oL2.A03, c3033oL2.A00, c3033oL2.A01, c3033oL2.A05);
                c3033oL.A0F = c3033oL2.A0F;
                return c3033oL;
            }
    ...
    public static <T extends C1S> AbstractC1531Am<T> A04(C1R<T> c1r, IBinder iBinder) {
        if (iBinder == null) {
            return AbstractC1531Am.A03();
        }
        C13071h c13071h = new C13071h();
        AbstractC1531Am<Bundle> abstractC1531AmA00 = C1Q.A00(iBinder);
        for (int i10 = 0; i10 < abstractC1531AmA00.size(); i10++) {
            c13071h.A04(c1r.A6X(abstractC1531AmA00.get(i10)));
        }
        return c13071h.A05();
    }
    ...
    public final int A09(int i10, C3035oN c3035oN, C3033oL c3033oL, int i11, boolean z10) {
        int i12 = A0H(i10, c3035oN).A00;
        int windowIndex = A0K(i12, c3033oL).A01;
        if (windowIndex == i10) {
            int nextWindowIndex = A08(i12, i11, z10);
            if (nextWindowIndex == -1) {
                return -1;
            }
            int windowIndex2 = A0K(nextWindowIndex, c3033oL).A00;
            return windowIndex2;
        }
    ...
    @Deprecated
    public final Pair<Object, Long> A0D(C3033oL c3033oL, C3035oN c3035oN, int i10, long j10) {
        return A0E(c3033oL, c3035oN, i10, j10);
    }

    public final Pair<Object, Long> A0E(C3033oL c3033oL, C3035oN c3035oN, int i10, long j10) {
        return (Pair) C3M.A01(A0G(c3033oL, c3035oN, i10, j10, 0L));
    }

    @Deprecated
    public final Pair<Object, Long> A0F(C3033oL c3033oL, C3035oN c3035oN, int i10, long j10, long j11) {
        return A0G(c3033oL, c3035oN, i10, j10, j11);
    }

    public final Pair<Object, Long> A0G(C3033oL c3033oL, C3035oN c3035oN, int i10, long j10, long j11) {
        C3M.A00(i10, 0, A07());
        A0L(i10, c3033oL, j11);
        if (j10 == C.TIME_UNSET) {
            j10 = c3033oL.A05();
        ...
        int i11 = c3033oL.A00;
        A0H(i11, c3035oN);
        while (i11 < c3033oL.A01 && c3035oN.A02 != j10 && A0H(i11 + 1, c3035oN).A02 <= j10) {
            i11++;
        }
        A0I(i11, c3035oN, true);
        long jMin = j10 - c3035oN.A02;
        if (c3035oN.A01 != C.TIME_UNSET) {
            long j12 = c3035oN.A01;
        ...
        return Pair.create(C3M.A01(c3035oN.A04), Long.valueOf(Math.max(0L, jMin)));
    }

    public final C3035oN A0H(int i10, C3035oN c3035oN) {
        return A0I(i10, c3035oN, false);
    }

    public C3035oN A0J(Object obj, C3035oN c3035oN) {
        return A0I(A0A(obj), c3035oN, true);
    }

    public final C3033oL A0K(int i10, C3033oL c3033oL) {
        return A0L(i10, c3033oL, 0L);
    }
    ...
    public final boolean A0O(int i10, C3035oN c3035oN, C3033oL c3033oL, int i11, boolean z10) {
        return A09(i10, c3035oN, c3033oL, i11, z10) == -1;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C3033oL window = new C3033oL();
        C3035oN otherPeriod = new C3035oN();
        for (int i10 = 0; i10 < A07(); i10++) {
            if (!A0K(i10, c3033oL).equals(timeline.A0K(i10, window))) {
                return false;
            }
        }
        for (int i11 = 0; i11 < A06(); i11++) {
            boolean zEquals = A0I(i11, c3035oN, true).equals(timeline.A0I(i11, otherPeriod, true));
            if (A00[6].length() != 11) {
                throw new RuntimeException();
            }
            String[] strArr = A00;
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < A07(); i11++) {
            C3033oL window = A0K(i11, c3033oL);
            i10 = (i10 * 31) + window.hashCode();
        }
        int result2 = i10 * 31;
        int i12 = result2 + A06();
        for (int i13 = 0; i13 < A06(); i13++) {
            i12 = (i12 * 31) + A0I(i13, c3035oN, true).hashCode();
        }
        int iA0B = A0B(true);
        while (iA0B != -1) {
