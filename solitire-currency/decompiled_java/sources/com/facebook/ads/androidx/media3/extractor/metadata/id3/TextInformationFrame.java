...
import com.facebook.ads.redexgen.core.C1705Hh;
...
public final class TextInformationFrame extends Id3Frame {
    ...
    public /* synthetic */ TextInformationFrame(Parcel parcel, C1705Hh c1705Hh) {
        this(parcel);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (cls == cls2) {
                ...
                if (AbstractC13764a.A1E(super.A00, ((Id3Frame) textInformationFrame).A00)) {
                    boolean zA1E = AbstractC13764a.A1E(this.A00, textInformationFrame.A00);
                    if (A04[5].length() == 10) {
                        throw new RuntimeException();
                    }
                    A04[7] = "aAA9QqK2VvJ";
