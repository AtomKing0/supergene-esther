...
import com.facebook.ads.redexgen.core.C1717Hu;
import com.facebook.ads.redexgen.core.C1718Hv;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceInsertCommand> CREATOR = new C1717Hu();
     ...
     */
    public SpliceInsertCommand(long j10, boolean z10, boolean z11, boolean z12, boolean z13, long j11, long j12, List<C1718Hv> list, boolean z14, long j13, int i10, int i11, int i12) {
        this.A06 = j10;
        this.A0B = z10;
        this.A09 = z11;
        this.A0A = z12;
    ...
    public SpliceInsertCommand(Parcel parcel) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            arrayList.add(C1718Hv.A00(parcel));
        }
    ...
    public /* synthetic */ SpliceInsertCommand(Parcel parcel, C1717Hu c1717Hu) {
        this(parcel);
    }
        ...
        if (!z10) {
            ...
            if (!outOfNetworkIndicator) {
                ...
                for (int i10 = 0; i10 < componentCount; i10++) {
                    ...
                    listEmptyList.add(new C1718Hv(componentTag, jA002, c4r.A06(jA002), null));
                }
            }
            if (autoReturn) {
                long jA0I = c4j.A0I();
