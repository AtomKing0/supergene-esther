...
public final class IcyHeaders implements Metadata.Entry {
    ...
    public IcyHeaders(Parcel parcel) {
        ...
        this.A05 = AbstractC13764a.A1C(parcel);
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.A00 == icyHeaders.A00) {
            boolean zA1E = AbstractC13764a.A1E(this.A02, icyHeaders.A02);
            if (A07[4].length() == 20) {
                throw new RuntimeException();
            }
            A07[5] = "I4GVatcg3Odw2bdDZmPqVg6Hl1I8OBM0";
            if (zA1E && AbstractC13764a.A1E(this.A03, icyHeaders.A03) && AbstractC13764a.A1E(this.A04, icyHeaders.A04) && this.A05 == icyHeaders.A05 && this.A01 == icyHeaders.A01) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        AbstractC13764a.A0w(parcel, this.A05);
