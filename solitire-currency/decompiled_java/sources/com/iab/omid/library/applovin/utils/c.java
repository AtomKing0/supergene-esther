...
public class c {
    ...
    private static WindowManager f10728a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f10729b = {ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f10730c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f10732a);
            jSONObject.put("height", bVarA.f10733b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f10728a != null) {
            ...
            f10728a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f10730c = context.getResources().getDisplayMetrics().density;
            f10728a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0236a c0236a) {
        com.iab.omid.library.applovin.internal.e eVarA = c0236a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0236a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f10731a[outputDeviceStatus.ordinal()] == 1;
    }
