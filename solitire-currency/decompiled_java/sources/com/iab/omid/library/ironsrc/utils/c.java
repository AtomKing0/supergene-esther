...
public class c {
    ...
    private static WindowManager f10854a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f10855b = {ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f10856c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f10858a);
            jSONObject.put("height", bVarA.f10859b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f10854a != null) {
            ...
            f10854a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f10856c = context.getResources().getDisplayMetrics().density;
            f10854a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0239a c0239a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0239a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f10857a[outputDeviceStatus.ordinal()] == 1;
    }
