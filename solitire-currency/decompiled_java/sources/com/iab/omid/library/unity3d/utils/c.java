...
public class c {
    ...
    private static WindowManager f10982a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f10983b = {ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f10984c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f10986a);
            jSONObject.put("height", bVarA.f10987b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f10982a != null) {
            ...
            f10982a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f10984c = context.getResources().getDisplayMetrics().density;
            f10982a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0243a c0243a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0243a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0243a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f10985a[outputDeviceStatus.ordinal()] == 1;
    }
