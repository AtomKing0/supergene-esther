...
import com.iab.omid.library.activision.utils.i;
...
public class JavaScriptSessionService {
    ...
    private com.iab.omid.library.activision.weakreference.a weakAdView;
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList(ProxyConfig.MATCH_ALL_SCHEMES)), new WebViewCompat.WebMessageListener() { // from class: com.iab.omid.library.activision.adsession.JavaScriptSessionService.2
    ...
    @Nullable
    View getAdView() {
        com.iab.omid.library.activision.weakreference.a aVar = this.weakAdView;
        if (aVar == null) {
            return null;
        }
        return aVar.get();
    ...
    public void setAdView(@Nullable View view) {
        ...
        this.weakAdView = new com.iab.omid.library.activision.weakreference.a(view);
    }
    ...
    public void tearDown(final TearDownHandler tearDownHandler) {
        ...
        timer.schedule(new TimerTask() { // from class: com.iab.omid.library.activision.adsession.JavaScriptSessionService.1
