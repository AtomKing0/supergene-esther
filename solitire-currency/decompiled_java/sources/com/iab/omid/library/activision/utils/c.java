...
import com.iab.omid.library.activision.adsession.OutputDeviceStatus;
...
public class c {
    ...
    private static WindowManager f10593a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f10594b = {ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f10595c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f10597a);
            jSONObject.put("height", bVarA.f10598b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f10593a != null) {
            ...
            f10593a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static JSONObject a(int i10, int i11, int i12, int i13) {
        ...
        try {
            jSONObject.put(ViewHierarchyNode.JsonKeys.X, a(i10));
            jSONObject.put(ViewHierarchyNode.JsonKeys.Y, a(i11));
    ...
    public static void a(Context context) {
        if (context != null) {
            f10595c = context.getResources().getDisplayMetrics().density;
            f10593a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0232a c0232a) {
        com.iab.omid.library.activision.internal.e eVarA = c0232a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0232a.b().iterator();
        while (it.hasNext()) {
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            d.a("JSONException during JSONObject.put for name [" + str + v8.i.f15839e, e10);
        }
    }
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f10596a[outputDeviceStatus.ordinal()] == 1;
    }
