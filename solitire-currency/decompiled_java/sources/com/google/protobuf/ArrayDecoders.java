...
final class ArrayDecoders {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 17:
                    ...
                    if (generatedExtension.isRepeated()) {
                        int iDecodeGroupField = decodeGroupField(schemaSchemaFor, bArr, i11, i12, i14, registers);
                    ...
                    return mergeGroupField(field, schemaSchemaFor, bArr, i11, i12, i14, registers);
                case 18:
    ...
    static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i10, int i11, int i12, Registers registers) throws IOException {
        int proto2Message = ((MessageSchema) schema).parseProto2Message(obj, bArr, i10, i11, i12, registers);
    ...
    static int mergeMessageField(Object obj, Schema schema, byte[] bArr, int i10, int i11, Registers registers) throws IOException {
        ...
        int i14 = i12 + i13;
        schema.mergeFrom(obj, bArr, i13, i14, registers);
        registers.object1 = obj;
        return i14;
    }
