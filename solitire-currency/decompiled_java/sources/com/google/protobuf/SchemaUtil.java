...
final class SchemaUtil {
    ...
    static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (enumLiteMap == null) {
            return ub;
        }
    ...
    public static boolean shouldUseTableSwitch(int i10, int i11, int i12) {
        ...
        long j10 = (((long) i11) - ((long) i10)) + 1;
        long j11 = i12;
        return j10 + 9 <= ((2 * j11) + 3) + ((j11 + 3) * 3);
    }

    @CanIgnoreReturnValue
    static <UT, UB> UB storeUnknownEnum(Object obj, int i10, int i11, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (ub == null) {
    ...
    @CanIgnoreReturnValue
    static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
