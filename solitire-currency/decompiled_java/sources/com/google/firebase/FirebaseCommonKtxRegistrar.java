...
public final class FirebaseCommonKtxRegistrar implements ComponentRegistrar {
    ...
    public static final class a<T> implements h {
        ...
        public static final a<T> f10214a = new a<>();
    ...
    public static final class b<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final b<T> f10215a = new b<>();
    ...
    public static final class c<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final c<T> f10216a = new c<>();
    ...
    public static final class d<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final d<T> f10217a = new d<>();
    ...
    public List<l5.c<?>> getComponents() {
        l5.c cVarD = l5.c.e(e0.a(k5.a.class, k0.class)).b(r.j(e0.a(k5.a.class, Executor.class))).f(a.f10214a).d();
        t.h(cVarD, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        l5.c cVarD2 = l5.c.e(e0.a(k5.c.class, k0.class)).b(r.j(e0.a(k5.c.class, Executor.class))).f(b.f10215a).d();
        t.h(cVarD2, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        l5.c cVarD3 = l5.c.e(e0.a(k5.b.class, k0.class)).b(r.j(e0.a(k5.b.class, Executor.class))).f(c.f10216a).d();
        t.h(cVarD3, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        l5.c cVarD4 = l5.c.e(e0.a(k5.d.class, k0.class)).b(r.j(e0.a(k5.d.class, Executor.class))).f(d.f10217a).d();
