...
/* JADX INFO: compiled from: NotificationParams.java */
...
public class k0 {
    ...
    public k0(@NonNull Bundle bundle) {
        ...
        this.f10442a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f10442a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f10442a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f10442a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f10442a);
        for (String str : this.f10442a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
