...
final class zzwf implements zzug, zzuf {
    ...
    public final long zzd() {
        ...
        return jZzd == C.TIME_UNSET ? C.TIME_UNSET : jZzd + this.zzb;
    }
    ...
    public final long zzg(zzxv[] zzxvVarArr, boolean[] zArr, zzvx[] zzvxVarArr, boolean[] zArr2, long j10) {
        ...
        while (true) {
            ...
            zzvxVarArr2[i10] = zzvxVarZzc;
            i10++;
        }
        long jZzg = this.zza.zzg(zzxvVarArr, zArr, zzvxVarArr2, zArr2, j10 - this.zzb);
        for (int i11 = 0; i11 < zzvxVarArr.length; i11++) {
            zzvx zzvxVar = zzvxVarArr2[i11];
            if (zzvxVar == null) {
                zzvxVarArr[i11] = null;
            } else {
                zzvx zzvxVar2 = zzvxVarArr[i11];
                if (zzvxVar2 == null || ((zzwe) zzvxVar2).zzc() != zzvxVar) {
                    zzvxVarArr[i11] = new zzwe(zzvxVar, this.zzb);
                }
            }
        }
