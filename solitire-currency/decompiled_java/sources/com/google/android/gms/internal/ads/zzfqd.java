...
public final class zzfqd {
    ...
    public zzfqd(@NonNull Context context, @NonNull int i10, @NonNull zzfpk zzfpkVar, boolean z10) {
        this.zzf = false;
        this.zzb = context;
    ...
    private static String zzf(@NonNull zzaxi zzaxiVar) {
        ...
        return Hex.bytesToStringLowercase(((zzaxl) zzaxkVarZze.zzbr()).zzaV());
    }
    ...
    private final zzaxl zzk(int i10) {
        ...
        try {
            ...
            return zzaxl.zzi(zzgwm.zzv(bArrStringToBytes, 0, bArrStringToBytes.length), this.zzf ? zzgxi.zza() : zzgxi.zzb());
        } catch (zzgyn unused) {
            return null;
    ...
    public final boolean zza(@NonNull zzaxi zzaxiVar) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        synchronized (zza) {
    ...
    public final boolean zzb(@NonNull zzaxi zzaxiVar, @Nullable zzfqc zzfqcVar) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        synchronized (zza) {
