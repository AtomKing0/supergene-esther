...
public abstract class zzja extends zzig {
    ...
    private static class zzb extends zzja {
        ...
        @Override // com.google.android.gms.internal.measurement.zzja
        final void zzc(int i10, zzlg zzlgVar, zzly zzlyVar) throws IOException {
            zzj(i10, 2);
            zzk(((zzhz) zzlgVar).zza(zzlyVar));
            zzlyVar.zza(zzlgVar, this.zza);
        }
    ...
    abstract void zzc(int i10, zzlg zzlgVar, zzly zzlyVar) throws IOException;
    ...
    static int zzb(int i10, zzlg zzlgVar, zzly zzlyVar) {
        return zzg(i10 << 3) + zza(zzlgVar, zzlyVar);
    }
    ...
    public static int zzb(int i10, zzij zzijVar) {
        return (zzg(8) << 1) + zzf(2, i10) + zza(3, zzijVar);
    }
    ...
    @Deprecated
    static int zza(int i10, zzlg zzlgVar, zzly zzlyVar) {
        return (zzg(i10 << 3) << 1) + ((zzhz) zzlgVar).zza(zzlyVar);
    }
    ...
    public static int zza(int i10, zzkk zzkkVar) {
        return (zzg(8) << 1) + zzf(2, i10) + zzb(3, zzkkVar);
    }
    ...
    public static int zza(int i10, zzlg zzlgVar) {
        return (zzg(8) << 1) + zzf(2, i10) + zzg(24) + zzb(zzlgVar);
    }

    static int zza(zzlg zzlgVar, zzly zzlyVar) {
