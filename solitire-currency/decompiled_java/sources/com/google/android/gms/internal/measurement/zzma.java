...
final class zzma {
    ...
    static int zzb(int i10, List<Integer> list, boolean z10) {
        ...
        return zzb(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zze(int i10, List<Integer> list, boolean z10) {
        ...
        return zze(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zzf(int i10, List<Long> list, boolean z10) {
        ...
        return zzf(list) + (list.size() * zzja.zzf(i10));
    }
    ...
    static int zzg(int i10, List<Integer> list, boolean z10) {
        ...
        return zzg(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zzh(int i10, List<Long> list, boolean z10) {
        ...
        return zzh(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zzi(int i10, List<Integer> list, boolean z10) {
        ...
        return zzi(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zzj(int i10, List<Long> list, boolean z10) {
        ...
        return zzj(list) + (size * zzja.zzf(i10));
    }
    ...
    static int zza(int i10, List<zzij> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        int iZzf = size * zzja.zzf(i10);
    ...
    static int zza(int i10, List<zzlg> list, zzly zzlyVar) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int zzb(int i10, List<?> list, zzly zzlyVar) {
        int iZza;
        int size = list.size();
        if (size == 0) {
            return 0;
    ...
    static int zza(int i10, Object obj, zzly zzlyVar) {
        if (obj instanceof zzkk) {
    ...
    static <UT, UB> UB zza(Object obj, int i10, List<Integer> list, zzjx zzjxVar, UB ub, zzmt<UT, UB> zzmtVar) {
        if (zzjxVar == null) {
            return ub;
        }
        if (list instanceof RandomAccess) {
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (zzjxVar.zza(iIntValue)) {
                    ...
                    ub = (UB) zza(obj, i10, iIntValue, ub, zzmtVar);
                }
            }
            if (i11 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (!zzjxVar.zza(iIntValue2)) {
                    ub = (UB) zza(obj, i10, iIntValue2, ub, zzmtVar);
                    it.remove();
                }
            }
        }
    ...
    static <UT, UB> UB zza(Object obj, int i10, int i11, UB ub, zzmt<UT, UB> zzmtVar) {
        if (ub == null) {
            ub = zzmtVar.zzc(obj);
        }
        zzmtVar.zzb(ub, i10, i11);
        return ub;
    }
    ...
    static <T, FT extends zzjl<FT>> void zza(zzji<FT> zzjiVar, T t10, T t11) {
    ...
    static <T> void zza(zzkz zzkzVar, T t10, T t11, long j10) {
    ...
    static <T, UT, UB> void zza(zzmt<UT, UB> zzmtVar, T t10, T t11) {
