...
public final class zzeaa implements zzhfc {
    ...
    public final zzdzz zzb() {
        ...
        VersionInfoParcel versionInfoParcelZza = ((zzchc) this.zze).zza();
        zzfki zzfkiVar = (zzfki) this.zzf.zzb();
        zzfkf zzfkfVar = (zzfkf) this.zzg.zzb();
        Context contextZza = ((zzcgp) this.zzh).zza();
        zzgcu zzgcuVar = zzbzo.zza;
        zzhfk.zzb(zzgcuVar);
        return new zzdzz(zzczmVarZzb, zzdzhVarZzb, zzfjlVar, zzffgVarZza, versionInfoParcelZza, zzfkiVar, zzfkfVar, contextZza, zzgcuVar);
    }
}
