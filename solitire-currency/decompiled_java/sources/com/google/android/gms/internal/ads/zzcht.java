...
final class zzcht extends zzewr {
    ...
    public final zzevr zzb() {
        ...
        zzhfk.zzb(zzgcuVar);
        return new zzevr(contextZzb, zzgcuVar, zzfxw.zzs(zzevoVarZza, zzevoVarZzb, zzevoVarZza2, zzevoVarZzc, zzeyxVar, zzexvVar, zzf(), zze(), new zzexr(zzbyvVar2, iZza, contextZzb5, zzbzeVar, scheduledExecutorService3, zzgcuVar, strZzc2), (zzevo) this.zzb.zzaL.zzb(), zzexn.zza(strZzc3, zzazyVar, zzbzeVar2, scheduledExecutorService4, zzgcuVar)), (zzfkf) this.zzc.zzb(), (zzdsk) this.zzb.zzM.zzb());
    }
