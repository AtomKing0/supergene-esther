...
final class zzjj<T extends zzjl<T>> {
    ...
    static int zza(zzng zzngVar, int i10, Object obj) {
    ...
    private final void zzb(Map.Entry<T, Object> entry) {
        ...
        this.zza.put(key, objZza2 instanceof zzll ? key.zza((zzll) objZza2, (zzll) value) : key.zza(((zzlg) objZza2).zzce(), (zzlg) value).zzah());
    }
    ...
    */
    ...
    public static int zza(zzjl<?> zzjlVar, Object obj) {
        ...
        if (zzjlVar.zze()) {
            ...
            if (zzjlVar.zzd()) {
                ...
                return zzja.zzf(iZza) + iZza2 + zzja.zzg(iZza2);
            }
    ...
    static void zza(zzja zzjaVar, zzng zzngVar, int i10, Object obj) throws IOException {
        if (zzngVar == zzng.zzj) {
