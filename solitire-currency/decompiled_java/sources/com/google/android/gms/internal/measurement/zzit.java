...
class zzit extends zziq {
    ...
    @Override // com.google.android.gms.internal.measurement.zzij
    final void zza(zzig zzigVar) throws IOException {
        zzigVar.zza(this.zzb, zze(), zzb());
    }

    @Override // com.google.android.gms.internal.measurement.zziq
    final boolean zza(zzij zzijVar, int i10, int i11) {
        if (i11 <= zzijVar.zzb()) {
            if (i11 <= zzijVar.zzb()) {
            ...
            throw new IllegalArgumentException("Ran off end of other: 0, " + i11 + ", " + zzijVar.zzb());
        }
