...
public final class zzbvd {
    ...
    public zzbvd(JSONObject jSONObject) {
        ...
        this.zze = zzm(jSONObject.optString("cookies_include", com.ironsource.mediationsdk.metadata.a.f13688g));
    ...
    private static boolean zzm(String str) {
        if (str != null) {
            return str.equals("1") || str.equals(com.ironsource.mediationsdk.metadata.a.f13688g);
        }
        return false;
    }
