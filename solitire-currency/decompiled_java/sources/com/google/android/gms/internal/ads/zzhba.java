...
final class zzhba {
    static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws zzgyn {
    ...
    */
    static /* bridge */ /* synthetic */ void zzb(byte r2, byte r3, byte r4, char[] r5, int r6) throws com.google.android.gms.internal.ads.zzgyn {
        /*
            boolean r0 = zzg(r3)
            if (r0 != 0) goto L2c
            r0 = -96
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i10) throws zzgyn {
        if (b10 < -62 || zzg(b11)) {
            throw zzgyn.zzd();
        }
