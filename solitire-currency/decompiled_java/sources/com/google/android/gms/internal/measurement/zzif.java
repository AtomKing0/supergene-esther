...
final class zzif {
    ...
    static int zzd(byte[] bArr, int i10, zzie zzieVar) {
        int i11 = i10 + 1;
        long j10 = bArr[i10];
        if (j10 >= 0) {
            zzieVar.zzb = j10;
    ...
    static int zza(byte[] bArr, int i10, zzie zzieVar) throws zzkb {
    ...
    static int zzb(byte[] bArr, int i10, zzie zzieVar) throws zzkb {
        int iZzc = zzc(bArr, i10, zzieVar);
        int i11 = zzieVar.zza;
        if (i11 < 0) {
            throw zzkb.zzf();
    ...
    static int zzc(byte[] bArr, int i10, zzie zzieVar) {
        int i11 = i10 + 1;
        byte b10 = bArr[i10];
        if (b10 < 0) {
    ...
    static int zza(zzly zzlyVar, byte[] bArr, int i10, int i11, int i12, zzie zzieVar) throws IOException {
    ...
    static int zza(zzly zzlyVar, byte[] bArr, int i10, int i11, zzie zzieVar) throws IOException {
        Object objZza = zzlyVar.zza();
    ...
    static int zza(zzly<?> zzlyVar, int i10, byte[] bArr, int i11, int i12, zzkc<?> zzkcVar, zzie zzieVar) throws IOException {
    ...
    static int zza(byte[] bArr, int i10, zzkc<?> zzkcVar, zzie zzieVar) throws IOException {
    ...
    static int zza(int i10, byte[] bArr, int i11, int i12, zzmw zzmwVar, zzie zzieVar) throws zzkb {
        if ((i10 >>> 3) == 0) {
            throw zzkb.zzc();
        }
        int i13 = i10 & 7;
    ...
    static int zza(int i10, byte[] bArr, int i11, zzie zzieVar) {
        int i12 = i10 & 127;
        int i13 = i11 + 1;
        byte b10 = bArr[i11];
        if (b10 >= 0) {
    ...
    static int zza(int i10, byte[] bArr, int i11, int i12, zzkc<?> zzkcVar, zzie zzieVar) {
        zzju zzjuVar = (zzju) zzkcVar;
        int iZzc = zzc(bArr, i11, zzieVar);
        zzjuVar.zzd(zzieVar.zza);
        while (iZzc < i12) {
    ...
    static int zza(Object obj, zzly zzlyVar, byte[] bArr, int i10, int i11, int i12, zzie zzieVar) throws IOException {
        int iZza = ((zzlk) zzlyVar).zza(obj, bArr, i10, i11, i12, zzieVar);
        zzieVar.zzc = obj;
        return iZza;
    }

    static int zza(Object obj, zzly zzlyVar, byte[] bArr, int i10, int i11, zzie zzieVar) throws IOException {
        int iZza = i10 + 1;
        int i12 = bArr[i10];
        if (i12 < 0) {
    ...
    static int zza(int i10, byte[] bArr, int i11, int i12, zzie zzieVar) throws zzkb {
        if ((i10 >>> 3) == 0) {
            throw zzkb.zzc();
        }
        int i13 = i10 & 7;
