...
public class zzcru implements zzeio {
    ...
    protected zzcru(zzcrt zzcrtVar) {
        this.zza = zzcrtVar.zza;
        this.zzb = zzcrtVar.zzb;
        this.zzc = zzcrtVar.zzc;
        this.zzd = zzcrtVar.zzd;
        this.zze = zzcrtVar.zze;
        this.zzf = zzcrtVar.zzf;
        this.zzg = zzcrtVar.zzg;
        this.zzh = zzcrtVar.zzh;
        this.zzi = zzcrtVar.zzi;
    }
