...
final class zzfti {
    ...
    final /* synthetic */ void zze(zzftp zzftpVar, int i10, zzftn zzftnVar) {
        try {
            zzftz zzftzVar = this.zza;
            zzftzVar.getClass();
            ?? Zzc = zzftzVar.zzc();
    ...
    final void zzg(final zzftp zzftpVar, final zzftn zzftnVar, final int i10) {
        zzftz zzftzVar = this.zza;
        if (zzftzVar == null) {
            zzb.zza("error: %s", "Play Store not found.");
        } else {
            zzftzVar.zzi(new Runnable() { // from class: com.google.android.gms.internal.ads.zzftd
                @Override // java.lang.Runnable
                public final void run() {
                    this.zza.zze(zzftpVar, i10, zzftnVar);
                }
            });
        }
    }
