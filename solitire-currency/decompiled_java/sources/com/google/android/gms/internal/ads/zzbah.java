...
public final class zzbah extends AbstractSafeParcelable {
    ...
    public static zzbah zza(Uri uri) {
        try {
            ...
            return new zzbah(queryParameter, j10, host, str, str2, bundle, zEquals, 0L, "", 0);
        } catch (NullPointerException | NumberFormatException e10) {
            com.google.android.gms.ads.internal.util.client.zzm.zzk("Unable to parse Uri into cache offering.", e10);
            return null;
        }
    }
