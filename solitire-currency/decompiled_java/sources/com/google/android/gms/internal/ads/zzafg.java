...
public final class zzafg implements zzbj {
    ...
    static {
        ...
        zzadVar2.zzX(MimeTypes.APPLICATION_SCTE35);
        zzadVar2.zzad();
        CREATOR = new zzaff();
    }
    ...
    public final int hashCode() {
        ...
        int i11 = iHashCode + IronSourceError.ERROR_NON_EXISTENT_INSTANCE;
        long j10 = this.zzc;
        long j11 = this.zzd;
        int iHashCode3 = (((((((i11 * 31) + iHashCode2) * 31) + ((int) (j10 ^ (j10 >>> 32)))) * 31) + ((int) (j11 ^ (j11 >>> 32)))) * 31) + Arrays.hashCode(this.zze);
        this.zzf = iHashCode3;
        return iHashCode3;
    }
