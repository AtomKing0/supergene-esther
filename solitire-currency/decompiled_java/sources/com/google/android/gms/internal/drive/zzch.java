...
public final class zzch extends DriveResourceClient {
    ...
    @Override // com.google.android.gms.drive.DriveResourceClient
    public final Task<DriveContents> openFile(@NonNull DriveFile driveFile, int i10) {
        zze(i10);
        return doRead(new zzct(this, driveFile, i10));
    }
    ...
    @Override // com.google.android.gms.drive.DriveResourceClient
    public final Task<ListenerToken> openFile(@NonNull DriveFile driveFile, int i10, @NonNull OpenFileCallback openFileCallback) {
        zze(i10);
        int iIncrementAndGet = zzfn.incrementAndGet();
        StringBuilder sb = new StringBuilder(27);
        ...
        return doRegisterEventListener(new zzcu(this, listenerHolderRegisterListener, driveFile, i10, zzgVar, listenerHolderRegisterListener), new zzcv(this, listenerKey, zzgVar)).continueWith(new Continuation(zzgVar) { // from class: com.google.android.gms.internal.drive.zzcj
