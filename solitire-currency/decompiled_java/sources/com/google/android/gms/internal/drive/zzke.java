...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum field 'zzoy' uses external variables
...
public final class zzke {
    ...
    static {
        ...
        zzqg = zzkeVar35;
        zzkg zzkgVar3 = zzkg.PACKED_VECTOR;
        ...
        zzqv = zzkeVar50;
        zzke zzkeVar51 = new zzke("MAP", 50, 50, zzkg.MAP, zzks.zzsr);
        zzqw = zzkeVar51;
        ...
        for (zzke zzkeVar52 : zzkeVarArrValues) {
            zzrb[zzkeVar52.id] = zzkeVar52;
        }
    }

    private zzke(String str, int i10, int i11, zzkg zzkgVar, zzks zzksVar) {
        int i12;
        this.id = i11;
        this.zzqy = zzkgVar;
        this.zzqx = zzksVar;
        int i13 = zzkf.zzre[zzkgVar.ordinal()];
        if (i13 == 1 || i13 == 2) {
            this.zzqz = zzksVar.zzdo();
        } else {
            this.zzqz = null;
        }
        this.zzra = (zzkgVar != zzkg.SCALAR || (i12 = zzkf.zzrf[zzksVar.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
