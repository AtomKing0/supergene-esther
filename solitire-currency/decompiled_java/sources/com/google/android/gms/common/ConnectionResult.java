...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    ConnectionResult(@SafeParcelable.Param(id = 1) int i10, @SafeParcelable.Param(id = 2) int i11, @Nullable @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 4) String str) {
        this.zza = i10;
        this.zzb = i11;
