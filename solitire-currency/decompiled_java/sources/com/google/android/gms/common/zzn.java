...
final class zzn {
    ...
    static zzx zza(String str, zzj zzjVar, boolean z10, boolean z11) {
    ...
    static /* synthetic */ String zzd(boolean z10, String str, zzj zzjVar) throws Exception {
        ...
        return String.format("%s: pkg=%s, sha256=%s, atk=%s, ver=%s", str2, str, Hex.bytesToStringLowercase(messageDigestZza.digest(zzjVar.zzf())), Boolean.valueOf(z10), "12451000.false");
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e10);
                    zzxVarZzd = zzx.zzd("module call", e10);
                }
            } catch (DynamiteModule.LoadingException e11) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e11);
                zzxVarZzd = zzx.zzd("module init: ".concat(String.valueOf(e11.getMessage())), e11);
            }
            return zzxVarZzd;
        } finally {
            StrictMode.setThreadPolicy(threadPolicyAllowThreadDiskReads);
