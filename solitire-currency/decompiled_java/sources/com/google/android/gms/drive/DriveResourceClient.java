...
public abstract class DriveResourceClient extends GoogleApi<Drive.zza> {
    ...
    @Deprecated
    public abstract Task<DriveContents> openFile(@NonNull DriveFile driveFile, int i10);

    @Deprecated
    public abstract Task<ListenerToken> openFile(@NonNull DriveFile driveFile, int i10, @NonNull OpenFileCallback openFileCallback);
