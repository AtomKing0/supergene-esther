...
final /* synthetic */ class zzhf {
    ...
    static {
        ...
        try {
            zzc[zzfn.zza.zzd.GRANTED.ordinal()] = 2;
        ...
        try {
            zzb[zzfn.zza.zze.ANALYTICS_STORAGE.ordinal()] = 2;
        } catch (NoSuchFieldError unused4) {
        }
        try {
            zzb[zzfn.zza.zze.AD_USER_DATA.ordinal()] = 3;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            zzb[zzfn.zza.zze.AD_PERSONALIZATION.ordinal()] = 4;
