...
final class zzga implements Runnable {
    ...
    zzga(zzgb zzgbVar, int i10, String str, Object obj, Object obj2, Object obj3) {
        this.zza = i10;
        this.zzb = str;
        this.zzc = obj;
        this.zzd = obj2;
    ...
    public final void run() {
        ...
        String strSubstring = "2" + "01VDIWEA?".charAt(this.zza) + this.zzf.zza + this.zzf.zzb + ":" + zzgb.zza(true, this.zzb, this.zzc, this.zzd, this.zze);
