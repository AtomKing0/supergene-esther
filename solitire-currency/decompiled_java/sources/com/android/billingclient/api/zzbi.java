...
final class zzbi extends com.google.android.gms.internal.play_billing.zzg {
    ...
    public final void zza(Bundle bundle) throws RemoteException {
        ...
        try {
            ...
            com.google.android.gms.internal.play_billing.zzb.zzl("BillingClient", "Runtime error while launching intent for alternative billing only dialog.", e10);
            Bundle bundle2 = new Bundle();
            bundle2.putInt("RESPONSE_CODE", 6);
            bundle2.putString("DEBUG_MESSAGE", "An internal error occurred.");
            bundle2.putInt("INTERNAL_LOG_ERROR_REASON", 75);
            bundle2.putString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS", String.format("%s: %s", e10.getClass().getName(), com.google.android.gms.internal.play_billing.zzab.zzb(e10.getMessage())));
