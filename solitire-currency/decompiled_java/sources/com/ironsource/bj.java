...
public class bj {
    ...
    public static final int f11414a = 1024;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final String f11415b = "RSA/ECB/PKCS1Padding";
    ...
    public static KeyPair a() {
        try {
            KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(f11415b);
    ...
    public static byte[] a(byte[] bArr, PrivateKey privateKey) {
        try {
            Cipher cipher = Cipher.getInstance(f11415b);
