...
public class cd {
    ...
    private static final String f11548a = "adunit_data";

    private JSONObject a(Context context, @NotNull ad.a aVar) throws JSONException {
        String strName = aVar.name();
        JSONObject jSONObjectB = bd.a().b(context);
        JSONObject jSONObjectOptJSONObject = jSONObjectB.optJSONObject(f11548a);
