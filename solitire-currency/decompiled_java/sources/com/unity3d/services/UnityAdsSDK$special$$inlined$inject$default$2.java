...
public final class UnityAdsSDK$special$$inlined$inject$default$2 extends v implements a<AlternativeFlowReader> {
    ...
    public final AlternativeFlowReader invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(AlternativeFlowReader.class));
    }
}
