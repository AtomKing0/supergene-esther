...
public class Device {
    ...
    public static String getConnectionType() {
        return isUsingWifi() ? r8.f14655b : isActiveNetworkConnected() ? r8.f14660g : "none";
    }
    ...
    */
    ...
    public static String getNetworkCountryISO() {
        return ClientProperties.getApplicationContext() != null ? ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(HintConstants.AUTOFILL_HINT_PHONE)).getNetworkCountryIso() : "";
    }
    ...
    public static String getNetworkOperator() {
        return ClientProperties.getApplicationContext() != null ? ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(HintConstants.AUTOFILL_HINT_PHONE)).getNetworkOperator() : "";
    }

    public static String getNetworkOperatorName() {
        return ClientProperties.getApplicationContext() != null ? ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(HintConstants.AUTOFILL_HINT_PHONE)).getNetworkOperatorName() : "";
    }
