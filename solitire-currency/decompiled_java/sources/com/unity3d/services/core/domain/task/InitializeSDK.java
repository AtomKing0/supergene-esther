...
public final class InitializeSDK extends MetricTask<EmptyParams, k0> {
    ...
    public InitializeSDK(@NotNull ISDKDispatchers dispatchers, @NotNull ConfigFileFromLocalStorage configFileFromLocalStorage, @NotNull InitializeStateReset initializeStateReset, @NotNull InitializeStateError initializeStateError, @NotNull InitializeStateConfig initializeStateConfig, @NotNull InitializeStateCreate initializeStateCreate, @NotNull InitializeStateLoadCache initializeStateLoadCache, @NotNull InitializeStateLoadWeb initializeStateLoadWeb, @NotNull InitializeStateComplete initializeStateComplete) {
        ...
        t.i(configFileFromLocalStorage, "configFileFromLocalStorage");
        t.i(initializeStateReset, "initializeStateReset");
        t.i(initializeStateError, "initializeStateError");
        t.i(initializeStateConfig, "initializeStateConfig");
        t.i(initializeStateCreate, "initializeStateCreate");
        t.i(initializeStateLoadCache, "initializeStateLoadCache");
        t.i(initializeStateLoadWeb, "initializeStateLoadWeb");
        t.i(initializeStateComplete, "initializeStateComplete");
    ...
    */
    public final java.lang.Object m4004executeErrorStateBWLJW6A(com.unity3d.services.core.configuration.ErrorState r6, java.lang.Throwable r7, com.unity3d.services.core.configuration.Configuration r8, z8.d<? super v8.t<v8.k0>> r9) {
        /*
            r5 = this;
        ...
        L48:
            ...
            r2.<init>(r6, r4, r8)
            r0.label = r3
            java.lang.Object r6 = r9.mo4000invokegIAlus(r2, r0)
            if (r6 != r1) goto L57
            return r1
        L57:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.m4004executeErrorStateBWLJW6A(com.unity3d.services.core.configuration.ErrorState, java.lang.Throwable, com.unity3d.services.core.configuration.Configuration, z8.d):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object handleInitializationException(com.unity3d.services.core.domain.task.InitializationException r6, z8.d<? super v8.k0> r7) throws com.unity3d.services.core.domain.task.InitializationException {
        /*
            r5 = this;
        ...
        L3a:
            ...
            r0.L$0 = r6
            r0.label = r3
            java.lang.Object r7 = r5.m4004executeErrorStateBWLJW6A(r7, r2, r4, r0)
            if (r7 != r1) goto L54
            return r1
        L54:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.handleInitializationException(com.unity3d.services.core.domain.task.InitializationException, z8.d):java.lang.Object");
    }

    @Override // com.unity3d.services.core.domain.task.BaseTask
    /* JADX INFO: renamed from: doWork-gIAlu-s */
    public /* bridge */ /* synthetic */ Object mo3999doWorkgIAlus(BaseParams baseParams, z8.d dVar) {
        return m4005doWorkgIAlus((EmptyParams) baseParams, (z8.d<? super v8.t<k0>>) dVar);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object m4005doWorkgIAlus(@org.jetbrains.annotations.NotNull com.unity3d.services.core.domain.task.EmptyParams r5, @org.jetbrains.annotations.NotNull z8.d<? super v8.t<v8.k0>> r6) {
        /*
            r4 = this;
        ...
        L49:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.m4005doWorkgIAlus(com.unity3d.services.core.domain.task.EmptyParams, z8.d):java.lang.Object");
    }
}
