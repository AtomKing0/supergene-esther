...
public final class UnityServices {
    ...
    public static final String getVersion() {
        ...
        t.h(versionName, "getVersionName()");
        return versionName;
    }
    ...
    public static final void initialize(@Nullable Context context, @Nullable String str, boolean z10, @Nullable IUnityAdsInitializationListener iUnityAdsInitializationListener) {
        ...
        if (SdkProperties.getCurrentInitializationState() != SdkProperties.InitializationState.NOT_INITIALIZED) {
            ...
            if (zIsTestMode != z10) {
                InitializeEventsMetricSender.getInstance().sendMetric(InitMetric.newInitTestModeChanged(Boolean.valueOf(zIsTestMode), Boolean.valueOf(z10)));
                sb.append(INSTANCE.createExpectedParametersString("Test Mode", Boolean.valueOf(zIsTestMode), Boolean.valueOf(z10)));
                t.h(sb, "append(value)");
                sb.append('\n');
                t.h(sb, "append('\\n')");
            } else {
                InitializeEventsMetricSender.getInstance().sendMetric(InitMetric.newInitTestModeSame(Boolean.valueOf(zIsTestMode), Boolean.valueOf(z10)));
            }
