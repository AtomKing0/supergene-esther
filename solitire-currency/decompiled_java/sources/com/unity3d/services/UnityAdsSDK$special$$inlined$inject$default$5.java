...
public final class UnityAdsSDK$special$$inlined$inject$default$5 extends v implements a<SendDiagnosticEvent> {
    ...
    public final SendDiagnosticEvent invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(SendDiagnosticEvent.class));
    }
}
