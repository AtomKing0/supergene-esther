...
public final class UnityAdsSDK$special$$inlined$inject$default$6 extends v implements a<OmFinishSession> {
    ...
    public final OmFinishSession invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(OmFinishSession.class));
    }
}
