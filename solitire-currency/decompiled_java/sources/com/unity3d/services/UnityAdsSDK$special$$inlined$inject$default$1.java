...
public final class UnityAdsSDK$special$$inlined$inject$default$1 extends v implements a<InitializeSDK> {
    ...
    public final InitializeSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(InitializeSDK.class));
    }
}
