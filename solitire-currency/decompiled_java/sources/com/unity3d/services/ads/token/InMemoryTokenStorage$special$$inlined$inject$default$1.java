...
public final class InMemoryTokenStorage$special$$inlined$inject$default$1 extends v implements h9.a<AsyncTokenStorage> {
    ...
    public final AsyncTokenStorage invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(AsyncTokenStorage.class));
    }
}
