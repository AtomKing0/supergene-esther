...
public final class WebviewConfigurationDataSource {
    ...
    static final class AnonymousClass2 extends l implements q<i<? super WebviewConfigurationStore.WebViewConfigurationStore>, Throwable, d<? super k0>, Object> {
        ...
        @Override // h9.q
        @Nullable
        public final Object invoke(@NotNull i<? super WebviewConfigurationStore.WebViewConfigurationStore> iVar, @NotNull Throwable th, @Nullable d<? super k0> dVar) {
    ...
    static final class C31682 extends l implements p<WebviewConfigurationStore.WebViewConfigurationStore, d<? super WebviewConfigurationStore.WebViewConfigurationStore>, Object> {
        final /* synthetic */ WebviewConfigurationStore.WebViewConfigurationStore $data;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C31682(WebviewConfigurationStore.WebViewConfigurationStore webViewConfigurationStore, d<? super C31682> dVar) {
            super(2, dVar);
        ...
        public final d<k0> create(@Nullable Object obj, @NotNull d<?> dVar) {
            return new C31682(this.$data, dVar);
        }

        @Override // h9.p
        @Nullable
        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method and merged with bridge method [inline-methods] */
        public final Object mo4invoke(@NotNull WebviewConfigurationStore.WebViewConfigurationStore webViewConfigurationStore, @Nullable d<? super WebviewConfigurationStore.WebViewConfigurationStore> dVar) {
            return ((C31682) create(webViewConfigurationStore, dVar)).invokeSuspend(k0.f35197a);
        }
    ...
    public final Object get(@NotNull d<? super WebviewConfigurationStore.WebViewConfigurationStore> dVar) {
        return j.w(j.h(this.webviewConfigurationStore.getData(), new AnonymousClass2(null)), dVar);
    }

    @Nullable
    public final Object set(@NotNull WebviewConfigurationStore.WebViewConfigurationStore webViewConfigurationStore, @NotNull d<? super k0> dVar) {
        Object objUpdateData = this.webviewConfigurationStore.updateData(new C31682(webViewConfigurationStore, null), dVar);
