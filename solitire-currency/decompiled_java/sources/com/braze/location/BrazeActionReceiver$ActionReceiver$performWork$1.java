...
final class BrazeActionReceiver$ActionReceiver$performWork$1 extends v implements a<String> {
    final /* synthetic */ BrazeActionReceiver.ActionReceiver this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BrazeActionReceiver$ActionReceiver$performWork$1(BrazeActionReceiver.ActionReceiver actionReceiver) {
        super(0);
