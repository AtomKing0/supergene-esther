...
final class GooglePlayLocationUtils$registerGeofencesWithGeofencingClient$2$2 extends v implements a<String> {
    final /* synthetic */ int $statusCode;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    GooglePlayLocationUtils$registerGeofencesWithGeofencingClient$2$2(int i10) {
        super(0);
        this.$statusCode = i10;
    }
