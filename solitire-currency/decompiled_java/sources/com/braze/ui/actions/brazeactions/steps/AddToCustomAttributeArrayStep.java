...
/* JADX INFO: compiled from: AddToCustomAttributeArrayStep.kt */
...
public final class AddToCustomAttributeArrayStep extends BaseBrazeActionStep {
    ...
    /* JADX INFO: renamed from: com.braze.ui.actions.brazeactions.steps.AddToCustomAttributeArrayStep$run$1, reason: invalid class name */
    /* JADX INFO: compiled from: AddToCustomAttributeArrayStep.kt */
    ...
    public void run(@NotNull Context context, @NotNull StepData data) {
        t.i(context, "context");
        t.i(data, "data");
        BaseBrazeActionStep.Companion.runOnUser$android_sdk_ui_release(Braze.Companion.getInstance(context), new AnonymousClass1(String.valueOf(data.getFirstArg()), String.valueOf(data.getSecondArg())));
    }
}
