...
public class BundleUtils {
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            n.c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e10);
        }
        return jSONObject;
    }
    ...
    public static boolean getBoolean(String str, boolean z10, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            ...
            if (obj instanceof String) {
                ...
                if (str2.equalsIgnoreCase(com.ironsource.mediationsdk.metadata.a.f13688g) || str2.equalsIgnoreCase("1")) {
                    return true;
                }
