...
public class ArrayService extends IAppHubDirectDownloadServiceCallback.Stub {
    ...
    public ArrayService(final j jVar) {
        ...
        this.minVersionCodeWithGenericEventsSupport = ((Integer) jVar.a(l4.f5615d0)).intValue();
        ...
        jVar.e().a(new b() { // from class: com.applovin.impl.sdk.array.ArrayService.1
            ...
            public void onActivityStopped(Activity activity) {
                ...
                try {
                    ...
                    jVar.A().a(ArrayService.TAG, "dismissDirectDownloadActivity", e10, ArrayService.this.getHealthEventExtraParameters());
                }
            }
        });
    }
    ...
    public void bindAppHubService() {
        ...
        try {
            ...
            this.sdk.A().a(TAG, "bindAppHubService", th, getHealthEventExtraParameters());
        }
    }
    ...
    private Intent createAppHubServiceIntent() {
        ...
        List<ResolveInfo> listQueryIntentServices = j.n().getPackageManager().queryIntentServices(intent, 0);
    ...
    private void handleEvent(String str, Bundle bundle) {
        ...
        healthEventExtraParameters.put(TransactionInfo.JsonKeys.SOURCE, "ArrayService:handleEvent");
        healthEventExtraParameters.put("details", str2);
        this.sdk.A().d(y1.f7814w0, healthEventExtraParameters);
    }
    ...
    public void collectAppHubData() {
        if (isAppHubInstalled()) {
            ...
            if (this.isDirectDownloadEnabled == null && ((Boolean) this.sdk.a(l4.f5592a0)).booleanValue()) {
            ...
            if (TextUtils.isEmpty(this.randomUserToken) && ((Boolean) this.sdk.a(l4.f5599b0)).booleanValue()) {
    ...
    public void maybeSendAdEvent(q2 q2Var, String str) {
        ...
        if (((Boolean) this.sdk.a(l4.f5607c0)).booleanValue() && (iAppHubService = this.appHubService) != null && l3.b(q2Var)) {
            if (n.a()) {
            ...
            try {
                ...
                this.sdk.A().a(TAG, "failedToSendAdEvent", th, map);
            }
        }
    }
    ...
    public void onError(String str, String str2) {
        ...
        this.sdk.A().d(y1.f7780f0, healthEventExtraParameters);
        DirectDownloadState directDownloadState = this.currentDownloadState;
        if (directDownloadState == null) {
            return;
        }
        ...
        this.sdk.A().a(y1.f7814w0, "ArrayService:onError", healthEventExtraParameters);
    }
    ...
    public void startDirectInstallOrDownloadProcess(ArrayDirectDownloadAd arrayDirectDownloadAd, @Nullable Bundle bundle, DirectDownloadListener directDownloadListener) {
        ...
        try {
            ...
            this.sdk.A().a(TAG, "directInstallDownload", th, getHealthEventExtraParameters());
            this.currentDownloadState = null;
            directDownloadListener.onFailure();
        }
    }
