...
public final class DynamicDeviceInfoKt {
    ...
    public static final class AndroidKt {
        ...
        public static final class Dsl {
            ...
            public final NetworkCapabilityTransportsOuterClass.NetworkCapabilityTransports getNetworkCapabilityTransports() {
                ...
                t.h(networkCapabilityTransports, "_builder.getNetworkCapabilityTransports()");
    ...
    public static final class Dsl {
        ...
        public final /* synthetic */ DynamicDeviceInfoOuterClass.DynamicDeviceInfo _build() {
            ...
            t.h(dynamicDeviceInfoBuild, "_builder.build()");
        ...
        public final String getNetworkOperatorName() {
            ...
            t.h(networkOperatorName, "_builder.getNetworkOperatorName()");
        ...
        public final String getTimeZone() {
            ...
            t.h(timeZone, "_builder.getTimeZone()");
            return timeZone;
        }
    ...
    public static final class IosKt {
        ...
        public static final class Dsl {
            ...
            public final String getCurrentRadioAccessTechnology() {
                ...
                t.h(currentRadioAccessTechnology, "_builder.getCurrentRadioAccessTechnology()");
            ...
            public final String getDeviceName() {
                ...
                t.h(deviceName, "_builder.getDeviceName()");
                return deviceName;
            }
            ...
            public final DslList<String, LocaleListProxy> getLocaleList() {
                ...
                t.h(localeListList, "_builder.getLocaleListList()");
            ...
            public final DslList<String, NwPathInterfacesProxy> getNwPathInterfaces() {
                ...
                t.h(nwPathInterfacesList, "_builder.getNwPathInterfacesList()");
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Android m4164initializeandroid(@NotNull l<? super AndroidKt.Dsl, k0> block) {
        t.i(block, "block");
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Ios m4165initializeios(@NotNull l<? super IosKt.Dsl, k0> block) {
        t.i(block, "block");
