...
public final class OperativeEventRequestOuterClass {
    ...
    public static final class OperativeEventErrorData extends GeneratedMessageLite<OperativeEventErrorData, Builder> implements OperativeEventErrorDataOrBuilder {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            a aVar = null;
            switch (a.f26358a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public enum OperativeEventErrorType implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            static final Internal.EnumVerifier f26356a = new b();
    ...
    public enum OperativeEventType implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            static final Internal.EnumVerifier f26357a = new b();
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f26358a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
