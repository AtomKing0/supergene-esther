...
public class c {
    ...
    private File a() {
        if (this.f37582a == null) {
            synchronized (this) {
                if (this.f37582a == null) {
                    this.f37582a = new File(this.f37583b.j().getFilesDir(), "PersistedInstallation." + this.f37583b.n() + ".json");
                }
            }
        }
        return this.f37582a;
    ...
    public d b(@NonNull d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f37583b.j().getFilesDir());
