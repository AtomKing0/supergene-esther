...
public final class e implements p2.l {
    ...
    public static final p2.r f37044d = new p2.r() { // from class: z2.d
        @Override // p2.r
    ...
    private final f f37045a = new f();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final a4.c0 f37046b = new a4.c0(16384);
    ...
    public int a(p2.m mVar, p2.a0 a0Var) throws IOException {
        int i10 = mVar.read(this.f37046b.d(), 0, 16384);
        if (i10 == -1) {
            return -1;
        }
        this.f37046b.P(0);
        this.f37046b.O(i10);
        if (!this.f37047c) {
            this.f37045a.packetStarted(0L, 4);
            this.f37047c = true;
        }
    ...
    public void b(p2.n nVar) {
        this.f37045a.c(nVar, new i0.d(0, 1));
        nVar.endTracks();
