...
public final class f {
    ...
    @NotNull
    public static final n a(@Nullable r rVar) {
        int i10 = Build.VERSION.SDK_INT;
        return (i10 < 26 || f32a) ? new p(false) : (i10 == 26 || i10 == 27) ? new q(rVar) : new p(true);
    }
}
