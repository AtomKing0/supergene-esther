...
public final class a {
    private static final boolean a(String str) {
        ...
        while (i10 < length) {
            ...
            if (t.k(cCharAt, 31) <= 0 || t.k(cCharAt, 127) >= 0 || r.d0(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
            i10 = i11;
        }
    ...
    private static final boolean b(String str, int i10, int i11, byte[] bArr, int i12) {
        ...
        while (i10 < i11) {
            ...
            while (i14 < i11) {
                ...
                if (t.k(cCharAt, 48) < 0 || t.k(cCharAt, 57) > 0) {
                    break;
                }
    ...
    */
    private static final java.net.InetAddress c(java.lang.String r18, int r19, int r20) {
        ...
        L15:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = p9.h.J(r0, r1, r2, r3, r4, r5)
            if (r0 == 0) goto L38
            if (r14 == r11) goto L2e
            return r16
        L2e:
        ...
        La9:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ha.a.c(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static final String d(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            if (i11 == i10) {
                ...
                cVar.v0((d.d(bArr[i11], 255) << 8) | d.d(bArr[i11 + 1], 255));
                i11 += 2;
            }
        }
        return cVar.K0();
    ...
    public static final String e(@NotNull String str) {
        ...
        InetAddress inetAddressC = (q.K(str, v8.i.f15837d, false, 2, null) && q.w(str, v8.i.f15839e, false, 2, null)) ? c(str, 1, str.length() - 1) : c(str, 0, str.length());
