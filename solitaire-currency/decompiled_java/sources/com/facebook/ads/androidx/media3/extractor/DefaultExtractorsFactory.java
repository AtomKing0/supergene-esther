...
import com.facebook.ads.redexgen.core.C2747jT;
import com.facebook.ads.redexgen.core.C2751jX;
import com.facebook.ads.redexgen.core.C2758je;
import com.facebook.ads.redexgen.core.C2773jt;
import com.facebook.ads.redexgen.core.C2775jv;
import com.facebook.ads.redexgen.core.C2778jy;
import com.facebook.ads.redexgen.core.C2781k1;
import com.facebook.ads.redexgen.core.C2807kR;
import com.facebook.ads.redexgen.core.C2813kX;
import com.facebook.ads.redexgen.core.C2814kY;
import com.facebook.ads.redexgen.core.C2827kl;
import com.facebook.ads.redexgen.core.C2838l8;
import com.facebook.ads.redexgen.core.C2841lB;
import com.facebook.ads.redexgen.core.C2846lG;
import com.facebook.ads.redexgen.core.C3064or;
...
public final class DefaultExtractorsFactory implements InterfaceC1673Gb {
    ...
    public List<C3064or> A0A = MetaExoPlayerCustomizedCollections.A03(new C3064or[0]);
    public boolean A0B;
    public boolean A0C;
    ...
    private void A06(int i10, List<GX> list) {
        ...
        switch (i10) {
            case 0:
                list.add(new C2781k1());
                return;
            case 1:
                list.add(new C2778jy());
                return;
            case 2:
            ...
            case 4:
                ...
                if (flacExtractor != null) {
                    ...
                    list.add(new C2841lB(this.A02));
                    return;
                }
            case 5:
                list.add(new C2838l8());
                return;
            case 6:
            ...
            case 7:
                ...
                list.add(new C2827kl(i11 | i14));
                return;
            case 8:
                list.add(new C2813kX().A01(this.A03));
                list.add(new C2814kY(this.A06));
                return;
            case 9:
                list.add(new C2807kR());
                return;
            case 10:
                list.add(new C2758je());
                return;
            case 11:
                list.add(new C2751jX(this.A08, new C4R(0L), new C2773jt(this.A07, this.A0A), this.A09));
                return;
            case 12:
                list.add(new C2747jT());
                return;
            case 13:
            case 14:
            default:
