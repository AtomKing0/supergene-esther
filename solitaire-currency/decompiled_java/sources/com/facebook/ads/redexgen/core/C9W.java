...
public final class C9W implements Handler.Callback, InterfaceC2913mN, EJ, CK, InterfaceC14155n, InterfaceC14536z {
    ...
    public boolean A0U;
    public boolean A0V;
    public InterfaceC2974nM[] A0W;
    public final long A0Y;
    public final long A0Z;
    public final Handler A0a;
    public final HandlerThread A0b;
    public final C3035oN A0c;
    public final C3033oL A0d;
    public final C3T A0e;
    public final InterfaceC13713v A0f;
    public final C2982nU A0g;
    public final C6A A0h;
    public final C6S A0i;
    public final C2968nG A0k;
    public final EK A0l;
    public final EL A0m;
    public final EU A0n;
    ...
    public final C14306c A0j = new C14306c();
    ...
    */
    ...
    private void A0f(C6B c6b) throws Throwable {
        ...
        if (pairA09 == null) {
            ...
            c2911mLA0K = this.A0j.A0K(this.A0A.A03, obj, jLongValue);
            if (c2911mLA0K.A00()) {
                jLongValue2 = 0;
                z10 = true;
            } else {
                ...
                if (this.A0D == null || this.A02 > 0) {
                    ...
                    try {
                        if (jLongValue2 == C.TIME_UNSET) {
                            ...
                            if (c2911mLA0K.equals(this.A0A.A05)) {
                                C6Y c6yA0F = this.A0j.A0F();
                                if (c6yA0F != null && jA6j != 0) {
                                    jA6j = c6yA0F.A07.A6j(jA6j, this.A0C);
                                }
                                if (AbstractC13221w.A01(jA6j) == AbstractC13221w.A01(this.A0A.A0C)) {
                                    this.A0A = this.A0A.A06(c2911mLA0K, this.A0A.A0C, jLongValue, A01());
                                    if (z10) {
                                        this.A0h.A04(2);
                                        return;
                                    }
                            ...
                            long jA06 = A06(c2911mLA0K, jA6j);
                            z10 |= jLongValue2 != jA06;
                            jLongValue2 = jA06;
                        }
                    } catch (Throwable th) {
                        th = th;
                        this.A0A = this.A0A.A06(c2911mLA0K, jLongValue2, jLongValue, A01());
                        if (z10) {
                            this.A0h.A04(2);
                        }
                        throw th;
    ...
    public C9W(InterfaceC2974nM[] interfaceC2974nMArr, EK ek, EL el, C6S c6s, EU eu, boolean z10, int i10, boolean z11, Handler handler, C3T c3t, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, long j10, boolean z18, int i11, boolean z19, boolean z20, boolean z21, boolean z22, boolean z23, boolean z24, C14667m c14667m) {
        this.A0v = interfaceC2974nMArr;
        this.A0l = ek;
        this.A0m = el;
        this.A0i = c6s;
        this.A0n = eu;
        ...
        this.A0t = z24;
        this.A0N = j10 > 0;
        this.A0Y = c6s.A6s(c14667m);
        this.A0r = c6s.AI3(c14667m);
        this.A0C = C7I.A03;
        this.A0A = new C14516x(Timeline.A02, C.TIME_UNSET, C2901mA.A06, el);
        this.A0h = new C6A();
        this.A0w = new C7D[interfaceC2974nMArr.length];
        for (int i12 = 0; i12 < interfaceC2974nMArr.length; i12++) {
            interfaceC2974nMArr[i12].AA1(i12, c14667m);
            this.A0w[i12] = interfaceC2974nMArr[i12].A75();
        }
        this.A0g = new C2982nU(this, c3t);
        this.A0k = new C2968nG(c3t);
        this.A0o = z20 ? new AnonymousClass91(c3t) : null;
        this.A0p = new ArrayList<>();
        this.A0W = new InterfaceC2974nM[0];
        this.A0d = new C3033oL();
        this.A0c = new C3035oN();
        ek.A02(this, eu);
    ...
    @MetaExoPlayerCustomization
    private int A00() {
        int exoplayerThreadPollingIntervalMs = MetaExoPlayerUpgradeConfig.A00(EnumC2664i3.A04);
    ...
    private final long A05(C6Y c6y) {
        ...
        InterfaceC1585Cr[] interfaceC1585CrArr = c6y.A09;
        for (int i10 = 0; i10 < interfaceC1585CrArr.length; i10++) {
            if (interfaceC1585CrArr[i10] instanceof InterfaceC1586Cs) {
                long periodStartPositionUs = ((InterfaceC1586Cs) interfaceC1585CrArr[i10]).A81();
    ...
    private long A06(C2911mL c2911mL, long j10) throws C9Y {
        return A07(false, c2911mL, j10, this.A0j.A0F() != this.A0j.A0G());
    }

    private long A07(boolean z10, C2911mL c2911mL, long j10, boolean z11) throws C9Y {
        A0O();
        this.A0R = false;
        A0V(2);
        C6Y c6yA0F = this.A0j.A0F();
        ...
        if (c6yA0F != c6yA0B || z11) {
            for (InterfaceC2974nM interfaceC2974nM : this.A0W) {
                A0l(interfaceC2974nM);
            }
            this.A0W = new InterfaceC2974nM[0];
            if (A0y[1].length() == 31) {
                throw new RuntimeException();
            ...
            if (elA0L != null) {
                if (z11) {
                    ...
                    for (int i11 = 0; i11 < this.A0v.length; i11++) {
                        InterfaceC2974nM interfaceC2974nM = this.A0v[i11];
                        zArr2[i11] = interfaceC2974nM.A92() != 0;
                        InterfaceC1585Cr interfaceC1585Cr = c6yA0F2.A09[i11];
                        if (interfaceC1585Cr != null) {
                            i10++;
                        }
                        if (zArr2[i11]) {
                            InterfaceC1585Cr interfaceC1585CrA95 = interfaceC2974nM.A95();
                            if (A0y[7].charAt(12) == '2') {
                                throw new RuntimeException();
                            }
                            A0y[1] = "PyyQ9suxdi7C";
                            if (interfaceC1585Cr != interfaceC1585CrA95) {
                                A0l(interfaceC2974nM);
                            } else if (zArr[i11]) {
                                interfaceC2974nM.AI2(this.A06);
                            }
                        }
                    }
    ...
    private void A0Q() throws C9Y {
        ...
        if (jAGg != C.TIME_UNSET) {
            ...
            C2982nU c2982nU = this.A0g;
            C6Y playingPeriodHolder = this.A0j.A0G();
            this.A06 = c2982nU.A04(c6yA0F != playingPeriodHolder);
    ...
    private void A0T(float f10) {
        for (C6Y c6yA0D = this.A0j.A0D(); c6yA0D != null && c6yA0D.A02; c6yA0D = c6yA0D.A0I()) {
            for (InterfaceC2874lj interfaceC2874lj : c6yA0D.A0K().A04) {
                if (interfaceC2874lj != null) {
                    interfaceC2874lj.AEc(f10);
                }
            }
        }
    }
    ...
    private void A0W(int i10, boolean z10) {
        if (this.A0A.A00 != i10) {
            C14516x c14516xA03 = this.A0A.A03(i10, z10);
            if (A0y[1].length() == 31) {
                throw new RuntimeException();
            }
            A0y[1] = "pTubBuiOOGTe";
    ...
    private void A0X(int i10, boolean playing, int i11) throws C9Y {
        C6Y c6yA0F = this.A0j.A0F();
        InterfaceC2974nM interfaceC2974nM = this.A0v[i10];
        this.A0W[i11] = interfaceC2974nM;
        if (interfaceC2974nM.A92() == 0) {
            ...
            C3064or[] c3064orArrA1A = A1A(c6yA0F.A0K().A04[i10]);
            boolean z11 = this.A0P && this.A0A.A00 == 3;
            interfaceC2974nM.A6D(c7g, c3064orArrA1A, c6yA0F.A09[i10], this.A06, !playing && z11, z10, c6yA0G.A0H(this.A0K), c6yA0F.A0B());
            this.A0g.A09(interfaceC2974nM);
            if (z11) {
                interfaceC2974nM.start();
            }
        }
    ...
    */
    ...
    private void A0b(C3048ob c3048ob) {
        this.A0g.AIt(c3048ob);
        if (this.A0o != null) {
            this.A0o.AIt(c3048ob);
        }
        if (this.A0k != null) {
            this.A0k.AIt(c3048ob);
        }
    }
    ...
    */
    ...
    private void A0l(InterfaceC2974nM interfaceC2974nM) throws C9Y {
        this.A0g.A08(interfaceC2974nM);
        A0m(interfaceC2974nM);
        interfaceC2974nM.A5p();
    }

    private void A0m(InterfaceC2974nM interfaceC2974nM) throws C9Y {
        if (interfaceC2974nM.A92() == 2) {
            interfaceC2974nM.stop();
        }
    }
    ...
    private void A0o(InterfaceC2912mM interfaceC2912mM) {
        if (!this.A0j.A0T(interfaceC2912mM)) {
            return;
        }
        this.A0j.A0L(this.A06);
        A0w(false);
    ...
    private void A0p(InterfaceC2912mM interfaceC2912mM) throws C9Y {
        byte b10;
        if (!this.A0j.A0T(interfaceC2912mM)) {
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1588Cu
    /* JADX INFO: renamed from: A0q, reason: merged with bridge method [inline-methods] */
    public final void ACs(InterfaceC2912mM interfaceC2912mM) {
        this.A0f.ACA(10, interfaceC2912mM).A02();
    }

    private void A0r(CL cl, boolean z10, boolean z11) {
        this.A02++;
        A13(true, z10, z11);
        this.A0i.AEj(C14667m.A03);
        this.A0D = cl;
        A0V(2);
        cl.AGN(this, null);
        this.A0f.AIQ(2);
    ...
    private void A0s(C2901mA c2901mA, EL el) {
        this.A0i.AFV(new C6R(C14667m.A03, this.A0A.A03, this.A0A.A04, this.A0A.A0C, A01(), this.A0g.A8e().A01, this.A0P, this.A0R, C.TIME_UNSET, this.A04), c2901mA, el.A04);
    }

    @MetaExoPlayerCustomization("D18870411: Adding start stall debug reason")
    private void A0t(EnumC2640hX enumC2640hX, boolean z10) {
        if (this.A0A.A00 != 3) {
            this.A0A = this.A0A.A02(3, enumC2640hX, z10);
            this.A04 = -1L;
        }
    }
    ...
    private void A0v(boolean z10) {
        ...
        if (c6yA0E == null) {
            ...
            c2911mL = c6yA0E.A00.A04;
        }
        C2911mL loadingMediaPeriodId = this.A0A.A04;
        boolean loadingMediaPeriodChanged = !loadingMediaPeriodId.equals(c2911mL);
        if (loadingMediaPeriodChanged) {
            this.A0A = this.A0A.A05(c2911mL);
        }
    ...
    private void A0w(boolean z10) {
        ...
        Timeline timeline = this.A0A.A03;
        C2911mL c2911mL = c6yA0E.A00.A04;
        float f10 = this.A0g.A8e().A01;
        boolean z11 = this.A0P || z10;
        boolean z12 = this.A0R;
        long nextLoadPositionUs2 = this.A04;
        boolean zAJB = this.A0i.AJB(new C6R(null, timeline, c2911mL, jA0D, jA0C, f10, z11, z12, C.TIME_UNSET, nextLoadPositionUs2));
        if (this.A0T && this.A0P && this.A0R && !zAJB && this.A0A.A00 == 2) {
            ...
            this.A0a.obtainMessage(5, AbstractC13764a.A0n(A0D(125, 70, 5), lValueOf, lValueOf2, lValueOf3)).sendToTarget();
            this.A0T = false;
        }
        A0y(zAJB);
        if (zAJB) {
    ...
    private void A0x(boolean z10) throws C9Y {
        C2911mL c2911mL = this.A0j.A0F().A00.A04;
        long jA07 = A07(false, c2911mL, this.A0A.A0C, true);
        if (jA07 != this.A0A.A0C) {
            this.A0A = this.A0A.A06(c2911mL, jA07, this.A0A.A01, A01());
            if (z10) {
                C6A c6a = this.A0h;
                String[] strArr = A0y;
                if (strArr[4].charAt(1) == strArr[3].charAt(1)) {
    ...
    private void A13(boolean z10, boolean z11, boolean z12) {
        ...
        C2911mL c2911mLA0A = z11 ? A0A() : this.A0A.A05;
        ...
        if (z12) {
            ...
            C14516x c14516x3 = this.A0A;
            if (A0y[7].charAt(12) == '2') {
                throw new RuntimeException();
            }
            A0y[5] = "yizxhFEcEwEbIh7DB6ScCbr86G64zHmf";
            c2901mA = c14516x3.A06;
        }
        if (z12) {
            el = this.A0m;
        } else {
        ...
        this.A0A = new C14516x(timeline, c2911mLA0A, j10, j11, i10, false, c2901mA, el, c2911mLA0A, j10, 0L, j10);
    ...
    */
    private void A14(boolean[] r6, int r7) throws com.facebook.ads.redexgen.core.C9Y {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.nM[] r0 = new com.facebook.ads.redexgen.core.InterfaceC2974nM[r7]
            r5.A0W = r0
            r4 = 0
    ...
    private boolean A16(AnonymousClass69 anonymousClass69) {
        if (anonymousClass69.A02 == null) {
            Pair<Object, Long> pairA09 = A09(new C6B(anonymousClass69.A03.A04(), anonymousClass69.A03.A00(), AbstractC13221w.A00(anonymousClass69.A03.A02())), false);
            if (pairA09 == null) {
                return false;
            }
    ...
    private boolean A17(InterfaceC2974nM interfaceC2974nM) {
        C6Y c6yA0G = this.A0j.A0G();
        C6Y readingPeriodHolder = c6yA0G.A0I();
        if (readingPeriodHolder != null) {
            C6Y readingPeriodHolder2 = c6yA0G.A0I();
            if (readingPeriodHolder2.A02 && interfaceC2974nM.A9h()) {
                return true;
            }
        }
        return false;
    ...
    private boolean A18(C2911mL c2911mL, long j10, C6Y c6y) {
        if (!c2911mL.equals(c6y.A00.A04)) {
            return false;
        }
        boolean z10 = c6y.A02;
        if (A0y[1].length() == 31) {
    ...
    */
    private boolean A19(boolean r19) {
        ...
        La6:
            if (r9 != 0) goto Lac
            com.facebook.ads.redexgen.X.hX r0 = com.facebook.ads.redexgen.core.EnumC2640hX.A04
            r3.A0E = r0
        Lac:
            return r9
        Lad:
    ...
    public static C3064or[] A1A(EE ee) {
        int length = ee != null ? ee.length() : 0;
        C3064or[] c3064orArr = new C3064or[length];
        for (int i10 = 0; i10 < length; i10++) {
            c3064orArr[i10] = ee.A83(i10);
        }
        return c3064orArr;
    }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC14155n
    public final void AEb(C3048ob c3048ob) {
        this.A0a.obtainMessage(1, c3048ob).sendToTarget();
        A0T(c3048ob.A01);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2913mN
    public final void AEk(InterfaceC2912mM interfaceC2912mM) {
        this.A0f.ACA(9, interfaceC2912mM).A02();
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC14536z
    ...
    public final boolean handleMessage(Message message) throws Throwable {
        ...
        switch (message.what) {
            ...
            case 8:
                ...
                return true;
            case 9:
                A0p((InterfaceC2912mM) message.obj);
                A0H();
                return true;
            case 10:
                A0o((InterfaceC2912mM) message.obj);
                A0H();
                return true;
            case 11:
                A0L();
