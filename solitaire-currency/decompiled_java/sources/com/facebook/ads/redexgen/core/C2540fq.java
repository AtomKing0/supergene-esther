...
public final class C2540fq extends MQ {
    ...
    public C2540fq(C1953Qz c1953Qz) {
        this.A02 = c1953Qz.A09();
        this.A01 = c1953Qz;
    }
    ...
    public final void A0C() {
        this.A02.A0F().A4M();
        AbstractC2065Vk.A00(new C2542fs(this));
    }

    @Override // com.facebook.ads.redexgen.core.MQ
    public final void A0D() {
        this.A02.A0F().A4P();
        AbstractC2065Vk.A00(new C2541fr(this));
    }
    ...
    public final void A0E(View view) {
        if (view != null) {
            ...
            if ((this.A00 instanceof C1783Ki) || (this.A00 instanceof Y9)) {
            ...
            AbstractC2065Vk.A00(new C2543ft(this));
            this.A01.A0B(this.A01.A07(), this.A00);
            if (U7.A1B(this.A01.A07().getContext())) {
                C2169Zm c2169Zm = new C2169Zm();
                this.A01.A0D(c2169Zm);
                c2169Zm.A0C(this.A01.getPlacementId());
                c2169Zm.A0B(this.A01.A07().getContext().getPackageName());
                if (this.A01.A08() != null && this.A01.A08().A0J() != null) {
                    c2169Zm.A09(this.A01.A08().A0J().A0C());
                }
                if (this.A00 instanceof C1783Ki) {
                    c2169Zm.A0A(((C1783Ki) this.A00).getViewabilityChecker());
                }
                this.A00.setOnLongClickListener(new R7(this, c2169Zm));
                this.A00.getOverlay().add(c2169Zm);
                return;
            }
            return;
        }
    ...
    public final void A0G(V1 v12) {
        ...
        AbstractC2065Vk.A00(new C2544fu(this, v12));
    }
}
