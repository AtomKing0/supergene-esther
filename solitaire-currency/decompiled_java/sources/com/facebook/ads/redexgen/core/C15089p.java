...
public final class C15089p extends AbstractC3042oU {
    ...
    public static final C1R<C15089p> A04;
    ...
    static {
        A03();
        A05 = AbstractC13764a.A0h(1);
        A06 = AbstractC13764a.A0h(2);
        A04 = new C1R() { // from class: com.facebook.ads.redexgen.X.oT
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return C15089p.A00(bundle);
            }
        };
    }

    public C15089p(int i10) {
        C3M.A09(i10 > 0, A02(0, 35, 26));
        this.A01 = i10;
        this.A00 = -1.0f;
    }

    public C15089p(int i10, float f10) {
        C3M.A09(i10 > 0, A02(0, 35, 26));
    ...
    public static C15089p A00(Bundle bundle) {
        C3M.A07(bundle.getInt(AbstractC3042oU.A02, -1) == 2);
        int i10 = bundle.getInt(A05, 5);
        float starRating = bundle.getFloat(A06, -1.0f);
        if (starRating == -1.0f) {
            return new C15089p(i10);
        }
        return new C15089p(i10, starRating);
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof C15089p)) {
            return false;
        }
        C15089p c15089p = (C15089p) obj;
        return this.A01 == c15089p.A01 && this.A00 == c15089p.A00;
    }
