...
public class C3100pi {
    ...
    public final Map<String, C3111pu> A00;
    public final Set<C3111pu> A01;
    ...
    public Collection<C3111pu> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C3111pu> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C3111pu> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C3111pu c3111pu) {
        if (this.A01.add(c3111pu)) {
            this.A00.remove(c3111pu.A02);
            return true;
        }
        return false;
    }
