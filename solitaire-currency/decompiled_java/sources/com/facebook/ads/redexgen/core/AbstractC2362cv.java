...
public abstract class AbstractC2362cv {
    ...
    public static BitmapDrawable A00(C2387dL c2387dL, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c2387dL, overlayBm))) {
                ...
                Resources resources = c2387dL.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c2387dL, A02(0, 23, 41));
                    }
                } else {
                    A04(c2387dL, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c2387dL.A08().AAy(A02(59, 3, 58), AbstractC2000Sv.A1u, new C2001Sw(th));
            return null;
        }
    }

    public static C2363cw A01(C2387dL c2387dL, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c2387dL, str)) == null) {
                return null;
            }
            C2363cw c2363cw = new C2363cw(c2387dL);
            c2363cw.setBackground(bitmapDrawableA00);
            c2363cw.setClickable(false);
            c2363cw.setFocusable(false);
            return c2363cw;
        } catch (Throwable th) {
            c2387dL.A08().AAy(A02(59, 3, 58), AbstractC2000Sv.A1u, new C2001Sw(th));
            return null;
    ...
    public static void A04(C2387dL c2387dL, String str) {
        c2387dL.A08().AAy(A02(59, 3, 58), AbstractC2000Sv.A1u, new C2001Sw(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.core.C2387dL r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC2362cv.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2362cv.A05(com.facebook.ads.redexgen.X.dL, android.graphics.Bitmap):boolean");
    }
}
