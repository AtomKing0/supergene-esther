...
public abstract class C3U {
    ...
    public static String A03(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        StringBuilder sb = new StringBuilder(AbstractC13764a.A0n(A02(25, 17, 35), A03[i10], Integer.valueOf(i11), Integer.valueOf(i12), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i13)));
