...
public final class XH {
    ...
    private EnumC2095Wq A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC2095Wq.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC2095Wq enumC2095Wq = EnumC2095Wq.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC2095Wq.A02);
            if (tag == null) {
                return EnumC2095Wq.A0I;
            }
            if (!(tag instanceof EnumC2095Wq)) {
                EnumC2095Wq enumC2095Wq2 = EnumC2095Wq.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC2095Wq2;
                }
            } else {
                return (EnumC2095Wq) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final void A06(C2387dL c2387dL, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c2387dL.A0F().AK0();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            case 0:
                this.A04 = (int) (iArr[0] / AbstractC2090Wl.A02);
                this.A05 = (int) (iArr[1] / AbstractC2090Wl.A02);
                this.A06 = (int) (view.getWidth() / AbstractC2090Wl.A02);
                this.A03 = (int) (view.getHeight() / AbstractC2090Wl.A02);
                this.A09 = 1;
                this.A0E = System.currentTimeMillis();
                this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC2090Wl.A02);
                int touchStartYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A0B = (int) (touchStartYInPx / AbstractC2090Wl.A02);
            ...
            case 3:
                ...
                this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC2090Wl.A02);
                int touchEndYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A08 = (int) (touchEndYInPx / AbstractC2090Wl.A02);
                this.A0F = view2;
                return;
            case 2:
