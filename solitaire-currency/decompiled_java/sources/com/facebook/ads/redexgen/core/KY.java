...
public final class KY {
    ...
    private int A00(InterfaceC2853lN interfaceC2853lN) {
        this.A07.A0i(AbstractC13764a.A07);
        this.A03 = true;
        interfaceC2853lN.AI1();
        return 0;
    }

    private int A01(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt, int i10) throws IOException {
        int iMin = (int) Math.min(this.A06, interfaceC2853lN.A8G());
        ...
        this.A07.A0d(iMin);
        interfaceC2853lN.AI1();
        interfaceC2853lN.AG9(this.A07.A0l(), 0, iMin);
        this.A01 = A03(this.A07, i10);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt, int i10) throws IOException {
        long inputLength = interfaceC2853lN.A8G();
        int iMin = (int) Math.min(this.A06, inputLength);
        long inputLength2 = inputLength - ((long) iMin);
        if (interfaceC2853lN.A8f() != inputLength2) {
            c1691Gt.A00 = inputLength2;
            return 1;
        }
        this.A07.A0d(iMin);
        interfaceC2853lN.AI1();
    ...
    private long A03(C4J c4j, int i10) {
        ...
        for (int iA09 = c4j.A09(); iA09 < iA0A; iA09++) {
            ...
            if (searchEndPosition == 71) {
                long jA01 = AbstractC1781Kg.A01(c4j, iA09, i10);
    ...
    private long A04(C4J c4j, int i10) {
        ...
        for (int i11 = iA0A - 188; i11 >= iA09; i11--) {
            if (AbstractC1781Kg.A03(c4j.A0l(), iA09, iA0A, i11)) {
                long jA01 = AbstractC1781Kg.A01(c4j, i11, i10);
                if (jA01 != C.TIME_UNSET) {
                    return jA01;
                }
            }
    ...
    public final int A07(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt, int i10) throws IOException {
        if (i10 <= 0) {
            return A00(interfaceC2853lN);
        }
        if (!this.A05) {
            return A02(interfaceC2853lN, c1691Gt, i10);
        }
        if (this.A02 == C.TIME_UNSET) {
            return A00(interfaceC2853lN);
        }
        if (!this.A04) {
            int iA01 = A01(interfaceC2853lN, c1691Gt, i10);
            if (A0A[0].charAt(2) == 'O') {
