...
public abstract class AbstractC1688Gq {
     ...
     */
    public static C1685Gn A06(byte[] bArr, int i10, int i11) {
        C1690Gs c1690Gs = new C1690Gs(bArr, i10, i11);
        int iA00 = -1;
        int i12 = -1;
        int iA01 = -1;
        c1690Gs.A07(4);
        int iA05 = c1690Gs.A05(3);
        c1690Gs.A06();
        int iA052 = c1690Gs.A05(2);
        boolean zA0A = c1690Gs.A0A();
        int iA053 = c1690Gs.A05(5);
        int i13 = 0;
        int i14 = 0;
        while (true) {
            if (A02[0].length() == 10) {
            ...
            if (i14 < 32) {
                ...
                for (int i15 = 0; i15 < iArr.length; i15++) {
                    iArr[i15] = c1690Gs.A05(8);
                }
                int iA054 = c1690Gs.A05(8);
                int i16 = 0;
                ...
                c1690Gs.A07(i16);
                if (iA05 > 0) {
                    c1690Gs.A07((8 - iA05) * 2);
                }
                int iA04 = c1690Gs.A04();
                int iA042 = c1690Gs.A04();
                if (iA042 == 3) {
                    c1690Gs.A06();
                }
                int iA043 = c1690Gs.A04();
                int iA044 = c1690Gs.A04();
                if (c1690Gs.A0A()) {
                    int iA045 = c1690Gs.A04();
                    int iA046 = c1690Gs.A04();
                    int iA047 = c1690Gs.A04();
                    int iA048 = c1690Gs.A04();
                ...
                c1690Gs.A04();
                c1690Gs.A04();
                int iA049 = c1690Gs.A04();
                for (int i19 = c1690Gs.A0A() ? 0 : iA05; i19 <= iA05; i19++) {
                    c1690Gs.A04();
                    c1690Gs.A04();
                    c1690Gs.A04();
                }
                ...
                A0E(c1690Gs);
                if (c1690Gs.A0A()) {
                    for (int i20 = 0; i20 < c1690Gs.A04(); i20++) {
                        c1690Gs.A07(iA049 + 4 + 1);
                    }
                }
                c1690Gs.A07(2);
                float f10 = 1.0f;
                boolean zA0A2 = c1690Gs.A0A();
                if (A02[0].length() != 10) {
                    String[] strArr3 = A02;
                    ...
                    if (zA0A2) {
                        if (c1690Gs.A0A()) {
                            int iA055 = c1690Gs.A05(8);
                            if (iA055 == 255) {
                                int iA056 = c1690Gs.A05(16);
                                int iA057 = c1690Gs.A05(16);
                                if (iA056 != 0 && iA057 != 0) {
                                    f10 = iA056 / iA057;
                                }
                        ...
                        if (c1690Gs.A0A()) {
                            c1690Gs.A07(3);
                            boolean zA0A3 = c1690Gs.A0A();
                            if (c1690Gs.A0A()) {
                                int iA058 = c1690Gs.A05(8);
                                int iA059 = c1690Gs.A05(8);
                                c1690Gs.A07(8);
                    ...
                    return new C1685Gn(iA052, zA0A, iA053, i13, iArr, iA054, iA04, iA043, iA044, f10, iA00, i12, iA01);
                }
            }
        }
    ...
    */
    public static com.facebook.ads.redexgen.core.C1687Gp A0A(byte[] r23, int r24, int r25) {
        /*
            Method dump skipped, instruction units count: 485
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1688Gq.A0A(byte[], int, int):com.facebook.ads.redexgen.X.Gp");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0E(com.facebook.ads.redexgen.core.C1690Gs r18) {
        /*
            Method dump skipped, instruction units count: 442
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1688Gq.A0E(com.facebook.ads.redexgen.X.Gs):void");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L19:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1688Gq.A03(byte[], int, int):int");
    }
    ...
    */
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1688Gq.A04(byte[], int, int, boolean[]):int");
    }

    public static C1685Gn A05(byte[] bArr, int i10, int i11) {
        return A06(bArr, i10 + 2, i11);
    }

    public static C1686Go A07(byte[] bArr, int i10, int i11) {
        return A08(bArr, i10 + 1, i11);
    }

    public static C1686Go A08(byte[] bArr, int i10, int i11) {
        C1690Gs data = new C1690Gs(bArr, i10, i11);
        int iA04 = data.A04();
        int seqParameterSetId = data.A04();
        data.A06();
        return new C1686Go(iA04, seqParameterSetId, data.A0A());
    }

    public static C1687Gp A09(byte[] bArr, int i10, int i11) {
        return A0A(bArr, i10 + 1, i11);
    }

    public static void A0D(C1690Gs c1690Gs) {
    ...
    public static void A0F(C1690Gs c1690Gs, int i10) {
        int i11 = 8;
        int lastScale = 8;
        for (int nextScale = 0; nextScale < i10; nextScale++) {
            if (lastScale != 0) {
                int lastScale2 = c1690Gs.A03();
    ...
    */
    public static void A0G(java.nio.ByteBuffer r6) {
        ...
        L3f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1688Gq.A0G(java.nio.ByteBuffer):void");
    }
