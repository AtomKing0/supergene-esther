...
public final class M4 {
    ...
    public final TreeSet<C2710iq> A04;
    ...
    public M4(int i10, String str) {
        this(i10, str, C2712is.A03);
    }

    public M4(int i10, String str, C2712is c2712is) {
        this.A01 = i10;
        this.A02 = str;
        this.A00 = c2712is;
    ...
    public final long A02(long j10, long j11) {
        ...
        C3M.A07(z10);
        C2710iq c2710iqA04 = A04(j10, j11);
        if (c2710iqA04.A03()) {
            return -Math.min(c2710iqA04.A04() ? Long.MAX_VALUE : c2710iqA04.A01, j11);
        }
        long j12 = j10 + j11;
        if (j12 < 0) {
            j12 = Long.MAX_VALUE;
        }
        long currentEndPosition = c2710iqA04.A02 + c2710iqA04.A01;
        if (currentEndPosition < j12) {
            TreeSet<C2710iq> treeSet = this.A04;
            String[] strArr = A06;
            ...
            for (C2710iq c2710iq : treeSet.tailSet(c2710iqA04, false)) {
                if (c2710iq.A02 > currentEndPosition) {
                    break;
                }
                long j13 = c2710iq.A02;
                long queryEndPosition = c2710iq.A01;
    ...
    public final C2712is A03() {
        return this.A00;
    }

    public final C2710iq A04(long j10, long j11) {
        C2710iq c2710iqA03 = C2710iq.A03(this.A02, j10);
        C2710iq c2710iqFloor = this.A04.floor(c2710iqA03);
        if (c2710iqFloor != null && c2710iqFloor.A02 + c2710iqFloor.A01 > j10) {
            return c2710iqFloor;
        }
        C2710iq lookupSpan = this.A04.ceiling(c2710iqA03);
        if (lookupSpan != null) {
        ...
        return C2710iq.A04(this.A02, j10, j11);
    }

    public final C2710iq A05(C2710iq c2710iq, long j10, boolean z10) {
        C3M.A08(this.A04.remove(c2710iq));
        File file = (File) C3M.A01(c2710iq.A03);
        if (z10) {
            File file2 = file.getParentFile();
            File fileA05 = C2710iq.A05((File) C3M.A01(file2), this.A01, c2710iq.A02, j10);
        ...
        C2710iq newCacheSpan = c2710iq.A09(file, j10);
        this.A04.add(newCacheSpan);
        return newCacheSpan;
    }

    public final TreeSet<C2710iq> A06() {
        return this.A04;
    }
    ...
    */
    ...
    public final void A08(C2710iq c2710iq) {
        this.A04.add(c2710iq);
    }
    ...
    */
    ...
    public final boolean A0D(C1824Lx c1824Lx) {
        if (this.A04.remove(c1824Lx)) {
            if (c1824Lx.A03 != null) {
                c1824Lx.A03.delete();
                return true;
            }
    ...
    public final boolean A0E(M9 m92) {
        C2712is c2712is = this.A00;
        C2712is oldMetadata = this.A00;
        this.A00 = oldMetadata.A05(m92);
        C2712is oldMetadata2 = this.A00;
        return !oldMetadata2.equals(c2712is);
    }
