...
public abstract class AbstractC1973Rt {
    ...
    public static C1972Rs A00(ContentResolver contentResolver) {
        ...
        try {
            ...
            if (c10 == null || !c10.moveToFirst()) {
                return new C1972Rs(null, null, false);
            }
            String string = c10.getString(c10.getColumnIndex(strA013));
            String attributionId = c10.getString(c10.getColumnIndex(strA012));
            C1972Rs c1972Rs = new C1972Rs(string, attributionId, Boolean.valueOf(c10.getString(c10.getColumnIndex(strA01))).booleanValue());
            if (c10 != null) {
                c10.close();
            }
            return c1972Rs;
