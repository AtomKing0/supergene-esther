...
public final class C9H implements InterfaceC2919mT {
    ...
    public boolean A00;
    public final InterfaceC13884m A01;
    ...
    public static String A05(String str) {
        ...
        if (A04(604, 3, 104).equals(str)) {
            return A04(IronSourceConstants.SDK_INIT_FAILED, 21, 32);
        }
    ...
    private List<B8> A08(SQLiteDatabase sQLiteDatabase) {
        ...
        if (!AbstractC13764a.A19(sQLiteDatabase, this.A04)) {
            return arrayList;
        }
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : AbstractC13764a.A1O(str, A04(412, 1, 1))) {
            String[] strArrA1O = AbstractC13764a.A1O(str2, A04(466, 2, 2));
    ...
    private void A0A() throws C13874l {
        synchronized (this.A02) {
            ...
            try {
                ...
                int iA00 = AbstractC13904o.A00(readableDatabase, 0, this.A03);
                if (iA00 != 3) {
                    SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
                    writableDatabase.beginTransactionNonExclusive();
                    try {
                        AbstractC13904o.A04(writableDatabase, 0, this.A03, 3);
    ...
    private void A0C(B8 b82, SQLiteDatabase sQLiteDatabase) {
        byte[] bArr = b82.A07.A06 == null ? AbstractC13764a.A07 : b82.A07.A06;
    ...
    public final B8 A7i(String str) throws C13874l {
        A0A();
        try {
    ...
    @Override // com.facebook.ads.redexgen.core.BL
    public final C2929md A7j(int... iArr) throws C13874l {
        A0A();
        return new C2929md(A00(A07(iArr), null));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AGV(B8 b82) throws C13874l {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AHh(String str) throws C13874l {
        A0A();
        try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AIe() throws C13874l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AJ5() throws C13874l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AJ6(int i10) throws C13874l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2919mT
    public final void AJ7(String str, int i10) throws C13874l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i10));
