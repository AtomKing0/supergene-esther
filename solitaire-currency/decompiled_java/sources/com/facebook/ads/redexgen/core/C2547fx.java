...
public final class C2547fx extends R8 implements AdOptionsViewApi {
    ...
    static {
        A02();
        A08 = (int) (AbstractC2090Wl.A02 * 23.0f);
        A09 = (int) (AbstractC2090Wl.A02 * 4.0f);
    }

    public C2547fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        this.A02 = false;
        this.A01 = false;
        this.A00 = false;
        ...
        C1930Qc c1930QcA0L = C1930Qc.A0L(nativeAdBase.getInternalNativeAd());
        c1930QcA0L.A1V(nativeAdLayout);
        c1930QcA0L.A1X(this);
        C2683iN c2683iNA0z = c1930QcA0L.A0z();
        if (c2683iNA0z != null && c2683iNA0z.A0R() && !c2683iNA0z.A0P()) {
            linearLayout.setVisibility(8);
        } else {
            linearLayout.setOnClickListener(new ViewOnClickListenerC1951Qx(this, c1930QcA0L, context, linearLayout));
            EnumC2095Wq.A04(this.A05, EnumC2095Wq.A0C);
        }
    }

    public C2547fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public final void setIconSizeDp(int i10) {
        int iconSize = Math.max(A08, (int) (AbstractC2090Wl.A02 * i10));
