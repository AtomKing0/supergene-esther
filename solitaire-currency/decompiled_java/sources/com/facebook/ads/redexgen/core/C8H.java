...
public final class C8H extends Exception {
    ...
    public C8H(int i10, int i11, int i12, int i13, C3064or c3064or, boolean z10, Exception exc, int i14) {
        ...
        super(sbAppend2.append(strA002).append(i12).append(strA002).append(i13).append(A00(15, 28, 19)).append(i14).append(strA00).append(c3064or).append(z10 ? A00(1, 14, 30) : A00(0, 0, 74)).toString(), exc);
        this.A00 = i10;
        this.A02 = z10;
        this.A01 = c3064or;
    }
