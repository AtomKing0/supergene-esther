...
public class C2568gJ implements QM {
    ...
    public final void A04(C14346g c14346g, boolean z10) {
        this.A00 = 0;
        if (this.A03 != null) {
            Arrays.fill(this.A03, -1);
        }
        QO qo = c14346g.A06;
        if (c14346g.A04 != null && qo != null && qo.A1W()) {
            if (z10) {
                if (!c14346g.A00.A0B()) {
                    qo.A1t(c14346g.A04.A0B(), this);
                }
            } else if (!c14346g.A1r()) {
                qo.A1s(this.A01, this.A02, c14346g.A0s, this);
            }
            if (this.A00 > qo.A00) {
                qo.A00 = this.A00;
                qo.A08 = z10;
