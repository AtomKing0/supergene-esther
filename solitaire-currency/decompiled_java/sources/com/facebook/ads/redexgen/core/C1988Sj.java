...
public final class C1988Sj {
    ...
    public C1988Sj(String str, Map<String, String> mStaticEnvironmentData) {
        this(str, mStaticEnvironmentData, false);
    }

    public C1988Sj(String str, Map<String, String> map, boolean z10) {
        this.A01 = str;
        this.A02 = map;
