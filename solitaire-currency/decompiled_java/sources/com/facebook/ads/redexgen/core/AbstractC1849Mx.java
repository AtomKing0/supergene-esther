...
public abstract class AbstractC1849Mx {
    ...
    public static List<C1841Mp> A01(JSONArray jSONArray, JSONObject jSONObject, C2387dL c2387dL, N1 n12) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                C1841Mp c1841MpA00 = C1841Mp.A00(jSONObject2);
                n12.A3q(c1841MpA00, jSONObject2);
                arrayList.add(c1841MpA00);
            } catch (JSONException e10) {
                c2387dL.A08().AAy(A00(8, 7, 90), AbstractC2000Sv.A2B, new C2001Sw(e10));
            }
        }
        return arrayList;
    }
