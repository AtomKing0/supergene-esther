...
public final class C2862lX implements FT {
    ...
    public C2862lX(WindowManager windowManager) {
        this.A00 = windowManager;
    }

    public static C2862lX A00(Context context) {
        WindowManager windowManager = (WindowManager) context.getSystemService(A01(0, 6, 15));
        if (windowManager != null) {
            return new C2862lX(windowManager);
        }
        return null;
    }
