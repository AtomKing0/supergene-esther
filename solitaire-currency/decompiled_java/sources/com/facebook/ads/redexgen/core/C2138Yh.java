...
public final class C2138Yh extends LinearLayout {
    public boolean A00;
    public final ImageView A01;
    public final TextView A02;
    public static final int A04 = (int) (AbstractC2090Wl.A02 * 16.0f);
    public static final int A05 = (int) (AbstractC2090Wl.A02 * 12.0f);
    public static final int A06 = (int) (AbstractC2090Wl.A02 * 12.0f);
    public static final int A03 = (int) (AbstractC2090Wl.A02 * 16.0f);

    public C2138Yh(C2387dL c2387dL) {
        super(c2387dL);
        this.A00 = false;
        setOrientation(0);
