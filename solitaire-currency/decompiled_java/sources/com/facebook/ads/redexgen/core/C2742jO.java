...
public final class C2742jO implements InterfaceC1790Kp {
    ...
    public final C1800Kz A03 = new C1800Kz();
    ...
    private File A02(C1796Kv c1796Kv, String str, String str2, int i10, C1799Ky c1799Ky) throws Exception {
        C1796Kv c1796Kv2;
        String strAGk;
        C1796Kv c1796Kv3;
        String strAGk2;
        ...
        try {
            ...
            C2737jI c2737jI = new C2737jI(file, new AbstractC2741jN(jA0R) { // from class: com.facebook.ads.redexgen.X.7f
                ...
                @Override // com.facebook.ads.redexgen.core.AbstractC2741jN
                public final boolean A08(File file2, long j10, int i11) {
                    return j10 <= this.A00;
                }

                @Override // com.facebook.ads.redexgen.core.AbstractC2741jN, com.facebook.ads.redexgen.core.L0
            ...
            if (c2737jI.A09()) {
                if (this.A08) {
                    String str4 = A03(49, 22, 36) + c2737jI.A00.getName();
                }
                this.A06.put(str3, file);
                c2737jI.A06();
                this.A04.AGl(str3, true, c1796Kv);
                return file;
            }
            if (this.A08) {
                String str5 = A03(71, 26, 76) + c2737jI.A00.getName();
            }
            if (!c1799Ky.A04()) {
                return null;
            }
            this.A04.AGl(str3, false, c1796Kv);
            for (int i11 = 0; i11 < this.A00; i11++) {
                try {
                    ...
                    str3 = str3;
                    try {
                        A05(sq, c2737jI, str3, i10, i11, jCurrentTimeMillis);
                        break;
                    } catch (L6 e10) {
                        e = e10;
                        if (i11 == this.A00 - 1) {
                            A06(c2737jI);
                            if (e instanceof C2738jJ) {
                                throw ((C2738jJ) e);
                            }
                            if (e instanceof C2733jE) {
                                throw ((C2733jE) e);
                            }
                        }
                    }
            ...
            int iA03 = c2737jI.A03();
            c2737jI.A06();
            long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
            c1799Ky.A00().A55(file, this.A04);
            this.A06.put(str3, file);
            this.A04.AGk(str3, IronSourceConstants.IS_CALLBACK_AD_DISPLAYED, null, Long.valueOf(iA03), Long.valueOf(jCurrentTimeMillis2), c1796Kv);
            return file;
        } catch (C2733jE e12) {
            this.A04.AGk(strAGk2, IronSourceConstants.IS_CALLBACK_AD_CLOSED, e12.toString(), null, null, c1796Kv3);
            if (!this.A08) {
                return null;
            }
            ...
            this.A04.AGk(strAGk, 2119, e13.toString(), null, null, c1796Kv2);
            if (!this.A08) {
                return null;
            }
    ...
    static {
        A04();
        A0B = C2742jO.class.getSimpleName();
    }

    public C2742jO(SQ sq, C1798Kx c1798Kx, LA la2) {
        this.A05 = sq;
        this.A08 = c1798Kx.A02();
        this.A00 = c1798Kx.A00();
        this.A04 = la2;
        this.A01 = c1798Kx.A01();
        this.A02 = c1798Kx;
    }

    public static C2739jK A00(Context context, String str) throws L6 {
        try {
            ...
            while (true) {
                ...
                if (i10 != -1) {
                    ...
                    return new C2739jK(byteArrayOutputStream.toByteArray());
                }
            }
    ...
    */
    private void A05(android.content.Context r24, com.facebook.ads.redexgen.core.C2737jI r25, java.lang.String r26, int r27, int r28, long r29) throws java.lang.Exception {
        /*
            Method dump skipped, instruction units count: 532
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2742jO.A05(android.content.Context, com.facebook.ads.redexgen.X.jI, java.lang.String, int, int, long):void");
    }

    private void A06(C2737jI c2737jI) {
        try {
            File fileA04 = c2737jI.A04();
            if (fileA04.exists()) {
                c2737jI.A06();
    ...
    private boolean A07(C2737jI c2737jI) {
        try {
            c2737jI.A05();
    ...
    public final <T> C1792Kr<T> A08(C1796Kv c1796Kv, C1799Ky<T> c1799Ky) {
        Semaphore semaphore;
        if (c1799Ky.A03()) {
            File file = this.A06.get(c1796Kv.A09);
            if (file != null) {
                this.A04.AGl(c1796Kv.A09, true, c1796Kv);
                return c1799Ky.A00().A3p(file, this.A04);
            }
            this.A04.AGl(c1796Kv.A09, false, c1796Kv);
            return new C1792Kr<>(false, null);
        }
        String str = c1796Kv.A09;
        String str2 = c1796Kv.A04;
        ...
        try {
            semaphore.acquire();
            File fileA02 = A02(c1796Kv, str, extension, this.A01, c1799Ky);
            if (fileA02 != null) {
                C1792Kr<T> c1792KrA3p = c1799Ky.A00().A3p(fileA02, this.A04);
                semaphore.release();
                synchronized (this.A07) {
                    this.A07.remove(extension);
                }
            ...
            C1792Kr<T> c1792Kr = new C1792Kr<>(false, null);
            semaphore.release();
            synchronized (this.A07) {
                this.A07.remove(extension);
            }
            ...
            C1792Kr<T> c1792Kr2 = new C1792Kr<>(false, null);
            semaphore.release();
            synchronized (this.A07) {
                this.A07.remove(extension);
                return c1792Kr2;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1790Kp
    public final C1792Kr<Bitmap> AHu(C1796Kv c1796Kv, boolean z10) {
        return A08(c1796Kv, new C1799Ky(new C2745jR(c1796Kv.A01, c1796Kv.A00, this.A02.A04(), this.A02.A03(), z10)));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1790Kp
    public final File AHv(C1796Kv c1796Kv) {
        C1799Ky c1799Ky = new C1799Ky(new C2744jQ());
        c1799Ky.A01(true);
        c1799Ky.A02(false);
        return (File) A08(c1796Kv, c1799Ky).A00();
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1790Kp
    public final String AHw(C1796Kv c1796Kv) {
        return (String) A08(c1796Kv, new C1799Ky(new C2743jP())).A00();
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1790Kp
    public final String AHx(C1796Kv c1796Kv) {
        C1799Ky c1799Ky = new C1799Ky(new C2743jP());
        c1799Ky.A01(true);
        c1799Ky.A02(false);
        return (String) A08(c1796Kv, c1799Ky).A00();
    }
}
