...
public class C1806Lf implements InterfaceC2116Xl {
    ...
    public C1806Lf(C1803Lc c1803Lc) {
        this.A00 = c1803Lc;
    }
    ...
    public final void ACC(AbstractC2117Xm abstractC2117Xm) {
        ...
        if (A01[4].charAt(5) == '8') {
            A01[1] = "011C";
            if (!c1803Lc.A0X || this.A00.A0V.get() || !this.A00.A0V()) {
                this.A00.A0N.A04(UZ.A07, null);
                if (this.A00.A0J.A0P()) {
                    this.A00.A0L.A0F().ADk();
                }
                InterfaceC2118Xn interfaceC2118Xn = this.A00.A0Q;
                C1803Lc c1803Lc2 = this.A00;
                if (A01[2].length() == 9) {
                    A01[6] = "SsRiNY9tvP3hEWy4eyTF9NsffnrPtCfL";
                    interfaceC2118Xn.A4b(c1803Lc2.A0R.A7o());
                    return;
                }
            } else {
