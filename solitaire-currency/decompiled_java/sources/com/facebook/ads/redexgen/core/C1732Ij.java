...
public final class C1732Ij {
    ...
    public static final C2736jH A05;
    public static final C2736jH A06;
    public int A01;
    public final List<C1729Ig> A02 = new ArrayList();
    public int A00 = 0;
     ...
     */
    private void A06(InterfaceC2853lN interfaceC2853lN, List<Metadata.Entry> list) throws IOException {
        long jA8f = interfaceC2853lN.A8f();
        int iA8G = (int) ((interfaceC2853lN.A8G() - interfaceC2853lN.A8f()) - ((long) this.A01));
        C4J c4j = new C4J(iA8G);
        interfaceC2853lN.readFully(c4j.A0l(), 0, iA8G);
        for (int i10 = 0; i10 < this.A02.size(); i10++) {
            C1729Ig c1729Ig = this.A02.get(i10);
            c4j.A0f((int) (c1729Ig.A02 - jA8f));
            c4j.A0g(4);
            int iA0E = c4j.A0E();
            String[] strArr = A04;
    ...
    */
    public static int A00(java.lang.String r3) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            int r0 = r3.hashCode()
            switch(r0) {
        ...
        Lb:
            ...
            r0 = 0
            com.facebook.ads.redexgen.X.2i r0 = com.facebook.ads.redexgen.core.C13322i.A01(r1, r0)
            throw r0
        L1a:
            r2 = 31
            r1 = 20
        ...
        L80:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1732Ij.A00(java.lang.String):int");
    }

    public static SlowMotionData A01(C4J c4j, int i10) throws C13322i {
    ...
    private void A04(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        C4J c4j = new C4J(8);
        interfaceC2853lN.readFully(c4j.A0l(), 0, 8);
        this.A01 = c4j.A0E() + 8;
        if (c4j.A0C() != 1397048916) {
            c1691Gt.A00 = 0L;
        } else {
            c1691Gt.A00 = interfaceC2853lN.A8f() - ((long) (this.A01 - 12));
            this.A00 = 2;
        }
    }

    private void A05(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        ...
        for (int i11 = 0; i11 < i10 / 12; i11++) {
            ...
            switch (i12) {
                ...
                case 2820:
                    ...
                    int size = c4j.A0E();
                    this.A02.add(new C1729Ig(i12, j10 - streamLength2, size));
                    break;
                default:
                    c4j.A0g(8);
                    break;
        ...
        c1691Gt.A00 = streamLength3;
    }

    public final int A07(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt, List<Metadata.Entry> slowMotionMetadataEntries) throws IOException {
        long j10 = 0;
        switch (this.A00) {
            case 0:
                long jA8G = interfaceC2853lN.A8G();
                ...
                return 1;
            case 1:
                A04(interfaceC2853lN, c1691Gt);
                return 1;
            case 2:
                A05(interfaceC2853lN, c1691Gt);
                return 1;
            case 3:
                A06(interfaceC2853lN, slowMotionMetadataEntries);
                c1691Gt.A00 = 0L;
                return 1;
            default:
                throw new IllegalStateException();
