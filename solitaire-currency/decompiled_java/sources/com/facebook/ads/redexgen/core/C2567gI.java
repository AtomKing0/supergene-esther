...
public class C2567gI extends QO implements InterfaceC1928Qa {
    ...
    public C2567gI(Context context) {
        this(context, 1, false);
    }

    public C2567gI(Context context, int i10, boolean z10) {
        this.A0A = false;
        this.A05 = false;
        this.A0C = false;
        this.A0B = true;
    ...
    private final int A04(int i10, QW qw, C1931Qd c1931Qd) {
        if (A0Y() == 0 || i10 == 0) {
            return 0;
        }
        this.A07.A0B = true;
        ...
        A0Y(absDy, consumed, true, c1931Qd);
        int i11 = this.A07.A07;
        int layoutDirection = A07(qw, this.A07, c1931Qd, false);
    ...
    private int A05(int i10, QW qw, C1931Qd c1931Qd, boolean z10) {
        int fixOffset;
        int gap = this.A04.A07() - i10;
        if (gap > 0) {
            int i11 = -A04(-gap, qw, c1931Qd);
            int i12 = i10 + i11;
    ...
    private int A06(int i10, QW qw, C1931Qd c1931Qd, boolean z10) {
        int iA0A;
    ...
    private final int A07(QW qw, Q3 q32, C1931Qd c1931Qd, boolean z10) {
        int i10 = q32.A00;
        int start = q32.A07;
        ...
        Q2 q22 = this.A0E;
        while (true) {
            if ((!q32.A09 && i13 <= 0) || !q32.A05(c1931Qd)) {
                break;
            }
            q22.A00();
            A2F(qw, c1931Qd, q32, q22);
            if (!q22.A01) {
                int i14 = q32.A06;
                int remainingSpace = q22.A00;
                int start5 = q32.A05;
                q32.A06 = i14 + (remainingSpace * start5);
                if (!q22.A03 || this.A07.A08 != null || !c1931Qd.A07()) {
    ...
    private int A08(C1931Qd c1931Qd) {
        if (A0Y() == 0) {
            return 0;
        }
        A2B();
        return AbstractC1935Qh.A00(c1931Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B);
    }

    private int A0A(C1931Qd c1931Qd) {
        if (A0Y() != 0) {
            A2B();
            return AbstractC1935Qh.A02(c1931Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B, this.A05);
        }
    ...
    private int A0B(C1931Qd c1931Qd) {
        if (A0Y() == 0) {
            return 0;
        }
        A2B();
        return AbstractC1935Qh.A01(c1931Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B);
    }

    private final int A0C(C1931Qd c1931Qd) {
        if (c1931Qd.A06()) {
            return this.A04.A0B();
        }
        return 0;
    ...
    private View A0J(QW qw, C1931Qd c1931Qd) {
        return A2A(qw, c1931Qd, 0, A0Y(), c1931Qd.A03());
    }

    private View A0L(QW qw, C1931Qd c1931Qd) {
        return A2A(qw, c1931Qd, A0Y() - 1, -1, c1931Qd.A03());
    }

    private View A0M(QW qw, C1931Qd c1931Qd) {
        return this.A05 ? A0D() : A0E();
    }

    private View A0N(QW qw, C1931Qd c1931Qd) {
        return this.A05 ? A0E() : A0D();
    }

    private View A0O(QW qw, C1931Qd c1931Qd) {
        return this.A05 ? A0J(qw, c1931Qd) : A0L(qw, c1931Qd);
    }

    private View A0P(QW qw, C1931Qd c1931Qd) {
        return this.A05 ? A0L(qw, c1931Qd) : A0J(qw, c1931Qd);
    }
    ...
    private void A0Y(int i10, int i11, boolean z10, C1931Qd c1931Qd) {
        int iA0A;
        this.A07.A09 = A0i();
        this.A07.A02 = A0C(c1931Qd);
        this.A07.A05 = i10;
        if (i10 == 1) {
    ...
    private void A0f(QW qw, C1931Qd c1931Qd, int scrapExtraEnd, int scrapExtraEnd2) {
        if (!c1931Qd.A08() || A0Y() == 0 || c1931Qd.A07() || !A24()) {
            return;
        }
        int iA0D = 0;
        int scrapExtraStart = 0;
        List<AbstractC1934Qg> listA0J = qw.A0J();
        int i10 = listA0J.size();
        int iA0r = A0r(A0v(0));
        for (int scrapSize = 0; scrapSize < i10; scrapSize++) {
            AbstractC1934Qg abstractC1934Qg = listA0J.get(scrapSize);
            if (!abstractC1934Qg.A0g()) {
                int direction = 1;
                if ((abstractC1934Qg.A0O() < iA0r) != this.A05) {
                    direction = -1;
                }
                if (direction == -1) {
                    iA0D += this.A04.A0D(abstractC1934Qg.A0H);
                } else {
                    scrapExtraStart += this.A04.A0D(abstractC1934Qg.A0H);
                }
            }
        }
    ...
    private void A0g(QW qw, C1931Qd c1931Qd, Q1 q12) {
        if (A0k(c1931Qd, q12) || A0j(qw, c1931Qd, q12)) {
            return;
        }
        q12.A02();
        q12.A01 = this.A0C ? c1931Qd.A03() - 1 : 0;
    }
    ...
    private boolean A0j(QW qw, C1931Qd c1931Qd, Q1 q12) {
        View viewA0P;
        int iA0A;
        if (A0Y() == 0) {
            return false;
        ...
        View viewA0u = A0u();
        if (viewA0u != null && q12.A06(viewA0u, c1931Qd)) {
            q12.A05(viewA0u);
            return true;
        }
        ...
        if (q12.A02) {
            viewA0P = A0O(qw, c1931Qd);
        } else {
            viewA0P = A0P(qw, c1931Qd);
        }
        if (viewA0P == null) {
            return false;
        }
    ...
    */
    private boolean A0k(com.facebook.ads.redexgen.core.C1931Qd r9, com.facebook.ads.redexgen.core.Q1 r10) {
        /*
            Method dump skipped, instruction units count: 347
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2567gI.A0k(com.facebook.ads.redexgen.X.Qd, com.facebook.ads.redexgen.X.Q1):boolean");
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public int A1f(int i10, QW qw, C1931Qd c1931Qd) {
        if (this.A00 == 1) {
            return 0;
        }
        return A04(i10, qw, c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public int A1g(int i10, QW qw, C1931Qd c1931Qd) {
        if (this.A00 == 0) {
            return 0;
        }
        return A04(i10, qw, c1931Qd);
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1h(C1931Qd c1931Qd) {
        return A08(c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1i(C1931Qd c1931Qd) {
        return A0A(c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1j(C1931Qd c1931Qd) {
        return A0B(c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1k(C1931Qd c1931Qd) {
        return A08(c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1l(C1931Qd c1931Qd) {
        return A0A(c1931Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1m(C1931Qd c1931Qd) {
        return A0B(c1931Qd);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public View A1p(View view, int i10, QW qw, C1931Qd c1931Qd) {
        int maxScroll;
        View nextFocus;
        View viewA0F;
        A0U();
        ...
        A0Y(maxScroll, (int) (layoutDir * 0.33333334f), false, c1931Qd);
        this.A07.A07 = Integer.MIN_VALUE;
        this.A07.A0B = false;
        A07(qw, this.A07, c1931Qd, true);
        if (maxScroll == -1) {
            nextFocus = A0N(qw, c1931Qd);
        } else {
            nextFocus = A0M(qw, c1931Qd);
        }
        if (maxScroll == -1) {
            viewA0F = A0G();
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final void A1s(int i10, int i11, C1931Qd c1931Qd, QM qm) {
        if (this.A00 != 0) {
            i10 = i11;
        }
        int delta = A0Y();
        ...
        A0Y(i12, delta2, true, c1931Qd);
        A2G(c1931Qd, this.A07, qm);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void A1w(com.facebook.ads.redexgen.core.QW r10, com.facebook.ads.redexgen.core.C1931Qd r11) {
        /*
            Method dump skipped, instruction units count: 608
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2567gI.A1w(com.facebook.ads.redexgen.X.QW, com.facebook.ads.redexgen.X.Qd):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final void A1y(C14346g c14346g, QW qw) {
        super.A1y(c14346g, qw);
        if (this.A09) {
            A1K(qw);
            qw.A0P();
        }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public void A1z(C14346g c14346g, C1931Qd c1931Qd, int i10) {
        C2566gH linearSmoothScroller = new C2566gH(c14346g.getContext());
    ...
    public View A2A(QW qw, C1931Qd c1931Qd, int i10, int i11, int i12) {
        A2B();
        View view = null;
        View view2 = null;
    ...
    public void A2E(QW qw, C1931Qd c1931Qd, Q1 q12, int i10) {
    }

    public void A2F(QW qw, C1931Qd c1931Qd, Q3 q32, Q2 q22) {
        int iA0i;
        int right;
        int iA0g;
        int iA0E;
    ...
    public void A2G(C1931Qd c1931Qd, Q3 q32, QM qm) {
        int i10 = q32.A01;
        if (i10 >= 0) {
            int pos = c1931Qd.A03();
            if (i10 < pos) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1928Qa
