...
public enum EnumC3086pK {
    ...
    public static EnumC3086pK[] valuesCustom() {
        EnumC3086pK[] enumC3086pKArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC3086pK[]) enumC3086pKArrValuesCustom.clone();
    }
