...
public final class C2774ju implements KJ {
    ...
    public C2774ju(boolean z10) {
        this(z10, null);
    }

    public C2774ju(boolean z10, String str) {
    ...
    private void A02() throws C13322i {
        this.A0H.A08(0);
        if (!this.A0G) {
            ...
            C3064or c3064orA14 = c2dA0b.A0m(audioObjectType3).A12(Collections.singletonList(bArrA07)).A10(this.A0J).A14();
            int audioObjectType4 = c3064orA14.A0G;
            this.A08 = 1024000000 / ((long) audioObjectType4);
            this.A0C.A6W(c3064orA14);
            this.A0G = true;
        } else {
            this.A0H.A09(10);
        }
    ...
    */
    private boolean A0G(com.facebook.ads.redexgen.core.C4J r11, int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2774ju.A0G(com.facebook.ads.redexgen.X.4J, int):boolean");
    }
    ...
    public final void A52(C4J c4j) throws C13322i {
        A01();
        while (c4j.A07() > 0) {
            switch (this.A06) {
                case 0:
    ...
    public final void A5U(GY gy, C1779Ke c1779Ke) {
        c1779Ke.A05();
        this.A0D = c1779Ke.A04();
        this.A0C = gy.AJh(c1779Ke.A03(), 1);
        this.A0A = this.A0C;
        if (this.A0K) {
            c1779Ke.A05();
            this.A0B = gy.AJh(c1779Ke.A03(), 5);
            this.A0B.A6W(new C2D().A0y(c1779Ke.A04()).A11(A00(60, 15, 103)).A14());
            return;
        }
        this.A0B = new C2854lO();
    }
