...
public class C2026Tw {
     ...
     */
    public static C2026Tw A04(File file) throws IOException {
        try {
            ...
            return new C2026Tw(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C2026Tw(RandomAccessFile randomAccessFile, long[] jArr, long j10) throws IOException {
    ...
    public static C2026Tw A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(TypedValues.CycleType.TYPE_PATH_ROTATE, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C2027Tx.A03);
            randomAccessFile.write(new byte[C2027Tx.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C2026Tw(randomAccessFile, new long[C2027Tx.A03], randomAccessFile.length());
        } catch (IOException unused) {
