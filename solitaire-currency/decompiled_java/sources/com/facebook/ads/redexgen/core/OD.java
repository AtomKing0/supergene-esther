...
public class OD extends RelativeLayout implements InterfaceC2119Xo {
    ...
    public OD(R0 r02, C2387dL c2387dL, US us, InterfaceC2118Xn interfaceC2118Xn) {
        LJ lj;
        super(c2387dL);
        this.A06 = new C1884Oi(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A07 = r02;
        ...
        this.A0D = A0E();
        if (U8.A02(c2387dL) || c2387dL.A0E() == null) {
            lj = new LJ(c2387dL, this.A0D);
        } else {
            lj = new LJ(c2387dL, c2387dL.A0E(), this.A0D);
        }
        this.A0E = lj;
        this.A0B = new ZO(c2387dL, this.A0E);
        this.A0B.setId(View.generateViewId());
        this.A0B.setListener(new C1881Of(this));
        this.A0E.setBrowserNavigationListener(this.A0B.getBrowserNavigationListener());
        this.A0C = new ZP(c2387dL, null, R.attr.progressBarStyleHorizontal);
        A0F();
        r02.A0A(this.A06);
    }
    ...
    public void A0F() {
        ...
        RelativeLayout.LayoutParams webViewParams2 = new RelativeLayout.LayoutParams(-1, (int) (AbstractC2090Wl.A02 * 2.0f));
