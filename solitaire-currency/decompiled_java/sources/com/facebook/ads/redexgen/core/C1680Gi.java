...
public final class C1680Gi {
    ...
    private boolean A02(String str) {
        ...
        if (matcher.find()) {
            try {
                int i10 = Integer.parseInt((String) AbstractC13764a.A0f(matcher.group(1)), 16);
                int i11 = Integer.parseInt((String) AbstractC13764a.A0f(matcher.group(2)), 16);
                if (i10 > 0 || i11 > 0) {
                    this.A00 = i10;
                    this.A01 = i11;
                    return true;
    ...
    */
    public final boolean A05(com.facebook.ads.androidx.media3.common.Metadata r9) {
        ...
        L59:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1680Gi.A05(com.facebook.ads.androidx.media3.common.Metadata):boolean");
    }
}
