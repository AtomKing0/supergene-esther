...
public final class C2133Yc extends RelativeLayout {
    public final int A00;
    public final int A01;
    public final O2 A02;
    public final C2387dL A03;
    public final InterfaceC2136Yf A04;
    public final boolean A05;
    public static final int A09 = (int) (AbstractC2090Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC2090Wl.A02 * 8.0f);
    public static final int A0D = (int) (AbstractC2090Wl.A02 * 44.0f);
    public static final int A08 = (int) (AbstractC2090Wl.A02 * 10.0f);
    public static final int A07 = A09 - A08;
    public static final int A0E = (int) (AbstractC2090Wl.A02 * 75.0f);
    public static final int A0B = (int) (AbstractC2090Wl.A02 * 25.0f);
    public static final int A0F = (int) (AbstractC2090Wl.A02 * 45.0f);
    public static final int A0C = (int) (AbstractC2090Wl.A02 * 15.0f);
    public static final int A06 = (int) (AbstractC2090Wl.A02 * 16.0f);

    public C2133Yc(C2132Yb c2132Yb) {
        super(c2132Yb.A0C);
        this.A03 = c2132Yb.A0C;
        this.A02 = O3.A00(this.A03.A02());
        this.A04 = c2132Yb.A02;
        this.A01 = c2132Yb.A0B ? A0E : A0F;
        this.A00 = c2132Yb.A0B ? A0B : A0C;
        this.A05 = c2132Yb.A07;
        setFocusable(true);
        View viewA01 = A01(c2132Yb);
        View viewA00 = A00(c2132Yb);
        ...
        footerView.setVisibility(c2132Yb.A08 ? 0 : 8);
    }

    public /* synthetic */ C2133Yc(C2132Yb c2132Yb, YZ yz) {
        this(c2132Yb);
    }

    private View A00(C2132Yb c2132Yb) {
        ImageView imageView = new ImageView(getContext());
        imageView.setPadding(this.A00, this.A00, this.A00, this.A00);
        imageView.setImageBitmap(XY.A01(c2132Yb.A01));
        imageView.setColorFilter(-1);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.A01, this.A01);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(1);
        gradientDrawable.setColor(c2132Yb.A00);
        ...
        subtitleView.setText(c2132Yb.A06);
        ...
        if (c2132Yb.A09) {
            ...
            if (!TextUtils.isEmpty(c2132Yb.A04)) {
                ...
                new KZ(c2201aK, this.A03).A05(A0F, A0F).A07(c2132Yb.A04);
                linearLayout2.addView(c2201aK, iconParams);
            }
            C2138Yh c2138Yh = new C2138Yh(this.A03);
            c2138Yh.setData(c2132Yb.A03, XX.CHECKMARK);
            c2138Yh.setSelected(true);
            linearLayout2.addView(c2138Yh, new LinearLayout.LayoutParams(-2, -2));
            linearLayout.addView(linearLayout2);
        }
        return linearLayout;
    }

    private View A01(C2132Yb c2132Yb) {
        LinearLayout linearLayout = new LinearLayout(getContext());
    ...
    private View getFooterView() {
        ...
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        linearLayout.setOnClickListener(new ViewOnClickListenerC2131Ya(this));
        linearLayout.addView(imageView, layoutParams);
