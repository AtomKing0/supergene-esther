...
import com.facebook.ads.redexgen.core.AbstractC2010Tf;
...
public final class C2009Te<T extends AbstractC2010Tf, E extends C2008Td> {
    ...
    private void A00(E e10) {
        ...
        while (it.hasNext()) {
            AbstractC2010Tf abstractC2010Tf = (AbstractC2010Tf) ((WeakReference) it.next()).get();
            if (abstractC2010Tf != null && abstractC2010Tf.A00(e10)) {
                abstractC2010Tf.A03(e10);
            }
        }
    }
    ...
    */
    private void A01(java.util.List<java.lang.ref.WeakReference<T>> r5) {
        ...
        L2d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2009Te.A01(java.util.List):void");
    }
