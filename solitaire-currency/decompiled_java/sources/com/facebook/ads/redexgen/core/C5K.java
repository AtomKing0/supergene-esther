...
public final class C5K extends FrameLayout implements InterfaceC2119Xo, I3 {
    ...
    public final US A08;
    public final C2030Ua A09;
    public final XC A0A;
    public final XH A0B;
    public final InterfaceC2118Xn A0C;
    public final YY A0D;
    public final C2290bl A0E;
    public final C2298bt A0F;
    public final AbstractC2459eW A0G;
    public final C2460eX A0H;
    ...
    public C5K(C2387dL c2387dL, US us, InterfaceC2118Xn interfaceC2118Xn, AbstractC2662hy abstractC2662hy, YY yy, int i10) {
        super(c2387dL);
        this.A01 = new C1731Ii(this);
        this.A0G = new C1730Ih(this);
        this.A03 = true;
        this.A07 = c2387dL;
        this.A08 = us;
        this.A0C = interfaceC2118Xn;
        this.A06 = abstractC2662hy;
        this.A0D = yy;
        C2298bt c2298btA02 = AbstractC2299bu.A02(abstractC2662hy.A17());
        if (c2298btA02 == null) {
            this.A0F = new C2298bt(this.A07, abstractC2662hy, us, i10);
            this.A04 = false;
        } else {
            this.A0F = c2298btA02;
            this.A04 = true;
        ...
        this.A0F.A0c(new C1726Id(this));
        XP.A0E(1003, this.A0F.A0O());
        if (this.A06.A1P()) {
            this.A0E = new C2290bl(this.A07, this.A08, this.A06, new SF(this.A07), this.A09, this.A0C, this.A0D, new C1724Ib(this));
            this.A0E.A0N();
            this.A0F.A0O().setOnTouchListener(new ViewOnTouchListenerC2286bh(this));
            addView(this.A0E, new FrameLayout.LayoutParams(-1, -1));
        } else {
            this.A0E = null;
        }
        ViewGroup mediaView = getMediaView();
        this.A0H = new C2460eX(mediaView, 1, new WeakReference(this.A0G), this.A07);
        ...
        if (U7.A1u(c2387dL)) {
            c2387dL.A0B().AK4(mediaView, abstractC2662hy.A25(), false, false, true);
        }
        try {
            JSONObject jSONObject = new JSONObject();
            boolean zA2C = abstractC2662hy.A2C();
            ...
            } else if (WR.A05(abstractC2662hy.A0u())) {
                jSONObject.put(strA0B4, true);
                jSONObject.put(strA0B3, 2);
            ...
            this.A0F.A0M().A04(AbstractC2000Sv.A15, A0B(0, 26, 113));
        }
    }

    private void A0C() {
        C2338cX c2338cXA0F = new C2336cV(this.A07, this.A06.A20().A0I(), this.A06.A23()).A0A(this.A06.A1z().A01()).A0F();
        addView(c2338cXA0F, new FrameLayout.LayoutParams(-1, -1));
        c2338cXA0F.A04(new IW(this));
    }
    ...
    public final void A9c() {
        ...
        C2384dI serverSideRewardHandler = new C2384dI(this.A07, this.A0D, this.A06.A1A(), this.A0C);
        serverSideRewardHandler.A05();
    }

    @Override // com.facebook.ads.redexgen.core.I3
    public final void AAd() {
        new Handler(Looper.getMainLooper()).post(new C1723Ia(this));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2119Xo
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        C2298bt.A0B().incrementAndGet();
        r02.A0A(this.A01);
        this.A00 = r02;
        A0E();
        if (this.A06.A20().A0W()) {
    ...
    public final void onDestroy() {
        ...
        this.A0A.A03();
        this.A08.AAt(this.A06.A25(), new C2172Zp().A02(this.A0B).A03(this.A0H).A05());
        this.A01 = null;
        this.A02 = null;
        this.A00 = null;
        AbstractC2299bu.A04(this.A06.A17());
        C2298bt.A0B().decrementAndGet();
    }
    ...
    public void setRtfActionsJavascriptListener(InterfaceC2305c0 interfaceC2305c0) {
        this.A02 = interfaceC2305c0;
    }
}
