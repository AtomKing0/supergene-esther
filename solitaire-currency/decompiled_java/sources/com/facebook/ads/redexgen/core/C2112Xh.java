...
public final class C2112Xh {
    ...
    static {
        A02();
        A02 = C2112Xh.class.getSimpleName();
    }

    public static Map<String, String> A01(@Nullable C2387dL c2387dL) {
        Window window;
        ...
        try {
            map.put(A00(40, 3, 0), String.valueOf(A04(c2387dL)));
            ...
            InterfaceC1999Su interfaceC1999SuA08 = c2387dL.A08();
            int type3 = AbstractC2000Sv.A2T;
            interfaceC1999SuA08.AAy(A00(43, 5, 77), type3, new C2001Sw(e10));
        }
        return map;
    }

    public static boolean A03(C2387dL c2387dL) {
        return !XQ.A04(A01(c2387dL));
    }

    public static boolean A04(C2387dL c2387dL) {
        KeyguardManager keyguardManager = (KeyguardManager) c2387dL.getSystemService(A00(32, 8, 57));
