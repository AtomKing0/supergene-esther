...
public final class C13663q extends NI {
    ...
    public AbstractC2662hy A03;
    public SF A04;
    public C12810h A05;
    public C2200aJ A06;
    public FH A07;
    public AbstractC2459eW A08;
    public C2460eX A09;
    public String A0A;
    public List<C2354cn> A0B;
    public boolean A0C;
    ...
    static {
        ...
        A0I = (int) (AbstractC2090Wl.A02 * 8.0f);
        A0J = (int) (AbstractC2090Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2090Wl.A02 * 56.0f);
        A0K = (int) (AbstractC2090Wl.A02 * 12.0f);
    }

    public C13663q(C2387dL c2387dL, US us, SF sf, InterfaceC2118Xn interfaceC2118Xn, AnonymousClass73 anonymousClass73) {
        super(c2387dL, us, interfaceC2118Xn, anonymousClass73);
        this.A0E = new XH();
        this.A0C = false;
        super.A07 = true;
        super.A06 = new C2384dI(c2387dL, new LX(), super.A0A.A1A(), interfaceC2118Xn);
        this.A04 = sf;
        this.A0D = c2387dL;
    }

    public C13663q(C2387dL c2387dL, US us, SF sf, InterfaceC2118Xn interfaceC2118Xn, AnonymousClass77 anonymousClass77) {
        super(c2387dL, us, interfaceC2118Xn, anonymousClass77);
        this.A0E = new XH();
        this.A0C = false;
        this.A04 = sf;
        this.A0D = c2387dL;
    ...
    */
    public com.facebook.ads.redexgen.core.ME A01(java.lang.String r7) {
        ...
        L7:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C13663q.A0G
            r0 = 5
            r1 = r2[r0]
            r0 = 6
            r2 = r2[r0]
            ...
            com.facebook.ads.redexgen.X.Ev r3 = (com.facebook.ads.redexgen.core.C1641Ev) r3
            if (r3 == 0) goto L7d
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C13663q.A0G
            r0 = 2
            r1 = r1[r0]
            r0 = 16
            char r1 = r1.charAt(r0)
        ...
        L91:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C13663q.A01(java.lang.String):com.facebook.ads.redexgen.X.ME");
    }

    private AbstractC2662hy A02(Intent intent) {
        if (super.A07) {
            return (AbstractC2662hy) intent.getSerializableExtra(A0C(14, 25, 103));
        }
        return (AbstractC2662hy) intent.getSerializableExtra(A0C(0, 14, 36));
    }
    ...
    private final void A0G(int i10, Bundle bundle) {
        ...
        int i12 = AbstractC2090Wl.A04.widthPixels;
        int i13 = AbstractC2090Wl.A04.heightPixels;
        if (i10 == 1) {
        ...
        this.A09 = new C2460eX(this, 1, new WeakReference(this.A08), this.A0D);
        this.A09.A0W(this.A00);
        this.A09.A0X(this.A01);
        this.A05 = new C12810h(this.A0D);
    ...
    private void A0H(AbstractC2662hy abstractC2662hy) {
        this.A03 = abstractC2662hy;
        this.A0A = this.A03.A25();
        this.A00 = this.A03.A0i();
        this.A01 = this.A03.A0j();
        List<C1841Mp> listA27 = this.A03.A27();
        List<AdInfo> adInfoList = new ArrayList<>(listA27.size());
        this.A0B = adInfoList;
        for (int i10 = 0; i10 < listA27.size(); i10++) {
            C1841Mp c1841Mp = listA27.get(i10);
            List<C2354cn> list = this.A0B;
            int i11 = listA27.size();
            list.add(new C2354cn(i10, i11, c1841Mp));
        }
    }

    private void A0I(FH fh) {
        new C14356h().A0G(this.A05);
        fh.A0Y(new F1(this));
        this.A06 = new C2200aJ(this.A0D, super.A05.A01(), this.A0B.size());
    ...
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        AbstractC2662hy dataBundle = A02(intent);
        A0Z(r02);
        A0H(dataBundle);
        A0G(r02.A05().getResources().getConfiguration().orientation, bundle);
        r02.A0A(new F0(this, r02));
        AbstractC2662hy dataBundle2 = super.A0A;
        int unskippableSec = dataBundle2.A20().A0H().A04();
        if (super.A07) {
            AbstractC2662hy dataBundle3 = super.A0A;
            unskippableSec = dataBundle3.A20().A0H().A03();
        }
        if (unskippableSec > 0) {
            A0X(unskippableSec);
        }
        AbstractC2662hy dataBundle4 = super.A0A;
        if (dataBundle4.A20().A0H().A02() >= 0) {
            super.A0E.setToolbarActionMode(8);
        }
        AbstractC2662hy dataBundle5 = super.A0A;
        if (dataBundle5.A2K()) {
            super.A0E.setOnClickListener(new ViewOnClickListenerC2357cq(this));
        }
    }

    @Override // com.facebook.ads.redexgen.core.NI, com.facebook.ads.redexgen.core.InterfaceC2119Xo
    ...
    public final void onDestroy() {
        ...
        if (!TextUtils.isEmpty(this.A0A)) {
            super.A0C.AAt(this.A0A, new C2172Zp().A03(this.A09).A02(this.A0E).A05());
        }
        A0F();
        this.A09.A0V();
        this.A09 = null;
