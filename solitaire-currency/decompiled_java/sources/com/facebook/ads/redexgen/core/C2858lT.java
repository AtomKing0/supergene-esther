...
public final class C2858lT implements InterfaceC1694Gw {
    ...
    public C2858lT(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j10) {
        return AbstractC13764a.A0L(this.A04, j10, true, true);
    }
    ...
    public final C1693Gv A8t(long j10) {
        int iA00 = A00(j10);
        C1695Gx c1695Gx = new C1695Gx(this.A04[iA00], this.A03[iA00]);
        if (c1695Gx.A01 < j10) {
            ...
            if (iA00 != chunkIndex - 1) {
                ...
                C1695Gx seekPoint = new C1695Gx(j11, this.A03[chunkIndex3]);
                return new C1693Gv(c1695Gx, seekPoint);
            }
        }
