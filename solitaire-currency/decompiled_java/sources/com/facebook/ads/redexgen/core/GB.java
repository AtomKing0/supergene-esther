...
public abstract class GB {
    ...
    static {
        A05();
        A03 = new int[]{96000, 88200, 64000, OpusUtil.SAMPLE_RATE, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350};
    ...
    public static int A01(C4I c4i) throws C13322i {
        int iA04 = c4i.A04(4);
        if (iA04 == 15) {
            int iA01 = c4i.A01();
            if (A01[0].length() != 5) {
            ...
            throw C13322i.A01(A04(0, 28, 60), null);
        }
        if (iA04 < 13) {
            int frequencyIndex2 = A03[iA04];
            return frequencyIndex2;
        }
        throw C13322i.A01(A04(28, 41, 57), null);
    }

    public static GA A02(C4I c4i, boolean z10) throws C13322i {
        int iA00 = A00(c4i);
        int iA01 = A01(c4i);
        int iA04 = c4i.A04(4);
        ...
        if (z10) {
            switch (iA00) {
                ...
                case 23:
                    ...
                    switch (iA00) {
                        ...
                        case 23:
                            int iA042 = c4i.A04(2);
                            if (iA042 == 2 || iA042 == 3) {
                                throw C13322i.A00(A04(137, 22, 118) + iA042);
                            }
                    }
                    break;
                case 5:
                ...
                case 18:
                default:
                    throw C13322i.A00(A04(106, 31, 42) + iA00);
            }
        }
    ...
    public static GA A03(byte[] bArr) throws C13322i {
