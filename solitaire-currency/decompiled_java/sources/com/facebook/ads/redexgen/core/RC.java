...
public final class RC implements View.OnLongClickListener {
    ...
    @Nullable
    public final C2169Zm A01;

    public RC(C2169Zm c2169Zm, RelativeLayout relativeLayout) {
        this.A01 = c2169Zm;
    ...
    public final boolean onLongClick(View view) {
        if (this.A01 != null && this.A00 != null) {
            ...
            A02[7] = "";
            c2169Zm.setBounds(0, 0, width, relativeLayout.getHeight());
