...
public final class YN implements InterfaceC2464eb {
    ...
    public YN(C2361cu c2361cu) {
        this.A00 = c2361cu;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2464eb
    public final Map<String, String> A6Y(boolean z10) {
        HashMap map = new HashMap();
        if (!AbstractC1971Rr.A00().A04()) {
            map.put(A00(0, 23, 64), TY.A00().A01(this.A00, true).A04());
        }
        map.put(A00(23, 10, 51), AbstractC2006Tb.A06(new T6(this.A00), this.A00, z10));
        return map;
    }
}
