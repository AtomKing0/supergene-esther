...
public final class C14075f extends AbstractC1771Jw {
    ...
    public final AbstractC2117Xm A07;
    ...
    public C14075f(C2225ai c2225ai) {
        super(c2225ai, true);
        this.A03 = new Handler(Looper.getMainLooper());
        this.A02 = false;
        this.A08 = c2225ai.A0D();
        this.A07 = c2225ai.A0C();
        this.A06 = new RelativeLayout(c2225ai.A06());
        this.A05 = new RelativeLayout(c2225ai.A06());
        XP.A0I(this.A05);
        XP.A0I(this.A06);
        this.A04 = c2225ai.A02();
        A04();
        this.A06.addView(this.A05, new RelativeLayout.LayoutParams(-2, -2));
        addView(this.A06, new RelativeLayout.LayoutParams(-1, -1));
        AbstractC2208aR.A00(c2225ai.A06(), this.A06, getAdInfo().A0H().A08());
        A03();
        ((AbstractC2221ae) this).A06.A06().A0F().AJw(AbstractC2081Wa.A00(this.A00), getResources().getConfiguration().orientation, false, false, MH.A0C(((AbstractC2221ae) this).A06.A04()));
    }

    private void A02() {
        XP.A0Z(this.A07, getAdDetailsView(), getCtaButton());
        this.A01 = new C2377dA(((AbstractC2221ae) this).A06.A06(), getAdDataBundle(), this.A08, getCtaButton(), this.A03, ((AbstractC2221ae) this).A06.A08());
    ...
    private void A04() {
        ...
        ((AbstractC2221ae) this).A06.A06().A0H().A00(c2085WgA02.A01);
        ...
        if (c2085WgA02.A00) {
            ...
            AbstractC2175Zs.A00(this.A04, U7.A1J(getAdContextWrapper()), new ViewOnClickListenerC2220ad(this));
        }
    }
    ...
    private void A05() {
        ...
        if (getAdInfo().A0K().A00() >= 0) {
            this.A02 = true;
            if (this.A07 != null) {
                AbstractC2117Xm abstractC2117Xm = this.A07;
                if (getAdDataBundle().A2G()) {
                    i10 = 8;
                }
                abstractC2117Xm.setToolbarActionMode(i10);
                this.A07.setProgressImmediate(0.0f);
            }
            new C2084Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C1768Jt(this)).A07();
        }
    }
