...
public final class C1760Jl {
    ...
    public C1760Jl(String str, float f10, float f11, int i10, int i11, float f12, float f13, int i12, float f14, int i13) {
        this.A09 = str;
        this.A02 = f10;
        this.A01 = f11;
        this.A06 = i10;
