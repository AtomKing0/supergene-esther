...
public final class C2751jX implements GX {
    ...
    public static final InterfaceC1673Gb A0L;
    public int A00;
    public int A01;
    public int A02;
    public GY A03;
    public C2755jb A04;
    public InterfaceC1780Kf A05;
    public boolean A06;
    public boolean A07;
    public boolean A08;
    public final int A09;
    public final int A0A;
    public final SparseArray<InterfaceC1780Kf> A0B;
    ...
    public final KY A0G;
    public final InterfaceC1777Kc A0H;
    ...
    static {
        A0G();
        A0L = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.ja
    ...
    public C2751jX(int i10) {
        this(1, i10, TsExtractor.DEFAULT_TIMESTAMP_SEARCH_BYTES);
    }

    public C2751jX(int i10, int i11, int i12) {
        this(i10, new C4R(0L), new C2773jt(i11), i12);
    }

    public C2751jX(int i10, C4R c4r, InterfaceC1777Kc interfaceC1777Kc, int i11) {
        this.A0H = (InterfaceC1777Kc) C3M.A01(interfaceC1777Kc);
        this.A0A = i11;
        this.A09 = i10;
        if (i10 == 1 || i10 == 2) {
    ...
    private int A00() throws C13322i {
        int iA09 = this.A0F.A09();
        int limit = this.A0F.A0A();
        int iA00 = AbstractC1781Kg.A00(this.A0F.A0l(), iA09, limit);
        this.A0F.A0f(iA00);
        int endOfPacket = iA00 + TsExtractor.TS_PACKET_SIZE;
        if (endOfPacket > limit) {
            ...
            if (this.A09 == 2 && this.A00 > 376) {
                throw C13322i.A01(A0D(0, 58, 29), null);
            }
        } else {
            this.A00 = 0;
        }
    ...
    public static /* synthetic */ int A02(C2751jX c2751jX) {
        int i10 = c2751jX.A02;
        c2751jX.A02 = i10 + 1;
        return i10;
    }
    ...
    private void A0F() {
        this.A0C.clear();
        this.A0B.clear();
        SparseArray<InterfaceC1780Kf> sparseArrayA5I = this.A0H.A5I();
        int size = sparseArrayA5I.size();
        for (int i10 = 0; i10 < size; i10++) {
            SparseArray<InterfaceC1780Kf> sparseArray = this.A0B;
        ...
        this.A0B.put(0, new C2757jd(new C2753jZ(this)));
        this.A05 = null;
    }
    ...
    private void A0H(long j10) {
        if (!this.A06) {
            ...
            if (this.A0G.A08() != C.TIME_UNSET) {
                this.A04 = new C2755jb(this.A0G.A09(), this.A0G.A08(), j10, this.A01, this.A0A);
                this.A03.AIN(this.A04.A07());
            } else {
                this.A03.AIN(new C2848lI(this.A0G.A08()));
            }
        }
    }
    ...
    private boolean A0J(InterfaceC2853lN interfaceC2853lN) throws IOException {
        ...
        while (this.A0F.A07() < 188) {
            ...
            int limit = interfaceC2853lN.read(bArrA0l, iA0A, 9400 - iA0A);
            if (limit == -1) {
                return false;
            }
    ...
    public final int AGb(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        InterfaceC1780Kf payloadReader;
        int i10;
        long jA8G = interfaceC2853lN.A8G();
        if (this.A08) {
            if (((jA8G == -1 || this.A09 == 2) ? false : true) && !this.A0G.A0A()) {
                return this.A0G.A07(interfaceC2853lN, c1691Gt, this.A01);
            }
            A0H(jA8G);
            if (this.A07) {
                this.A07 = false;
            ...
            if (c2755jb != null && this.A04.A09()) {
                return this.A04.A06(interfaceC2853lN, c1691Gt);
            }
        }
        boolean zA0J = A0J(interfaceC2853lN);
        if (A0K[5].charAt(9) == '6') {
            throw new RuntimeException();
        }
    ...
    */
    public final void AIM(long r16, long r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2751jX.AIM(long, long):void");
    }

    @Override // com.facebook.ads.redexgen.core.GX
    public final boolean AJL(InterfaceC2853lN interfaceC2853lN) throws IOException {
        byte[] bArrA0l = this.A0F.A0l();
        interfaceC2853lN.AG9(bArrA0l, 0, 940);
        for (int i10 = 0; i10 < 188; i10++) {
            ...
            while (true) {
                ...
                int startPosCandidate = bArrA0l[(i11 * TsExtractor.TS_PACKET_SIZE) + i10];
