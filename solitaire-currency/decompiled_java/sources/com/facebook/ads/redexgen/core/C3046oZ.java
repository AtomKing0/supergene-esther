...
public final class C3046oZ implements C1S {
    ...
    public static final C3046oZ A03 = new C13372n().A04();
    public static final String A04 = AbstractC13764a.A0h(0);
    public static final C1R<C3046oZ> A02 = new C1R() { // from class: com.facebook.ads.redexgen.X.oa
        @Override // com.facebook.ads.redexgen.core.C1R
        public final C1S A6X(Bundle bundle) {
            return C3046oZ.A01(bundle);
        }
    };

    public C3046oZ(C2B c2b) {
        this.A00 = c2b;
    }

    public static C3046oZ A01(Bundle bundle) {
        ArrayList<Integer> integerArrayList = bundle.getIntegerArrayList(A04);
        if (integerArrayList == null) {
            return A03;
        }
        C13372n c13372n = new C13372n();
        int i10 = 0;
        while (true) {
            ...
            if (i10 < size) {
                c13372n.A00(integerArrayList.get(i10).intValue());
                i10++;
            } else {
                return c13372n.A04();
            }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (!(obj instanceof C3046oZ)) {
                return false;
            }
            return this.A00.equals(((C3046oZ) obj).A00);
        }
