...
public final class C2734jF implements L9 {
    ...
    static {
        A04();
        A07 = C2734jF.class.getSimpleName();
    }

    public C2734jF(String str) {
        this(str, L7.A01(str));
    }

    public C2734jF(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C2734jF(String str, String str2) {
    ...
    */
    private java.net.HttpURLConnection A02(int r9, int r10) throws java.io.IOException, com.facebook.ads.redexgen.core.C2738jJ {
        /*
            Method dump skipped, instruction units count: 295
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2734jF.A02(int, int):java.net.HttpURLConnection");
    }

    private void A03() throws C2738jJ {
    ...
    private final void A05(int i10, int i11) throws C2738jJ {
        try {
            ...
            throw new C2738jJ(A01(154, 29, 90) + this.A03 + A01(19, 13, 66) + i10, e10);
        }
    }
    ...
    public final void AFz(int i10) throws C2738jJ {
        A05(i10, this.A00);
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final void close() throws C2738jJ {
        if (this.A02 != null) {
            try {
                this.A02.disconnect();
            } catch (NullPointerException e10) {
                throw new C2738jJ(A01(92, 37, 89), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final synchronized int length() throws C2738jJ {
    ...
    @Override // com.facebook.ads.redexgen.core.L9
    public final int read(byte[] bArr) throws C2738jJ {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C2738jJ(str, e10) { // from class: com.facebook.ads.redexgen.X.7e
                };
            } catch (IOException e11) {
                throw new C2738jJ(strA01 + this.A03, e11);
            }
        }
        throw new C2738jJ(strA01 + this.A03 + A01(51, 23, 42));
    }
