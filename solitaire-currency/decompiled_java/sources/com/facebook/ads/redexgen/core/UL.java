...
public final class UL implements AudienceNetworkExportedActivityApi {
    ...
    private boolean A03(UK uk) {
        ...
        A02(12);
        if (uk.A00 instanceof C2608gz) {
            ((C2608gz) uk.A00).A0F().A0F().AHA();
        }
        if (uk.A00 instanceof C2605gw) {
            LH lhA0F = ((C2605gw) uk.A00).A0H().A0F();
            if (A02[6].charAt(24) == 'N') {
    ...
    public final void onCreate(Bundle bundle) {
        C2387dL c2387dLA05 = RB.A05(this.A00, UUID.randomUUID().toString());
        ...
        InterfaceC1854Nc interfaceC1854Nc = ukA04 != null ? ukA04.A00 : null;
        if (ukA04 != null && (interfaceC1854Nc instanceof C2605gw)) {
            ...
            C2605gw c2605gw = (C2605gw) interfaceC1854Nc;
            c2605gw.A0G().A01().A0J(this.A00);
            c2605gw.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 101), -1), 0L);
        } else if (ukA04 != null && (interfaceC1854Nc instanceof C2608gz)) {
            if (!A03(ukA04)) {
                return;
            }
            C2608gz c2608gz = (C2608gz) interfaceC1854Nc;
            c2608gz.A0E().A05().A0J(this.A00);
            c2608gz.A0J();
        } else {
            c2387dLA05.A0F().AHY();
            A02(13);
