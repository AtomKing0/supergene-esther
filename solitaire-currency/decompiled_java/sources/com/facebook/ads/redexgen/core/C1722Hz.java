...
public final class C1722Hz {
     ...
     */
    public static C1722Hz A02(C4J c4j) {
        long jA0Q = c4j.A0Q();
        ...
        if (!z10) {
            ...
            if (!z12) {
                ...
                for (int i10 = 0; i10 < iA0I4; i10++) {
                    arrayList.add(new C1721Hy(c4j.A0I(), c4j.A0Q(), null));
                }
                if (A0B[3].charAt(19) == '7') {
        ...
        return new C1722Hz(jA0Q, z10, z11, z12, arrayList, jA0Q2, z13, jA0Q3, iA0M, iA0I, iA0I2);
    }

    public C1722Hz(long j10, boolean z10, boolean z11, boolean z12, List<C1721Hy> list, long j11, boolean z13, long j12, int i10, int i11, int i12) {
        this.A04 = j10;
        this.A0A = z10;
        this.A08 = z11;
        this.A09 = z12;
    ...
    public C1722Hz(Parcel parcel) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            arrayList.add(C1721Hy.A00(parcel));
        }
    ...
    public static C1722Hz A00(Parcel parcel) {
        return new C1722Hz(parcel);
    }
