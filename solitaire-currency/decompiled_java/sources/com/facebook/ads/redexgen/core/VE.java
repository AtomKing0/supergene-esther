...
public final class VE implements UQ {
    ...
    public VE(C2361cu c2361cu, WO wo) {
        this.A00 = c2361cu;
        this.A01 = wo;
    }

    public static JSONArray A01(C2361cu c2361cu, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c2361cu, jSONArray, jSONArray2, i10);
    }
    ...
    */
    public static org.json.JSONArray A02(com.facebook.ads.redexgen.core.C2361cu r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) {
        /*
    ...
    */
    private org.json.JSONObject A03() {
        /*
            ...
            if (r0 == 0) goto L46
            com.facebook.ads.redexgen.X.cu r0 = r7.A00
            org.json.JSONArray r6 = com.facebook.ads.redexgen.core.C2002Sx.A03(r0)
            if (r6 == 0) goto L46
            int r0 = r6.length()
            if (r0 <= 0) goto L46
    ...
    private JSONObject A04(int i10) {
        ...
        if (U9.A0P(this.A00) && (jSONArrayA04 = C2002Sx.A04(this.A00, (iA08 = U9.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    private void A06(String str) {
        if (C2002Sx.A0I(str)) {
            C2361cu c2361cu = this.A00;
            String[] strArr = A03;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                throw new RuntimeException();
            }
            A03[2] = "U9Gor";
            C2002Sx.A0B(c2361cu, str);
            return;
        }
        this.A01.A9x(str);
    }
    ...
    public final boolean AAS() {
        ...
        int eventLimit = C2002Sx.A00(this.A00);
    ...
    public final void ACJ() {
        ...
        if (iA4s > 0) {
            this.A00.A08().AAy(A00(379, 8, 37), AbstractC2000Sv.A10, new C2001Sw(A00(28, 44, 62) + iA4s));
        }
        C2002Sx.A0F(this.A00);
    }
