...
public final class IV {
    ...
    public C1735Im A05;
    public final H1 A06;
    public final C1737Io A07 = new C1737Io();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A02() {
        C1736In c1736InA00 = A00();
        if (c1736InA00 == null) {
            return;
        }
        C4J c4j = this.A07.A0H;
        if (c1736InA00.A00 != 0) {
            c4j.A0g(c1736InA00.A00);
        }
    ...
    public final int A04() {
        ...
        if (c1736InA00.A00 != 0) {
            c4j = this.A07.A0H;
            vectorSize = c1736InA00.A00;
        } else {
            byte[] initVectorData = c1736InA00.A04;
    ...
    */
    ...
    public final void A07(DrmInitData drmInitData) {
        C1736In encryptionBox = this.A05.A00(this.A07.A06.A02);
        this.A06.A6W(this.A05.A07.A09(drmInitData.A01(encryptionBox != null ? encryptionBox.A02 : null)));
    }

    public final void A08(C1735Im c1735Im, IP ip) {
        this.A05 = (C1735Im) C3M.A01(c1735Im);
        this.A04 = (IP) C3M.A01(ip);
        this.A06.A6W(c1735Im.A07);
        A05();
    }
