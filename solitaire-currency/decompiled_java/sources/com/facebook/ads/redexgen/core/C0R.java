...
public final class C0R<T extends Enum<T>> extends C1F<T> implements InterfaceC15159w<T>, Serializable {
    ...
    public C0R(T[] tArr) {
        C3078p6.A09(tArr, A03(7, 7, 113));
        this.A00 = tArr;
    }

    private final int A00(T t10) {
        C3078p6.A09(t10, A03(0, 7, 111));
