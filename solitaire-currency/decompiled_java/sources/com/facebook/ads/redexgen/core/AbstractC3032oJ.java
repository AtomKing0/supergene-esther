...
public abstract class AbstractC3032oJ {
     ...
     */
    public static boolean A01(@CheckForNull InterfaceC3027oE<?, ?> multimap, Object object) {
        if (object == multimap) {
            return true;
        }
        if (object instanceof InterfaceC3027oE) {
            return multimap.A49().equals(((InterfaceC3027oE) object).A49());
        }
        return false;
    }
    ...
    public static <K, V> InterfaceC1526Ah<K, V> A00(final Map<K, Collection<V>> map, final InterfaceC2740jM<? extends List<V>> factory) {
        return new C0Z<K, V>(map, factory) { // from class: com.facebook.ads.redexgen.X.0H
            public static final long serialVersionUID = 0;
            public transient InterfaceC2740jM<? extends List<V>> A00;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jM != com.google.common.base.Supplier<? extends java.util.List<V>> */
            {
                this.A00 = (InterfaceC2740jM) AbstractC2729jA.A04(factory);
            }
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0H != com.google.common.collect.Multimaps$CustomListMultimap<K, V> */
            @Override // com.facebook.ads.redexgen.core.AbstractC13081i
            ...
            private void readObject(ObjectInputStream stream) throws ClassNotFoundException, IOException {
                ...
                this.A00 = (InterfaceC2740jM) Objects.requireNonNull(stream.readObject());
