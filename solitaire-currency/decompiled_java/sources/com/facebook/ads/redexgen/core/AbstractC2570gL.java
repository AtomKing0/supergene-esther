...
public abstract class AbstractC2570gL {
    public static volatile InterfaceC2563gE A02 = C13161q.A00();
    ...
    public static void A01(@Nullable String str, String str2, Object obj) {
        if (A02.AAP(4)) {
            A00(str, AbstractC2565gG.A0J(str2, obj));
        }
    }
