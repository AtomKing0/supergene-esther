...
public final class C2070Vp implements InterfaceC2013Tj {
    ...
    public final InterfaceC2024Tu<UP> A01;
    public final InterfaceC2024Tu<UP> A02;
    ...
    */
    public final int A0B(int r13, java.util.Set<java.lang.String> r14, java.util.Set<java.lang.String> r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2070Vp.A0B(int, java.util.Set, java.util.Set):int");
    }

    static {
        A03();
        A05 = C2070Vp.class.getSimpleName();
    }

    public C2070Vp(C2361cu c2361cu) throws IOException {
        this.A00 = c2361cu;
        this.A01 = new C2067Vm(C2021Tr.A00(A00(11, 28, 27), c2361cu), new W7(this));
        this.A02 = new C2067Vm(C2021Tr.A00(A00(322, 37, 96), c2361cu), new W3(this));
    }
    ...
    public void A04(int i10, String str) {
        C2001Sw c2001Sw = new C2001Sw(str);
        c2001Sw.A05(1);
        this.A00.A08().AAz(A00(TypedValues.CycleType.TYPE_WAVE_PHASE, 15, 3), i10, c2001Sw);
    }

    private void A05(int i10, Throwable th) {
        this.A00.A08().AAy(A00(TypedValues.CycleType.TYPE_WAVE_PHASE, 15, 3), i10, new C2001Sw(th));
    }
    ...
    */
    public final java.util.List<org.json.JSONObject> A0C(int r8) {
        ...
        L69:
            ...
            com.facebook.ads.redexgen.X.Tt r0 = (com.facebook.ads.redexgen.core.InterfaceC2023Tt) r0     // Catch: com.facebook.ads.redexgen.core.U3 -> L79
        ...
        L79:
            ...
            boolean r0 = r0.AAF()
            if (r0 == 0) goto L95
            java.lang.String r3 = com.facebook.ads.redexgen.core.C2070Vp.A05
        ...
        L95:
            int r0 = com.facebook.ads.redexgen.core.AbstractC2000Sv.A2M
            r7.A05(r0, r4)
        L9a:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2070Vp.A0C(int):java.util.List");
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2013Tj
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2013Tj
    public final void AKL(UP up, AbstractC2011Tg<String> abstractC2011Tg) {
        XR.A00(XU.A07, new AsyncTaskC2014Tk(up, abstractC2011Tg, this.A01, this.A00), new Void[0]);
    }
}
