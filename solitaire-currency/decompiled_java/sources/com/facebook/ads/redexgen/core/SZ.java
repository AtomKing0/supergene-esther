...
public final class SZ {
    ...
    public final C2359cs A03 = new C2359cs(this);
    public final C2360ct A02 = new C2360ct(this);
    ...
    static {
        A07();
        StringBuilder sbAppend = new StringBuilder().append(A05(107, 14, 44)).append(C2359cs.A03.A01);
        ...
        StringBuilder sbAppend4 = sbAppend3.append(strA053).append(C2359cs.A02.A01).append(strA05);
        String strA054 = A05(136, 6, 26);
        A05 = sbAppend4.append(strA054).append(strA053).append(C2360ct.A04.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A05.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A0A.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A08.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A07.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A06.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A03.A01).append(strA05).append(strA054).append(strA053).append(C2360ct.A02.A01).append(A05(11, 6, 105)).append(strA054).append(A05(17, 6, 78)).append(strA052).append(A05(30, 4, 114)).append(strA054).append(strA053).append(C2360ct.A09.A01).append(A05(0, 3, 125)).append(strA052).append(strA053).append(C2359cs.A03.A01).append(A05(34, 10, 38)).append(strA054).append(strA053).append(C2360ct.A08.A01).append(A05(7, 4, 36)).toString();
        A08 = new ReentrantReadWriteLock();
        A06 = A08.readLock();
        A07 = A08.writeLock();
    }

    public SZ(C2361cu c2361cu) {
        this.A01 = c2361cu;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            this.A00 = new C1979Sa(this.A01, this);
        }
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A08().AAy(A05(128, 8, 110), AbstractC2000Sv.A0v, new C2001Sw(e10));
        throw e10;
        return A00();
    }
    ...
    public final int A08(int i10) {
        A07.lock();
        try {
            return A0E().delete(A05(136, 6, 26), C2360ct.A02.A01 + A05(3, 4, 60), new String[]{String.valueOf(i10 - 1)});
        } finally {
            A07.unlock();
        }
    }
    ...
    public final <T> AsyncTask A0F(AbstractC1981Sc<T> abstractC1981Sc, AbstractC2011Tg<T> abstractC2011Tg) {
        return XR.A00(XU.A07, new SY(this.A01, abstractC1981Sc, abstractC2011Tg), new Void[0]);
    }
    ...
    public final AsyncTask A0G(final String str, final int i10, final String str2, final double d10, final double d11, final String str3, final Map<String, String> data, AbstractC2011Tg<String> abstractC2011Tg) {
        return A0F(new AbstractC2358cr<String>() { // from class: com.facebook.ads.redexgen.X.6L
            ...
            @Override // com.facebook.ads.redexgen.core.AbstractC1981Sc
                    ...
                    try {
                        ...
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                ...
                                this.A03.A01.A08().AAy(eventId, AbstractC2000Sv.A0z, new C2001Sw(e10));
                            }
                        }
                        SZ.A07.unlock();
                        return strA0E;
                        ...
                        A01(EnumC1980Sb.A05);
                        this.A03.A01.A08().AAy(eventId, AbstractC2000Sv.A0y, new C2001Sw(e11));
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                if (sQLiteDatabaseA0E.inTransaction()) {
                                    sQLiteDatabaseA0E.endTransaction();
                                ...
                                this.A03.A01.A08().AAy(eventId, AbstractC2000Sv.A0z, new C2001Sw(e12));
                            }
                        }
                        SZ.A07.unlock();
                        return null;
                    ...
                    if (sQLiteDatabaseA0E != null) {
                        ...
                        if (zIsOpen) {
                            try {
                                ...
                                this.A03.A01.A08().AAy(eventId, AbstractC2000Sv.A0z, new C2001Sw(e13));
                            }
                        }
                    }
                    SZ.A07.unlock();
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb.append(A05(121, 7, 90)).append(A05(136, 6, 26)).append(A05(44, 5, 36)).append(C2360ct.A02.A01).append(A05(61, 1, 32)).append(C2360ct.A02.A01).append(A05(56, 2, 50)).append(A05(49, 7, 92)).append(C2360ct.A04.A01).append(A05(62, 2, 77));
    ...
    public final AbstractC1982Sd[] A0M() {
        return new AbstractC1982Sd[]{this.A03, this.A02};
    }
}
