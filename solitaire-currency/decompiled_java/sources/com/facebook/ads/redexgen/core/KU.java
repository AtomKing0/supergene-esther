...
public final class KU {
    ...
    private int A00(InterfaceC2853lN interfaceC2853lN) {
        this.A06.A0i(AbstractC13764a.A07);
        this.A03 = true;
        interfaceC2853lN.AI1();
        return 0;
    }

    private int A01(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        int iMin = (int) Math.min(20000L, interfaceC2853lN.A8G());
        ...
        c4j.A0d(iMin);
        interfaceC2853lN.AI1();
        interfaceC2853lN.AG9(this.A06.A0l(), 0, iMin);
        this.A01 = A04(this.A06);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        long jA8G = interfaceC2853lN.A8G();
        int iMin = (int) Math.min(20000L, jA8G);
        long j10 = jA8G - ((long) iMin);
        long searchStartPosition = interfaceC2853lN.A8f();
    ...
    */
    ...
    public final int A0B(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        if (!this.A05) {
            return A02(interfaceC2853lN, c1691Gt);
        }
