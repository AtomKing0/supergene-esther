...
public final class C14436p extends AbstractC2621hD {
    ...
    public C2605gw A00;
    public final C2595gm A01;

    public C14436p(C2595gm c2595gm, String str) {
        super(c2595gm.A0B, str, A00(c2595gm));
        this.A01 = c2595gm;
    }

    public static C2594gl A00(C2595gm c2595gm) {
        return new C2594gl(c2595gm);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2621hD
    ...
    public final void A09() {
        this.A00 = new C2605gw(this.A01, this, A04());
    ...
    public final void A0G(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, AbstractC1872Nu.A00(new Bundle(), rewardData));
    ...
    public final boolean A0J(Ad ad, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int iA00 = ((C1955Rb) rewardedVideoShowAdConfig).A00();
        long jA01 = ((C1955Rb) rewardedVideoShowAdConfig).A01();
        if (super.A00.A6N()) {
            return false;
        }
        this.A01.A02(ad);
