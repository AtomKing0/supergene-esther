...
public abstract class AbstractC2161Ze extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC2161Ze.class.getSimpleName();
    }

    public AbstractC2161Ze(Activity activity, C2387dL c2387dL) {
        super(activity);
        A0E(c2387dL);
    }

    public AbstractC2161Ze(C2387dL c2387dL) {
        super(c2387dL);
        A0E(c2387dL);
    }

    public static void A0D(int i10) {
        C2361cu context = SP.A00();
        if (context != null) {
            context.A08().AAy(A0B(56, 8, 37), i10, new C2001Sw(A0B(35, 10, 3)));
        }
    }
