...
public abstract class X7 {
    ...
    public static String A06(Throwable th, int i10, int i11, boolean z10) {
        ...
        try {
            ...
            if (i11 >= 0) {
                c1898Ow = new C1897Ov(c1898Ow, i11);
            }
            if (i10 >= 0) {
                c1898Ow = new C1896Ou(c1898Ow, i10, i10);
            }
            if (z10) {
                c1898Ow = new C1898Ow(c1898Ow);
            }
            C1900Oy c1900Oy = new C1900Oy(c1899Ox, 1, c1898Ow);
            th.printStackTrace(new PrintWriter(new X6(c1900Oy)));
            c1900Oy.flush();
            return c1899Ox.toString();
