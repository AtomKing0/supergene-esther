...
public final class RunnableC13543e implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC13543e(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C13523c(AbstractC13764a.A0n(A04(0, 67, 111), Boolean.valueOf(success), Integer.valueOf(iArr[0]), configs[0]));
    }
    ...
    public static EGLContext A01(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i10) {
        ...
        throw new C13523c(A04(67, 23, 12));
    }

    public static EGLDisplay A02() {
        EGLDisplay eGLDisplayEglGetDisplay = EGL14.eglGetDisplay(0);
        if (eGLDisplayEglGetDisplay == null) {
            throw new C13523c(A04(120, 20, 33));
        }
        int[] iArr = new int[2];
        boolean eglInitialized = EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1);
        if (!eglInitialized) {
            throw new C13523c(A04(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 20, 106));
        }
    ...
    public static void A06(int[] iArr) {
        ...
        if (iGlGetError == 0) {
            ...
            throw new C13523c(A04(181, 29, 50) + Integer.toHexString(iGlGetError));
        }
    }
