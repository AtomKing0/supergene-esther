...
public final class H2 {
    ...
    public final void A03(InterfaceC2853lN interfaceC2853lN) throws IOException {
        if (this.A05) {
            return;
        }
        interfaceC2853lN.AG9(this.A06, 0, 10);
    ...
    public final void A04(H1 h12, long j10, int i10, int i11, int i12, C1697Gz c1697Gz) {
    ...
    public final void A05(H1 h12, C1697Gz c1697Gz) {
        if (this.A02 > 0) {
            h12.AIA(this.A04, this.A00, this.A03, this.A01, c1697Gz);
            this.A02 = 0;
        }
    }
}
