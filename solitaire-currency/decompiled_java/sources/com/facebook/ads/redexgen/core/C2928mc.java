...
public final class C2928mc implements InterfaceC1551Bh {
    public static byte[] A02;
    public static final SparseArray<Constructor<? extends InterfaceC1549Bf>> A03;
    public final C2717ix A00;
     ...
     */
    public static Constructor<? extends InterfaceC1549Bf> A03(Class<?> cls) {
        try {
            return cls.asSubclass(InterfaceC1549Bf.class).getConstructor(C3055oi.class, C2717ix.class, Executor.class);
    ...
    public C2928mc(C2717ix c2717ix, Executor executor) {
        this.A00 = (C2717ix) C3M.A01(c2717ix);
        this.A01 = (Executor) C3M.A01(executor);
    }

    public static SparseArray<Constructor<? extends InterfaceC1549Bf>> A00() {
        SparseArray<Constructor<? extends InterfaceC1549Bf>> sparseArray = new SparseArray<>();
        try {
    ...
    private InterfaceC1549Bf A01(DownloadRequest downloadRequest, int i10) {
        Constructor<? extends InterfaceC1549Bf> constructor = A03.get(i10);
        if (constructor != null) {
            try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1551Bh
    public final InterfaceC1549Bf A5E(DownloadRequest downloadRequest) {
        int iA0B = AbstractC13764a.A0B(downloadRequest.A00, downloadRequest.A03);
        switch (iA0B) {
            case 0:
            case 1:
            case 2:
            ...
            case 4:
                return new C2921mV(new C2I().A00(downloadRequest.A00).A02(downloadRequest.A01).A05(), this.A00, this.A01);
        }
    }
}
