...
public final class WR {
    ...
    public static int A00(C2387dL c2387dL, int i10) {
        return AbstractC2059Ve.A00(c2387dL).getInt(A01(0, 21, 52), i10);
    }

    public static String A02(C2387dL c2387dL, String str) {
        int iA00 = A00(c2387dL, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C2387dL c2387dL, String str, String str2) {
        if (c2387dL == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c2387dL, str);
    ...
    public final RewardedVideoAd A07(C2387dL c2387dL, String str, String str2) {
        if (c2387dL == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c2387dL, str);
    ...
    public final void A08(C2387dL c2387dL, boolean z10) {
        int i10 = 0;
        String strA01 = A01(0, 21, 52);
        if (!z10) {
            int lastNonChainedAds = AbstractC2059Ve.A00(c2387dL).getInt(strA01, 0);
            i10 = lastNonChainedAds + 1;
        }
        AbstractC2059Ve.A00(c2387dL).edit().putInt(strA01, i10).apply();
    }

    public final boolean A09(C2387dL c2387dL, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c2387dL, i10 - 1);
