...
public abstract class AbstractC13904o {
     ...
     */
    public static int A00(SQLiteDatabase sQLiteDatabase, int i10, String str) throws C13874l {
        try {
        } catch (SQLException e10) {
            throw new C13874l(e10);
        }
        if (!AbstractC13764a.A19(sQLiteDatabase, A01(159, 17, 73))) {
            return -1;
        }
    ...
    public static void A03(SQLiteDatabase sQLiteDatabase, int i10, String str) throws C13874l {
        String strA01 = A01(159, 17, 73);
        try {
            if (!AbstractC13764a.A19(sQLiteDatabase, strA01)) {
                return;
            }
    ...
    public static void A04(SQLiteDatabase sQLiteDatabase, int i10, String str, int i11) throws C13874l {
        try {
