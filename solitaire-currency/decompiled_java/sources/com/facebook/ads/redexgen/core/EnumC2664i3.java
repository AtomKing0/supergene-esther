...
public enum EnumC2664i3 {
    ...
    public static EnumC2664i3[] valuesCustom() {
        EnumC2664i3[] enumC2664i3ArrValuesCustom = values();
        if (A01[0].charAt(28) == 't') {
            throw new RuntimeException();
        }
        A01[7] = "Z";
        return (EnumC2664i3[]) enumC2664i3ArrValuesCustom.clone();
    }
}
