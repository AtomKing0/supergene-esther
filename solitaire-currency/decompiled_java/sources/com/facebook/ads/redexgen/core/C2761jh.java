...
public final class C2761jh implements GP {
    ...
    private GN A00(C4J c4j, long scrValue, long scrTimeUs) {
        ...
        while (c4j.A07() >= 4) {
            if (C2760jg.A00(c4j.A0l(), c4j.A09()) != 442) {
                c4j.A0g(1);
            } else {
                c4j.A0g(4);
    ...
    */
    public static void A01(com.facebook.ads.redexgen.core.C4J r5) {
        ...
        L33:
            byte[] r1 = r5.A0l()
            int r0 = r5.A09()
            int r1 = com.facebook.ads.redexgen.core.C2760jg.A01(r1, r0)
        ...
        L86:
            ...
            goto L57
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2761jh.A01(com.facebook.ads.redexgen.X.4J):void");
    }

    @Override // com.facebook.ads.redexgen.core.GP
    public final void AFA() {
        this.A00.A0i(AbstractC13764a.A07);
    }

    @Override // com.facebook.ads.redexgen.core.GP
    public final GN AIC(InterfaceC2853lN interfaceC2853lN, long j10) throws IOException {
        long jA8f = interfaceC2853lN.A8f();
        int iMin = (int) Math.min(20000L, interfaceC2853lN.A8G() - jA8f);
        this.A00.A0d(iMin);
        interfaceC2853lN.AG9(this.A00.A0l(), 0, iMin);
