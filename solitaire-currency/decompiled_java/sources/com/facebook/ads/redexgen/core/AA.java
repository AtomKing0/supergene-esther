...
public final class AA implements InterfaceC3114px {
    ...
    public final InterfaceC3117q2 A03;
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC3118q3> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public AA(View view, InterfaceC3117q2 interfaceC3117q2) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC3117q2;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC3114px
