...
public final class C2384dI {
    ...
    public C2384dI(C2387dL c2387dL, YY yy, String str, InterfaceC2118Xn interfaceC2118Xn) {
        this.A01 = c2387dL;
        this.A03 = yy;
        this.A04 = str;
    ...
    public final void A05() {
        if (!TextUtils.isEmpty(this.A04)) {
            AsyncTaskC2486ex asyncTaskC2486ex = new AsyncTaskC2486ex(this.A01, new HashMap());
            asyncTaskC2486ex.A07(new EV(this));
            asyncTaskC2486ex.executeOnExecutor(this.A00, this.A04);
        }
    }
}
