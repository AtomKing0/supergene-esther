...
public class RunnableC2302bx implements Runnable {
    public static byte[] A02;
    public final /* synthetic */ C2306c1 A00;
    ...
    public RunnableC2302bx(C2306c1 c2306c1, String str) {
        this.A00 = c2306c1;
        this.A01 = str;
    }
        ...
        try {
            try {
                ...
                if (this.A00.A05.equals(jSONObject.optString(A00(64, 7, 87)))) {
                    this.A00.A0C(EnumC2304bz.A00(jSONObject.optString(A00(81, 4, 27))), jSONObject.optString(A00(71, 10, 49), A00(85, 2, 32)));
                } else {
                    this.A00.A04.A04(AbstractC2000Sv.A11, A00(0, 30, 47));
                }
            } catch (JSONException e10) {
                this.A00.A04.A04(AbstractC2000Sv.A15, A00(30, 34, 108) + e10.getMessage());
            }
        } catch (Throwable th) {
