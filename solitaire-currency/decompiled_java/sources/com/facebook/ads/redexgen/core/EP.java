...
public final class EP extends FrameLayout implements InterfaceC2388dM {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public static final int A0E = (int) (AbstractC2090Wl.A02 * 6.0f);
    public static final int A0D = (int) (AbstractC2090Wl.A02 * 8.0f);
    public static final int A0C = (int) (AbstractC2090Wl.A02 * 12.0f);
    public static final int A0A = (int) (AbstractC2090Wl.A02 * 350.0f);
    public static final int A09 = (int) (AbstractC2090Wl.A02 * 250.0f);
    public static final int A0B = (int) (AbstractC2090Wl.A02 * 175.0f);

    public EP(C2387dL c2387dL, NativeAd nativeAd, C2047Ur c2047Ur, EnumC2048Us enumC2048Us, C2201aK c2201aK, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c2387dL);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C2389dN(c2387dL, this.A05, c2047Ur, c2201aK, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC2048Us == EnumC2048Us.A09 || enumC2048Us == EnumC2048Us.A0B) {
            A07(c2047Ur);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC2048Us != EnumC2048Us.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c2047Ur);
            A04(c2047Ur);
            A05(c2047Ur);
        }
        this.A07.add(c2201aK);
    ...
    */
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        C2389dN c2389dN = this.A06;
        int top = this.A06.getMeasuredHeight();
        c2389dN.layout(i10, i11, i12, top + i11);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (emptySpace == 0) {
            ...
            if (emptySpace2 == 0 || ((C2531fh) this.A04.getMediaViewApi()).A0N()) {
                iMin = iA00;
            } else {
