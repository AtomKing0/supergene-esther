...
public final class C6F extends C2567gI {
    ...
    public final C2347cg A06;
    public final C2348ch A07;

    public C6F(C2387dL c2387dL, C2348ch c2348ch, C2347cg c2347cg) {
        super(c2387dL);
        this.A02 = 0;
        this.A00 = 50.0f;
        this.A05 = c2387dL;
    ...
    public final void A1L(QW qw, C1931Qd c1931Qd, int i10, int widthMode) {
        int[] iArrA02;
        int mode = View.MeasureSpec.getMode(i10);
        int mode2 = View.MeasureSpec.getMode(widthMode);
        if ((mode == 1073741824 && A28() == 1) || (mode2 == 1073741824 && A28() == 0)) {
            super.A1L(qw, c1931Qd, i10, widthMode);
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.core.C2567gI, com.facebook.ads.redexgen.core.QO
    public final void A1r(int i10) {
        A2D(i10, this.A02);
    }

    @Override // com.facebook.ads.redexgen.core.C2567gI, com.facebook.ads.redexgen.core.QO
    public final void A1z(C14346g c14346g, C1931Qd c1931Qd, int i10) {
        this.A03.A0A(i10);
        A1N(this.A03);
    }
