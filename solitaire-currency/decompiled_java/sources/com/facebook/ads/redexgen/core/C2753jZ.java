...
public class C2753jZ implements KW {
    public final C4I A00 = new C4I(new byte[4]);
    public final /* synthetic */ C2751jX A01;

    public C2753jZ(C2751jX c2751jX) {
        this.A01 = c2751jX;
    }
        ...
        for (int i10 = 0; i10 < iA07; i10++) {
            ...
            if (programCount == 0) {
                ...
                if (this.A01.A0B.get(iA04) == null) {
                    this.A01.A0B.put(iA04, new C2757jd(new C2752jY(this.A01, iA04)));
                    C2751jX.A02(this.A01);
                }
            }
        }
