...
public final class C3057ok implements C1S {
    ...
    public static final C3057ok A07 = new C2O().A05();
    public static final C1R<C3057ok> A06 = new C1R() { // from class: com.facebook.ads.redexgen.X.ol
        @Override // com.facebook.ads.redexgen.core.C1R
        public final C1S A6X(Bundle bundle) {
            return C3057ok.A00(bundle);
        }
    };

    @Deprecated
    public C3057ok(long j10, long j11, long j12, float f10, float f11) {
        this.A04 = j10;
        this.A03 = j11;
        this.A02 = j12;
        this.A01 = f10;
    ...
    public C3057ok(C2O c2o) {
        this(c2o.A04, c2o.A03, c2o.A02, c2o.A01, c2o.A00);
    }

    public static /* synthetic */ C3057ok A00(Bundle bundle) {
        return new C3057ok(bundle.getLong(A01(0), C.TIME_UNSET), bundle.getLong(A01(1), C.TIME_UNSET), bundle.getLong(A01(2), C.TIME_UNSET), bundle.getFloat(A01(3), -3.4028235E38f), bundle.getFloat(A01(4), -3.4028235E38f));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C3057ok)) {
            return false;
        }
        C3057ok c3057ok = (C3057ok) obj;
        if (this.A04 == c3057ok.A04 && this.A03 == c3057ok.A03) {
            long j10 = this.A02;
            ...
            if (j10 == c3057ok.A02) {
                ...
                if (f10 == f11 && this.A00 == c3057ok.A00) {
                    return true;
                }
            }
        }
