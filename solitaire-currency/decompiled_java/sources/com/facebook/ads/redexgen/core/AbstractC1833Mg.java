...
public abstract class AbstractC1833Mg {
     ...
     */
    public static C2671iB A01(@Nullable C2387dL c2387dL, JSONObject jSONObject, String str, boolean z10, int i10, int i11) {
        boolean zOptBoolean;
        int iOptInt;
        ArrayList arrayList;
        if (jSONObject == null) {
        ...
        String strA02 = AbstractC2096Wr.A02(jSONObject, A02(266, 12, 52));
        Uri uriA00 = TextUtils.isEmpty(strA02) ? null : WQ.A00(strA02);
        String strA022 = AbstractC2096Wr.A02(jSONObject, A02(128, 4, 54));
        String strA01 = X9.A01(strA022);
        String strA023 = AbstractC2096Wr.A02(jSONObject, A02(101, 15, 34));
        String strA024 = AbstractC2096Wr.A02(jSONObject, A02(485, 5, 32));
        String strA025 = AbstractC2096Wr.A02(jSONObject, A02(477, 8, 43));
        String strA026 = AbstractC2096Wr.A02(jSONObject, A02(278, 8, 99));
        String strA027 = AbstractC2096Wr.A02(jSONObject, A02(431, 14, 94));
        String strA028 = AbstractC2096Wr.A02(jSONObject, A02(295, 16, 122));
        String strA029 = AbstractC2096Wr.A02(jSONObject, A02(445, 21, 1));
        String strA0210 = AbstractC2096Wr.A02(jSONObject, A02(87, 14, 99));
        String strA0211 = AbstractC2096Wr.A02(jSONObject, A02(351, 20, 125));
        String strA0212 = AbstractC2096Wr.A02(jSONObject, A02(335, 16, 114));
        String strA0213 = AbstractC2096Wr.A02(jSONObject, A02(318, 17, 38));
        String strA0214 = AbstractC2096Wr.A02(jSONObject, A02(132, 14, 16));
        AnonymousClass74 anonymousClass74A00 = AnonymousClass74.A00(jSONObject, c2387dL);
        C2045Up c2045UpA00 = C2045Up.A00(jSONObject.optJSONObject(A02(286, 4, 38)));
        C2045Up c2045UpA002 = C2045Up.A00(jSONObject.optJSONObject(A02(290, 5, 12)));
        C2046Uq c2046UqA00 = C2046Uq.A00(jSONObject.optJSONObject(A02(466, 11, 29)));
        String strA0215 = AbstractC2096Wr.A02(jSONObject, A02(490, 15, 41));
        boolean zOptBoolean2 = jSONObject.optBoolean(A02(238, 15, 64));
        boolean zOptBoolean3 = jSONObject.optBoolean(A02(219, 19, 54));
        int iOptInt3 = jSONObject.optInt(A02(c3.a.b.f11497f, 25, 123), 4);
        ...
        C2045Up c2045UpA003 = jSONObjectOptJSONObject != null ? C2045Up.A00(jSONObjectOptJSONObject) : null;
        String strA0216 = AbstractC2096Wr.A02(jSONObject, A02(68, 19, 95));
        MJ mjA00 = ML.A00(jSONObject);
        Collection<String> collectionA03 = ML.A03(c2387dL, jSONObject);
        String strA0217 = AbstractC2096Wr.A02(jSONObject, A02(560, 9, 10));
        ...
        String strA0218 = AbstractC2096Wr.A02(jSONObject, A02(IronSourceError.ERROR_NON_EXISTENT_INSTANCE, 9, 123));
        String strA0219 = A02(505, 22, 124);
        EnumC2050Uu enumC2050Uu = !jSONObject.has(strA0219) ? EnumC2050Uu.A03 : jSONObject.optBoolean(strA0219) ? EnumC2050Uu.A05 : EnumC2050Uu.A04;
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                ...
                for (int i12 = 0; i12 < length; i12++) {
                    try {
                        arrayList2.add(A01(c2387dL, jSONArrayOptJSONArray.getJSONObject(i12), str, true, i12, length));
                    } catch (JSONException e10) {
                        e = e10;
                        arrayList = arrayList2;
                        c2387dL.A08().AAy(A02(311, 7, 111), AbstractC2000Sv.A2A, new C2001Sw(e));
                        Log.e(C2683iN.A0E, A02(23, 30, 97), e);
                        return new C2671iB(strA0216, strA01, strA022, strA023, strA024, strA025, strA026, strA027, strA028, strA029, strA0210, strA0211, strA0212, strA0213, strA0214, c2045UpA003, anonymousClass74A00, c2045UpA00, c2045UpA002, c2046UqA00, strA0217, strA0218, jOptLong, enumC2050Uu, z10, i10, i11, arrayList, str, strOptString, iOptInt2, strOptString2, uriA00, strA0215, zOptBoolean2, zOptBoolean3, iOptInt4, iOptInt3, iOptInt5, iOptInt6, mjA00, collectionA03, iOptInt, zOptBoolean);
                    }
                }
                arrayList = arrayList2;
            }
    ...
    public static C2671iB A00(C2387dL c2387dL, JSONObject jSONObject, String str) {
        return A01(c2387dL, jSONObject, str, false, -1, 0);
    }
}
