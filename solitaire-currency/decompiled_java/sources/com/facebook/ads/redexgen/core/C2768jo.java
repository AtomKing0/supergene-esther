...
public final class C2768jo implements KJ {
    ...
    public C2768jo(KX kx, boolean z10, boolean z11) {
        this.A0B = kx;
        this.A0C = z10;
        this.A0D = z11;
    }
    ...
    private void A03(long j10, int i10, int i11, long j11) {
        if (!this.A05 || this.A03.A06()) {
            ...
            if (!this.A05) {
                if (this.A0A.A03() && this.A08.A03()) {
                    ...
                    C1687Gp c1687GpA09 = AbstractC1688Gq.A09(this.A0A.A01, 3, this.A0A.A00);
                    C1686Go c1686GoA07 = AbstractC1688Gq.A07(this.A08.A01, 3, this.A08.A00);
                    this.A02.A6W(new C2D().A0y(this.A04).A11(A00(0, 9, 116)).A0w(C3U.A01(c1687GpA09.A08, c1687GpA09.A01, c1687GpA09.A04)).A0r(c1687GpA09.A0A).A0f(c1687GpA09.A03).A0Y(c1687GpA09.A00).A12(arrayList).A14());
                    this.A05 = true;
                    this.A03.A04(c1687GpA09);
                    this.A03.A03(c1686GoA07);
                    this.A0A.A00();
                    this.A08.A00();
                }
            } else {
                ...
                if (sampleIsKeyFrame) {
                    this.A03.A04(AbstractC1688Gq.A09(this.A0A.A01, 3, this.A0A.A00));
                    this.A0A.A00();
                } else if (this.A08.A03()) {
                    this.A03.A03(AbstractC1688Gq.A07(this.A08.A01, 3, this.A08.A00));
                    this.A08.A00();
                }
            }
        }
        if (this.A09.A04(i11)) {
            ...
            strArr[2] = "";
            this.A07.A0j(this.A09.A01, AbstractC1688Gq.A02(bArr, this.A09.A00));
            this.A07.A0f(4);
    ...
    public final void A52(C4J c4j) {
        ...
        h12.AI7(c4j, offset2);
        while (true) {
            int iA04 = AbstractC1688Gq.A04(bArrA0l, iA09, iA0A, this.A0E);
            if (iA04 == iA0A) {
                A05(bArrA0l, iA09, iA0A);
                return;
            }
            int lengthToNalUnit = AbstractC1688Gq.A01(bArrA0l, iA04);
            if (A0G[7].charAt(24) == 'z') {
                throw new RuntimeException();
            }
            String[] strArr = A0G;
