...
public abstract class BZ implements InterfaceC2730jB<Character> {
    ...
    public static C12750b A02(final char match) {
        return new AbstractC13151p(match) { // from class: com.facebook.ads.redexgen.X.0b
    ...
    public int A08(CharSequence sequence, int start) {
        ...
        AbstractC2729jA.A01(start, length);
        while (start < length) {
