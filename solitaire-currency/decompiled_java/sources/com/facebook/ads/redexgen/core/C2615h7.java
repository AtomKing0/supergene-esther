...
public final class C2615h7 {
    ...
    public /* synthetic */ C2615h7(AbstractC3079p7 abstractC3079p7) {
        this();
    }
    ...
    private final long A01(List<C2617h9> list, int i10, int i11) {
    ...
    private final String A04(List<Long> list) {
        ...
        C3078p6.A08(string, A02(115, 13, 74));
        return A03(string);
    }

    private final String A05(List<C2617h9> list, int i10, int i11, boolean z10) {
    ...
    private final void A08(StringBuilder sb, long j10) {
        while (j10 >= 128) {
            ...
            long v10 = 128;
            j10 >>= 7;
            sb.append((char) (AbstractC3088pM.A00((short) (j11 | v10)) & 65535));
        }
        int iA00 = AbstractC3088pM.A00((short) j10) & 65535;
        String[] strArr = A01;
    ...
    private final void A09(List<C2617h9> list, int i10, int i11) {
        long a00;
        int i12 = (i10 + i11) - 1;
        int i13 = i10 + 1;
        if (i13 > i12) {
    ...
    @JvmStatic
    public final String A0A(List<C2617h9> list) {
        if (list != null) {
