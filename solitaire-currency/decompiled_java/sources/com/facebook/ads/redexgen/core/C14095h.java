...
public class C14095h extends AbstractC1740Ir {
    public YM A00;
    public InterfaceC2276bX A01;
    public C2356cp A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    ...
    public static final int A0L = (int) (AbstractC2090Wl.A02 * 0.0f);
    public static final int A0M = (int) (AbstractC2090Wl.A02 * 9.0f);
    public static final int A0K = (int) (AbstractC2090Wl.A02 * 9.0f);

    public C14095h(C2225ai c2225ai, boolean z10, String str, FH fh) {
        super(c2225ai, z10);
        this.A0G = new Path();
        this.A0H = new RectF();
    ...
    public void A00() {
        if (this.A0I.A0F() != null && this.A02 != null) {
            C1590Cw c1590CwA0F = this.A0I.A0F();
            ...
            c1590CwA0F.AAm(simpleVideoView);
    ...
    */
    public void A02() {
        ...
        L5:
            ...
            if (r0 == 0) goto L25
            boolean r3 = r4.A05
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C14095h.A0J
            r0 = 4
            r1 = r1[r0]
            r0 = 16
            ...
            r0 = 83
            if (r1 == r0) goto L35
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C14095h.A0J
        ...
        L35:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C14095h.A02():void");
    }
    ...
    public void setCTAInfo(C1851Mz c1851Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c1851Mz, this.A0E, extraData);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC2276bX interfaceC2276bX) {
        this.A01 = interfaceC2276bX;
    }

    public void setUpImageView(C2387dL c2387dL) {
        this.A00 = new YM(c2387dL);
        if (U7.A1I(c2387dL)) {
            AbstractC2175Zs.A00(this.A00, U7.A1J(c2387dL), new ViewOnClickListenerC2193aC(this));
        }
        A04(this.A00);
    }
    ...
    public void setUpVideoView(C2387dL c2387dL) {
        this.A02 = new C2356cp(c2387dL, new C2030Ua(this.A0E, getAdEventManager()));
        if (U7.A1K(c2387dL)) {
            AbstractC2175Zs.A00(this.A02, U7.A1L(c2387dL), new ViewOnClickListenerC2194aD(this));
        }
        C2356cp c2356cp = this.A02;
        if (A0J[2].charAt(30) != 'G') {
            throw new RuntimeException();
