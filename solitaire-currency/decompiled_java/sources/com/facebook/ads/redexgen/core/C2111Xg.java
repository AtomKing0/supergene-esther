...
public final class C2111Xg {
    ...
    static {
        A01();
        A02 = C2111Xg.class.getSimpleName();
    }

    public static boolean A02(C2387dL c2387dL) {
        return A03(c2387dL) && C2112Xh.A03(c2387dL);
    }
    ...
    public static boolean A03(C2387dL c2387dL) {
        ...
        try {
            return ((PowerManager) c2387dL.getSystemService(A00(60, 5, 91))).isInteractive();
        } catch (Exception e10) {
            Log.e(A02, A00(0, 60, 20), e10);
            c2387dL.A08().AAy(A00(65, 5, 53), AbstractC2000Sv.A2S, new C2001Sw(e10));
            return true;
        }
    }
}
