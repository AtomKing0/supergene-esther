...
public final class C1741Is extends AbstractC2221ae {
    ...
    public final C2030Ua A0Z;
    public final KL A0a;
    public final InterfaceC2187a4 A0b;
    public final C2225ai A0c;
    ...
    public C1741Is(C2225ai c2225ai) {
        super(c2225ai, true);
        this.A0K = false;
        this.A0M = false;
        this.A0N = false;
        ...
        this.A0C = true;
        this.A0d = new RunnableC2268bP(this);
        this.A0b = new J2(this);
        this.A0S = new Handler(Looper.getMainLooper());
        this.A0W = (InputMethodManager) c2225ai.A06().getSystemService(A0J(12, 12, 46));
        this.A0c = c2225ai;
        this.A0Y = this.A0c.A05();
        this.A0Z = new C2030Ua(c2225ai.A05().A25(), c2225ai.A07());
        this.A0R = A00(c2225ai);
        this.A0V = this.A0c.A03();
        this.A0X = MI.A01(c2225ai.A06(), c2225ai.A07(), c2225ai.A05().A25(), WQ.A00(c2225ai.A05().A20().A0J().A05()), new HashMap(), false, true, this.A0Y.A21());
        AbstractC2208aR.A00(c2225ai.A06(), this, c2225ai.A05().A20().A0H().A08());
        this.A0D = false;
        ...
        this.A0e = c2225ai.A05().A1e();
        getAdContextWrapper().A0F().ABe(this.A0e, true, c2225ai.A05().A2C());
        this.A09 = null;
    ...
    private float A00(C2225ai c2225ai) {
        ...
        float mAspectRatio2 = new SF(c2225ai.A06()).A0M(this.A0Y.A20().A0H().A08());
        return mAspectRatio2;
    }

    public static /* synthetic */ int A02(C1741Is c1741Is) {
        int i10 = c1741Is.A00;
        c1741Is.A00 = i10 + 1;
        return i10;
    }

    public static /* synthetic */ int A04(C1741Is c1741Is) {
        int i10 = c1741Is.A01;
        c1741Is.A01 = i10 + 1;
        return i10;
    }

    private KL A0F(C2225ai c2225ai) {
        KL c14195r;
        if (A0w(this.A0R)) {
            c14195r = new C14185q(c2225ai.A06(), getCtaButton(), AbstractC1771Jw.A0I, true, getColors(), c2225ai.A05().A0r(), c2225ai.A07(), c2225ai.A0D(), c2225ai.A0G(), c2225ai.A0A(), c2225ai.A05(), c2225ai.A0F(), c2225ai.A08(), true);
        } else if (A0x(this.A0R)) {
            c14195r = new C14175p(c2225ai.A06(), getCtaButton(), AbstractC1771Jw.A0I, true, getColors(), c2225ai.A05().A0r(), c2225ai.A07(), c2225ai.A0D(), c2225ai.A0G(), c2225ai.A0A(), c2225ai.A05(), c2225ai.A0F(), c2225ai.A08(), true);
        } else {
            c14195r = new C14195r(c2225ai.A06(), getCtaButton(), AbstractC1771Jw.A0I, true, getColors(), c2225ai.A05().A0r(), c2225ai.A07(), c2225ai.A0D(), c2225ai.A0G(), c2225ai.A0A(), c2225ai.A05(), c2225ai.A0F(), c2225ai.A08(), true);
        }
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams.addRule(12);
        c14195r.setVisibility(8);
        c14195r.setLayoutParams(layoutParams);
        if (c2225ai.A0H() != null) {
            c14195r.setChainedAdInfo(c2225ai.A0H());
        }
        return c14195r;
    }

    private C2199aI A0G(E1 e12) {
        return new C2199aI(this.A0c, this.A0Y, e12, this.A0c.A0D(), new J4(this), this.A0V, this.A0a, this.A03);
    }
    ...
    private void A0O() {
        this.A0c.A06().A0F().AJw(AbstractC2081Wa.A00(this.A0R), getResources().getConfiguration().orientation, false, this.A0c.A0H() != null, MH.A0A());
        ...
        A0q(this.A0D, false);
        this.A0a.A0r(getResources().getConfiguration().orientation);
        this.A0a.bringToFront();
    }

    private void A0P() {
        AbstractC2117Xm abstractC2117XmA0C;
        if (this.A0c.A05().A1n() && (abstractC2117XmA0C = this.A0c.A0C()) != null) {
            abstractC2117XmA0C.setProgressSpinnerInvisible(false);
        }
    }
    ...
    private void A0R() {
        if (this.A0Y.A1W()) {
            this.A0U.setOnClickListener(new ViewOnClickListenerC2270bR(this));
        }
        XP.A0H(this.A0U);
        addView(this.A0U, new RelativeLayout.LayoutParams(-1, -1));
        XP.A0I(this.A0U);
        if (U7.A17(this.A0c.A06())) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC2271bS(this);
            this.A0a.setCTAClickListener(onClickListener);
            if (this.A0c.A0C() != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC2272bT(this);
                this.A0c.A0C().setCTAClickListener(onClickListener2);
            }
        }
        if (U7.A1K(getAdContextWrapper())) {
            AbstractC2175Zs.A00(this.A0U, U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC2273bU(this));
        } else {
            if (!U7.A1I(getAdContextWrapper())) {
                return;
            }
            AbstractC2175Zs.A00(this.A0U, U7.A1J(getAdContextWrapper()), new ViewOnClickListenerC2274bV(this));
        }
    }
    ...
    private void A0S() {
        if (this.A0V != null) {
            XP.A0H(this.A0V);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC2221ae.A0J, AbstractC2221ae.A0J);
            layoutParams.setMargins(AbstractC2221ae.A0A, AbstractC2221ae.A0G, AbstractC2221ae.A0A, AbstractC2221ae.A09);
    ...
    private void A0T() {
        AbstractC2117Xm abstractC2117XmA0C = this.A0c.A0C();
        if (abstractC2117XmA0C == null) {
            return;
        }
        abstractC2117XmA0C.setPageDetailsVisible((this.A0D || abstractC2117XmA0C.A0B()) ? false : true);
        String[] strArr = A0g;
    ...
    private void A0V() {
        int videoDuration;
        C1590Cw c1590CwA0F = this.A0c.A0F();
        if (c1590CwA0F != null && c1590CwA0F.getCustomDuration() > (videoDuration = ((E1) this.A0U).getDuration())) {
            c1590CwA0F.setCustomDuration(videoDuration);
        }
    }
    ...
    private final void A0Z(int i10, ViewGroup viewGroup, RelativeLayout relativeLayout) {
        ...
        XP.A0H(this.A0a);
        if ((this.A0a instanceof C14195r) || (this.A0a instanceof C14185q)) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        ...
        } else if (this.A0a instanceof C14175p) {
        ...
        this.A0a.A0i(i10);
        this.A0a.A0t(viewGroup, relativeLayout, i10);
    }
    ...
    private void A0b(ViewGroup viewGroup, View view, AbstractC2117Xm abstractC2117Xm, int i10) {
        XP.A0Z(this.A03);
        XP.A0H(abstractC2117Xm);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(10);
        layoutParams.setMargins(AbstractC2221ae.A0H, AbstractC2221ae.A0G, 0, 0);
        ...
        this.A0a.A0u(viewGroup, false, false, this.A03.getId());
        A0X(i10);
        viewGroup.addView(abstractC2117Xm, layoutParams);
    }

    private void A0c(ViewGroup viewGroup, View view, AbstractC2117Xm abstractC2117Xm, int i10) {
        XP.A0H(this.A03);
        XP.A0H(abstractC2117Xm);
        XP.A0H(this.A0a);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        ...
        if (strArr[0].length() == strArr[4].length()) {
            ...
            this.A0a.A0u(viewGroup, true, zA0x, this.A03.getId());
            String[] strArr3 = A0g;
    ...
    public void A0j(String str) {
        ...
        this.A08 = lj;
        if (this.A0Y.A1d()) {
            this.A08.addJavascriptInterface(new C2210aT(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.bK
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.A00.A1Q(view);
                }
            }, this.A08, new InterfaceC2209aS() { // from class: com.facebook.ads.redexgen.X.JH
                @Override // com.facebook.ads.redexgen.core.InterfaceC2209aS
                public final void ACk() {
                    this.A00.A1O();
                }
            }), C2210aT.A01());
        }
        this.A08.setOnTouchListener(new ViewOnTouchListenerC2265bM(this));
    ...
    private void A0o(boolean z10) {
        ...
        if (A0t()) {
            E1 e12 = (E1) this.A0U;
            Iterator<InterfaceC2404dc> it = e12.getPlugins().iterator();
            while (true) {
        ...
        this.A0B = new C2237au(this.A0c.A06(), this.A0Y, this.A0Z, this.A0T, this.A0c.A0D());
        this.A0B.A0D(z10);
        ...
        if (!z10) {
            ...
            this.A0C = true;
            InterfaceC2334cT interfaceC2334cTA0E = this.A0c.A0E();
            if (A0g[7].charAt(21) != '6') {
                A0g[6] = "OOVaJo";
                if (interfaceC2334cTA0E == null) {
                    return;
                }
            } else if (interfaceC2334cTA0E == null) {
                return;
            }
            ...
            if (this.A0c.A0C() != null && this.A0c.A05().A20().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC2269bQ(this), this.A0c.A05().A20().A0K().A00());
            }
        }
    }
    ...
    public void A0q(boolean z10, boolean z11) {
        ...
        if (z10) {
            A0c(parentView, containerView, abstractC2117XmA0C, i10);
        } else if (z11) {
            A0b(parentView, containerView, abstractC2117XmA0C, i10);
        } else {
    ...
    public final void A1C() {
        AbstractC2117Xm abstractC2117XmA0C = this.A0c.A0C();
        if (abstractC2117XmA0C != null) {
            abstractC2117XmA0C.setPageDetailsVisible((A1S() || abstractC2117XmA0C.A0B()) ? false : true);
        }
        this.A0O = false;
    }
    ...
    public final void A1G(C1841Mp c1841Mp, String str, double d10, Bundle bundle) {
        ...
        this.A0a.setInfo(c1841Mp.A0I(), c1841Mp.A0J(), str, this.A0Y.A23().A01(), this.A0c.A09(), this.A0b);
    ...
    public final void A1I(DO r82) {
        super.A1I(r82);
        this.A0c.A06().A0F().AJw(AbstractC2081Wa.A00(this.A0R), getResources().getConfiguration().orientation, true, false, MH.A0A());
        this.A0Q = true;
        A0X(getResources().getConfiguration().orientation);
        this.A0a.setVisibility(0);
        A0q(this.A0D, false);
    ...
    public final void A1J(C3Q c3q, int i10) {
        ...
        this.A0a.A0p((duration + videoDuration) / 1000);
    }
    ...
    private KE getRegularCtaForEndCard() {
        KE ke = new KE(getAdContextWrapper(), this.A0c.A05().A0r(), this.A0Y.A1z().A01(), getAdEventManager(), this.A0c.A0D(), (C2460eX) null, this.A0c.A0A(), this.A0Y.A21());
    ...
    private void setUpBrowserControls(LJ lj) {
        ...
        layoutParams.setMargins(AbstractC2221ae.A0I, AbstractC2221ae.A0I, AbstractC2221ae.A0I, AbstractC2221ae.A0I);
