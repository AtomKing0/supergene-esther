...
public abstract class AbstractC1929Qb {
    ...
    public abstract void A0H(int i10, int i11, C1931Qd c1931Qd, QZ qz);

    public abstract void A0I(View view, C1931Qd c1931Qd, QZ qz);
    ...
    public void A04(int i10, int i11) {
        ...
        if (!this.A05 || this.A00 == -1 || c14346g == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c14346g.A0s, this.A06);
                this.A06.A05(c14346g);
                A09();
            } else {
        ...
        if (this.A05) {
            A0H(i10, i11, c14346g.A0s, this.A06);
    ...
    public final void A0D(C14346g c14346g, QO qo) {
        this.A03 = c14346g;
        this.A02 = qo;
        if (this.A00 != -1) {
