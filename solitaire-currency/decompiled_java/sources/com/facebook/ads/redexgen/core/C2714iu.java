...
public final class C2714iu implements M5 {
    public static byte[] A04;
    public static final String[] A05;
    public String A00;
    public String A01;
    public final SparseArray<M4> A02 = new SparseArray<>();
    public final InterfaceC13884m A03;
    ...
    public final void AAj(HashMap<String, M4> map, SparseArray<String> sparseArray) throws IOException {
        ...
        try {
            if (AbstractC13904o.A00(this.A03.getReadableDatabase(), 1, (String) C3M.A01(this.A00)) != 1) {
    ...
    public C2714iu(InterfaceC13884m interfaceC13884m) {
        this.A03 = interfaceC13884m;
    }
    ...
    private void A04(SQLiteDatabase sQLiteDatabase) throws C13874l {
        AbstractC13904o.A04(sQLiteDatabase, 1, (String) C3M.A01(this.A00), 1);
    ...
    public static void A08(InterfaceC13884m interfaceC13884m, String str) throws C13874l {
        try {
            String strA02 = A02(str);
            SQLiteDatabase writableDatabase = interfaceC13884m.getWritableDatabase();
            writableDatabase.beginTransactionNonExclusive();
            try {
                AbstractC13904o.A03(writableDatabase, 1, str);
    ...
    @Override // com.facebook.ads.redexgen.core.M5
    public final void A5h() throws C13874l {
        A08(this.A03, (String) C3M.A01(this.A00));
    }

    @Override // com.facebook.ads.redexgen.core.M5
    public final boolean A6K() throws C13874l {
        try {
            return AbstractC13904o.A00(this.A03.getReadableDatabase(), 1, (String) C3M.A01(this.A00)) != -1;
        } catch (SQLException e10) {
            throw new C13874l(e10);
        }
    }
