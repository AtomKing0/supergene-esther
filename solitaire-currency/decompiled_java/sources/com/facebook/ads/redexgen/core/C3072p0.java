...
public final class C3072p0 implements C1S {
    ...
    public static final C3072p0 A08;
    public static final C1R<C3072p0> A09;
    public static final C3073p1 A0A;
     ...
     */
    public static C3072p0 A00(Bundle bundle) {
        C3073p1[] c3073p1Arr;
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(A0B);
        if (parcelableArrayList == null) {
            c3073p1Arr = new C3073p1[0];
        } else {
            c3073p1Arr = new C3073p1[parcelableArrayList.size()];
            for (int i10 = 0; i10 < parcelableArrayList.size(); i10++) {
                c3073p1Arr[i10] = (C3073p1) C3073p1.A09.A6X((Bundle) parcelableArrayList.get(i10));
            }
        }
        return new C3072p0(null, c3073p1Arr, bundle.getLong(A0C, A08.A02), bundle.getLong(A0D, A08.A03), bundle.getInt(A0E, A08.A01));
    }
    ...
    static {
        A03();
        A08 = new C3072p0(null, new C3073p1[0], 0L, C.TIME_UNSET, 0);
        A0A = new C3073p1(0L).A06(0);
        A0B = AbstractC13764a.A0h(1);
        A0C = AbstractC13764a.A0h(2);
        A0D = AbstractC13764a.A0h(3);
        A0E = AbstractC13764a.A0h(4);
        A09 = new C1R() { // from class: com.facebook.ads.redexgen.X.p3
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return C3072p0.A00(bundle);
            }
        };
    }

    public C3072p0(Object obj, C3073p1[] c3073p1Arr, long j10, long j11, int i10) {
        this.A04 = obj;
        this.A02 = j10;
        this.A03 = j11;
        this.A00 = c3073p1Arr.length + i10;
        this.A05 = c3073p1Arr;
        this.A01 = i10;
    }
    ...
    public final C3073p1 A07(int i10) {
        if (i10 < this.A01) {
            return A0A;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        C3072p0 c3072p0 = (C3072p0) obj;
        if (AbstractC13764a.A1E(this.A04, c3072p0.A04) && this.A00 == c3072p0.A00 && this.A02 == c3072p0.A02 && this.A03 == c3072p0.A03 && this.A01 == c3072p0.A01) {
            C3073p1[] c3073p1Arr = this.A05;
            String[] strArr = A07;
            if (strArr[5].length() == strArr[1].length()) {
                throw new RuntimeException();
            }
            ...
            if (Arrays.equals(c3073p1Arr, c3072p0.A05)) {
                return true;
            }
        }
        return false;
