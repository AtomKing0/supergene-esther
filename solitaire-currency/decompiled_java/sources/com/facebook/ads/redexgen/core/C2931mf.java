...
public final class C2931mf implements AO {
    ...
    public C2931mf(MediaCodec mediaCodec) {
        this.A02 = mediaCodec;
    }
    ...
    public final int A5m(MediaCodec.BufferInfo bufferInfo) {
        ...
        do {
            ...
            if (iDequeueOutputBuffer == -3 && AbstractC13764a.A02 < 21) {
    ...
    public final ByteBuffer A8B(int i10) {
        ...
        strArr[2] = "7Nv94jZvV7";
        strArr[1] = "iAeXpyFDwx";
        return ((ByteBuffer[]) AbstractC13764a.A0f(byteBufferArr))[i10];
    }
    ...
    public final ByteBuffer A8W(int i10) {
        ...
        return ((ByteBuffer[]) AbstractC13764a.A0f(this.A01))[i10];
    }
