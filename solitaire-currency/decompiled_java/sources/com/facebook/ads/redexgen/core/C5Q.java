...
public abstract class C5Q extends AbstractC1740Ir implements Wf {
    ...
    public final C2086Wh A0C;
    public final InterfaceC2118Xn A0D;
    public final C2225ai A0E;
    public final DX A0F;
    public final DR A0G;
    public final DP A0H;
    public final DN A0I;
    ...
    public abstract void A1V(C2387dL c2387dL);

    static {
        A03();
        A0O = (int) (AbstractC2090Wl.A02 * 1.0f);
        A0P = (int) (AbstractC2090Wl.A02 * 4.0f);
        A0N = (int) (AbstractC2090Wl.A02 * 6.0f);
    }

    public C5Q(C2225ai c2225ai, boolean z10, String str, FH fh) {
        super(c2225ai, z10);
        this.A09 = new Path();
        this.A0A = new RectF();
        ...
        this.A0D = c2225ai.A0D();
        this.A0E = c2225ai;
        this.A03 = fh;
        this.A0K = str;
        this.A0B = c2225ai.A06();
        this.A0C = C2086Wh.A00(c2225ai.A06(), c2225ai.A05(), this);
        setGravity(17);
    ...
    public final void A1Q() {
        if (A1T()) {
            A1R();
            C2356cp c2356cp = this.A04;
            EnumC2403db enumC2403db = EnumC2403db.A02;
            if (A0M[2].length() == 4) {
                throw new RuntimeException();
            }
            A0M[2] = "GrzUS";
            c2356cp.A05(enumC2403db);
        }
    }
    ...
    public final C2356cp getVideoView() {
        return this.A04;
    }
    ...
    public void setCTAInfo(C1851Mz c1851Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c1851Mz, this.A0K, extraData);
    }

    public void setImageUrl(String str) {
        this.A01.setVisibility(0);
        this.A04.setVisibility(8);
        new KZ(this.A01, this.A0B).A04().A06(new C1734Il(this)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC2276bX interfaceC2276bX) {
        this.A02 = interfaceC2276bX;
    }

    public void setUpImageView(C2387dL c2387dL) {
        this.A01 = new YM(c2387dL);
        if (U7.A1I(c2387dL)) {
            AbstractC2175Zs.A00(this.A01, U7.A1J(c2387dL), new ViewOnClickListenerC2282bd(this));
        }
        A04(this.A01);
    }

    public void setUpMediaContainer(C2387dL c2387dL) {
        this.A00 = new RelativeLayout(c2387dL);
        A04(this.A00);
        C2085Wg c2085WgA02 = this.A0C.A02(this.A0E.A05());
        this.A0E.A06().A0H().A00(c2085WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(this.A0C);
        if (this.A0E.A05().A1W() && U7.A2o(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC2281bc(this));
        } else {
            if (!c2085WgA02.A00) {
                return;
            }
    ...
    public void setUpVideoView(C2387dL c2387dL) {
        this.A04 = new C2356cp(c2387dL, new C2030Ua(this.A0K, getAdEventManager()));
        if (U7.A1K(c2387dL)) {
            AbstractC2175Zs.A00(this.A04, U7.A1L(c2387dL), new ViewOnClickListenerC2283be(this));
        }
        A04(this.A04);
    }

    private void setUpView(C2387dL c2387dL) {
        setUpImageView(c2387dL);
        setUpVideoView(c2387dL);
        setUpMediaContainer(c2387dL);
