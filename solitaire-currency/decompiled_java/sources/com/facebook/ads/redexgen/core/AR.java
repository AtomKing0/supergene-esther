...
public final class AR {
    ...
    public AR(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
        ...
        this.A08 = z14;
        this.A06 = z15;
        this.A0A = AbstractC13312h.A0F(str2);
    }
    ...
    */
    ...
    public static Point A01(MediaCodecInfo.VideoCapabilities videoCapabilities, int i10, int i11) {
        ...
        return new Point(AbstractC13764a.A05(i10, heightAlignment) * heightAlignment, AbstractC13764a.A05(i11, widthAlignment) * widthAlignment);
    }
    ...
    */
    ...
    private void A05(String str) {
        ...
        AnonymousClass44.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(AbstractC13764a.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    public static boolean A07() {
        return AbstractC13764a.A03.equals(A03(532, 7, 62)) || AbstractC13764a.A03.equals(A03(427, 6, 6)) || AbstractC13764a.A06.startsWith(A03(55, 14, 69)) || AbstractC13764a.A06.startsWith(A03(69, 14, 52)) || AbstractC13764a.A06.startsWith(A03(83, 14, 0));
    }

    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC13764a.A02 >= 19 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC13764a.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public static boolean A0D(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC13764a.A02 >= 21 && A0E(codecCapabilities);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0G(com.facebook.ads.redexgen.core.C3064or r12, boolean r13) {
        /*
    ...
    public static boolean A0I(String str) {
        return AbstractC13764a.A06.startsWith(A03(253, 7, 89)) && A03(191, 36, 1).equals(str);
    }

    public static boolean A0J(String str) {
        if (AbstractC13764a.A02 <= 22) {
            if ((A03(130, 10, 94).equals(AbstractC13764a.A06) || A03(111, 8, 72).equals(AbstractC13764a.A06)) && (A03(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 22, 117).equals(str) || A03(162, 29, 74).equals(str))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A0K(String str) {
        if (A03(227, 26, 94).equals(str) && A03(IronSourceError.ERROR_NON_EXISTENT_INSTANCE, 5, 83).equals(AbstractC13764a.A03)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean A0L(String str, int i10) {
        if (A03(751, 10, 121).equals(str) && 2 == i10) {
            if (A03(539, 8, 36).equals(AbstractC13764a.A03) || A03(521, 6, 9).equals(AbstractC13764a.A03)) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.facebook.ads.redexgen.core.C14115j A0O(com.facebook.ads.redexgen.core.C3064or r13, com.facebook.ads.redexgen.core.C3064or r14) {
        /*
    ...
    public final boolean A0S(C3064or c3064or) {
        String strA07;
        if (c3064or.A0R == null || this.A02 == null || (strA07 = AbstractC13312h.A07(c3064or.A0R)) == null) {
            return true;
        }
        ...
        if (!codecMimeType.equals(strA07)) {
            ...
            String codecMimeType3 = c3064or.A0R;
        ...
        return A0G(c3064or, true);
    }

    public final boolean A0T(C3064or c3064or) {
        if (this.A0A) {
        ...
        Pair<Integer, Integer> profileLevel = C1543Ay.A0B(c3064or);
        return profileLevel != null && ((Integer) profileLevel.first).intValue() == 42;
    }

    @Deprecated
    public final boolean A0U(C3064or c3064or, C3064or c3064or2, boolean z10) {
        if (!z10 && c3064or.A0N != null) {
            ColorInfo colorInfo = c3064or2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c3064or2 = c3064or2.A07().A0t(c3064or.A0N).A14();
            }
        }
        int i10 = A0O(c3064or, c3064or2).A01;
        return i10 == 2 || i10 == 3;
    }
