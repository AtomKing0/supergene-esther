...
public final class C2711ir implements InterfaceC1814Ln {
    ...
    public C1811Lk A02;
    public boolean A03;
    public final InterfaceC2716iw A04;
    public final C1820Lt A05;
    public final M6 A06;
    public final File A07;
    public final HashMap<String, ArrayList<InterfaceC1813Lm>> A08;
    ...
    */
    private void A0G(java.io.File r18, boolean r19, java.io.File[] r20, java.util.Map<java.lang.String, com.facebook.ads.redexgen.core.C1819Ls> r21) {
        /*
            r17 = this;
            r6 = r17
            r8 = r20
        ...
        L12:
            if (r3 >= r5) goto Laa
            r11 = r8[r3]
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2711ir.A0C
            r0 = 2
            r1 = r1[r0]
            r0 = 26
            ...
            r0 = 56
            if (r1 == r0) goto La4
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2711ir.A0C
        ...
        L4c:
            ...
            r0 = 2
            if (r1 == r0) goto La4
            java.lang.String[] r9 = com.facebook.ads.redexgen.core.C2711ir.A0C
        ...
        L7b:
            ...
            com.facebook.ads.redexgen.X.Ls r0 = (com.facebook.ads.redexgen.core.C1819Ls) r0
        L8a:
            if (r0 == 0) goto L90
            long r12 = r0.A01
            long r14 = r0.A00
        L90:
            ...
            r16 = r0
            com.facebook.ads.redexgen.X.iq r0 = com.facebook.ads.redexgen.core.C2710iq.A01(r11, r12, r14, r16)
            if (r0 == 0) goto La0
            r6.A0C(r0)
            goto L49
        L9e:
        ...
        Laa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2711ir.A0G(java.io.File, boolean, java.io.File[], java.util.Map):void");
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized NavigableSet<C1824Lx> A0I(String str) {
        M4 m4A0C;
        C3M.A08(!this.A03);
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    ...
    @Deprecated
    public C2711ir(File file, InterfaceC2716iw interfaceC2716iw) {
        this(file, interfaceC2716iw, (byte[]) null, false);
    }

    public C2711ir(File file, InterfaceC2716iw interfaceC2716iw, InterfaceC13884m interfaceC13884m, byte[] bArr, boolean z10, boolean z11) {
        C1820Lt c1820Lt;
        M6 m62 = new M6(interfaceC13884m, file, bArr, z10, z11);
        if (interfaceC13884m != null && !z11) {
            c1820Lt = new C1820Lt(interfaceC13884m);
        } else {
            c1820Lt = null;
        }
        this(file, interfaceC2716iw, m62, c1820Lt);
    }

    public C2711ir(File file, InterfaceC2716iw interfaceC2716iw, M6 m62, C1820Lt c1820Lt) {
        if (A0H(file)) {
            this.A07 = file;
            this.A04 = interfaceC2716iw;
            this.A06 = m62;
            this.A05 = c1820Lt;
            this.A08 = new HashMap<>();
            this.A09 = new Random();
            this.A0A = interfaceC2716iw.AHz();
            this.A01 = -1L;
    ...
    @Deprecated
    public C2711ir(File file, InterfaceC2716iw interfaceC2716iw, byte[] bArr, boolean z10) {
        this(file, interfaceC2716iw, null, bArr, z10, true);
    }
    ...
    private C2710iq A03(String str, long j10, long j11) {
        C2710iq c2710iqA04;
        M4 m4A0C = this.A06.A0C(str);
        if (m4A0C == null) {
            return C2710iq.A04(str, j10, j11);
        }
        while (true) {
            c2710iqA04 = m4A0C.A04(j10, j11);
            if (!c2710iqA04.A05 || c2710iqA04.A03.length() == c2710iqA04.A01) {
                break;
            }
            A06();
        }
    ...
    public void A05() {
        ...
        try {
            ...
            if (this.A05 != null) {
                ...
                Map<String, C1819Ls> mapA05 = this.A05.A05();
    ...
    private void A06() {
        ...
        while (it.hasNext()) {
            for (C2710iq c2710iq : it.next().A06()) {
                if (c2710iq.A03.length() != c2710iq.A01) {
                    arrayList.add(c2710iq);
                }
            }
        }
        int i10 = 0;
    ...
    private final synchronized void A08() throws C1811Lk {
        if (this.A02 != null) {
            throw this.A02;
        }
    }

    private void A09(C1824Lx c1824Lx) {
        ArrayList<InterfaceC1813Lm> arrayList = this.A08.get(c1824Lx.A04);
        if (arrayList != null) {
            for (int i10 = arrayList.size() - 1; i10 >= 0; i10--) {
                arrayList.get(i10).AFK(this, c1824Lx);
            }
        }
        this.A04.AFK(this, c1824Lx);
    }

    private void A0A(C1824Lx c1824Lx) {
        M4 m4A0C = this.A06.A0C(c1824Lx.A04);
        if (m4A0C == null || !m4A0C.A0D(c1824Lx)) {
            return;
        }
        this.A00 -= c1824Lx.A01;
        if (this.A05 != null) {
            String name = c1824Lx.A03.getName();
            try {
                this.A05.A07(name);
    ...
    private void A0C(C2710iq c2710iq) {
        this.A06.A0D(c2710iq.A04).A08(c2710iq);
        this.A00 += c2710iq.A01;
        A0D(c2710iq);
    }

    private void A0D(C2710iq c2710iq) {
        ArrayList<InterfaceC1813Lm> arrayList = this.A08.get(c2710iq.A04);
        if (arrayList != null) {
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                InterfaceC1813Lm interfaceC1813Lm = arrayList.get(size);
                int i10 = A0C[0].length();
                if (i10 == 2) {
                    throw new RuntimeException();
                }
                A0C[0] = "Z81vyiSZneiyPRnyPjjjzGlAG4UB";
                interfaceC1813Lm.AFJ(this, c2710iq);
            }
        }
        this.A04.AFJ(this, c2710iq);
    }

    private void A0E(C2710iq c2710iq, C1824Lx c1824Lx) {
        ArrayList<InterfaceC1813Lm> arrayList = this.A08.get(c2710iq.A04);
        if (arrayList != null) {
            for (int i10 = arrayList.size() - 1; i10 >= 0; i10--) {
                arrayList.get(i10).AFL(this, c2710iq, c1824Lx);
            }
        }
        this.A04.AFL(this, c2710iq, c1824Lx);
    }

    public static void A0F(File file) throws C1811Lk {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized void A46(String str, M9 m92) throws C1811Lk {
        C3M.A08(!this.A03);
        A08();
        ...
        try {
            ...
            throw new C1811Lk(e10);
        }
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized void A4x(File file, long j10) throws C1811Lk {
        C3M.A08(!this.A03);
        if (file.exists()) {
            if (j10 == 0) {
                file.delete();
            ...
            C2710iq c2710iq = (C2710iq) C3M.A01(C2710iq.A02(file, j10, this.A06));
            M4 m42 = (M4) C3M.A01(this.A06.A0C(c2710iq.A04));
            C3M.A08(m42.A0B(c2710iq.A02, c2710iq.A01));
            long jA00 = M7.A00(m42.A03());
            if (jA00 != -1) {
                C3M.A08(c2710iq.A02 + c2710iq.A01 <= jA00);
            }
            if (this.A05 != null) {
                try {
                    this.A05.A08(file.getName(), c2710iq.A01, c2710iq.A00);
                    A0C(c2710iq);
                    try {
                        this.A06.A0I();
                        notifyAll();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized void AGw(C1824Lx c1824Lx) {
        C3M.A08(!this.A03);
        M4 m42 = (M4) C3M.A01(this.A06.A0C(c1824Lx.A04));
        m42.A07(c1824Lx.A02);
    ...
    public final synchronized void AHk(String str) {
        C3M.A08(!this.A03);
        Iterator<C1824Lx> it = A0I(str).iterator();
        while (it.hasNext()) {
            A0A(it.next());
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized void AHl(C1824Lx c1824Lx) {
        C3M.A08(!this.A03);
        A0A(c1824Lx);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized File AJN(String str, long lastTouchTimestamp, long j10) throws C1811Lk {
        M4 m4A0C;
        File file;
        C3M.A08(!this.A03);
        A08();
        ...
        return C2710iq.A05(file, m4A0C.A01, lastTouchTimestamp, System.currentTimeMillis());
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized C1824Lx AJP(String str, long j10, long j11, EnumC1812Ll enumC1812Ll) throws InterruptedException, C1811Lk {
        C1824Lx span;
        C3M.A08(!this.A03);
        A08();
        while (true) {
            span = AJQ(str, j10, j11, enumC1812Ll);
            if (span == null) {
                wait();
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1814Ln
    public final synchronized C2710iq AJQ(String str, long j10, long j11, EnumC1812Ll enumC1812Ll) throws C1811Lk {
        C3M.A08(!this.A03);
        A08();
        C2710iq c2710iqA03 = A03(str, j10, j11);
        if (c2710iqA03.A05) {
            C2710iq span = this.A06.A0C(str).A05(c2710iqA03, c2710iqA03.A00, false);
            A0E(c2710iqA03, span);
            return span;
        }
        if (this.A06.A0D(str).A0C(j10, c2710iqA03.A01)) {
            return c2710iqA03;
        }
        return null;
    }
