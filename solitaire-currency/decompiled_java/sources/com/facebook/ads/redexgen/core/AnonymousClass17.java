...
public final class AnonymousClass17 extends AbstractC15049l {
    ...
    public final long AFy(AnonymousClass56 anonymousClass56) throws C2993nf {
        C4S.A02(A01(0, 15, 71));
        ...
        try {
            try {
                ...
                C4S.A00();
                if (this.A00 < 0) {
                    throw new C2993nf(null, null, 2008);
                }
                this.A03 = true;
    ...
    public static RandomAccessFile A00(Uri uri) throws C2993nf {
        try {
            ...
            if (zIsEmpty && TextUtils.isEmpty(uri.getFragment())) {
                throw new C2993nf(e10, (AbstractC13764a.A02 < 21 || !AnonymousClass58.A00(e10.getCause())) ? 2005 : 2006);
            }
            throw new C2993nf(String.format(A01(30, PsExtractor.AUDIO_STREAM, 19), uri.getPath(), uri.getQuery(), uri.getFragment()), e10, 1004);
        } catch (SecurityException e11) {
            throw new C2993nf(e11, 2006);
        } catch (RuntimeException e12) {
            throw new C2993nf(e12, 2000);
        }
    }
    ...
    */
    public final void close() throws com.facebook.ads.redexgen.core.C2993nf {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
    ...
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i10, int i11) throws C2993nf {
        if (i11 == 0) {
            return 0;
        }
        try {
            ...
            try {
                ...
                int i12 = ((RandomAccessFile) AbstractC13764a.A0f(this.A02)).read(bArr, i10, (int) Math.min(this.A00, i11));
                if (i12 > 0) {
                    this.A00 -= (long) i12;
                    A0F(i12);
                }
