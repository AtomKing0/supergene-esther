...
public final class C1640Eu {
    ...
    public static final Comparator<C1639Et> A08 = new Comparator() { // from class: com.facebook.ads.redexgen.X.Eq
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return C1640Eu.A00((C1639Et) obj, (C1639Et) obj2);
        }
    };
    public static final Comparator<C1639Et> A09 = new Comparator() { // from class: com.facebook.ads.redexgen.X.Er
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return Float.compare(((C1639Et) obj).A00, ((C1639Et) obj2).A00);
        }
    };
    public int A01;
    public int A02;
    ...
    public final C1639Et[] A06 = new C1639Et[5];
    public final ArrayList<C1639Et> A05 = new ArrayList<>();
    public int A00 = -1;

    public C1640Eu(int i10) {
        this.A04 = i10;
    }

    public static /* synthetic */ int A00(C1639Et c1639Et, C1639Et c1639Et2) {
        return c1639Et.A01 - c1639Et2.A01;
    }
    ...
    private final void A04(int i10, float f10) {
        C1639Et oldestSample;
        A02();
        if (this.A02 > 0) {
            C1639Et[] c1639EtArr = this.A06;
            int i11 = this.A02 - 1;
            this.A02 = i11;
            oldestSample = c1639EtArr[i11];
        } else {
            oldestSample = new C1639Et();
        }
        int i12 = this.A01;
        this.A01 = i12 + 1;
        ...
        while (this.A03 > this.A04) {
            ...
            C1639Et c1639Et = this.A05.get(0);
            if (c1639Et.A02 <= excessWeight) {
                this.A03 -= c1639Et.A02;
                this.A05.remove(0);
                if (this.A02 < 5) {
                    C1639Et[] c1639EtArr2 = this.A06;
                    int excessWeight2 = this.A02;
                    this.A02 = excessWeight2 + 1;
                    c1639EtArr2[excessWeight2] = c1639Et;
                }
            } else {
                c1639Et.A02 -= excessWeight;
    ...
    public final float A05(float f10) {
        ...
        while (true) {
            ...
            if (i11 < size) {
                C1639Et c1639Et = this.A05.get(i11);
                i10 += c1639Et.A02;
                float desiredWeight = i10;
                if (desiredWeight >= f11) {
                    float desiredWeight2 = c1639Et.A00;
    ...
    public final void A07(int i10, float f10) {
        C1639Et oldestSample;
        if (MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A1G)) {
            A04(i10, f10);
            return;
        }
        A02();
