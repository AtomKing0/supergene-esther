...
public final class C2814kY implements GX, InterfaceC1694Gw {
    ...
    public static final InterfaceC1673Gb A0S;
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public final C1732Ij A0N;
    public final ArrayDeque<C2825kj> A0O;
    ...
    */
    private int A03(com.facebook.ads.redexgen.core.InterfaceC2853lN r22, com.facebook.ads.redexgen.core.C1691Gt r23) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 426
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2814kY.A03(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    static {
        A0C();
        A0S = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.kZ
    ...
    public C2814kY(int i10) {
        this.A0I = i10;
        this.A04 = (i10 & 4) != 0 ? 3 : 0;
        this.A0N = new C1732Ij();
        this.A0P = new ArrayList();
        this.A0J = new C4J(16);
        this.A0O = new ArrayDeque<>();
        this.A0L = new C4J(AbstractC1688Gq.A03);
        this.A0K = new C4J(4);
        this.A0M = new C4J();
        this.A08 = -1;
        this.A0E = GY.A00;
        this.A0G = new C1725Ic[0];
    }
    ...
    private int A01(long j10) {
        ...
        int i12 = 0;
        while (true) {
            C1725Ic[] c1725IcArr = this.A0G;
            String[] strArr = A0R;
            if (strArr[3].length() != strArr[7].length()) {
                throw new RuntimeException();
            }
            A0R[6] = "Fcko3uaud46cO6nUcug7HhLZFNYBY";
            if (i12 >= c1725IcArr.length) {
            ...
            C1725Ic c1725Ic = this.A0G[i12];
            int i13 = c1725Ic.A00;
            if (i13 != c1725Ic.A04.A01) {
                long j14 = c1725Ic.A04.A06[i13];
                long minAccumulatedBytes = ((long[][]) AbstractC13764a.A0f(this.A0H))[i12][i13];
                long j15 = j14 - j10;
    ...
    private int A04(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        int iA07 = this.A0N.A07(interfaceC2853lN, c1691Gt, this.A0P);
        if (iA07 == 1 && c1691Gt.A00 == 0) {
            A0A();
        }
        return iA07;
    }

    public static int A05(C1738Ip c1738Ip, long j10) {
        int iA00 = c1738Ip.A00(j10);
        if (iA00 == -1) {
            return c1738Ip.A01(j10);
        }
        return iA00;
    }

    public static long A06(C1738Ip c1738Ip, long j10, long j11) {
        int iA05 = A05(c1738Ip, j10);
        if (iA05 == -1) {
            return j11;
        }
        return Math.min(c1738Ip.A06[iA05], j11);
    }

    private final C1693Gv A07(long j10, int i10) {
        long jA06;
        long j11;
        int mainTrackIndex;
        ...
        if (i11 != -1) {
            C1738Ip c1738Ip = this.A0G[i11].A04;
            int iA05 = A05(c1738Ip, j10);
            if (iA05 == -1) {
                return new C1693Gv(C1695Gx.A04);
            }
            j11 = c1738Ip.A07[iA05];
            jA06 = c1738Ip.A06[iA05];
            if (A0R[6].length() != 29) {
                throw new RuntimeException();
            }
            A0R[1] = "zbT5rN6sguJCvWwII8HLCHwSkH7sQNQT";
            if (j11 < j10 && iA05 < c1738Ip.A01 - 1 && (mainTrackIndex = c1738Ip.A01(j10)) != -1 && mainTrackIndex != iA05) {
                j12 = c1738Ip.A07[mainTrackIndex];
                jA062 = c1738Ip.A06[mainTrackIndex];
            }
        } else {
            jA06 = Long.MAX_VALUE;
            if (A0R[4].length() != 11) {
        ...
        if (i10 == -1) {
            for (int i12 = 0; i12 < this.A0G.length; i12++) {
                if (i12 != this.A03) {
                    C1738Ip sampleTable = this.A0G[i12].A04;
        ...
        C1695Gx c1695Gx = new C1695Gx(j11, jA06);
        if (j12 == C.TIME_UNSET) {
            return new C1693Gv(c1695Gx);
        }
        return new C1693Gv(c1695Gx, new C1695Gx(j12, jA062));
    }

    public static /* synthetic */ C1735Im A08(C1735Im c1735Im) {
        return c1735Im;
    }
    ...
    private void A0B() {
        if (this.A02 == 2 && (this.A0I & 2) != 0) {
            ...
            this.A0E.A6G();
            this.A0E.AIN(new C2848lI(C.TIME_UNSET));
        }
    }

    private void A0D(long j10) throws C13322i {
        while (!this.A0O.isEmpty() && this.A0O.peek().A00 == j10) {
            C2825kj c2825kjPop = this.A0O.pop();
            if (((II) c2825kjPop).A00 == 1836019574) {
                A0G(c2825kjPop);
                this.A0O.clear();
                this.A04 = 2;
            } else if (!this.A0O.isEmpty()) {
                C2825kj containerAtom = this.A0O.peek();
                containerAtom.A08(c2825kjPop);
            }
        }
        if (this.A04 != 2) {
            A0A();
    ...
    private void A0F(InterfaceC2853lN interfaceC2853lN) throws IOException {
        this.A0M.A0d(8);
        interfaceC2853lN.AG9(this.A0M.A0l(), 0, 8);
        IO.A0Q(this.A0M);
        interfaceC2853lN.AJJ(this.A0M.A09());
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void A0G(com.facebook.ads.redexgen.core.C2825kj r36) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            Method dump skipped, instruction units count: 462
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2814kY.A0G(com.facebook.ads.redexgen.X.kj):void");
    }

    private void A0H(C1725Ic c1725Ic, long j10) {
        C1738Ip c1738Ip = c1725Ic.A04;
        int sampleIndex = c1738Ip.A00(j10);
        if (sampleIndex == -1) {
            sampleIndex = c1738Ip.A01(j10);
        }
        c1725Ic.A00 = sampleIndex;
        if (A0R[2].length() == 19) {
            throw new RuntimeException();
        }
    ...
    */
    public static boolean A0J(int r4) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2814kY.A0R
            r0 = 4
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 11
            ...
            throw r0
        L20:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2814kY.A0R
        ...
        L91:
            ...
            goto L6f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2814kY.A0J(int):boolean");
    }

    private boolean A0K(InterfaceC2853lN interfaceC2853lN) throws IOException {
        C2825kj containerAtom;
        if (this.A00 == 0) {
            if (!interfaceC2853lN.AGh(this.A0J.A0l(), 0, 8, true)) {
                A0B();
                return false;
            }
            this.A00 = 8;
        ...
        if (this.A09 == 1) {
            ...
            interfaceC2853lN.readFully(this.A0J.A0l(), 8, 8);
            ...
            if (jA8G != -1) {
                this.A09 = (jA8G - interfaceC2853lN.A8f()) + ((long) this.A00);
            }
        }
        if (this.A09 >= this.A00) {
            if (A0I(this.A01)) {
                long jA8f = (interfaceC2853lN.A8f() + this.A09) - ((long) this.A00);
                if (this.A09 != this.A00 && this.A01 == 1835365473) {
                    A0F(interfaceC2853lN);
                }
                this.A0O.push(new C2825kj(this.A01, jA8f));
                if (this.A09 == this.A00) {
                    A0D(jA8f);
                } else {
                    A0A();
                ...
                A0E(interfaceC2853lN.A8f() - ((long) this.A00));
                this.A0D = null;
                this.A04 = 1;
            }
            return true;
        }
        throw C13322i.A00(A09(0, 48, 61));
    }

    private boolean A0L(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        long j10 = this.A09 - ((long) this.A00);
        long atomEndPosition = interfaceC2853lN.A8f() + j10;
        boolean z10 = false;
        C4J c4j = this.A0D;
        if (c4j != null) {
            interfaceC2853lN.readFully(c4j.A0l(), this.A00, (int) j10);
            if (this.A01 == 1718909296) {
                this.A02 = A02(c4j);
            } else if (!this.A0O.isEmpty()) {
                this.A0O.peek().A09(new C2824ki(this.A01, c4j));
            }
        } else if (j10 < 262144) {
            interfaceC2853lN.AJJ((int) j10);
        } else {
            long atomPayloadSize = interfaceC2853lN.A8f();
            c1691Gt.A00 = atomPayloadSize + j10;
            z10 = true;
        }
        A0D(atomEndPosition);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static long[][] A0N(com.facebook.ads.redexgen.core.C1725Ic[] r16) {
        /*
            Method dump skipped, instruction units count: 214
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2814kY.A0N(com.facebook.ads.redexgen.X.Ic[]):long[][]");
    }
    ...
    public final int AGb(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        while (true) {
            switch (this.A04) {
                case 0:
                    if (!A0K(interfaceC2853lN)) {
                        return -1;
                    }
                    break;
                    break;
                case 1:
                    if (A0L(interfaceC2853lN, c1691Gt)) {
                        return 1;
                    }
                    break;
                case 2:
                    return A03(interfaceC2853lN, c1691Gt);
                case 3:
                    return A04(interfaceC2853lN, c1691Gt);
                default:
    ...
    public final boolean AJL(InterfaceC2853lN interfaceC2853lN) throws IOException {
        return AbstractC1733Ik.A02(interfaceC2853lN, (this.A0I & 2) != 0);
    }
}
