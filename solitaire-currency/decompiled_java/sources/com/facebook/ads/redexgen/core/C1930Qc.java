...
public final class C1930Qc implements Ad, NativeAdBaseApi, Repairable, InterfaceC2053Ux {
    ...
    public static final WeakHashMap<View, WeakReference<C1930Qc>> A0o;
    public long A00;
    public Drawable A01;
    ...
    public EnumC1829Mc A08;
    public C2672iC A09;
    public C14506w A0A;
    public C2627hK A0B;
    public SL A0C;
    public TF A0D;
    public EnumC2041Ul A0E;
    public ViewOnClickListenerC1960Rg A0F;
    public QQ A0G;
    public C2047Ur A0H;
    public EnumC2048Us A0I;
    public V6 A0J;
    public YX A0K;
    public C2169Zm A0L;
    public C2298bt A0M;
    public C2363cw A0N;
    public AbstractC2459eW A0O;
    public AbstractC2459eW A0P;
    public C2460eX A0Q;
    public C2460eX A0R;
    public String A0S;
    public String A0T;
    public WeakReference<C2547fx> A0U;
    public WeakReference<AbstractC2459eW> A0V;
    public boolean A0W;
    public boolean A0X;
    public boolean A0Y;
    public boolean A0Z;
    ...
    public final InterfaceC2044Uo A0d;
    public final C2055Uz A0e;
    public final XH A0f;
    ...
    */
    private void A0g(android.view.View r13, android.view.View r14, java.util.List<android.view.View> r15, boolean r16) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1930Qc.A0g(android.view.View, android.view.View, java.util.List, boolean):void");
    }

    static {
        A0e();
        A0n = C1930Qc.class.getSimpleName();
        A0o = new WeakHashMap<>();
    }

    public C1930Qc(Context context, String str, InterfaceC2044Uo interfaceC2044Uo, boolean z10) {
        this.A0h = UUID.randomUUID().toString();
        this.A0J = V6.A06;
        this.A0E = EnumC2041Ul.A04;
        this.A08 = EnumC1829Mc.A03;
        ...
        this.A0e = new C2055Uz(this.A0c, this);
    }

    public C1930Qc(C1930Qc c1930Qc) {
        this((Context) c1930Qc.A0c, (String) null, c1930Qc.A0d, true);
        this.A0D = c1930Qc.A0D;
        this.A0a = c1930Qc.A0a;
        this.A0B = c1930Qc.A0B;
        this.A0j = true;
        this.A05 = new View(this.A0c);
    }

    public C1930Qc(C2387dL c2387dL, C2683iN c2683iN, TF tf, InterfaceC2044Uo interfaceC2044Uo) {
        this((Context) c2387dL, (String) null, interfaceC2044Uo, true);
        this.A0a = c2683iN;
        this.A0D = tf;
        this.A0j = true;
        this.A05 = new View(c2387dL);
    }

    public C1930Qc(C2387dL c2387dL, C2683iN c2683iN, TF tf, InterfaceC2044Uo interfaceC2044Uo, C2627hK c2627hK) {
        this(c2387dL, c2683iN, tf, interfaceC2044Uo);
        this.A0B = c2627hK;
    }
    ...
    private int A03() {
        ...
        C14506w c14506w = this.A0A;
        if (A0m[3].charAt(5) != 'B') {
            throw new RuntimeException();
        }
        A0m[5] = "Xt";
        if (c14506w == null || this.A0A.A0J() == null) {
            return 0;
        }
        return this.A0A.A0J().A09();
    }

    public static Drawable A05(C2387dL c2387dL, Bitmap bitmap, boolean z10, String str) {
        BitmapDrawable bitmapDrawableA00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c2387dL.getResources(), bitmap);
        if (z10 && (bitmapDrawableA00 = AbstractC2362cv.A00(c2387dL, str)) != null) {
    ...
    private final C2683iN A0C() {
        C2683iN c2683iN = this.A0a;
        if (c2683iN != null && c2683iN.A0R()) {
            return c2683iN;
        }
        return null;
    }
    ...
    private C2671iB A0G(boolean z10) {
        if (this.A0a != null) {
            C2683iN c2683iN = this.A0a;
            if (A0m[3].charAt(5) == 'B') {
                String[] strArr = A0m;
    ...
    public static C1930Qc A0L(NativeAdBaseApi nativeAdBaseApi) {
        if (nativeAdBaseApi instanceof Proxy) {
            return (C1930Qc) ((C1949Qv) Proxy.getInvocationHandler(nativeAdBaseApi)).A04();
        }
        return (C1930Qc) nativeAdBaseApi;
    }
    ...
    public final C2045Up getAdChoicesIcon() {
        return A0F().A0D();
    }
    ...
    public final C2046Uq getAdStarRating() {
        return A0F().A0G();
    }
    ...
    private void A0h(FrameLayout frameLayout, String str) {
        ...
        this.A0N = AbstractC2362cv.A01(RB.A03(this.A0c), str);
        if (this.A0N != null) {
    ...
    private void A0i(C2683iN c2683iN, boolean z10) {
        if (c2683iN == null) {
            return;
        }
        boolean zEquals = this.A0E.equals(EnumC2041Ul.A04);
        String strA0W = A0W(596, 6, 7);
        if (zEquals) {
            C2671iB c2671iBA0E = c2683iN.A0E();
            String clientToken = c2683iN.A7G();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0e(new C2030Ua(clientToken, this.A0c.A0A()));
            }
            C2045Up c2045UpA0F = c2671iBA0E.A0F();
            String[] strArr = A0m;
            ...
            if (c2045UpA0F != null) {
                SD sd = new SD(c2671iBA0E.A0F().getUrl(), c2671iBA0E.A0F().getHeight(), c2671iBA0E.A0F().getWidth(), c2683iN.A0G(), A0W(596, 6, 7));
                sd.A01 = this.A0C;
                this.A0b.A0W();
                this.A0b.A0c(sd);
            }
            if (!this.A0J.equals(V6.A05)) {
                if (c2671iBA0E.A0E() != null) {
                    this.A0b.A0c(new SD(c2671iBA0E.A0E().getUrl(), c2671iBA0E.A0E().getHeight(), c2671iBA0E.A0E().getWidth(), c2683iN.A0G(), A0W(596, 6, 7)));
                }
                if (c2683iN.A0H() != null) {
                    for (C1930Qc c1930Qc : c2683iN.A0H()) {
                        if (c1930Qc.getAdCoverImage() != null) {
                            this.A0b.A0c(new SD(c1930Qc.getAdCoverImage().getUrl(), c1930Qc.getAdCoverImage().getHeight(), c1930Qc.getAdCoverImage().getWidth(), c2683iN.A0G(), A0W(596, 6, 7)));
                        }
                    }
                }
                String strA0b = c2671iBA0E.A0b();
                if (!TextUtils.isEmpty(strA0b)) {
                    this.A0b.A0b(new SB(strA0b, c2683iN.A0G(), A0W(596, 6, 7), c2671iBA0E.A0A()));
                }
            }
            AbstractC2662hy abstractC2662hyA0C = c2671iBA0E.A0C();
            if (abstractC2662hyA0C != null && abstractC2662hyA0C.A1Y()) {
                SB sb = new SB(abstractC2662hyA0C.A0s(), abstractC2662hyA0C.A17(), strA0W);
                sb.A04 = true;
                sb.A03 = A0W(0, 5, 66);
                this.A0b.A0Y(sb);
            }
        }
        this.A0b.A0X(new T7(this, c2683iN, z10), new S8(c2683iN.A0G(), strA0W));
    }

    private void A0j(InterfaceC1831Me interfaceC1831Me) {
        if (this.A0a == null) {
            return;
        }
        this.A0a.A0K(interfaceC1831Me);
    }

    public static void A0k(NativeAdImageApi nativeAdImageApi, ImageView imageView, C2387dL c2387dL) {
        if (nativeAdImageApi != null && imageView != null) {
            new KZ(imageView, c2387dL).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0q() {
        return A19() == EnumC2050Uu.A05 || A19() == EnumC2050Uu.A03;
    }
    ...
    public final C2683iN A0z() {
        return this.A0a;
    }

    public final AbstractC2662hy A10() {
        return A0F().A0C();
    }
    ...
    public final C2047Ur A17() {
        return this.A0H;
    }

    public final EnumC2048Us A18() {
        return this.A0I;
    }

    public final EnumC2050Uu A19() {
        return A0F().A0H();
    }
    ...
    public final void A1J() {
        ...
        AbstractC2134Yd abstractC2134YdA01 = AbstractC2135Ye.A01(this.A0c, this.A0c.A0A(), A1C(), this.A07);
        if (abstractC2134YdA01 == null) {
            A0b();
        } else {
            ((C2530fg) this.A07.getNativeAdLayoutApi()).A03(abstractC2134YdA01);
            abstractC2134YdA01.A0M();
        }
    }
    ...
    public final void A1W(C2683iN c2683iN) {
        A0i(c2683iN, true);
        if (this.A0G != null && c2683iN.A0H() != null) {
            T9 t92 = new T9(this);
            for (C1930Qc c1930Qc : c2683iN.A0H()) {
                if (A0m[3].charAt(5) != 'B') {
                    throw new RuntimeException();
    ...
    public final void A1X(C2547fx c2547fx) {
        this.A0U = new WeakReference<>(c2547fx);
    }

    public final void A1Y(EnumC2041Ul enumC2041Ul, String str, SL sl) {
        if (str == null) {
            this.A0c.A0F().A3I();
        } else {
            this.A0c.A0F().A3H();
        ...
        if (strArr[0].charAt(21) != strArr[4].charAt(21)) {
            ...
            if (z10) {
                ...
                if (!integrationErrorMode.equals(integrationErrorModeA00)) {
                    ...
                    C2001Sw c2001Sw = new C2001Sw(strA0W);
                    A12().A08().AAy(A0W(550, 3, 101), AbstractC2000Sv.A0c, c2001Sw);
                } else {
                    throw new C1853Nb(strA0W);
                }
            }
            this.A0j = true;
            this.A0E = enumC2041Ul;
            if (enumC2041Ul.equals(EnumC2041Ul.A05)) {
                EnumC1829Mc enumC1829Mc = EnumC1829Mc.A05;
                if (A0m[3].charAt(5) == 'B') {
                    A0m[3] = "N11XMBa1eBkGGouoRChlRsXEwEtHvHDZ";
                    this.A08 = enumC1829Mc;
                }
            }
            this.A0C = sl;
            NT nt = new NT(this.A0g, this.A0J, A0R(), null, 1, new C2619hB());
            nt.A05(enumC2041Ul);
            nt.A06(this.A0S);
            nt.A07(this.A0T);
            this.A0A = new C14506w(this.A0c, nt);
    ...
    public final void A1Z(C2047Ur c2047Ur) {
        this.A0H = c2047Ur;
    }

    public final void A1a(EnumC2048Us enumC2048Us) {
        this.A0I = enumC2048Us;
    }
    ...
    public final void A1c(AbstractC2459eW abstractC2459eW) {
        this.A0V = new WeakReference<>(abstractC2459eW);
    }
    ...
    public final void A1f(boolean z10, boolean z11) {
        String strA0W;
        if (z10) {
            if (this.A0E.equals(EnumC2041Ul.A05)) {
                boolean zA0r = A0r();
                if (A0m[3].charAt(5) != 'B') {
                    throw new RuntimeException();
                }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2053Ux
    public final int A7V() {
        View view = this.A06;
        if (view instanceof AdNativeComponentView) {
            View videoView = ((AdNativeComponentView) view).getAdContentsView();
            if (videoView instanceof C2400dY) {
                return ((C2400dY) videoView).getCurrentPosition();
            }
            return -1;
        }
        return -1;
    ...
    public final NativeAdBase.NativeAdLoadConfigBuilder buildLoadAdConfig(NativeAdBase nativeAdBase) {
        return new C2051Uv(this, nativeAdBase);
    }
    ...
    public final Drawable getPreloadedIconViewDrawable() {
        C2045Up c2045UpA0F;
        Bitmap bitmapA0N;
        C2683iN adapter = this.A0a;
        if (adapter != null && (c2045UpA0F = A0F().A0F()) != null && (bitmapA0N = this.A0b.A0N(c2045UpA0F.getUrl())) != null) {
    ...
    public final void loadAd() {
        ...
        A1Y(EnumC2041Ul.A00(NativeAdBase.MediaCacheFlag.ALL), null, new SL(false, -1, -1));
    }
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        ...
        ((C2051Uv) nativeLoadAdConfig).A00();
    }
    ...
    */
    public final void unregisterView() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1930Qc.unregisterView():void");
    }
}
