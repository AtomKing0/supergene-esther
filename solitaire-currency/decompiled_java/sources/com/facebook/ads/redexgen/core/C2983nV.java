...
public final class C2983nV implements C6S {
    ...
    public C2983nV() {
        this(new C2872lh(true, 65536), 50000, 50000, 2500, 5000, -1, false, 0, false);
    }

    public C2983nV(C2872lh c2872lh, int i10, int i11, int i12, int i13, int i14, boolean z10, int i15, boolean z11) {
        int i16;
        ...
        this.A08 = c2872lh;
        this.A07 = AbstractC13764a.A0O(i10);
        this.A06 = AbstractC13764a.A0O(i11);
        this.A05 = AbstractC13764a.A0O(i12);
        this.A04 = AbstractC13764a.A0O(i13);
        this.A02 = i14;
        if (this.A02 != -1) {
            i16 = this.A02;
        } else {
        ...
        this.A00 = i16;
        this.A09 = z10;
        this.A03 = AbstractC13764a.A0O(i15);
        this.A0A = z11;
    }
    ...
    private final int A01(InterfaceC2874lj[] interfaceC2874ljArr) {
        int iA00 = 0;
        for (InterfaceC2874lj interfaceC2874lj : interfaceC2874ljArr) {
            if (interfaceC2874lj != null) {
                int targetBufferSize = interfaceC2874lj.A9D().A02;
    ...
    public final C2872lh A6n() {
        return this.A08;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final long A6s(C14667m c14667m) {
        return this.A03;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEj(C14667m c14667m) {
        A05(false);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEu(C14667m c14667m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFN(C14667m c14667m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFV(C6R c6r, C2901mA c2901mA, InterfaceC2874lj[] interfaceC2874ljArr) {
        int iA01;
        if (this.A02 == -1) {
            iA01 = A01(interfaceC2874ljArr);
        } else {
            iA01 = this.A02;
        }
        this.A00 = iA01;
    ...
    @Override // com.facebook.ads.redexgen.core.C6S
    public final boolean AI3(C14667m c14667m) {
        return this.A0A;
    }
    ...
    public final boolean AJB(C6R c6r) {
        ...
        long jMin = this.A07;
        if (c6r.A00 > 1.0f) {
            jMin = Math.min(AbstractC13764a.A0Q(jMin, c6r.A00), this.A06);
        }
    ...
    public final boolean AJE(long j10, float f10, boolean z10, boolean z11, long minBufferDurationUs) {
        long jA0R = AbstractC13764a.A0R(j10, f10);
