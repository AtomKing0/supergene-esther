...
public abstract class AbstractC2926ma<E> extends AbstractCollection<E> implements Serializable {
    ...
    public abstract AbstractC1531Am<E> A0J();
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC2729jA.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC3045oY.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC3039oR.A05(tArr, size);
