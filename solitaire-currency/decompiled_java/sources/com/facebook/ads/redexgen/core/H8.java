...
public abstract class H8 {
     ...
     */
    public static H7 A06(C4J c4j) throws C13322i {
        A0C(1, c4j, false);
        int iA0F = c4j.A0F();
        int iA0I = c4j.A0I();
        int iA0F2 = c4j.A0F();
    ...
    public static Metadata A02(List<String> list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            String[] strArrA1P = AbstractC13764a.A1P(str, A07(0, 1, 56));
    ...
    */
    public static com.facebook.ads.redexgen.core.H4 A03(com.facebook.ads.redexgen.core.H3 r15) throws com.facebook.ads.redexgen.core.C13322i {
        /*
    ...
    public static H5 A04(C4J c4j) throws C13322i {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.redexgen.core.H5 A05(com.facebook.ads.redexgen.core.C4J r9, boolean r10, boolean r11) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            if (r10 == 0) goto L7
            r1 = 3
            r0 = 0
    ...
    public static void A09(int i10, H3 h32) throws C13322i {
        int i11;
        ...
        for (int i12 = 0; i12 < iA02; i12++) {
            ...
            if (iA022 != 0) {
                ...
                if (mappingsCount4 == 0) {
                    ...
                    throw C13322i.A01(A07(491, 58, 71), null);
                }
            }
        }
    }

    public static void A0A(H3 h32) throws C13322i {
        int iA02 = h32.A02(6) + 1;
        for (int i10 = 0; i10 < iA02; i10++) {
            ...
            switch (iA022) {
                ...
                case 1:
                    ...
                    break;
                default:
                    throw C13322i.A01(A07(199, 41, 99) + iA022, null);
            }
        }
    }

    public static void A0B(H3 h32) throws C13322i {
        int iA02 = h32.A02(6) + 1;
        for (int i10 = 0; i10 < iA02; i10++) {
            ...
            if (residueCount <= 2) {
                ...
                throw C13322i.A01(A07(448, 43, 92), null);
            }
        }
    }

    public static boolean A0C(int i10, C4J c4j, boolean z10) throws C13322i {
        if (c4j.A07() < 7) {
            if (z10) {
                return false;
            }
            throw C13322i.A01(A07(549, 18, 10) + c4j.A07(), null);
        }
        if (c4j.A0I() != i10) {
            if (z10) {
                return false;
            }
            throw C13322i.A01(A07(178, 21, 53) + Integer.toHexString(i10), null);
        }
        if (c4j.A0I() != 118 || c4j.A0I() != 111 || c4j.A0I() != 114 || c4j.A0I() != 98 || c4j.A0I() != 105 || c4j.A0I() != 115) {
            if (z10) {
                return false;
            }
            throw C13322i.A01(A07(95, 28, 49), null);
        }
        return true;
    }

    public static H6[] A0D(C4J c4j, int i10) throws C13322i {
        A0C(5, c4j, false);
        int iA0I = c4j.A0I() + 1;
        ...
        for (int i11 = 0; i11 < timeCount; i11++) {
            ...
            if (numberOfBooks4 != 0) {
                throw C13322i.A01(A07(396, 52, 114), null);
            }
        }
        A0A(h32);
        A0B(h32);
        ...
        throw C13322i.A01(A07(PsExtractor.VIDEO_STREAM_MASK, 43, 105), null);
    }
