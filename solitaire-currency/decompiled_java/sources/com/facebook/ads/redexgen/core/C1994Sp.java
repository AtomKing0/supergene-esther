...
public final class C1994Sp {
    ...
    public static final List<C1995Sq> A07;
    public static final AtomicBoolean A08;
    public static final AtomicInteger A09;
    public static final AtomicReference<InterfaceC1992Sn> A0A;
    public static final AtomicReference<InterfaceC1993So> A0B;
    ...
    public static int A00(String str, int i10, SQ sq) {
        if ((A01(462, 7, 5).equals(str) && AbstractC2000Sv.A20 == i10) || A01(TypedValues.CycleType.TYPE_CUSTOM_WAVE_SHAPE, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
    ...
    public static void A05(SQ sq, int i10, int i11) {
        sq.A08().AAy(A01(427, 10, 35), AbstractC2000Sv.A2Z, new C2001Sw(A01(338, 33, 12) + i10, A01(87, 9, 54) + i11));
    }

    @Deprecated
    public static void A06(SQ sq, String str, int i10, C2001Sw c2001Sw) {
        if (sq == null) {
            A0F(new RuntimeException(A01(48, 39, 37)));
            return;
        }
        SP.A01(sq.A02());
        if (A02 && c2001Sw.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 81) + str + A01(31, 16, 108) + i10, c2001Sw));
        }
        try {
            if (A0J(sq, str, i10, Math.random(), c2001Sw)) {
                A09(sq, str, i10, c2001Sw);
            }
        } catch (Throwable th) {
            if (A05[7].length() == 7) {
                throw new RuntimeException();
    ...
    @Deprecated
    public static void A07(SQ sq, String str, int i10, C2001Sw c2001Sw) {
        try {
            c2001Sw.A05(2);
            c2001Sw.A0A(false);
            c2001Sw.A06(1);
    ...
    @Deprecated
    public static void A08(SQ sq, String str, int i10, C2001Sw c2001Sw) {
        try {
            c2001Sw.A05(2);
            c2001Sw.A08(false);
            A06(sq, str, i10, c2001Sw);
    ...
    public static void A09(SQ sq, String str, int i10, C2001Sw c2001Sw) {
        synchronized (C1994Sp.class) {
            if (!A03) {
                int iA01 = U9.A01(sq);
                int threshold = A09.getAndIncrement();
                if (threshold < iA01 - 1) {
                    A07.add(new C1995Sq(str, i10, c2001Sw));
                } else if (A09.get() == iA01) {
                    A07.add(new C1995Sq(A01(427, 10, 35), AbstractC2000Sv.A2W, new C2001Sw(A01(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 42, 70) + str + A01(47, 1, 91) + i10)));
                }
            } else {
                A0A(sq, str, i10, c2001Sw, true);
            }
        }
    }

    public static void A0A(SQ sq, String str, int i10, C2001Sw c2001Sw, boolean z10) {
        InterfaceC1993So interfaceC1993So = A0B.get();
        boolean z11 = interfaceC1993So != null && interfaceC1993So.AAZ();
        boolean z12 = A08.get();
        String[] strArr = A05;
        ...
        if (z12 || z11) {
            int iA01 = c2001Sw.A01();
            String strA01 = A01(289, 17, 3);
            String strA012 = A01(31, 16, 108);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 114) + str + strA012 + i10, c2001Sw);
            } else {
                Log.i(strA01, A01(306, 32, 102) + str + strA012 + i10 + A01(19, 12, 98) + c2001Sw.getMessage() + A01(0, 19, 12) + c2001Sw.A03());
            }
        }
        C2206aP c2206aP = new C2206aP(sq, str, i10, c2001Sw, interfaceC1993So);
        if (z10) {
            A01.execute(c2206aP);
        } else {
            c2206aP.run();
    ...
    public static void A0C(C2361cu c2361cu, InterfaceC1993So interfaceC1993So, InterfaceC1992Sn interfaceC1992Sn, boolean z10) {
        A0A.set(interfaceC1992Sn);
        A0B.set(interfaceC1993So);
        A08.set(z10);
        synchronized (C1994Sp.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C2261bI(c2361cu));
            }
        }
    }
    ...
    public static void A0D(RuntimeException runtimeException) {
        if (A02) {
            new Handler(Looper.getMainLooper()).post(new RunnableC1991Sm(runtimeException));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x017b, code lost:
        ...
        com.facebook.ads.redexgen.core.C1994Sp.A0C.set(true);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:105:0x018c, code lost:
        ...
        r7 = r7 * r2;
        r2 = com.facebook.ads.redexgen.core.C1994Sp.A05;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x0164, code lost:
        ...
        r0 = com.facebook.ads.redexgen.core.C1994Sp.A0C.get();
     */
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.core.SQ r13, java.lang.String r14, int r15, double r16, com.facebook.ads.redexgen.core.C2001Sw r18) {
        /*
            Method dump skipped, instruction units count: 633
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1994Sp.A0J(com.facebook.ads.redexgen.X.SQ, java.lang.String, int, double, com.facebook.ads.redexgen.X.Sw):boolean");
    }

    public static boolean A0K(SQ sq, String str, int i10, C2001Sw c2001Sw) {
        if (!U9.A0P(sq)) {
            return true;
        }
        ...
        if (customLimit >= eventsLimit) {
            if (A06.contains(Integer.valueOf(customLimit)) && c2001Sw.A0D()) {
