...
public enum EnumC2095Wq {
    ...
    EnumC2095Wq(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC2095Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC2095Wq enumC2095Wq : values()) {
            if (enumC2095Wq.A01 == nativeComponentTag) {
                return enumC2095Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC2095Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC2095Wq enumC2095Wq) {
        if (view != null && enumC2095Wq != null) {
            view.setTag(A02, enumC2095Wq);
        }
    }
