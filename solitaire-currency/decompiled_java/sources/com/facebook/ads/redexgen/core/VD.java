...
public class VD extends AbstractRunnableC2074Vt {
    ...
    public final void A07() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C2033Ud.A06(this.A00, C2484ev.A00(this.A00), all);
            }
            ...
            this.A00.A08().AAy(A00(31, 14, 46), IronSourceConstants.BN_AUCTION_SUCCESS, new C2001Sw(e10));
            sharedPreferences.edit().clear().apply();
        }
        synchronized (C2033Ud.class) {
            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
            for (Map.Entry entry : C2033Ud.A02.entrySet()) {
