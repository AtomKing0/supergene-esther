...
public final class C2290bl extends FrameLayout {
    ...
    public final C2030Ua A08;
    public final InterfaceC2118Xn A09;
    public final YY A0A;
    public final InterfaceC2289bk A0B;
    public final EG A0C;
    public final E1 A0D;
    public final C13583i A0E;
    public final DX A0F;
    public final DV A0G;
    public final DR A0H;
    public final DP A0I;
    ...
    public C2290bl(C2387dL c2387dL, US us, AbstractC2662hy abstractC2662hy, SF sf, C2030Ua c2030Ua, InterfaceC2118Xn interfaceC2118Xn, YY yy, InterfaceC2289bk interfaceC2289bk) {
        boolean z10;
        super(c2387dL);
        ...
        this.A0A = yy;
        this.A0D = new E1(c2387dL);
        this.A0B = interfaceC2289bk;
        this.A0D.setFunnelLoggingHandler(c2030Ua);
        this.A0D.getEventBus().A03(this.A0J, this.A0I, this.A0H, this.A0K, this.A0F, this.A0G);
        this.A0E = new C13583i(c2387dL, us, this.A0D, abstractC2662hy.A25());
        if (U7.A1v(this.A07)) {
            z10 = true;
            this.A0C = new EG(c2387dL, us, this.A0D, abstractC2662hy.A25(), false, this.A0E, null);
        } else {
            z10 = true;
            this.A0C = null;
        }
        ...
        String videoUrl = abstractC2662hy.A20().A0H().A08();
        if (!TextUtils.isEmpty(videoUrl)) {
            AbstractC2208aR.A00(c2387dL, this, videoUrl);
        }
    ...
    private void A0B() {
        if (!TextUtils.isEmpty(this.A05.A20().A0H().A08())) {
            C13392p c13392p = new C13392p(this.A07);
            this.A0D.A0i(c13392p);
            c13392p.setImage(this.A05.A20().A0H().A08());
        }
        C2R c2r = new C2R(this.A07, true, this.A08);
        this.A0D.A0i(c2r);
        this.A0D.A0i(new D4(c2r, EnumC2418dr.A02, true));
        this.A0D.A0i(new C2Y(this.A07));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(C3Q c3q) {
        if (this.A0D.getState() == EnumC2457eU.A02 && U7.A1Z(this.A07)) {
    ...
    public final void A0N() {
        ...
        this.A0D.A0h(EnumC2403db.A02, 26);
        A08();
    }
    ...
    public final void A0T(boolean z10) {
        if (this.A0D.A0r() || this.A02 || this.A0D.getState() == EnumC2457eU.A06 || this.A00 == null) {
            return;
        }
        if (!this.A01 || z10) {
    ...
    public final void A0V(boolean z10) {
        this.A0D.A0h(EnumC2403db.A04, 25);
    }
}
