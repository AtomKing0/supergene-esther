...
public final class ZO extends LinearLayout {
    ...
    public ZO(C2387dL c2387dL, WebView webView) {
        this(c2387dL, webView, false, false);
    }

    public ZO(C2387dL c2387dL, WebView webView, boolean z10, boolean z11) {
        super(c2387dL);
        this.A08 = getResources().getDisplayMetrics().density;
        this.A0B = new LQ(this);
        this.A09 = webView;
        this.A0A = c2387dL;
        this.A0C = U8.A06(c2387dL);
        this.A0E = z10;
        this.A0D = z11;
        A08();
        if (z11) {
