...
public final class U1 implements Closeable {
    ...
    public U1(C2021Tr c2021Tr, InterfaceC2029Tz interfaceC2029Tz) throws IOException {
        this.A01 = c2021Tr;
        A05(c2021Tr, interfaceC2029Tz);
        if (this.A02.isEmpty()) {
            A00();
        }
    }
    ...
    private U0 A00() throws IOException {
        ...
        int i10 = iA00 + 1;
        this.A02.add(new U0(i10, new C2027Tx(new File(this.A01.A05(), A01(i10)))));
    ...
    private void A04(int i10, File file) throws IOException {
        C2027Tx c2027Tx = new C2027Tx(file);
        c2027Tx.A05();
        this.A02.addFirst(new U0(i10, c2027Tx));
    }

    private void A05(C2021Tr c2021Tr, InterfaceC2029Tz interfaceC2029Tz) throws IOException {
        File[] fileArrListFiles = c2021Tr.A05().listFiles();
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC2029Tz.AHs(String.format(Locale.US, A02(260, 39, 118), file.getCanonicalPath()));
                }
            }
            ...
            if (!zIsEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i12) {
                        interfaceC2029Tz.AHs(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i12)));
                ...
                while (i10 >= i12) {
                    ...
                    try {
                        ...
                        interfaceC2029Tz.AHt(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i10)), e10);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC2029Tz.AHs(String.format(locale, A02(40, 26, 116), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC2029Tz.AHs(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
        }
        IOException e11 = new IOException(String.format(Locale.US, A02(66, 38, 13), c2021Tr.A05().getCanonicalPath()));
        throw e11;
    }
    ...
    public final synchronized C2019Tp A0A(int i10, int i11, byte[] bArr, int i12, int[] iArr, int i13) throws IOException {
        if (!this.A00) {
            for (U0 file : this.A02) {
                if (file.A00() == i10) {
                    return new C2019Tp(i10, file.A02(i11, bArr, i12, iArr, i13));
                }
            }
            return new C2019Tp(-1, new C2018To(EnumC2017Tn.A05, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 31));
    }
