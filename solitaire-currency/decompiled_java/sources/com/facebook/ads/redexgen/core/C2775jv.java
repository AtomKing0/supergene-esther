...
public final class C2775jv implements GX {
    ...
    public static final InterfaceC1673Gb A0E;
    public int A00;
    public long A01;
    public long A02;
    public GY A03;
    ...
    static {
        A04();
        A0E = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.jw
    ...
    public C2775jv(int i10) {
        this.A07 = (i10 & 2) != 0 ? i10 | 1 : i10;
        this.A0B = new C2774ju(true);
    ...
    private int A01(InterfaceC2853lN interfaceC2853lN) throws IOException {
        int i10 = 0;
        while (true) {
            interfaceC2853lN.AG9(this.A0A.A0l(), 0, 10);
            this.A0A.A0f(0);
    ...
    private C2857lS A02(long j10, boolean z10) {
        return new C2857lS(j10, this.A01, A00(this.A00, this.A0B.A0J()), this.A00, z10);
    }
    ...
    private void A05(long j10, boolean z10) {
        ...
        if (!z11 || this.A0B.A0J() == C.TIME_UNSET) {
            this.A03.AIN(new C2848lI(C.TIME_UNSET));
        } else {
    ...
    private void A06(InterfaceC2853lN interfaceC2853lN) throws IOException {
        ...
        if (interfaceC2853lN.A8f() == 0) {
            A01(interfaceC2853lN);
        }
        int currentFrameSize = 0;
        long j10 = 0;
        while (true) {
            try {
                if (!interfaceC2853lN.AGA(this.A0A.A0l(), 0, 2, true)) {
                    break;
                }
                this.A0A.A0f(0);
                if (C2774ju.A0F(this.A0A.A0M())) {
                    if (!interfaceC2853lN.AGA(this.A0A.A0l(), 0, 4, true)) {
                        break;
                    }
                    this.A08.A08(14);
                    ...
                    if (numValidFrames != 114) {
                        ...
                        if (iA04 > 6) {
                            j10 += (long) iA04;
                            currentFrameSize++;
                            if (currentFrameSize == 1000 || !interfaceC2853lN.A40(iA04 - 6, true)) {
                                break;
                            }
                        } else {
                            this.A04 = true;
                            throw C13322i.A01(A03(0, 21, 88), null);
                        }
                    } else {
                        throw new RuntimeException();
                    }
    ...
    public static /* synthetic */ GX[] A07() {
        return new GX[]{new C2775jv()};
    }

    @Override // com.facebook.ads.redexgen.core.GX
    public final void AA4(GY gy) {
        this.A03 = gy;
        this.A0B.A5U(gy, new C1779Ke(0, 1));
        gy.A6G();
    }
    ...
    public final int AGb(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        ...
        int bytesRead = interfaceC2853lN.read(this.A09.A0l(), 0, 2048);
    ...
    public final boolean AJL(InterfaceC2853lN interfaceC2853lN) throws IOException {
        ...
        int syncBytes = 0;
        do {
            interfaceC2853lN.AG9(this.A0A.A0l(), 0, 2);
            this.A0A.A0f(0);
            int startPosition = this.A0A.A0M();
            if (!C2774ju.A0F(startPosition)) {
                syncBytes = 0;
                frameSize = 0;
                i10++;
                interfaceC2853lN.AI1();
                ...
                interfaceC2853lN.AG9(this.A0A.A0l(), 0, 4);
                this.A08.A08(14);
                C4I c4i = this.A08;
                ...
                if (headerPosition4 <= 6) {
                    ...
                    interfaceC2853lN.A3z(startPosition3);
