...
public final class C2749jV implements InterfaceC1784Kj {
    ...
    public final C3064or A06;
    public final C4J A07;
    public final GY A08;
    public final H1 A09;
    public final C1786Kl A0A;
    ...
    private void A06(byte[] bArr, int i10, int i11, byte[] bArr2) {
        ...
        for (int i19 = 0; i19 < i16 * 2; i19++) {
            ...
            iA07 = AbstractC13764a.A07(iA07 + i22, -32768, 32767);
            i18 += i13 * 2;
            bArr2[i18] = (byte) (iA07 & 255);
            bArr2[i18 + 1] = (byte) (iA07 >> 8);
            iMin = AbstractC13764a.A07(iMin + A0E[i21], 0, A0F.length - 1);
            i17 = A0F[iMin];
        }
    }
    ...
    static {
        ...
        A0F = new int[]{7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, 130, 143, 157, 173, 190, 209, 230, 253, 279, 307, 337, 371, c3.a.b.f11499h, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
    }

    public C2749jV(GY gy, H1 h12, C1786Kl c1786Kl) throws C13322i {
        this.A08 = gy;
        this.A09 = h12;
        this.A0A = c1786Kl;
        this.A05 = Math.max(1, c1786Kl.A04 / 10);
        C4J scratch = new C4J(c1786Kl.A06);
        scratch.A0G();
        this.A04 = scratch.A0G();
        int i10 = c1786Kl.A05;
        int i11 = (((c1786Kl.A02 - (i10 * 4)) * 8) / (c1786Kl.A01 * i10)) + 1;
        if (this.A04 == i11) {
            int numChannels = AbstractC13764a.A05(this.A05, this.A04);
            this.A0B = new byte[c1786Kl.A02 * numChannels];
            int maxBlocksToDecode = A02(this.A04, i10);
            this.A07 = new C4J(maxBlocksToDecode * numChannels);
            int maxBlocksToDecode2 = c1786Kl.A04;
            int constantBitrate = ((maxBlocksToDecode2 * c1786Kl.A02) * 8) / this.A04;
            this.A06 = new C2D().A11(A03(34, 9, 83)).A0a(constantBitrate).A0j(constantBitrate).A0h(A02(this.A05, i10)).A0b(c1786Kl.A05).A0m(c1786Kl.A04).A0i(2).A14();
            return;
        }
        throw C13322i.A01(A03(7, 27, 67) + i11 + A03(0, 7, 8) + this.A04, null);
    }
    ...
    private void A05(int i10) {
        long jA0U = this.A03 + AbstractC13764a.A0U(this.A02, 1000000L, this.A0A.A04);
        int iA01 = A01(i10);
    ...
    */
    private void A07(byte[] r4, int r5, com.facebook.ads.redexgen.core.C4J r6) {
        ...
        L17:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2749jV.A07(byte[], int, com.facebook.ads.redexgen.X.4J):void");
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1784Kj
    public final void AA0(int i10, long j10) {
        this.A08.AIN(new C2746jS(this.A0A, this.A04, i10, j10));
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1784Kj
    public final boolean AI9(InterfaceC2853lN interfaceC2853lN, long j10) throws IOException {
        int iA00 = this.A05 - A00(this.A01);
        int targetFramesRemaining = this.A04;
        int blocksToDecode = AbstractC13764a.A05(iA00, targetFramesRemaining);
        ...
        while (!z10) {
            ...
            int blocksToDecode2 = interfaceC2853lN.read(bArr, targetFramesRemaining4, targetReadBytes);
