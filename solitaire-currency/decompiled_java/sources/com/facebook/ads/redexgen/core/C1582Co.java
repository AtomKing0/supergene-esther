...
public final class C1582Co implements InterfaceC2429e2 {
    public int A00;
    ...
    public C1582Co(View view, int i10, int i11, int i12) {
        this.A05 = view;
        this.A03 = i10;
        this.A00 = i11;
        this.A04 = i12;
    ...
    private ValueAnimator A00(int i10, int i11, View view) {
        ...
        valueAnimatorOfInt.addUpdateListener(new C2432e5(this, view));
    ...
    public void A07(boolean z10) {
        if (z10) {
            ...
            this.A01.addListener(new C2431e4(this));
            this.A01.start();
            return;
        }
    ...
    public void A08(boolean z10) {
        ...
        if (z10) {
            ...
            this.A01.addListener(new C2430e3(this));
            this.A01.start();
            return;
        }
        ViewGroup.LayoutParams layoutParams = this.A05.getLayoutParams();
