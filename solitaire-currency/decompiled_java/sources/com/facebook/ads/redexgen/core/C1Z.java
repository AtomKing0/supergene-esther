...
public class C1Z<K, V> extends AbstractC1530Al<Map.Entry<K, V>> {
    public final transient int A00;
    public final transient int A01;
    public final transient AbstractC2935mj<K, V> A02;
    ...
    public C1Z(AbstractC2935mj<K, V> map, Object[] alternatingKeysAndValues, int keyOffset, int size) {
        this.A02 = map;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1Z != com.google.common.collect.RegularImmutableMap$EntrySet<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC1530Al
    public final AbstractC1531Am<Map.Entry<K, V>> A0M() {
        return new AbstractC1531Am<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.1a
            /* JADX INFO: Access modifiers changed from: private */
            @Override // java.util.List
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
            public final Map.Entry<K, V> get(int index) {
                AbstractC2729jA.A00(index, this.A00.A01);
    ...
    public final AbstractC3098pg<Map.Entry<K, V>> iterator() {
        return A0J().iterator();
    }
