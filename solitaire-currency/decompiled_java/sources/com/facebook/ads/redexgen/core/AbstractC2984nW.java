...
import com.facebook.ads.redexgen.core.AbstractC2985nX;
import com.facebook.ads.redexgen.core.C2986nY;
...
public abstract class AbstractC2984nW<I extends C2986nY, O extends AbstractC2985nX, E extends C5P> implements C5O<I, O, E> {
    ...
    public AbstractC2984nW(I[] iArr, O[] oArr) {
        this.A0B = iArr;
    ...
    private boolean A0X() throws InterruptedException {
        ...
        synchronized (this.A07) {
            ...
            if (iRemoveFirst.A05()) {
                ...
                if (iRemoveFirst.A06()) {
                    o10.A00(C.BUFFER_FLAG_FIRST_SAMPLE);
                }
                try {
