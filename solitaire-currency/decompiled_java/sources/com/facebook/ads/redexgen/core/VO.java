...
public final class VO implements InterfaceC2034Ue {
    ...
    public ViewOnAttachStateChangeListenerC2056Va A00;
    public C3111pu<UE, UJ> A01;
    public final C2361cu A02;
    ...
    public VO(C2361cu c2361cu) {
        this.A02 = c2361cu;
    }

    private void A01() {
        this.A02.A08().AAy(A00(89, 14, 19), 3600, new C2001Sw(A00(67, 22, 124)));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2034Ue
    ...
    public final void AJj(View view) {
        if (this.A01 == null) {
            this.A02.A08().AAy(A00(89, 14, 19), 3600, new C2001Sw(A00(32, 35, 85)));
            return;
        }
        this.A03.A08(view);
    }
    ...
    public final void AK4(View view, String str, boolean z10, boolean z11, boolean z12) {
        if (view != null) {
            this.A00 = new ViewOnAttachStateChangeListenerC2056Va(view, this.A02);
            this.A03.A0A(this.A00, view);
            if (z11) {
                this.A00.A04();
            }
            this.A01 = C3111pu.A00(new UE(this.A02, view, str, z10, z12), new UJ(), A06).A06(new C2060Vf(new VN())).A07();
            this.A03.A09(view, this.A01);
            return;
        }
        this.A02.A08().AAy(A00(89, 14, 19), 3600, new C2001Sw(A00(0, 32, 98)));
    }
}
