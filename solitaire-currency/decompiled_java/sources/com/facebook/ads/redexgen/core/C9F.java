...
public final class C9F implements InterfaceC2912mM, InterfaceC2913mN {
    ...
    public long A01;
    public long A02;
    public InterfaceC2913mN A03;
    public C2916mQ[] A04 = new C2916mQ[0];
    public final InterfaceC2912mM A05;

    public C9F(InterfaceC2912mM interfaceC2912mM, boolean z10, long j10, long j11) {
        this.A05 = interfaceC2912mM;
    ...
    private C7I A00(long j10, C7I c7i) {
        long toleranceBeforeUs = AbstractC13764a.A0T(c7i.A01, 0L, j10 - this.A01);
        long jA0T = AbstractC13764a.A0T(c7i.A00, 0L, this.A00 == Long.MIN_VALUE ? Long.MAX_VALUE : this.A00 - j10);
    ...
    public final void ACs(InterfaceC2912mM interfaceC2912mM) {
        ((InterfaceC2913mN) C3M.A01(this.A03)).ACs(this);
    }

    public static boolean A02(long j10, InterfaceC2874lj[] interfaceC2874ljArr) {
        if (j10 != 0) {
            for (InterfaceC2874lj interfaceC2874lj : interfaceC2874ljArr) {
                if (interfaceC2874lj != null) {
                    C3064or c3064orA8u = interfaceC2874lj.A8u();
                    if (!AbstractC13312h.A0G(c3064orA8u.A0W, c3064orA8u.A0R)) {
                        return true;
                    }
                }
            }
    ...
    public final void AEk(InterfaceC2912mM interfaceC2912mM) {
        ...
        ((InterfaceC2913mN) C3M.A01(this.A03)).AEk(this);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2912mM
    public final void AGL(InterfaceC2913mN interfaceC2913mN, long j10) {
        this.A03 = interfaceC2913mN;
    ...
    public final long AGg() {
        ...
        InterfaceC2912mM interfaceC2912mM = this.A05;
        if (A06[2].length() == 0) {
            throw new RuntimeException();
        }
        A06[6] = "ABWUoGiNBoa";
        long jAGg2 = interfaceC2912mM.AGg();
    ...
    */
    public final long AIP(com.facebook.ads.redexgen.core.InterfaceC2874lj[] r18, boolean[] r19, com.facebook.ads.redexgen.core.InterfaceC1585Cr[] r20, boolean[] r21, long r22) {
        /*
