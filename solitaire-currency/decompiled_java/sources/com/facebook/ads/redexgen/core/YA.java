...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC2090Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC2090Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC2090Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC2090Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC2090Wl.A02 * 12.0f);

    public YA(C2387dL c2387dL, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c2387dL);
        this.A05 = new TextView(c2387dL);
        this.A02 = new Button(c2387dL);
        this.A01 = new Button(c2387dL);
        this.A03 = new ImageView(c2387dL);
        this.A04 = new LinearLayout(c2387dL);
