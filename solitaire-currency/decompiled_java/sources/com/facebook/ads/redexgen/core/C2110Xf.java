...
public final class C2110Xf implements SensorEventListener {
    ...
    public final Set<InterfaceC2109Xe> A09 = new CopyOnWriteArraySet();
    ...
    public C2110Xf(C2387dL c2387dL) {
        this.A08 = c2387dL;
    }
    ...
    public final void A03(InterfaceC2109Xe interfaceC2109Xe) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC2109Xe)) {
            return;
        }
        this.A09.add(interfaceC2109Xe);
    }
        ...
        if (now - this.A06 > 100) {
            ...
            if (speed > 800.0f) {
                ...
                if (i10 >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
                    Iterator<InterfaceC2109Xe> it = this.A09.iterator();
                    while (it.hasNext()) {
                        it.next().AFD();
                    }
                }
