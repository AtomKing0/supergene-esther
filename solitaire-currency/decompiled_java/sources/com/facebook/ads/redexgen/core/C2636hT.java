...
public class C2636hT implements MX {
    ...
    public C2636hT(AnonymousClass72 anonymousClass72, Runnable runnable) {
        this.A00 = anonymousClass72;
        this.A01 = runnable;
    }

    @Override // com.facebook.ads.redexgen.core.MX
    public final void ACb(InterfaceC2699id interfaceC2699id) {
        this.A00.A02.A0F().A4S();
        this.A00.A07.A0C();
    }

    @Override // com.facebook.ads.redexgen.core.MX
    public final void ACc(InterfaceC2699id interfaceC2699id, View view) {
        this.A00.A02.A0F().A4R(interfaceC2699id == ((AbstractC2633hQ) this.A00).A00);
        if (interfaceC2699id != ((AbstractC2633hQ) this.A00).A00) {
            return;
        }
        this.A00.A0H().removeCallbacks(this.A01);
        MP mp = ((AbstractC2633hQ) this.A00).A01;
        ...
        ((AbstractC2633hQ) anonymousClass72).A01 = interfaceC2699id;
        this.A00.A01 = view;
        if (!this.A00.A0C) {
            this.A00.A07.A0F(interfaceC2699id);
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.MX
    public final void ACd(InterfaceC2699id interfaceC2699id) {
    ...
    @Override // com.facebook.ads.redexgen.core.MX
    public final void ADj(InterfaceC2699id interfaceC2699id, V1 v12) {
        this.A00.A02.A0F().A4T(interfaceC2699id == ((AbstractC2633hQ) this.A00).A00, v12.A03().getErrorCode());
        if (interfaceC2699id != ((AbstractC2633hQ) this.A00).A00) {
            return;
        }
        this.A00.A0H().removeCallbacks(this.A01);
        this.A00.A0Q(interfaceC2699id);
        this.A00.ADB(v12);
    }
}
