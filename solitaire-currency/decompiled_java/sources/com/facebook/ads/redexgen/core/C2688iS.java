...
public final class C2688iS implements MP, NG {
    ...
    private int A00() {
        ...
        EnumC2176Zt enumC2176ZtA02 = A02();
        if (enumC2176ZtA02 == EnumC2176Zt.A05) {
            String[] strArr = A0C;
            String str = strArr[4];
        ...
        } else if (enumC2176ZtA02 == EnumC2176Zt.A03) {
            switch (rotation) {
                case 2:
                case 3:
    ...
    private final EnumC2057Vb A01() {
        return this.A04.A0E();
    }

    private EnumC2176Zt A02() {
        return this.A04.A0F();
    }
    ...
    private void A06(Intent intent) {
        this.A04.A0I(intent, this.A01, C2384dI.A03(this.A01, this.A0A, this.A06));
    }

    private final void A07(C2387dL c2387dL, InterfaceC1827Ma interfaceC1827Ma, NU nu, EnumSet<CacheFlag> cacheFlags, String str) {
        NH nh = new NH(c2387dL, nu, this, str);
        AbstractC1840Mo abstractC1840MoA0D = nh.A0D();
        if (U7.A0v(c2387dL) && (abstractC1840MoA0D instanceof AbstractC2662hy) && ML.A06(this.A05, ML.A01(c2387dL, nu.A03(), ((AbstractC2662hy) abstractC1840MoA0D).A25()), c2387dL.A0A())) {
            this.A05.A0F().A4u();
            this.A02.ADc(this, AdError.NO_FILL);
        } else {
            this.A04 = nh;
            A08(nh.A0E());
            nh.A0J(c2387dL, cacheFlags);
        }
    }

    private void A08(EnumC2057Vb enumC2057Vb) {
        if (enumC2057Vb.equals(EnumC2057Vb.A04)) {
            this.A05.A0F().AJ9(LT.A05);
            return;
        }
        if (enumC2057Vb.equals(EnumC2057Vb.A0A)) {
            this.A05.A0F().AJ9(LT.A04);
            return;
        }
        if (enumC2057Vb.equals(EnumC2057Vb.A0B)) {
            this.A05.A0F().AJ9(LT.A0B);
            return;
        }
        if (enumC2057Vb.equals(EnumC2057Vb.A0D)) {
            this.A05.A0F().AJ9(LT.A0D);
            return;
        }
        if (enumC2057Vb.equals(EnumC2057Vb.A0C)) {
            this.A05.A0F().AJ9(LT.A0C);
            return;
        }
        if (!enumC2057Vb.equals(EnumC2057Vb.A06)) {
            return;
        }
        if (this.A04.A0K()) {
        ...
        if ((A09() instanceof AbstractC2662hy) && this.A04.A0L((AbstractC2662hy) A09())) {
    ...
    public final AbstractC1840Mo A09() {
        return this.A04.A0D();
    }

    public final void A0A(C2387dL c2387dL, InterfaceC1827Ma interfaceC1827Ma, NU nu, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c2387dL;
        this.A02 = interfaceC1827Ma;
        this.A08 = nu.A02();
        this.A06 = this.A08 != null ? this.A08.split(A03(107, 1, 22))[0] : A03(0, 0, 85);
        this.A00 = nu.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c2387dL, interfaceC1827Ma, nu, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        EnumC2057Vb enumC2057VbA01 = A01();
        A08(enumC2057VbA01);
        adActivityIntentA05.putExtra(A03(186, 8, 88), enumC2057VbA01);
        if (this.A07 != null) {
        ...
        try {
            ...
            this.A05.A08().AAy(A03(108, 11, 27), AbstractC2000Sv.A0D, new C2001Sw(cause2));
    ...
    public final void AGo() {
        this.A03 = new C1828Mb(this.A05, this.A0A, this, this.A02);
        this.A03.A02();
    }
