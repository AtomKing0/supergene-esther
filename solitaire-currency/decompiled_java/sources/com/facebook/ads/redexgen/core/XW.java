...
public abstract class XW {
    ...
    public static Bitmap A00(C2387dL c2387dL, Bitmap bitmap, int i10) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c2387dL);
    ...
    public static Bitmap A01(C2387dL c2387dL, Bitmap bitmap, int i10, int i11) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c2387dL, bitmapCreateBitmap, i10);
                if (i11 != 1) {
                ...
                return new C1892Oq().A02(bitmapCreateBitmap, i10);
            }
        }
        return null;
    }
