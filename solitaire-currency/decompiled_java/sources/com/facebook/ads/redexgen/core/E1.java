...
public class E1 extends RelativeLayout implements InterfaceC2458eV, InterfaceC2392dQ {
    ...
    public final C2009Te<AbstractC2010Tf, C2008Td> A0C;
    public final List<InterfaceC2404dc> A0D;
    public final InterfaceC2455eS A0E;
    ...
    public E1(C2387dL c2387dL) {
        super(c2387dL);
        this.A0D = new ArrayList();
        this.A08 = new Handler();
        this.A09 = new Handler();
        this.A0C = new C2009Te<>();
        this.A06 = true;
        this.A01 = 200;
        this.A00 = 1.0f;
        this.A0A = new ViewOnTouchListenerC2391dP(this);
        this.A0B = c2387dL;
        if (A0W(c2387dL)) {
            this.A0E = new CM(c2387dL);
        } else {
            this.A0E = new CJ(c2387dL);
        }
        A0H();
    }

    public E1(C2387dL c2387dL, AttributeSet attributeSet) {
        ...
        this.A0B = c2387dL;
        if (A0W(c2387dL)) {
            this.A0E = new CM(c2387dL, attributeSet);
        } else {
            this.A0E = new CJ(c2387dL, attributeSet);
        }
        A0H();
    }

    public E1(C2387dL c2387dL, AttributeSet attributeSet, int i10) {
        ...
        this.A0B = c2387dL;
        if (A0W(c2387dL)) {
            this.A0E = new CM(c2387dL, attributeSet, i10);
        } else {
            this.A0E = new CJ(c2387dL, attributeSet, i10);
        }
        A0H();
    }

    private float A06(InterfaceC2455eS interfaceC2455eS) {
        int videoHeight = interfaceC2455eS.getVideoHeight();
        if (videoHeight == 0) {
            return 1.0f;
        }
        int height = interfaceC2455eS.getVideoWidth();
    ...
    private void A0H() {
        ...
        this.A03 = new C2400dY(this.A0B, this.A0E);
    ...
    private final void A0K() {
        for (InterfaceC2404dc interfaceC2404dc : this.A0D) {
            boolean z10 = interfaceC2404dc instanceof AbstractC1594Da;
            String[] strArr = A0G;
            ...
            if (z10) {
                A0R((AbstractC1594Da) interfaceC2404dc);
            }
            interfaceC2404dc.AAm(this);
        }
    }
    ...
    private void A0Q(InterfaceC2404dc interfaceC2404dc) {
        if (interfaceC2404dc instanceof AbstractC1594Da) {
            A0S((AbstractC1594Da) interfaceC2404dc);
        }
        interfaceC2404dc.AJk(this);
    }

    private void A0R(AbstractC1594Da abstractC1594Da) {
        if (abstractC1594Da.getParent() == null) {
            if (abstractC1594Da instanceof C13392p) {
                this.A03.A02(abstractC1594Da);
            } else {
                addView(abstractC1594Da);
            }
        }
    }

    private void A0S(AbstractC1594Da abstractC1594Da) {
        if (abstractC1594Da instanceof C13392p) {
            this.A03.A03(abstractC1594Da);
        } else {
            XP.A0H(abstractC1594Da);
        }
    }
    ...
    private boolean A0W(C2387dL c2387dL) {
        return U7.A2t(c2387dL, C2442eF.A03());
    }
    ...
    public final void A0b() {
        Iterator<InterfaceC2404dc> it = this.A0D.iterator();
        while (it.hasNext()) {
            A0Q(it.next());
        }
        this.A0D.clear();
    ...
    public final void A0c(int i10) {
        ...
        C2400dY c2400dY = this.A03;
        if (A0G[3].length() == 1) {
            throw new RuntimeException();
        }
        A0G[7] = "Fk13SNDKaQVX0dV87s1e6TAwbDOb9nQX";
        c2400dY.setLayoutParams(layoutParams);
    }
    ...
    public final void A0g(EnumC2395dT enumC2395dT) {
        E8 e82 = new E8(this);
        if (this.A07) {
            XJ.A00(e82);
        } else {
        ...
        this.A0E.AJH(enumC2395dT.A03());
    }

    public final void A0h(EnumC2403db enumC2403db, int i10) {
        if (this.A04 && this.A0E.getState() == EnumC2457eU.A06) {
            this.A04 = false;
        }
        this.A0E.AJM(enumC2403db, i10);
        if (A0G[7].charAt(27) == '4') {
            throw new RuntimeException();
        }
        A0G[3] = "hMpnI8E";
    ...
    public final void A0i(InterfaceC2404dc interfaceC2404dc) {
        this.A0D.add(interfaceC2404dc);
    }

    public final void A0j(InterfaceC2404dc interfaceC2404dc) {
        this.A0D.remove(interfaceC2404dc);
        A0Q(interfaceC2404dc);
    }
    ...
    public final boolean A0q() {
        return getState() == EnumC2457eU.A05;
    }
    ...
    public final boolean A0s() {
        return getState() == EnumC2457eU.A0A;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2392dQ
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2458eV
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2458eV
    public final void AFt(EnumC2457eU enumC2457eU) {
        int currentPositionInMillis = getCurrentPositionInMillis();
        int currentPositionMS = getDuration();
        ED ed = new ED(this, enumC2457eU, currentPositionInMillis, currentPositionMS);
        if (this.A07) {
            XJ.A00(ed);
        } else {
            this.A09.post(ed);
    ...
    public C2009Te<AbstractC2010Tf, C2008Td> getEventBus() {
        return this.A0C;
    }
    ...
    public List<InterfaceC2404dc> getPlugins() {
        return this.A0D;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2392dQ
    public EnumC2403db getVideoStartReason() {
    ...
    public void setFunnelLoggingHandler(C2030Ua c2030Ua) {
        this.A02 = c2030Ua;
    }
