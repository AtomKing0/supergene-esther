...
public abstract class KB {
     ...
     */
    public static int A06(List<C1774Jz> list, String str, K7 k72) {
        List<K8> listA0E = A0E(list, str, k72);
        for (int i10 = 0; i10 < listA0E.size(); i10++) {
            C1774Jz c1774Jz = listA0E.get(i10).A01;
            if (c1774Jz.A07() != -1) {
                return c1774Jz.A07();
            }
        }
    ...
    */
    public static android.text.SpannedString A07(java.lang.String r11, java.lang.String r12, java.util.List<com.facebook.ads.redexgen.core.C1774Jz> r13) {
        /*
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 6 out of bounds for length 6
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static K3 A0A(C4J c4j, List<C1774Jz> list) {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 19 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static void A0H(SpannableStringBuilder spannableStringBuilder, String str, K7 k72, List<K6> list, List<C1774Jz> list2) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (A0C(415, 2, 49).equals(((K6) arrayList.get(i11)).A01.A01)) {
                ...
                spannableStringBuilder.setSpan(new C3008nv(charSequenceSubSequence.toString(), iA00), i10, i12, 33);
    ...
    static {
        ...
        map.put(A0C(AnimationConstants.DefaultDurationMillis, 4, 98), Integer.valueOf(Color.rgb(0, 255, 255)));
        map.put(A0C(c3.a.b.f11496e, 3, 61), Integer.valueOf(Color.rgb(255, 0, 0)));
    ...
    */
    ...
    public static C3015o2 A09(CharSequence charSequence) {
        KA infoBuilder = new KA();
        infoBuilder.A0A = charSequence;
        return infoBuilder.A07().A0H();
    }

    public static K3 A0B(String str, Matcher matcher, C4J c4j, List<C1774Jz> list) {
        KA ka2 = new KA();
        try {
    ...
    public static String A0D(String str) {
        ...
        return AbstractC13764a.A1P(strTrim, A0C(182, 5, 117))[0];
    }

    public static List<K8> A0E(List<C1774Jz> list, String str, K7 k72) {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < list.size(); i10++) {
            C1774Jz c1774Jz = list.get(i10);
            int i11 = c1774Jz.A09(str, k72.A01, k72.A03, k72.A02);
            if (i11 > 0) {
                arrayList.add(new K8(i11, c1774Jz));
            }
        }
    ...
    public static void A0G(SpannableStringBuilder spannableStringBuilder, C1774Jz c1774Jz, int i10, int i11) {
        if (c1774Jz == null) {
            return;
        }
        if (c1774Jz.A08() != -1) {
            C3H.A00(spannableStringBuilder, new StyleSpan(c1774Jz.A08()), i10, i11, 33);
        }
        if (c1774Jz.A0S()) {
            spannableStringBuilder.setSpan(new StrikethroughSpan(), i10, i11, 33);
        }
        boolean zA0T = c1774Jz.A0T();
        if (A01[3].charAt(21) != 'Z') {
            ...
            if (c1774Jz.A0R()) {
                C3H.A00(spannableStringBuilder, new ForegroundColorSpan(c1774Jz.A05()), i10, i11, 33);
            }
            if (c1774Jz.A0Q()) {
                C3H.A00(spannableStringBuilder, new BackgroundColorSpan(c1774Jz.A04()), i10, i11, 33);
            }
            if (c1774Jz.A0K() != null) {
                C3H.A00(spannableStringBuilder, new TypefaceSpan(c1774Jz.A0K()), i10, i11, 33);
            }
            switch (c1774Jz.A06()) {
                case 1:
                    C3H.A00(spannableStringBuilder, new AbsoluteSizeSpan((int) c1774Jz.A03(), true), i10, i11, 33);
                    break;
                case 2:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c1774Jz.A03()), i10, i11, 33);
                    break;
                case 3:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c1774Jz.A03() / 100.0f), i10, i11, 33);
                    break;
            }
            if (c1774Jz.A0P()) {
                spannableStringBuilder.setSpan(new C3009nw(), i10, i11, 33);
                return;
            }
            return;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0K(java.lang.String r8, com.facebook.ads.redexgen.core.K7 r9, java.util.List<com.facebook.ads.redexgen.core.K6> r10, android.text.SpannableStringBuilder r11, java.util.List<com.facebook.ads.redexgen.core.C1774Jz> r12) {
        /*
