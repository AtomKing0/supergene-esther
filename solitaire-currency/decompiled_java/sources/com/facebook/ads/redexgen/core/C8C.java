...
public final class C8C {
    ...
    public final /* synthetic */ void A02(int i10, long j10, long j11) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACY(i10, j10, j11);
    }
    ...
    public final /* synthetic */ void A04(long j10) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACU(j10);
    }
    ...
    public final /* synthetic */ void A06(C3064or c3064or, C14115j c14115j) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACS(c3064or);
        ((C8D) AbstractC13764a.A0f(this.A01)).ACT(c3064or, c14115j);
    }

    public final void A07(final C14085g c14085g) {
        c14085g.A02();
        if (this.A00 != null) {
            this.A00.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.85
                @Override // java.lang.Runnable
                public final void run() {
                    this.A01.A09(c14085g);
                }
            });
        }
    }

    public final void A08(final C14085g c14085g) {
        if (this.A00 != null) {
            this.A00.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.8B
                @Override // java.lang.Runnable
                public final void run() {
                    this.A01.A0A(c14085g);
                }
            });
        }
    }

    public final /* synthetic */ void A09(C14085g c14085g) {
        c14085g.A02();
        ((C8D) AbstractC13764a.A0f(this.A01)).ACQ(c14085g);
    }

    public final /* synthetic */ void A0A(C14085g c14085g) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACR(c14085g);
    }
    ...
    public final /* synthetic */ void A0E(Exception exc) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACV(exc);
    }
    ...
    public final /* synthetic */ void A0H(String str, long j10, long j11) {
        ((C8D) AbstractC13764a.A0f(this.A01)).ACP(str, j10, j11);
    }
    ...
    public final /* synthetic */ void A0J(boolean z10) {
        ((C8D) AbstractC13764a.A0f(this.A01)).AFF(z10);
    }
