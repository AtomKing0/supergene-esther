...
public class C2157Za extends WebChromeClient {
    ...
    public final WeakReference<C2387dL> A00;
    ...
    public C2157Za(WeakReference<C2387dL> weakReference, WeakReference<ZY> weakReference2, WeakReference<ZT> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C2387dL c2387dL = this.A00.get();
        if (c2387dL != null && c2387dL.A0E() != null && LJ.A09) {
            if (LJ.A08 != null) {
            ...
            try {
                ...
                c2387dL.A0E().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 84)), 1001);
                return true;
            } catch (Exception e10) {
                c2387dL.A08().AAz(A00(80, 8, 33), AbstractC2000Sv.A2d, new C2001Sw(e10));
