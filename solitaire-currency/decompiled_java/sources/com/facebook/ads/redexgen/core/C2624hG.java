...
public final class C2624hG implements InterfaceC1852Na {
    ...
    public final AbstractC2621hD A03;
    ...
    public C2624hG(C2387dL c2387dL, AbstractC2621hD abstractC2621hD) {
        this.A04 = c2387dL;
        this.A03 = abstractC2621hD;
    }
    ...
    private void A02(NZ nz, NZ nz2) {
        ...
        InterfaceC1999Su interfaceC1999SuA08 = this.A04.A08();
        int i10 = AbstractC2000Sv.A0e;
        C2001Sw c2001Sw = new C2001Sw(strA00, string);
        String errorTitle3 = A00(TsExtractor.TS_STREAM_TYPE_DTS_UHD, 3, 61);
        interfaceC1999SuA08.AAy(errorTitle3, i10, c2001Sw);
    ...
    private void A03(String str, String str2, boolean z10) {
        ...
        if (!z10) {
            Log.e(strA002, str3);
            this.A04.A08().AAy(strA00, AbstractC2000Sv.A0c, new C2001Sw(str3));
        ...
        switch (NY.A00[integrationErrorModeA00.ordinal()]) {
            case 1:
                ...
                throw new C1853Nb(errorMessage);
            case 2:
                this.A03.A08();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1852Na
