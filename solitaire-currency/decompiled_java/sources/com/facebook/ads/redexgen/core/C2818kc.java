...
public final class C2818kc implements GX {
    ...
    public static final InterfaceC1673Gb A0b;
    public static final C3064or A0c;
    ...
    public final H1 A0S;
    public final HO A0T;
    public final C1735Im A0U;
    public final ArrayDeque<C2825kj> A0V;
    public final ArrayDeque<IX> A0W;
    public final List<C3064or> A0X;
    public final byte[] A0Y;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static int A01(IY iy, int i10, int i11, C4J c4j, int i12) throws C13322i {
        int iA0C;
        int i13 = i12;
        c4j.A0f(8);
        int iA00 = II.A00(c4j.A0C());
        C1735Im c1735Im = iy.A05.A03;
        C1737Io c1737Io = iy.A09;
        IP ip = (IP) AbstractC13764a.A0f(c1737Io.A06);
        c1737Io.A0C[i10] = c4j.A0L();
        c1737Io.A0E[i10] = c1737Io.A04;
        if ((iA00 & 1) != 0) {
            long[] jArr = c1737Io.A0E;
        ...
        long j10 = A0a(c1735Im) ? ((long[]) AbstractC13764a.A0f(c1735Im.A09))[0] : 0L;
        int[] iArr = c1737Io.A0B;
        long[] jArr2 = c1737Io.A0D;
        boolean[] zArr = c1737Io.A0G;
        boolean z15 = c1735Im.A03 == 2 && (i11 & 1) != 0;
        int i14 = i13 + c1737Io.A0C[i10];
        long j11 = c1735Im.A06;
        long j12 = c1737Io.A05;
        while (i13 < i14) {
            if (z11) {
                iA0C = c4j.A0C();
                if (A0a[5].length() == 30) {
            ...
            jArr2[i13] = AbstractC13764a.A0U((((long) (z14 ? c4j.A0C() : 0)) + j12) - j10, 1000000L, j11);
            if (!c1737Io.A09) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Pair<Long, C2858lT> A05(C4J c4j, long j10) throws C13322i {
        long jA0R;
        long jA0R2;
        c4j.A0f(8);
        ...
        long jA0U = AbstractC13764a.A0U(jA0R, 1000000L, jA0Q);
        c4j.A0g(2);
        int iA0M = c4j.A0M();
        ...
        for (int i10 = 0; i10 < iA0M; i10++) {
            ...
            if ((Integer.MIN_VALUE & iA0C) != 0) {
                throw C13322i.A01(A0A(756, 28, 79), null);
            }
            long jA0Q2 = c4j.A0Q();
            ...
            jArr3[i10] = jA0U2;
            jA0R += jA0Q2;
            jA0U2 = AbstractC13764a.A0U(jA0R, 1000000L, jA0Q);
            jArr2[i10] = jA0U2 - jArr3[i10];
            c4j.A0g(4);
            jA0R2 += (long) iArr[i10];
        }
        return Pair.create(Long.valueOf(jA0U), new C2858lT(iArr, jArr, jArr2, jArr3));
    }
    ...
    private void A0H(C4J c4j, Uri uri) {
        ...
        switch (iA01) {
            case 0:
                ...
                long jA0Q2 = c4j.A0Q();
                jA0U2 = AbstractC13764a.A0U(c4j.A0Q(), 1000000L, jA0Q2);
                if (this.A0C != C.TIME_UNSET) {
                    jA05 = this.A0C + jA0U2;
                }
                jA0U = AbstractC13764a.A0U(c4j.A0Q(), 1000L, jA0Q2);
                jA0Q = c4j.A0Q();
                break;
            case 1:
                long jA0Q3 = c4j.A0Q();
                jA05 = AbstractC13764a.A0U(c4j.A0R(), 1000000L, jA0Q3);
                jA0U = AbstractC13764a.A0U(c4j.A0Q(), 1000L, jA0Q3);
                jA0Q = c4j.A0Q();
                str = (String) C3M.A01(c4j.A0U());
                str2 = (String) C3M.A01(c4j.A0U());
                break;
        ...
        if (this.A0A != C.TIME_UNSET && !MetaExoPlayerUpgradeConfig.A03(EnumC2663i2.A12)) {
            jA05 = this.A0A;
        }
        H1[] h1Arr2 = this.A0J;
        if (A0a[0].length() != 3) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0R(C2825kj c2825kj, SparseArray<IY> sparseArray, boolean z10, int i10, byte[] bArr) throws C13322i {
        IY iyA09 = A09(((C2824ki) C3M.A01(c2825kj.A07(Atom.TYPE_tfhd))).A00, sparseArray, z10);
        if (iyA09 == null) {
            return;
        }
        C1737Io c1737Io = iyA09.A09;
        long j10 = c1737Io.A05;
        boolean z11 = c1737Io.A09;
        iyA09.A08();
        iyA09.A06 = true;
        C2824ki c2824kiA07 = c2825kj.A07(Atom.TYPE_tfdt);
        if (c2824kiA07 == null || (i10 & 2) != 0) {
            c1737Io.A05 = j10;
            String[] strArr = A0a;
            if (strArr[4].charAt(20) == strArr[6].charAt(20)) {
                throw new RuntimeException();
            ...
            c1737Io.A05 = A03(c2824kiA07.A00);
            c1737Io.A09 = true;
        }
        A0S(c2825kj, iyA09, i10);
        C1735Im c1735Im = iyA09.A05.A03;
        Object objA01 = C3M.A01(c1737Io.A06);
        String[] strArr2 = A0a;
        if (strArr2[4].charAt(20) == strArr2[6].charAt(20)) {
            throw new RuntimeException();
        }
        A0a[1] = "vW8YzoDO1k8YQphW8Ysx";
        C1736In c1736InA00 = c1735Im.A00(((IP) objA01).A02);
        C2824ki c2824kiA072 = c2825kj.A07(Atom.TYPE_saiz);
        if (c2824kiA072 != null) {
            A0V((C1736In) C3M.A01(c1736InA00), c2824kiA072.A00, c1737Io);
        }
        C2824ki c2824kiA073 = c2825kj.A07(Atom.TYPE_saio);
        if (c2824kiA073 != null) {
            A0I(c2824kiA073.A00, c1737Io);
        }
        C2824ki c2824kiA074 = c2825kj.A07(Atom.TYPE_senc);
        if (c2824kiA074 != null) {
            A0J(c2824kiA074.A00, c1737Io);
        }
        A0T(c2825kj, c1736InA00 != null ? c1736InA00.A02 : null, c1737Io);
        int size = c2825kj.A02.size();
        for (int i11 = 0; i11 < size; i11++) {
            C2824ki c2824ki = c2825kj.A02.get(i11);
            if (((II) c2824ki).A00 == 1970628964) {
                A0K(c2824ki.A00, c1737Io, bArr);
            }
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0T(C2825kj c2825kj, String str, C1737Io c1737Io) throws C13322i {
        C4J c4j = null;
        C4J c4j2 = null;
        for (int i10 = 0; i10 < c2825kj.A02.size(); i10++) {
            C2824ki c2824ki = c2825kj.A02.get(i10);
            C4J c4j3 = c2824ki.A00;
            if (((II) c2824ki).A00 == 1935828848) {
                c4j3.A0f(12);
                if (c4j3.A0C() == 1936025959) {
                    c4j = c4j3;
                }
            } else if (((II) c2824ki).A00 == 1936158820) {
                c4j3.A0f(12);
                if (c4j3.A0C() == 1936025959) {
                    c4j2 = c4j3;
                }
        ...
        if (c4j.A0C() != 1) {
            throw C13322i.A00(A0A(126, 39, 73));
        }
        c4j2.A0f(8);
        ...
        if (iA012 == 1) {
            if (c4j2.A0Q() == 0) {
                throw C13322i.A00(A0A(784, 55, 110));
            }
        } else if (iA012 >= 2) {
            c4j2.A0g(4);
        }
        if (c4j2.A0Q() != 1) {
            throw C13322i.A00(A0A(165, 39, 18));
        }
        c4j2.A0g(1);
        int iA0I = c4j2.A0I();
        ...
        if (z10) {
            ...
            c1737Io.A08 = true;
            c1737Io.A07 = new C1736In(z10, str, iA0I2, bArr, i11, i12, bArr2);
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0V(C1736In c1736In, C4J c4j, C1737Io c1737Io) throws C13322i {
        int i10 = c1736In.A00;
        c4j.A0f(8);
        ...
        int iA0L = c4j.A0L();
        if (iA0L > c1737Io.A00) {
            throw C13322i.A01(A0A(IronSourceConstants.INIT_COMPLETE, 18, 58) + iA0L + A0A(40, 38, 7) + c1737Io.A00, null);
        }
        int i11 = 0;
        if (iA0I == 0) {
            boolean[] zArr = c1737Io.A0F;
            if (A0a[1].length() == 3) {
                throw new RuntimeException();
            }
            A0a[0] = "ACu";
            ...
            i11 = 0 + (iA0I * iA0L);
            Arrays.fill(c1737Io.A0F, 0, iA0L, iA0I > i10);
        }
        Arrays.fill(c1737Io.A0F, iA0L, c1737Io.A00, false);
        if (i11 > 0) {
            c1737Io.A02(i11);
        }
    }
    ...
    static {
        A0D();
        A0b = new InterfaceC1673Gb() { // from class: com.facebook.ads.redexgen.X.kd
    ...
    public C2818kc(int i10) {
        this(i10, null);
    }

    public C2818kc(int i10, C4R c4r) {
        this(i10, c4r, null, Collections.emptyList());
    }

    public C2818kc(int i10, C4R c4r, C1735Im c1735Im, List<C3064or> list) {
        this(i10, c4r, c1735Im, list, null);
    }

    @MetaExoPlayerCustomization("Additional fields for custom behaviors")
    public C2818kc(int i10, C4R c4r, C1735Im c1735Im, List<C3064or> list, H1 h12) {
        ...
        this.A0T = new HO();
        this.A0M = new C4J(16);
        this.A0P = new C4J(AbstractC1688Gq.A03);
        this.A0O = new C4J(5);
        this.A0N = new C4J();
    ...
    public static int A00(int i10) throws C13322i {
        if (i10 >= 0) {
            return i10;
        }
        throw C13322i.A01(A0A(700, 27, 67) + i10, null);
    }
    ...
    public static DrmInitData A06(List<C2824ki> list) {
        ArrayList arrayList = null;
        int size = list.size();
        for (int i10 = 0; i10 < size; i10++) {
            C2824ki c2824ki = list.get(i10);
            int leafChildrenSize = ((II) c2824ki).A00;
            if (leafChildrenSize == 1886614376) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                byte[] bArrA0l = c2824ki.A00.A0l();
                UUID uuidA02 = AbstractC1728If.A02(bArrA0l);
                if (uuidA02 == null) {
    ...
    */
    private void A0C() {
        ...
        L2c:
            ...
            java.lang.Object[] r0 = com.facebook.ads.redexgen.core.AbstractC13764a.A1I(r0, r6)
        ...
        L3a:
            if (r2 >= r3) goto L46
            r1 = r4[r2]
            com.facebook.ads.redexgen.X.or r0 = com.facebook.ads.redexgen.core.C2818kc.A0c
            r1.A6W(r0)
            int r2 = r2 + 1
            goto L3a
        L46:
        ...
        L51:
            ...
            com.facebook.ads.redexgen.X.or r0 = (com.facebook.ads.redexgen.core.C3064or) r0
            r1.A6W(r0)
            com.facebook.ads.redexgen.X.H1[] r0 = r7.A0I
            r0[r3] = r1
            int r3 = r3 + 1
        ...
        L72:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2818kc.A0C():void");
    }
    ...
    private void A0F(long j10) throws C13322i {
    ...
    public static void A0G(C4J c4j, int i10, C1737Io c1737Io) throws C13322i {
        c4j.A0f(i10 + 8);
        int fullAtom = c4j.A0C();
        ...
        if (fullAtom2 == 0) {
            ...
            if (sampleCount == 0) {
                boolean[] zArr = c1737Io.A0F;
                int fullAtom4 = c1737Io.A00;
                Arrays.fill(zArr, 0, fullAtom4, false);
                return;
            }
            int fullAtom5 = c1737Io.A00;
            if (sampleCount == fullAtom5) {
                Arrays.fill(c1737Io.A0F, 0, sampleCount, z10);
                int fullAtom6 = c4j.A07();
                c1737Io.A02(fullAtom6);
                c1737Io.A04(c4j);
                return;
            }
            StringBuilder sbAppend = new StringBuilder().append(A0A(532, 18, 95)).append(sampleCount).append(A0A(0, 40, 98));
            int fullAtom7 = c1737Io.A00;
            throw C13322i.A01(sbAppend.append(fullAtom7).toString(), null);
        }
        throw C13322i.A00(A0A(458, 56, 30));
    }

    public static void A0I(C4J c4j, C1737Io c1737Io) throws C13322i {
        c4j.A0f(8);
        int flags = c4j.A0C();
        ...
        if (iA0L == 1) {
            ...
            c1737Io.A03 += entryCount == 0 ? c4j.A0Q() : c4j.A0R();
            return;
        }
        throw C13322i.A01(A0A(727, 29, 60) + iA0L, null);
    }

    public static void A0J(C4J c4j, C1737Io c1737Io) throws C13322i {
        A0G(c4j, 0, c1737Io);
    }

    public static void A0K(C4J c4j, C1737Io c1737Io, byte[] bArr) throws C13322i {
        c4j.A0f(8);
        c4j.A0k(bArr, 0, 16);
    ...
    private void A0L(InterfaceC2853lN interfaceC2853lN) throws IOException {
        int i10 = ((int) this.A07) - this.A00;
        C4J c4j = this.A0D;
        if (c4j != null) {
            interfaceC2853lN.readFully(c4j.A0l(), 8, i10);
            A0U(new C2824ki(this.A01, c4j), interfaceC2853lN.A8f(), interfaceC2853lN.A9H());
        } else {
            interfaceC2853lN.AJJ(i10);
        }
        A0F(interfaceC2853lN.A8f());
    }

    private void A0M(InterfaceC2853lN interfaceC2853lN) throws IOException {
        IY iyValueAt = null;
        long j10 = Long.MAX_VALUE;
        int size = this.A0L.size();
        for (int i10 = 0; i10 < size; i10++) {
            IY nextTrackBundle = this.A0L.valueAt(i10);
            C1737Io c1737Io = nextTrackBundle.A09;
            if (c1737Io.A0A && c1737Io.A03 < j10) {
                j10 = c1737Io.A03;
        ...
        int iA8f = (int) (j10 - interfaceC2853lN.A8f());
        if (iA8f >= 0) {
            interfaceC2853lN.AJJ(iA8f);
            iyValueAt.A09.A05(interfaceC2853lN);
            return;
        }
        throw C13322i.A01(A0A(RendererCapabilities.DECODER_SUPPORT_MASK, 39, 59), null);
    }

    private void A0N(C2825kj c2825kj) throws C13322i {
        if (((II) c2825kj).A00 == 1836019574) {
            A0P(c2825kj);
            return;
        }
        if (((II) c2825kj).A00 == 1836019558) {
            A0O(c2825kj);
            return;
        }
        if (this.A0V.isEmpty()) {
        ...
        C2825kj c2825kjPeek = this.A0V.peek();
        if (A0a[1].length() == 3) {
            throw new RuntimeException();
        }
        A0a[5] = "pjYwVuiFyV8fJrHeJXv5AlOqs";
        c2825kjPeek.A08(c2825kj);
    }

    private void A0O(C2825kj c2825kj) throws C13322i {
        A0Q(c2825kj, this.A0L, this.A0U != null, this.A0K, this.A0Y);
        DrmInitData drmInitDataA06 = A06(c2825kj.A02);
    ...
    private void A0P(C2825kj c2825kj) throws C13322i {
        C3M.A0A(this.A0U == null, A0A(680, 20, 8));
        DrmInitData drmInitDataA06 = A06(c2825kj.A02);
        C2825kj c2825kj2 = (C2825kj) C3M.A01(c2825kj.A06(Atom.TYPE_mvex));
        SparseArray<IP> sparseArray = new SparseArray<>();
        long jA02 = C.TIME_UNSET;
        int size = c2825kj2.A02.size();
        for (int i10 = 0; i10 < size; i10++) {
            C2824ki c2824ki = c2825kj2.A02.get(i10);
            if (((II) c2824ki).A00 == 1953654136) {
                Pair<Integer, IP> pairA04 = A04(c2824ki.A00);
            ...
            } else if (((II) c2824ki).A00 == 1835362404) {
                jA02 = A02(c2824ki.A00);
            }
        }
        List<C1738Ip> listA0O = IO.A0O(c2825kj, new C1680Gi(), jA02, drmInitDataA06, (this.A0K & 16) != 0, false, new InterfaceC2709ip() { // from class: com.facebook.ads.redexgen.X.ke
            @Override // com.facebook.ads.redexgen.core.InterfaceC2709ip
            public final Object A43(Object obj2) {
                return this.A00.A0c((C1735Im) obj2);
            }
        });
        int size2 = listA0O.size();
        if (this.A0L.size() == 0) {
            for (int i11 = 0; i11 < size2; i11++) {
                C1738Ip c1738Ip = listA0O.get(i11);
                C1735Im c1735Im = c1738Ip.A03;
                this.A0L.put(c1735Im.A00, new IY(this.A0E.AJh(i11, c1735Im.A03), c1738Ip, A07(sparseArray, c1735Im.A00)));
                this.A08 = Math.max(this.A08, c1735Im.A04);
            }
            this.A0E.A6G();
            return;
        }
        ...
        for (int i12 = 0; i12 < size2; i12++) {
            C1738Ip c1738Ip2 = listA0O.get(i12);
            C1735Im c1735Im2 = c1738Ip2.A03;
            this.A0L.get(c1735Im2.A00).A0C(c1738Ip2, A07(sparseArray, c1735Im2.A00));
        }
    }

    public static void A0Q(C2825kj c2825kj, SparseArray<IY> sparseArray, boolean z10, int i10, byte[] bArr) throws C13322i {
        int size = c2825kj.A01.size();
        for (int i11 = 0; i11 < size; i11++) {
            C2825kj child = c2825kj.A01.get(i11);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0S(com.facebook.ads.redexgen.core.C2825kj r8, com.facebook.ads.redexgen.core.IY r9, int r10) throws com.facebook.ads.redexgen.core.C13322i {
        /*
            r4 = 0
            r3 = 0
        ...
        L9:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2818kc.A0a
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 30
            if (r1 == r0) goto L67
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2818kc.A0a
            java.lang.String r1 = "g5KWW"
            r0 = 1
            r2[r0] = r1
            if (r5 >= r7) goto L3f
            java.lang.Object r1 = r8.get(r5)
            com.facebook.ads.redexgen.X.ki r1 = (com.facebook.ads.redexgen.core.C2824ki) r1
            int r0 = r1.A00
            if (r0 != r6) goto L3c
        ...
        L4e:
            ...
            com.facebook.ads.redexgen.X.ki r3 = (com.facebook.ads.redexgen.core.C2824ki) r3
            int r1 = r3.A00
            if (r1 != r6) goto L63
            int r2 = r5 + 1
        ...
        L67:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2818kc.A0S(com.facebook.ads.redexgen.X.kj, com.facebook.ads.redexgen.X.IY, int):void");
    }

    @MetaExoPlayerCustomization("Adding Uri for eMsg")
    private void A0U(C2824ki c2824ki, long j10, Uri uri) throws C13322i {
        if (!this.A0V.isEmpty()) {
            this.A0V.peek().A09(c2824ki);
            return;
        }
        if (((II) c2824ki).A00 == 1936286840) {
            Pair<Long, C2858lT> pairA05 = A05(c2824ki.A00, j10);
            ...
            this.A0E.AIN((InterfaceC1694Gw) pairA05.second);
            this.A0G = true;
            return;
        }
        if (((II) c2824ki).A00 != 1701671783 || uri == null) {
            return;
        }
        A0H(c2824ki.A00, uri);
    }
    ...
    */
    public static boolean A0X(int r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2818kc.A0X(int):boolean");
    }

    private boolean A0Y(InterfaceC2853lN interfaceC2853lN) throws IOException {
        int trackCount;
        int i10;
        if (this.A00 == 0) {
            C4J c4j = this.A0M;
            if (A0a[2].charAt(14) != 'D') {
                ...
                if (!interfaceC2853lN.AGh(c4j.A0l(), 0, 8, true)) {
                    return false;
                }
                this.A00 = 8;
                this.A0M.A0f(0);
        ...
        if (this.A07 == 1) {
            interfaceC2853lN.readFully(this.A0M.A0l(), 8, 8);
            int headerBytesRemaining = this.A00;
            this.A00 = headerBytesRemaining + 8;
            this.A07 = this.A0M.A0R();
        } else if (this.A07 == 0) {
            long jA8G = interfaceC2853lN.A8G();
            if (jA8G == -1 && !this.A0V.isEmpty()) {
                jA8G = this.A0V.peek().A00;
            }
            if (jA8G != -1) {
                long jA8f = jA8G - interfaceC2853lN.A8f();
                int trackCount2 = this.A00;
                this.A07 = jA8f + ((long) trackCount2);
            }
        }
        if (this.A07 >= this.A00) {
            long jA8f2 = interfaceC2853lN.A8f() - ((long) this.A00);
            if ((this.A01 == 1836019558 || this.A01 == 1835295092) && !this.A0G) {
                this.A0E.AIN(new C2848lI(this.A08, jA8f2));
                this.A0G = true;
            }
            if (this.A01 == 1836019558) {
                ...
                while (i10 < trackCount) {
                    C1737Io c1737Io = this.A0L.valueAt(i10).A09;
                    c1737Io.A02 = jA8f2;
                    c1737Io.A03 = jA8f2;
                    c1737Io.A04 = jA8f2;
                    i10++;
            ...
            if (A0W(this.A01)) {
                long jA8f3 = (interfaceC2853lN.A8f() + this.A07) - 8;
                this.A0V.push(new C2825kj(this.A01, jA8f3));
                if (this.A07 == this.A00) {
                    A0F(jA8f3);
                } else {
                    A0B();
                ...
                if (this.A00 != 8) {
                    throw C13322i.A00(A0A(284, 51, 6));
                }
                if (this.A07 <= 2147483647L) {
                    ...
                    throw C13322i.A00(A0A(335, 49, 77));
                }
            } else if (this.A07 <= 2147483647L) {
                this.A0D = null;
                this.A02 = 1;
            } else {
                throw C13322i.A00(A0A(592, 53, 87));
            }
            return true;
        }
        throw C13322i.A00(A0A(78, 48, 36));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x0246, code lost:
        ...
        throw com.facebook.ads.redexgen.core.C13322i.A01(A0A(androidx.constraintlayout.core.motion.utils.TypedValues.CycleType.TYPE_WAVE_PERIOD, 35, 125), null);
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0Z(com.facebook.ads.redexgen.core.InterfaceC2853lN r19) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 774
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2818kc.A0Z(com.facebook.ads.redexgen.X.lN):boolean");
    }

    public static boolean A0a(C1735Im c1735Im) {
        if (c1735Im.A08 == null || c1735Im.A08.length != 1 || c1735Im.A09 == null) {
            return false;
        }
        if (c1735Im.A08[0] == 0) {
            return true;
        }
        long editListEndMediaTimeUs = AbstractC13764a.A0U(c1735Im.A08[0] + c1735Im.A09[0], 1000000L, c1735Im.A05);
        if (A0a[2].charAt(14) == 'D') {
            throw new RuntimeException();
        }
        A0a[1] = "wHdUW";
        return editListEndMediaTimeUs >= c1735Im.A04;
    }

    public static /* synthetic */ GX[] A0b() {
        return new GX[]{new C2817kb()};
    }

    public final C1735Im A0c(C1735Im c1735Im) {
        return c1735Im;
    }
    ...
    public final void AA4(GY gy) {
        ...
        A0C();
        if (this.A0U != null) {
            this.A0L.put(0, new IY(gy.AJh(0, this.A0U.A03), new C1738Ip(this.A0U, new long[0], new int[0], 0, new long[0], new int[0], 0L), new IP(0, 0, 0, 0)));
            this.A0E.A6G();
        }
    }
    ...
    public final int AGb(InterfaceC2853lN interfaceC2853lN, C1691Gt c1691Gt) throws IOException {
        while (true) {
            switch (this.A02) {
                case 0:
                    if (!A0Y(interfaceC2853lN)) {
                        return -1;
                    }
                    break;
                    break;
                case 1:
                    A0L(interfaceC2853lN);
                    break;
                case 2:
                    A0M(interfaceC2853lN);
                    break;
                default:
                    if (A0Z(interfaceC2853lN)) {
                        return 0;
                    }
                    break;
            }
    ...
    public final boolean AJL(InterfaceC2853lN interfaceC2853lN) throws IOException {
        return AbstractC1733Ik.A01(interfaceC2853lN);
    }
}
