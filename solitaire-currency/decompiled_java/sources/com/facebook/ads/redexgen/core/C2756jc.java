...
public final class C2756jc implements GP {
    ...
    public C2756jc(int i10, C4R c4r, int i11) {
        this.A00 = i10;
        this.A03 = c4r;
        this.A01 = i11;
    }
    ...
    private GN A00(C4J c4j, long j10, long j11) {
        ...
        while (c4j.A07() >= 188 && (iA002 = (iA00 = AbstractC1781Kg.A00(c4j.A0l(), c4j.A09(), iA0A)) + TsExtractor.TS_PACKET_SIZE) <= iA0A) {
            long jA01 = AbstractC1781Kg.A01(c4j, iA00, this.A00);
    ...
    public final void AFA() {
        this.A02.A0i(AbstractC13764a.A07);
    }

    @Override // com.facebook.ads.redexgen.core.GP
    public final GN AIC(InterfaceC2853lN interfaceC2853lN, long j10) throws IOException {
        long jA8f = interfaceC2853lN.A8f();
        int iMin = (int) Math.min(this.A01, interfaceC2853lN.A8G() - jA8f);
        this.A02.A0d(iMin);
        interfaceC2853lN.AG9(this.A02.A0l(), 0, iMin);
