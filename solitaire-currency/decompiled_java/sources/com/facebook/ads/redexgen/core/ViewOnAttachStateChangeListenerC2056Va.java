...
public final class ViewOnAttachStateChangeListenerC2056Va extends AbstractC3109ps implements View.OnAttachStateChangeListener {
    ...
    public ViewOnAttachStateChangeListenerC2056Va(View view, C2361cu c2361cu) {
        this.A00 = view;
        this.A01 = c2361cu;
        ...
        if (A05()) {
            try {
                ...
                this.A01.A08().AAy(A00(137, 14, 83), 3600, new C2001Sw(A00(0, 45, 1) + th.getMessage()));
            }
        }
    }
    ...
    public final void A04() {
        try {
            ...
            this.A01.A08().AAy(A00(137, 14, 83), 3600, new C2001Sw(A00(45, 48, 117) + th.getMessage()));
        }
    }
    ...
    public final void onViewDetachedFromWindow(View view) {
        try {
            ...
            this.A01.A08().AAy(A00(137, 14, 83), 3600, new C2001Sw(A00(93, 44, 25) + th.getMessage()));
        }
    }
}
