...
public final class C3030oH implements C1S {
    public static byte[] A05;
    public static final C1R<C3030oH> A06;
    ...
    static {
        A05();
        A07 = AbstractC13764a.A0h(0);
        A08 = AbstractC13764a.A0h(1);
        A06 = new C1R() { // from class: com.facebook.ads.redexgen.X.oI
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return C3030oH.A01(bundle);
            }
        };
    }

    public C3030oH(String str, C3064or... c3064orArr) {
        C3M.A07(c3064orArr.length > 0);
        this.A03 = str;
        this.A04 = c3064orArr;
        this.A01 = c3064orArr.length;
        int iA01 = AbstractC13312h.A01(c3064orArr[0].A0W);
        this.A02 = iA01 == -1 ? AbstractC13312h.A01(c3064orArr[0].A0S) : iA01;
        A04();
    }

    public C3030oH(C3064or... c3064orArr) {
        this(A02(0, 0, 114), c3064orArr);
    }
    ...
    public static /* synthetic */ C3030oH A01(Bundle bundle) {
        List listA01;
        List<Format> formats = bundle.getParcelableArrayList(A07);
        if (formats == null) {
            listA01 = MetaExoPlayerCustomizedCollections.A01();
        } else {
            listA01 = C3S.A01(C3064or.A0b, formats);
        }
        String id = bundle.getString(A08, A02(0, 0, 114));
        return new C3030oH(id, (C3064or[]) listA01.toArray(new C3064or[0]));
    }
    ...
    */
    public final int A07(com.facebook.ads.redexgen.core.C3064or r3) {
        /*
            r2 = this;
            r1 = 0
        L1:
        ...
        L10:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3030oH.A07(com.facebook.ads.redexgen.X.or):int");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C3030oH c3030oH = (C3030oH) obj;
        return this.A03.equals(c3030oH.A03) && Arrays.equals(this.A04, c3030oH.A04);
    }
