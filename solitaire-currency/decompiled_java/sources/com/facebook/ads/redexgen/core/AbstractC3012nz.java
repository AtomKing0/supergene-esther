...
public abstract class AbstractC3012nz {
    ...
    public static int A00(int expectedSize) {
        if (expectedSize < 3) {
            AbstractC2876ll.A00(expectedSize, A07(2, 12, 124));
    ...
    public static <K, V> Map.Entry<K, V> A01(@ParametricNullness K key, @ParametricNullness V value) {
        return new C1532An(key, value);
    }

    public static <K, V> Iterator<K> A02(Iterator<Map.Entry<K, V>> entryIterator) {
        return new C1525Ag(entryIterator);
    }

    public static <K, V> Iterator<V> A03(Iterator<Map.Entry<K, V>> entryIterator) {
        return new C1524Af(entryIterator);
    }

    public static <V> InterfaceC2709ip<Map.Entry<?, V>, V> A04() {
        EnumC1523Ae enumC1523Ae = EnumC1523Ae.A03;
        if (A01[6].charAt(13) == 's') {
            throw new RuntimeException();
        }
    ...
    public static String A08(Map<?, ?> map) {
        StringBuilder sbAppend = AbstractC2881lq.A01(map.size()).append('{');
        boolean z10 = true;
    ...
    public static boolean A0A(@CheckForNull Map<?, ?> map, Object value) {
        return AbstractC2973nL.A0E(A03(map.entrySet().iterator()), value);
    }
