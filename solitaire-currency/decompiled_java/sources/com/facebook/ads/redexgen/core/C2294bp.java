...
public class C2294bp extends WebViewClient {
    ...
    public final /* synthetic */ C2298bt A00;
    ...
    public C2294bp(C2298bt c2298bt) {
        this.A00 = c2298bt;
    }
    ...
    private void A02(int i10, String str, String str2, boolean z10) {
        ...
        this.A00.A0E.A04(AbstractC2000Sv.A16, string);
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        String string = jSONObject.toString();
        C2387dL c2387dL = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c2387dL.A0F().A62(string);
            AbstractC2299bu.A04(this.A00.A09.A17());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C2309c4.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1O());
    }
}
