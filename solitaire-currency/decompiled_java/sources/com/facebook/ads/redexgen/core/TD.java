...
public final class TD extends R8 implements DefaultMediaViewVideoRendererApi {
    ...
    public C2387dL A01;
    public InterfaceC2040Uk A02;
    public AnonymousClass64 A04;
    public C13392p A05;
    public C2Z A06;
    public AbstractC2459eW A07;
    public C2460eX A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    public final InterfaceC2399dX A0C = new UW(this);
    public final AtomicBoolean A0D = new AtomicBoolean(false);
    public final AtomicBoolean A0E = new AtomicBoolean(false);
    public EnumC2050Uu A03 = EnumC2050Uu.A03;
    ...
    private C2020Tq A02() {
        return new C2020Tq(this);
    }

    private C2460eX A05() {
        return new C2460eX(this.A00, 50, true, new WeakReference(this.A07), this.A01);
    }
    ...
    private void A09() {
        if (this.A04 != null) {
            ...
            ((C2400dY) anonymousClass64.getVideoView()).setViewImplInflationListener(this.A0C);
        }
    }

    private void A0A() {
        if (this.A04 != null) {
            this.A04.getVideoView().setOnTouchListener(new ViewOnTouchListenerC2039Uj(this));
        }
    }

    private void A0B() {
        if (this.A04 != null) {
            ((C2400dY) this.A04.getVideoView()).setViewImplInflationListener(null);
        }
    }
    ...
    private void A0C() {
        ...
        if (this.A04 != null) {
            EnumC2457eU state = this.A04.getState();
            String[] strArr = A0G;
            if (strArr[7].length() != strArr[1].length()) {
                throw new RuntimeException();
            }
            A0G[4] = "z79LrkWpr7afRwAllWq14kp6jWBswbkV";
            if (state == EnumC2457eU.A05) {
                this.A0B = true;
            }
        }
        this.A08.A0V();
    ...
    public void A0D() {
        this.A03 = EnumC2050Uu.A03;
        A0B();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0I(C1930Qc c1930Qc, InterfaceC2040Uk interfaceC2040Uk) {
        String url;
        this.A0A = false;
        this.A0B = false;
        this.A02 = interfaceC2040Uk;
        A09();
        C13392p c13392p = this.A05;
        if (c1930Qc != null && c1930Qc.getAdCoverImage() != null) {
        ...
        c13392p.setImage(url, new C2025Tv(this));
        this.A03 = c1930Qc.A19();
        this.A06.setPlayAccessibilityLabel(c1930Qc.A1F());
        this.A06.setPauseAccessibilityLabel(c1930Qc.A1E());
        this.A08.A0U();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0J(EnumC2403db enumC2403db) {
        if (this.A04 != null) {
            this.A04.A0h(enumC2403db, 24);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0K() {
        if (this.A04 == null || this.A04.getState() == EnumC2457eU.A06) {
            return false;
        }
        return this.A03 == EnumC2050Uu.A05 || this.A03 == EnumC2050Uu.A03;
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i10) {
        InterfaceC2042Um interfaceC2042UmA01;
        ((R8) mediaViewVideoRendererApi.getAdComponentViewApi()).A00(this);
        switch (i10) {
            case 0:
                interfaceC2042UmA01 = A01(mediaViewVideoRendererApi);
                break;
            case 1:
                interfaceC2042UmA01 = A00(mediaViewVideoRendererApi);
                break;
            default:
                throw new IllegalArgumentException(A06(0, 30, 15));
        }
        ((RH) mediaViewVideoRendererApi).A06(interfaceC2042UmA01);
        this.A01 = RB.A03(context);
        this.A00 = mediaViewVideoRenderer;
        this.A05 = new C13392p(this.A01);
        this.A07 = A02();
        this.A08 = A05();
        float density = AbstractC2090Wl.A02;
    ...
    public final void onPrepared() {
        ...
        this.A00.setOnTouchListener(new ViewOnTouchListenerC2038Ui(this, zA0s));
        if (!zA0s) {
            A0A();
        }
    }
