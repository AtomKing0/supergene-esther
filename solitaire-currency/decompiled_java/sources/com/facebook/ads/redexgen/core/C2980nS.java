...
public final class C2980nS implements C7H {
    public static byte[] A05;
    public InterfaceC1607Dn A00;
    ...
    public C2980nS(Context context) {
        this(context, 0);
    }

    public C2980nS(Context context, int i10) {
        this(context, null, i10, 5000L);
    }

    @Deprecated
    public C2980nS(Context context, C9U c9u, int i10, long j10) {
        this.A00 = new C2981nT(this);
        this.A03 = context;
        this.A01 = i10;
        this.A02 = j10;
        this.A04 = c9u;
    ...
    private final void A02(Context context, C9U c9u, long j10, Handler handler, InterfaceC1660Fo interfaceC1660Fo, int extensionRendererIndex, ArrayList<InterfaceC2974nM> arrayList) throws Exception {
        Class<?> cls;
        Class<?> clazz;
        Class<?> clazz2;
        Class<?> clazz3;
        arrayList.add(new C0O(context, C2659hv.A0S, new MediaCodecRendererMetaParameters(null, false), InterfaceC1536Ar.A00, j10, c9u, false, false, handler, interfaceC1660Fo, 50, 5, 0, 0, 0));
        ...
        try {
            ...
            try {
                arrayList.add(size, (InterfaceC2974nM) cls.getConstructor(clazz, clazz2, Handler.class, InterfaceC1660Fo.class, clazz3, clazz3).newInstance(true, Long.valueOf(j10), handler, interfaceC1660Fo, 50, 5));
    ...
    private final void A03(Context context, C9U c9u, AnonymousClass38[] anonymousClass38Arr, Handler handler, C8D c8d, int extensionRendererIndex, ArrayList<InterfaceC2974nM> arrayList) throws Exception {
        int extensionRendererIndex2;
        int extensionRendererIndex3;
        Constructor<?> constructor;
        Constructor<?> constructor2;
        String strA00 = A00(0, 23, 29);
        arrayList.add(new C0Q(context, C2659hv.A0S, new MediaCodecRendererMetaParameters(null, false), InterfaceC1536Ar.A00, c9u, false, false, false, handler, c8d, C14697p.A02(context), anonymousClass38Arr));
        if (extensionRendererIndex == 0) {
            return;
        }
        int size = arrayList.size();
        ...
        try {
            ...
            try {
                arrayList.add(size, (InterfaceC2974nM) Class.forName(A00(415, 72, 19)).getConstructor(Handler.class, C8D.class, AnonymousClass38[].class).newInstance(handler, c8d, anonymousClass38Arr));
        ...
        try {
            constructor2 = Class.forName(A00(343, 72, 102)).getConstructor(Handler.class, C8D.class, AnonymousClass38[].class);
        ...
        try {
            arrayList.add(extensionRendererIndex2, (InterfaceC2974nM) constructor2.newInstance(handler, c8d, anonymousClass38Arr));
        ...
        try {
            try {
                constructor = Class.forName(A00(270, 73, 68)).getConstructor(Handler.class, C8D.class, AnonymousClass38[].class);
            } catch (Exception e14) {
                e = e14;
            }
            try {
                arrayList.add(extensionRendererIndex3, (InterfaceC2974nM) constructor.newInstance(handler, c8d, anonymousClass38Arr));
    ...
    private final void A04(Context context, B3 b32, Looper looper, int i10, ArrayList<InterfaceC2974nM> arrayList) {
        arrayList.add(new AnonymousClass13(b32, looper));
    }

    private final void A05(Context context, InterfaceC1610Dq interfaceC1610Dq, Looper looper, int i10, ArrayList<InterfaceC2974nM> arrayList) {
        arrayList.add(new C12990z(interfaceC1610Dq, looper, this.A00));
    }
    ...
    public final InterfaceC2974nM[] A5Q(Handler handler, InterfaceC1660Fo interfaceC1660Fo, C8D c8d, InterfaceC1610Dq interfaceC1610Dq, B3 b32, C9U c9u) throws Exception {
        C9U c9u2 = c9u;
        if (c9u2 == null) {
            c9u2 = this.A04;
        }
        ArrayList<InterfaceC2974nM> arrayList = new ArrayList<>();
        A02(this.A03, c9u2, this.A02, handler, interfaceC1660Fo, this.A01, arrayList);
        A03(this.A03, c9u2, A06(), handler, c8d, this.A01, arrayList);
        A05(this.A03, interfaceC1610Dq, handler.getLooper(), this.A01, arrayList);
        A04(this.A03, b32, handler.getLooper(), this.A01, arrayList);
        return (InterfaceC2974nM[]) arrayList.toArray(new InterfaceC2974nM[arrayList.size()]);
    }
}
