...
public final class AnonymousClass13 extends C9Z implements Handler.Callback {
    ...
    private void A07(Metadata metadata, List<Metadata.Entry> list) {
        for (int i10 = 0; i10 < metadata.A02(); i10++) {
            C3064or c3064orA9T = metadata.A03(i10).A9T();
            if (c3064orA9T == null || !this.A07.AJc(c3064orA9T)) {
                list.add(metadata.A03(i10));
            } else {
                HK hkA5B = this.A07.A5B(c3064orA9T);
                byte[] bArr = (byte[]) C3M.A01(metadata.A03(i10).A9S());
                this.A09.A0A();
                this.A09.A0C(bArr.length);
                ((ByteBuffer) AbstractC13764a.A0f(this.A09.A02)).put(bArr);
                this.A09.A0B();
    ...
    public AnonymousClass13(B3 b32, Looper looper, B1 b12, String str) {
        ...
        this.A06 = looper == null ? null : AbstractC13764a.A0c(looper, this);
        this.A07 = (B1) C3M.A01(b12);
        this.A09 = new C14928z();
    ...
    public final void A1c(C3064or[] c3064orArr, long j10, long j11) {
        this.A03 = this.A07.A5B(c3064orArr[0]);
    }
            ...
            if (i10 < 5) {
                ...
                if (iA1R == -4) {
                    if (this.A09.A05()) {
                        ...
                        this.A09.A0B();
                        Metadata metadataA5g = ((HK) AbstractC13764a.A0f(this.A03)).A5g(this.A09);
                        if (metadataA5g != null) {
                    ...
                    this.A02 = ((C3064or) C3M.A01(c6nA1U.A00)).A0M;
                }
            }
        }
        if (this.A00 > 0 && this.A0A[this.A01] <= j10) {
            A05((Metadata) AbstractC13764a.A0f(this.A0B[this.A01]), AbstractC13221w.A01(j10 - this.A0A[this.A01]));
    ...
    public final int AJb(C3064or c3064or) {
        int i10;
        if (this.A07.AJc(c3064or)) {
            if (AnonymousClass14.A1G(c3064or)) {
                i10 = 4;
            } else {
                i10 = 2;
            }
