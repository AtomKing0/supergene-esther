...
public final class C1979Sa extends SQLiteOpenHelper {
    ...
    static {
        A02();
        A03 = C1979Sa.class.getSimpleName();
    }

    public C1979Sa(C2361cu c2361cu, SZ sz) {
        super(c2361cu, A01(c2361cu), (SQLiteDatabase.CursorFactory) null, 4);
        if (sz != null) {
            this.A00 = sz;
            return;
        }
    ...
    public static String A01(C2361cu c2361cu) {
        ...
        String defaultDbName = c2361cu.getPackageName();
        String processName = ProcessUtils.getProcessName(c2361cu);
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        for (AbstractC1982Sd abstractC1982Sd : this.A00.A0M()) {
            abstractC1982Sd.A07(sQLiteDatabase);
        }
    }
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        for (AbstractC1982Sd abstractC1982Sd : this.A00.A0M()) {
            abstractC1982Sd.A08(sQLiteDatabase);
            abstractC1982Sd.A07(sQLiteDatabase);
        }
    }
