...
import com.facebook.ads.redexgen.core.AbstractC1950Qw;
import com.facebook.ads.redexgen.core.C1930Qc;
import com.facebook.ads.redexgen.core.C1952Qy;
import com.facebook.ads.redexgen.core.C1953Qz;
import com.facebook.ads.redexgen.core.C2045Up;
import com.facebook.ads.redexgen.core.C2046Uq;
import com.facebook.ads.redexgen.core.C2047Ur;
import com.facebook.ads.redexgen.core.C2530fg;
import com.facebook.ads.redexgen.core.C2531fh;
import com.facebook.ads.redexgen.core.C2547fx;
import com.facebook.ads.redexgen.core.InterfaceC2044Uo;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        return new C2547fx(context, nativeAdBase, nativeAdLayout, orientation, i10, adOptionsView);
    }
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        return new C2547fx(context, nativeAdBase, nativeAdLayout, adOptionsView);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        return (AdViewApi) AbstractC1950Qw.A00(new C1953Qz(context, str, adSize, adViewParentApi, adView), AdViewApi.class);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws Exception {
        try {
            return (AdViewApi) AbstractC1950Qw.A00(new C1953Qz(context, str, str2, adViewParentApi, adView), AdViewApi.class);
        } catch (V2 e10) {
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) AbstractC1950Qw.A00(new RE(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C2046Uq createNativeAdRatingApi(JSONObject jSONObject) {
        return C2046Uq.A00(jSONObject);
    }
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i10) {
        return (NativeAdsManagerApi) AbstractC1950Qw.A00(new RO(context, str, i10), NativeAdsManagerApi.class);
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AbstractC1950Qw.A00(new RV(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AbstractC1950Qw.A00(new RZ(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }
