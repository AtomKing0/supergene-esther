...
public final class UnityAdsSDK$special$$inlined$inject$default$8 extends v implements a<SetInitializationState> {
    ...
    public final SetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(SetInitializationState.class));
    }
}
