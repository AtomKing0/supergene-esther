...
public class GMAScarAdapterBridge {
    ...
    private void loadInterstitialAd(a7.c cVar) {
    ...
    private void loadRewardedAd(a7.c cVar) {
    ...
    public void load(boolean z10, String str, String str2, String str3, String str4, int i10) {
        a7.c cVar = new a7.c(str, str2, str4, str3, Integer.valueOf(i10));
        f scarAdapterObject = getScarAdapterObject();
        this._scarAdapter = scarAdapterObject;
        if (scarAdapterObject == null) {
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, a7.c cVar, UnityBannerSize unityBannerSize) {
        this._scarAdapter = getScarAdapterObject();
