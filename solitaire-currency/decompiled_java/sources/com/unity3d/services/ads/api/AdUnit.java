...
public class AdUnit {
        ...
        for (int i12 = 0; i12 < events.size(); i12++) {
            ...
            for (int i13 = 0; i13 < sparseArray2.size(); i13++) {
                ...
                try {
                    ...
                    jSONObject4.put(TransactionInfo.JsonKeys.SOURCE, adUnitMotionEvent.getSource());
                    jSONObject4.put("deviceId", adUnitMotionEvent.getDeviceId());
                    jSONObject4.put(ViewHierarchyNode.JsonKeys.X, adUnitMotionEvent.getX());
                    jSONObject4.put(ViewHierarchyNode.JsonKeys.Y, adUnitMotionEvent.getY());
    ...
    public static void getViewFrame(String str, WebViewCallback webViewCallback) {
        if (getAdUnitActivity() == null) {
            ...
            webViewCallback.invoke(viewFrame.get(ViewHierarchyNode.JsonKeys.X), viewFrame.get(ViewHierarchyNode.JsonKeys.Y), viewFrame.get("width"), viewFrame.get("height"));
        }
    }
