...
public class AdUnitActivityController {
    ...
    public Map<String, Integer> getViewFrame(String str) {
        ...
        if (str.equals("adunit")) {
            ...
            map.put(ViewHierarchyNode.JsonKeys.X, Integer.valueOf(layoutParams.leftMargin));
            map.put(ViewHierarchyNode.JsonKeys.Y, Integer.valueOf(layoutParams.topMargin));
        ...
        map2.put(ViewHierarchyNode.JsonKeys.X, Integer.valueOf(layoutParams2.leftMargin));
        map2.put(ViewHierarchyNode.JsonKeys.Y, Integer.valueOf(layoutParams2.topMargin));
