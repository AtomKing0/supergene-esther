...
public final class UnityAdsSDK$special$$inlined$inject$default$4 extends v implements a<GetInitializationState> {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(GetInitializationState.class));
    }
}
