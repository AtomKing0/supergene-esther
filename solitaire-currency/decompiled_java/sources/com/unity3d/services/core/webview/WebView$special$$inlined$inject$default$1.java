...
public final class WebView$special$$inlined$inject$default$1 extends v implements h9.a<SDKMetricsSender> {
    ...
    public final SDKMetricsSender invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(SDKMetricsSender.class));
    }
}
