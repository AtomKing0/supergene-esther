        ...
        Utilities.runOnUiThread(new Runnable() { // from class: com.unity3d.services.core.webview.WebViewApp.4
            ...
            public void run() {
                try {
                    ...
                    webViewApp.getWebView().loadDataWithBaseURL(new WebViewUrlBuilder(com.vungle.ads.internal.model.b.FILE_SCHEME + SdkProperties.getLocalWebViewFile(), configuration).getUrlWithQueryString(), configuration.getWebViewData(), "text/html", "UTF-8", null);
                    WebViewApp.setCurrentApp(webViewApp);
                } catch (Exception e10) {
