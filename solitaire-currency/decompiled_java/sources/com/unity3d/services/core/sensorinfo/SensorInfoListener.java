...
public class SensorInfoListener implements SensorEventListener {
    ...
    public static JSONObject getAccelerometerData() {
        ...
        try {
            jSONObject.put(ViewHierarchyNode.JsonKeys.X, _latestAccelerometerEvent.values[0]);
            jSONObject.put(ViewHierarchyNode.JsonKeys.Y, _latestAccelerometerEvent.values[1]);
