...
public final class DiagnosticEventJob$special$$inlined$inject$default$1 extends v implements a<GetRequestPolicy> {
    ...
    public final GetRequestPolicy invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(GetRequestPolicy.class));
    }
}
