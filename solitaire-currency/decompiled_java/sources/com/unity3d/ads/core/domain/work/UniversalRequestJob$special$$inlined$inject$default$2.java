...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends v implements a<UniversalRequestDataSource> {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(UniversalRequestDataSource.class));
    }
}
