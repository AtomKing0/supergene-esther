...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends v implements a<DiagnosticEventRequestWorkModifier> {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0.b(DiagnosticEventRequestWorkModifier.class));
    }
}
