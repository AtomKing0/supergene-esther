...
final class zzaj {
    ...
    public static zzaj zza(String str) {
        ...
        if (str.length() >= zziq.zza.values().length) {
            ...
            if (str.charAt(0) == '1') {
                ...
                int i11 = 1;
                while (i10 < length) {
                    enumMap.put(zzaVarArrValues[i10], zzai.zza(str.charAt(i11)));
                    i10++;
                    i11++;
                }
    ...
    */
    public final void zza(com.google.android.gms.measurement.internal.zziq.zza r3, int r4) {
        ...
        L20:
            java.util.EnumMap<com.google.android.gms.measurement.internal.zziq$zza, com.google.android.gms.measurement.internal.zzai> r4 = r2.zza
            r4.put(r3, r0)
            return
        */
