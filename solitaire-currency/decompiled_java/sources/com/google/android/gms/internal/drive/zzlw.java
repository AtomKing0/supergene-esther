...
final class zzlw<T> implements zzmf<T> {
    ...
    public final boolean equals(T t10, T t11) {
        if (!this.zzur.zzr(t10).equals(this.zzur.zzr(t11))) {
            return false;
        }
        if (this.zzui) {
            return this.zzus.zzb(t10).equals(this.zzus.zzb(t11));
        }
        return true;
    }
    ...
    public final int hashCode(T t10) {
        int iHashCode = this.zzur.zzr(t10).hashCode();
        return this.zzui ? (iHashCode * 53) + this.zzus.zzb(t10).hashCode() : iHashCode;
    }
    ...
    public final int zzn(T t10) {
        ...
        int iZzs = zzmxVar.zzs(zzmxVar.zzr(t10)) + 0;
        return this.zzui ? iZzs + this.zzus.zzb(t10).zzco() : iZzs;
    }

    @Override // com.google.android.gms.internal.drive.zzmf
    public final boolean zzp(T t10) {
        return this.zzus.zzb(t10).isInitialized();
    }

    @Override // com.google.android.gms.internal.drive.zzmf
    public final void zza(T t10, zzns zznsVar) throws IOException {
        for (T t11 : this.zzus.zzb(t10)) {
            zzkd zzkdVar = (zzkd) t11.getKey();
            if (zzkdVar.zzcr() != zznr.MESSAGE || zzkdVar.zzcs() || zzkdVar.zzct()) {
                throw new IllegalStateException("Found invalid MessageSet item.");
            }
            if (t11 instanceof zzkv) {
                zznsVar.zza(zzkdVar.zzcp(), (Object) ((zzkv) t11).zzdq().zzbl());
            } else {
                zznsVar.zza(zzkdVar.zzcp(), t11.getValue());
            }
        }
        zzmx<?, ?> zzmxVar = this.zzur;
        zzmxVar.zzc(zzmxVar.zzr(t10), zznsVar);
    }
