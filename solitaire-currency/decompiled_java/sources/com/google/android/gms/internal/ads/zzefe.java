...
public final class zzefe implements zzeet {
    ...
    public final m zza(final zzfex zzfexVar, final zzfel zzfelVar) {
        ...
        m mVarZzn = zzgcj.zzn(zzgcj.zzh(null), new zzgbq() { // from class: com.google.android.gms.internal.ads.zzefa
            @Override // com.google.android.gms.internal.ads.zzgbq
            public final m zza(Object obj) {
                return this.zza.zzc(zzfelVar, zzfexVar, zzdppVar, obj);
            }
        }, this.zze);
        mVarZzn.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzefb
    ...
    final /* synthetic */ m zzc(final zzfel zzfelVar, zzfex zzfexVar, zzdpp zzdppVar, Object obj) throws Exception {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbbw.zzeC)).booleanValue() && zzcovVarZza.zzi().zze(true)) {
