...
public final class zzeof implements zzevo {
    ...
    final /* synthetic */ zzeog zzc(zzevx zzevxVar) {
        ...
        if (zzqVarArr2 != null) {
            ...
            for (com.google.android.gms.ads.internal.client.zzq zzqVar3 : zzqVarArr2) {
                if (zzqVar3.zzi) {
                    ...
                    int i13 = zzqVar3.zze;
                    if (i13 == -1) {
                        i13 = f10 != 0.0f ? (int) (zzqVar3.zzf / f10) : -1;
                    }
                    sb.append(i13);
                    sb.append(ViewHierarchyNode.JsonKeys.X);
                    int i14 = zzqVar3.zzb;
                    if (i14 == -2) {
                        i14 = f10 != 0.0f ? (int) (zzqVar3.zzc / f10) : -2;
                    }
                    sb.append(i14);
                }
            }
        ...
        return new zzeog(zzqVar, str, z10, sb.toString(), f10, i11, i10, strZzm, this.zzb.zzq);
    }
}
