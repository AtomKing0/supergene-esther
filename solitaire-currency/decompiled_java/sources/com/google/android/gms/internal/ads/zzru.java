...
final class zzru implements zzsd {
    ...
    */
    static /* bridge */ /* synthetic */ void zza(com.google.android.gms.internal.ads.zzru r9, android.os.Message r10) {
        /*
            int r0 = r10.what
            r1 = 0
            if (r0 == 0) goto L57
    ...
    public final void zzd(int i10, int i11, int i12, long j10, int i13) {
        zzc();
        zzrt zzrtVarZzi = zzi();
        zzrtVarZzi.zza(i10, 0, i12, j10, i13);
        Handler handler = this.zze;
        int i14 = zzet.zza;
    ...
    public final void zze(int i10, int i11, zzha zzhaVar, long j10, int i12) {
        ...
        if (zzet.zza >= 24) {
            cryptoInfo.setPattern(new MediaCodec.CryptoInfo.Pattern(zzhaVar.zzg, zzhaVar.zzh));
        }
