...
final class zzkx {
    ...
    public zzkx(zzcc zzccVar, zzui zzuiVar, long j10, long j11, int i10, @Nullable zzhw zzhwVar, boolean z10, zzwi zzwiVar, zzyc zzycVar, List list, zzui zzuiVar2, boolean z11, int i11, zzbq zzbqVar, long j12, long j13, long j14, long j15, boolean z12) {
        this.zza = zzccVar;
        this.zzb = zzuiVar;
        this.zzc = j10;
        this.zzd = j11;
    ...
    public static zzkx zzg(zzyc zzycVar) {
        ...
        zzui zzuiVar = zzt;
        return new zzkx(zzccVar, zzuiVar, C.TIME_UNSET, 0L, 1, null, false, zzwi.zza, zzycVar, zzfxr.zzm(), zzuiVar, false, 0, zzbq.zza, 0L, 0L, 0L, 0L, false);
    }
    ...
    public final zzkx zzb(zzui zzuiVar, long j10, long j11, long j12, long j13, zzwi zzwiVar, zzyc zzycVar, List list) {
        ...
        return new zzkx(this.zza, zzuiVar, j11, j12, this.zze, this.zzf, this.zzg, zzwiVar, zzycVar, list, zzuiVar2, z10, i10, zzbqVar, j14, j13, j10, jElapsedRealtime, false);
    }
