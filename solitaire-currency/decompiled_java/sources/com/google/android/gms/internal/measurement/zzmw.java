...
public final class zzmw {
    ...
    public final int zza() {
        ...
        for (int i12 = 0; i12 < this.zzb; i12++) {
            ...
            int i15 = i13 & 7;
            if (i15 == 0) {
                iZze = zzja.zze(i14, ((Long) this.zzd[i12]).longValue());
            } else if (i15 == 1) {
                iZze = zzja.zza(i14, ((Long) this.zzd[i12]).longValue());
            } else if (i15 == 2) {
                iZze = zzja.zza(i14, (zzij) this.zzd[i12]);
            } else if (i15 == 3) {
                iZze = (zzja.zzf(i14) << 1) + ((zzmw) this.zzd[i12]).zza();
            } else {
                if (i15 != 5) {
                    throw new IllegalStateException(zzkb.zza());
                }
                iZze = zzja.zzb(i14, ((Integer) this.zzd[i12]).intValue());
            }
            i11 += iZze;
        }
        this.zze = i11;
    ...
    static zzmw zza(zzmw zzmwVar, zzmw zzmwVar2) {
    ...
    final void zza(StringBuilder sb, int i10) {
        for (int i11 = 0; i11 < this.zzb; i11++) {
            zzlh.zza(sb, i10, String.valueOf(this.zzc[i11] >>> 3), this.zzd[i11]);
        }
    }
    ...
    final void zza(zznt zzntVar) throws IOException {
