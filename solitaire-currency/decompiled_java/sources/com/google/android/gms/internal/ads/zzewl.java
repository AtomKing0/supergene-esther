...
public final class zzewl implements zzhfc {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        com.google.android.gms.ads.internal.util.zzg zzgVarZzb = ((zzcgn) this.zza).zzb();
        Context contextZza = ((zzcgp) this.zzb).zza();
        zzgcu zzgcuVar = zzbzo.zza;
        zzhfk.zzb(zzgcuVar);
        return new zzewi(zzgVarZzb, contextZza, zzgcuVar, (ScheduledExecutorService) this.zzc.zzb(), ((zzees) this.zzd).zzb(), ((zzcwh) this.zze).zza(), ((zzchc) this.zzf).zza());
    }
}
