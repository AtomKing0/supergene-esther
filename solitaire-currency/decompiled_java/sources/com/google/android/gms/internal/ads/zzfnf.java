...
public final class zzfnf {
    ...
    public static JSONObject zza(int i10, int i11, int i12, int i13) {
        ...
        try {
            jSONObject.put(ViewHierarchyNode.JsonKeys.X, i10 / zza);
            jSONObject.put(ViewHierarchyNode.JsonKeys.Y, i11 / zza);
    ...
    public static void zze(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfng.zza("JSONException during JSONObject.put for name [" + str + v8.i.f15839e, e10);
        }
    }
