...
public final class zzdzz {
    ...
    final /* synthetic */ zzbug zza(zzbvb zzbvbVar, zzebk zzebkVar) {
        zzebkVar.zzc.put(nb.K, zzebkVar.zze);
        zzebkVar.zzc.put("User-Agent", com.google.android.gms.ads.internal.zzu.zzp().zzc(this.zzi, zzbvbVar.zzb.afmaVersion));
    ...
    public final m zzc(final zzbvb zzbvbVar, final JSONObject jSONObject, final zzbvd zzbvdVar) {
        ...
        m mVarZzn = zzgcj.zzn(this.zzd.zzb(zzfjf.PRE_PROCESS, zzfiqVarZza).zze(new zzfio() { // from class: com.google.android.gms.internal.ads.zzdzu
        ...
        zzgcj.zzr(mVarZzn, new zzdzy(this), this.zzj);
        return mVarZzn;
    }

    final /* synthetic */ m zzd(zzbvb zzbvbVar, InputStream inputStream) throws Exception {
