...
final class zzko extends zzkl {
    ...
    private static <L> List<L> zza(Object obj, long j10, int i10) {
        ...
        if (listZzc.isEmpty()) {
            List<L> zzkjVar = listZzc instanceof zzkm ? new zzkj(i10) : ((listZzc instanceof zzls) && (listZzc instanceof zzkc)) ? ((zzkc) listZzc).zza(i10) : new ArrayList<>(i10);
            zzmz.zza(obj, j10, zzkjVar);
            return zzkjVar;
        }
        if (zza.isAssignableFrom(listZzc.getClass())) {
            ...
            zzkj zzkjVar2 = new zzkj(listZzc.size() + i10);
            zzkjVar2.addAll((zzmy) listZzc);
