...
public final class zzvw implements zzadp {
    ...
    protected zzvw(zzyk zzykVar, @Nullable zzri zzriVar, @Nullable zzrd zzrdVar) {
        this.zzd = zzriVar;
    ...
    private final synchronized long zzD(long j10, boolean z10, boolean z11) {
        ...
        if (i11 != 0) {
            ...
            if (j10 >= jArr[i12]) {
                ...
                int iZzA = zzA(i12, i11, j10, false);
                if (iZzA != -1) {
                    return zzF(iZzA);
                }
            }
    ...
    private final long zzF(int i10) {
        ...
        this.zzs = Math.max(j10, jMax);
        this.zzn -= i10;
        int i12 = this.zzo + i10;
        this.zzo = i12;
        ...
        int i17 = i16 - 1;
        return this.zzi[i17] + ((long) this.zzj[i17]);
    }

    private final synchronized void zzG(long j10, int i10, long j11, int i11, @Nullable zzado zzadoVar) {
        int i12 = this.zzn;
        if (i12 > 0) {
            int iZzB = zzB(i12 - 1);
            zzdi.zzd(this.zzi[iZzB] + ((long) this.zzj[iZzB]) <= j11);
        }
        this.zzu = (536870912 & i10) != 0;
    ...
    public final synchronized int zzc(long j10, boolean z10) {
        int i10 = this.zzq;
        int iZzB = zzB(i10);
        if (zzK() && j10 >= this.zzl[iZzB]) {
            if (j10 > this.zzt && z10) {
                return this.zzn - i10;
            }
            int iZzA = zzA(iZzB, this.zzn - i10, j10, true);
            if (iZzA == -1) {
                return 0;
            }
            return iZzA;
    ...
    */
    ...
    public final void zzs(long j10, int i10, int i11, int i12, @Nullable zzado zzadoVar) {
        ...
        zzG(j10, i10, (this.zza.zzb() - ((long) i11)) - ((long) i12), i11, zzadoVar);
    }
    ...
    public final synchronized boolean zzz(long j10, boolean z10) {
        ...
        if (zzK() && j10 >= this.zzl[iZzB]) {
            ...
            if (this.zzy) {
                ...
                iZzA = zzA(iZzB, this.zzn - i10, j10, true);
            }
            if (iZzA != -1) {
                this.zzr = j10;
                this.zzq += iZzA;
