...
final class zzavj implements zzfqg {
    ...
    zzavj(@NonNull zzfoj zzfojVar, @NonNull zzfpa zzfpaVar, @NonNull zzavw zzavwVar, @NonNull zzavi zzaviVar, @Nullable zzaus zzausVar, @Nullable zzavy zzavyVar, @Nullable zzavq zzavqVar, @Nullable zzavh zzavhVar) {
        this.zza = zzfojVar;
        this.zzb = zzfpaVar;
        this.zzc = zzavwVar;
        this.zzd = zzaviVar;
