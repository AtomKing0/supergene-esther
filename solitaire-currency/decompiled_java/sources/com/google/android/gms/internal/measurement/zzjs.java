        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    Logger.getLogger(zzja.class.getName()).logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load " + cls.getSimpleName(), (Throwable) e14);
                }
            }
            if (arrayList.size() == 1) {
