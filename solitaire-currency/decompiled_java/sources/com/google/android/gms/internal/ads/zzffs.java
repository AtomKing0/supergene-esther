...
public final class zzffs {
    ...
    public final void zzb(String str, int i10) {
        if (!this.zza.zzai) {
            ...
            this.zzc.zzd(new zzedj(com.google.android.gms.ads.internal.zzu.zzB().currentTimeMillis(), this.zzb.zzb, str, i10));
        }
    }
    ...
    public final void zzc(List list, int i10) {
        ...
        while (it.hasNext()) {
            ...
            zzgcj.zzr((((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbbw.zzjg)).booleanValue() && zzcni.zzj(str)) ? this.zzf.zzb(str, com.google.android.gms.ads.internal.client.zzay.zze()) : zzgcj.zzh(str), new zzffr(this, i10), zzbzo.zza);
        }
    }
}
