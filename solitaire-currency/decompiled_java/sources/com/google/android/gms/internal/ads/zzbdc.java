...
public class zzbdc {
    ...
    protected zzbdc(String str, Object obj, int i10) {
        this.zza = str;
        this.zzb = obj;
        this.zzc = i10;
    }
    ...
    public final Object zze() {
        ...
        if (zzbehVarZza != null) {
            int i10 = this.zzc - 1;
            return i10 != 0 ? i10 != 1 ? i10 != 2 ? zzbehVarZza.zzd(this.zza, (String) this.zzb) : zzbehVarZza.zzb(this.zza, ((Double) this.zzb).doubleValue()) : zzbehVarZza.zzc(this.zza, ((Long) this.zzb).longValue()) : zzbehVarZza.zza(this.zza, ((Boolean) this.zzb).booleanValue());
        }
        if (zzbej.zzb() != null) {
            zzbej.zzb().zza();
        }
