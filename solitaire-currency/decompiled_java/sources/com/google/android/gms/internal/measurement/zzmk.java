...
final class zzmk implements Comparable, Map.Entry {
    ...
    zzmk(zzlz zzlzVar, Map.Entry entry) {
    ...
    public final String toString() {
        return String.valueOf(this.zza) + v8.i.f15833b + String.valueOf(this.zzb);
    }

    zzmk(zzlz zzlzVar, Comparable comparable, Object obj) {
        this.zzc = zzlzVar;
        this.zza = comparable;
        this.zzb = obj;
    }
