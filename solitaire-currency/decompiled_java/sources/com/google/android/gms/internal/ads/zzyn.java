...
public final class zzyn implements zzyj, zzgu {
    ...
    public static final zzfxr zzc;
    public static final zzfxr zzd;
    public static final zzfxr zze;
    public static final zzfxr zzf;
    ...
    static {
        ...
        zzc = zzfxr.zzq(lValueOf, 1300000L, 1000000L, 860000L, 610000L);
        zzd = zzfxr.zzq(2500000L, 1700000L, 1200000L, 970000L, 680000L);
        zze = zzfxr.zzq(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
        zzf = zzfxr.zzq(2700000L, lValueOf, 1600000L, 1300000L, 1000000L);
    }

    /* synthetic */ zzyn(Context context, Map map, int i10, zzdj zzdjVar, boolean z10, zzym zzymVar) {
    ...
    public final synchronized void zzk(int i10) {
        if (this.zzr != i10) {
            ...
            if (i10 != 1 && i10 != 0 && i10 != 8) {
                ...
                zzj(this.zzk > 0 ? (int) (jElapsedRealtime - this.zzl) : 0, this.zzm, this.zzp);
    ...
    */
    ...
    public final synchronized void zzb(zzfs zzfsVar, zzfy zzfyVar, boolean z10) {
        if (zzl(zzfyVar, z10)) {
            zzdi.zzf(this.zzk > 0);
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            int i10 = (int) (jElapsedRealtime - this.zzl);
            this.zzn += (long) i10;
            long j10 = this.zzo;
            long j11 = this.zzm;
            this.zzo = j10 + j11;
            if (i10 > 0) {
                this.zzj.zzb((int) Math.sqrt(j11), (j11 * 8000.0f) / i10);
                if (this.zzn >= ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS || this.zzo >= 524288) {
