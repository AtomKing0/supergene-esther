...
final class zzcif extends zzcgj {
    ...
    /* synthetic */ zzcif(zzcgm zzcgmVar, zzcko zzckoVar, zzfjp zzfjpVar, zzcla zzclaVar, zzfgj zzfgjVar, zzcie zzcieVar) {
        ...
        CsiParamDefaults_Factory csiParamDefaults_FactoryCreate = CsiParamDefaults_Factory.create(zzcgpVar, zzchcVar);
        this.zzs = csiParamDefaults_FactoryCreate;
        zzhfl zzhflVarZzc11 = zzhfb.zzc(new zzdst(zzfig.zza(), zzhflVarZza, csiParamDefaults_FactoryCreate, CsiUrlBuilder_Factory.create(), zzcgpVar));
        ...
        zzhfl zzhflVarZzc35 = zzhfb.zzc(new com.google.android.gms.ads.nonagon.signalgeneration.zzh(zzcgpVar, zzhflVarZzc11, zzfig.zza()));
        this.zzY = zzhflVarZzc35;
        zzbcy zzbcyVar = new zzbcy(zzhflVarZzc3, zzhflVarZzc35);
        this.zzZ = zzbcyVar;
        this.zzaa = zzhfb.zzc(new com.google.android.gms.ads.nonagon.signalgeneration.zzal(zzhfcVarZza, zzcgpVar, zzhflVarZzc28, zzhflVarZzc34, zzfig.zza(), zzhflVarZzc3, zzhflVarZzc11, zzhflVarZzc30, zzchcVar, zzbcyVar, zzhflVarZzc32, zzhflVarZzc35));
        this.zzab = zzhfb.zzc(new com.google.android.gms.ads.nonagon.signalgeneration.zzo(zzhflVarZzc11));
