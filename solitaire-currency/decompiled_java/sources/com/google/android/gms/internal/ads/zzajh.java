...
final class zzajh {
    ...
    private final zzek zzb = new zzek(new byte[OggPageHeader.MAX_PAGE_PAYLOAD], 0);
    private int zzc = -1;
    private int zzd;
    private boolean zze;
    ...
    public final void zzd() {
        ...
        zzekVar.zzI(Arrays.copyOf(zzekVar.zzM(), Math.max(OggPageHeader.MAX_PAGE_PAYLOAD, zzekVar.zze())), this.zzb.zze());
    }
    ...
    */
    public final boolean zze(com.google.android.gms.internal.ads.zzacl r7) throws java.io.IOException {
        /*
            r6 = this;
            boolean r0 = r6.zze
            r1 = 0
