...
public final class zzcvv implements zzhfc {
    ...
    public final zzcvu zzb() {
        ...
        return new zzcvu(zzfjlVar, versionInfoParcelZza, applicationInfoZzb, strZzb, com.google.android.gms.ads.internal.client.zzba.zza().zza(), (PackageInfo) this.zze.zzb(), zzhfb.zza(zzhfn.zza(this.zzf)), ((zzcgn) this.zzg).zzb(), (String) this.zzh.zzb(), ((zzevs) this.zzi).zzb(), ((zzcwh) this.zzj).zza(), (zzdcc) this.zzk.zzb());
    }
}
