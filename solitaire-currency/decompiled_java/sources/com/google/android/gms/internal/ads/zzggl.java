...
public final class zzggl {
    ...
    public final zzggl zza(int i10) throws GeneralSecurityException {
        this.zzb = 12;
        return this;
    }

    public final zzggl zzb(int i10) throws GeneralSecurityException {
    ...
    public final zzggl zzc(int i10) throws GeneralSecurityException {
        this.zzc = 16;
        return this;
    }
