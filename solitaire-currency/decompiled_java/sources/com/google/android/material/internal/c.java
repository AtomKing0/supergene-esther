...
public class c {
    ...
    private static final ThreadLocal<Matrix> f9443a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f9444b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f9443a;
        ...
        ThreadLocal<RectF> threadLocal2 = f9444b;
