...
/* JADX INFO: compiled from: CarouselOrientationHelper.java */
...
abstract class c {
    ...
    class a extends c {
        ...
        final /* synthetic */ CarouselLayoutManager f9044b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f9044b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int i() {
            return this.f9044b.getPaddingLeft();
        }

        @Override // com.google.android.material.carousel.c
        int j() {
            return this.f9044b.getWidth() - this.f9044b.getPaddingRight();
        }
        ...
        public void m(View view, int i10, int i11) {
            int i12 = i();
            this.f9044b.layoutDecoratedWithMargins(view, i12, i10, i12 + p(view), i11);
        }
        ...
        int p(View view) {
            ...
            return this.f9044b.getDecoratedMeasuredWidth(view) + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
        }
    }
    ...
    class b extends c {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ CarouselLayoutManager f9045b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f9045b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int g() {
            return this.f9045b.getHeight() - this.f9045b.getPaddingBottom();
        }

        @Override // com.google.android.material.carousel.c
        int h() {
            return this.f9045b.P() ? i() : j();
        }
        ...
        @Override // com.google.android.material.carousel.c
        int j() {
            return this.f9045b.getWidth();
        }

        @Override // com.google.android.material.carousel.c
        int k() {
            return this.f9045b.P() ? j() : i();
        }

        @Override // com.google.android.material.carousel.c
        int l() {
            return this.f9045b.getPaddingTop();
        }

        @Override // com.google.android.material.carousel.c
        public void m(View view, int i10, int i11) {
            int iL = l();
            this.f9045b.layoutDecoratedWithMargins(view, i10, iL, i11, iL + p(view));
        }
        ...
        int p(View view) {
            RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
            return this.f9045b.getDecoratedMeasuredHeight(view) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
        }
    }
