...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.vungle.weakreference.b f11099b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f11100c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f11101d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f11098a = str;
        this.f11099b = new com.iab.omid.library.vungle.weakreference.b(null);
    }

    public void a() {
        this.f11103f = f.b();
        this.f11102e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f11099b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f11098a);
    }

    public void g() {
        h.a().b(getWebView(), this.f11098a);
    }

    public WebView getWebView() {
        return this.f11099b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f11098a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f11103f) {
            this.f11102e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f11098a, str);
        }
    }

    void a(WebView webView) {
        this.f11099b = new com.iab.omid.library.vungle.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f11098a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f11100c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f11098a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f11098a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f11098a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f11098a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f11098a, z10 ? "foregrounded" : "backgrounded");
        }
    }
