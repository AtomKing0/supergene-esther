...
public class c {
    ...
    private static WindowManager f11116a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f11117b = {ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f11118c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f11120a);
            jSONObject.put("height", bVarA.f11121b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f11116a != null) {
            ...
            f11116a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f11118c = context.getResources().getDisplayMetrics().density;
            f11116a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0247a c0247a) {
        com.iab.omid.library.vungle.internal.e eVarA = c0247a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0247a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f11119a[outputDeviceStatus.ordinal()] == 1;
    }
