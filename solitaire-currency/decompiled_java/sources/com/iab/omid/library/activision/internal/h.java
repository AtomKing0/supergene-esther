...
public class h {
    ...
    private static h f10556a = new h();
    ...
    class a implements Runnable {
        ...
        public void run() {
            h.this.c(this.f10557a, this.f10558b);
        }
    }
    ...
    public void a(WebView webView, String str, JSONObject jSONObject) {
        a(webView, v8.a.f15678e, jSONObject, str);
    }
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.activision.utils.d.a("The WebView is null for " + str);
            return;
        }
