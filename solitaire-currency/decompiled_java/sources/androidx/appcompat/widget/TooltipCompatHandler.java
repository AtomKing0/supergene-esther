...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.z
        @Override // java.lang.Runnable
        public final void run() {
            this.f720a.lambda$new$0();
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.a0
        @Override // java.lang.Runnable
        public final void run() {
            this.f716a.hide();
        }
