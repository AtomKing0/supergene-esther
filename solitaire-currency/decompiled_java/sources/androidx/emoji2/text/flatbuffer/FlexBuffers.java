...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f934bb.data());
        ...
        public byte get(int i10) {
            return this.f934bb.get(this.end + i10);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                bArr[i10] = this.f934bb.get(this.end + i10);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f934bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f934bb.getString(this.end, size()));
            sb.append('\"');
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i10 = this.end;
            while (this.f934bb.get(i10) != 0) {
                i10++;
            }
            int i11 = this.end;
            return this.f934bb.getString(i11, i10 - i11);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i10) {
            ...
            ReadBuf readBuf = typedVector2.f934bb;
    ...
    public static class Map extends Vector {
        ...
        public StringBuilder toString(StringBuilder sb) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                sb.append('\"');
                sb.append(keyVectorKeys.get(i10).toString());
                sb.append("\" : ");
                sb.append(vectorValues.get(i10).toString());
                if (i10 != size - 1) {
                    sb.append(", ");
                }
            }
        ...
        public Vector values() {
            return new Vector(this.f934bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public Blob asBlob() {
            ...
            ReadBuf readBuf = this.f935bb;
            return new Blob(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
        }

        public boolean asBoolean() {
            return isBoolean() ? this.f935bb.get(this.end) != 0 : asUInt() != 0;
        }

        public double asFloat() {
            int i10 = this.type;
            if (i10 == 3) {
                return FlexBuffers.readDouble(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 1) {
                return FlexBuffers.readInt(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 != 2) {
                if (i10 == 5) {
            ...
            return FlexBuffers.readUInt(this.f935bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            if (i10 == 2) {
                return (int) FlexBuffers.readUInt(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (int) FlexBuffers.readDouble(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
        ...
        public long asLong() {
            int i10 = this.type;
            if (i10 == 1) {
                return FlexBuffers.readLong(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 2) {
                return FlexBuffers.readUInt(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (long) FlexBuffers.readDouble(this.f935bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
                try {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f935bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f935bb;
                int i10 = this.byteWidth;
                return this.f935bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i10, i10));
            }
            if (!isKey()) {
                return "";
            }
            int iIndirect2 = FlexBuffers.indirect(this.f935bb, this.end, this.byteWidth);
            int i11 = iIndirect2;
            while (this.f935bb.get(i11) != 0) {
                i11++;
            }
            return this.f935bb.getString(iIndirect2, i11 - iIndirect2);
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i10, int i11) {
            super(readBuf, i10, i11);
            this.size = FlexBuffers.readInt(this.f934bb, i10 - i11, i11);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f934bb, this.end + (i10 * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f934bb, this.end + (i10 * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f934bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j10))));
        }
