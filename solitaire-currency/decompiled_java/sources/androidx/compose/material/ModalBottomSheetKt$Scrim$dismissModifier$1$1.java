...
final class ModalBottomSheetKt$Scrim$dismissModifier$1$1 extends l implements p<PointerInputScope, d<? super k0>, Object> {
    final /* synthetic */ a<k0> $onDismiss;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: androidx.compose.material.ModalBottomSheetKt$Scrim$dismissModifier$1$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: ModalBottomSheet.kt */
    static final class AnonymousClass1 extends v implements h9.l<Offset, k0> {
        ...
        public /* bridge */ /* synthetic */ k0 invoke(Offset offset) {
            m1070invokek4lQ0M(offset.m1377unboximpl());
            return k0.f35197a;
        }

        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1070invokek4lQ0M(long j10) {
            this.$onDismiss.invoke();
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ModalBottomSheetKt$Scrim$dismissModifier$1$1(a<k0> aVar, d<? super ModalBottomSheetKt$Scrim$dismissModifier$1$1> dVar) {
        super(2, dVar);
        this.$onDismiss = aVar;
    }
    ...
    public final Object mo4invoke(@NotNull PointerInputScope pointerInputScope, @Nullable d<? super k0> dVar) {
        return ((ModalBottomSheetKt$Scrim$dismissModifier$1$1) create(pointerInputScope, dVar)).invokeSuspend(k0.f35197a);
    }
