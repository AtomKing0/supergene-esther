...
final class DrawerKt$Scrim$dismissDrawer$2$1 extends v implements l<SemanticsPropertyReceiver, k0> {
    final /* synthetic */ String $closeDrawer;
    final /* synthetic */ a<k0> $onClose;

    /* JADX INFO: renamed from: androidx.compose.material.DrawerKt$Scrim$dismissDrawer$2$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: Drawer.kt */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DrawerKt$Scrim$dismissDrawer$2$1(String str, a<k0> aVar) {
        super(1);
