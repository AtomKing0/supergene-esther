...
final class CheckboxKt$CheckboxImpl$checkDrawFraction$2 extends v implements q<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(@NotNull Transition.Segment<ToggleableState> animateFloat, @Nullable Composer composer, int i10) {
        ...
        FiniteAnimationSpec<Float> finiteAnimationSpecTween$default = initialState == toggleableState ? AnimationSpecKt.tween$default(100, 0, null, 6, null) : animateFloat.getTargetState() == toggleableState ? AnimationSpecKt.snap(100) : AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null);
