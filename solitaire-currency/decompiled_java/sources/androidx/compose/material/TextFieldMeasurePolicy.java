...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    /* JADX INFO: renamed from: androidx.compose.material.TextFieldMeasurePolicy$maxIntrinsicHeight$1, reason: invalid class name */
    /* JADX INFO: compiled from: TextField.kt */
    ...
    /* JADX INFO: renamed from: androidx.compose.material.TextFieldMeasurePolicy$maxIntrinsicWidth$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: TextField.kt */
    static final class C09571 extends v implements p<IntrinsicMeasurable, Integer, Integer> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material.TextFieldMeasurePolicy$minIntrinsicHeight$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: TextField.kt */
    static final class C09581 extends v implements p<IntrinsicMeasurable, Integer, Integer> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material.TextFieldMeasurePolicy$minIntrinsicWidth$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: TextField.kt */
    static final class C09591 extends v implements p<IntrinsicMeasurable, Integer, Integer> {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i10, p<? super IntrinsicMeasurable, ? super Integer, Integer> pVar) {
        ...
        for (Object obj2 : list2) {
            if (t.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj2), TextFieldImplKt.TextFieldId)) {
                ...
                return TextFieldKt.m1210calculateHeightO3s9Psw(iIntValue, iIntValue2 > 0, iIntValue2, iIntValue4, iIntValue3, intrinsicMeasurable4 != null ? pVar.mo4invoke(intrinsicMeasurable4, Integer.valueOf(i10)).intValue() : 0, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
            }
        }
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> list, int i10, p<? super IntrinsicMeasurable, ? super Integer, Integer> pVar) {
        ...
        for (Object obj2 : list2) {
            if (t.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj2), TextFieldImplKt.TextFieldId)) {
                ...
                IntrinsicMeasurable intrinsicMeasurable4 = (IntrinsicMeasurable) obj;
                return TextFieldKt.m1211calculateWidthVsPV1Ek(iIntValue4, iIntValue3, iIntValue, iIntValue2, intrinsicMeasurable4 != null ? pVar.mo4invoke(intrinsicMeasurable4, Integer.valueOf(i10)).intValue() : 0, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i10) {
        t.i(intrinsicMeasureScope, "<this>");
        t.i(measurables, "measurables");
        return intrinsicWidth(measurables, i10, C09571.INSTANCE);
    }
    ...
    public MeasureResult mo8measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j10) {
        ...
        t.i(measurables, "measurables");
        int iMo290roundToPx0680j_4 = measure.mo290roundToPx0680j_4(this.paddingValues.mo382calculateTopPaddingD9Ej5fM());
        int iMo290roundToPx0680j_42 = measure.mo290roundToPx0680j_4(this.paddingValues.mo379calculateBottomPaddingD9Ej5fM());
        int iMo290roundToPx0680j_43 = measure.mo290roundToPx0680j_4(TextFieldKt.getTextFieldTopPadding());
        ...
        int i10 = -iMo290roundToPx0680j_42;
        int i11 = -(iWidthOrZero + TextFieldImplKt.widthOrZero(placeableMo2987measureBRTryo02));
        long jM3657offsetNN6EwU = ConstraintsKt.m3657offsetNN6EwU(jM3632copyZbe2FdA$default, i11, i10);
        ...
        if (placeableMo2987measureBRTryo03 != null) {
            height = placeableMo2987measureBRTryo03.get(AlignmentLineKt.getLastBaseline());
            if (height == Integer.MIN_VALUE) {
                height = placeableMo2987measureBRTryo03.getHeight();
            }
        } else {
            height = 0;
        }
        int iMax = Math.max(height, iMo290roundToPx0680j_4);
        long jM3657offsetNN6EwU2 = ConstraintsKt.m3657offsetNN6EwU(Constraints.m3632copyZbe2FdA$default(j10, 0, 0, 0, 0, 11, null), i11, placeableMo2987measureBRTryo03 != null ? (i10 - iMo290roundToPx0680j_43) - iMax : (-iMo290roundToPx0680j_4) - iMo290roundToPx0680j_42);
        for (Measurable measurable4 : list) {
            if (t.d(LayoutIdKt.getLayoutId(measurable4), TextFieldImplKt.TextFieldId)) {
                Placeable placeableMo2987measureBRTryo04 = measurable4.mo2987measureBRTryo0(jM3657offsetNN6EwU2);
                long jM3632copyZbe2FdA$default2 = Constraints.m3632copyZbe2FdA$default(jM3657offsetNN6EwU2, 0, 0, 0, 0, 14, null);
                ...
                Placeable placeableMo2987measureBRTryo05 = measurable5 != null ? measurable5.mo2987measureBRTryo0(jM3632copyZbe2FdA$default2) : null;
                int iM1211calculateWidthVsPV1Ek = TextFieldKt.m1211calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(placeableMo2987measureBRTryo0), TextFieldImplKt.widthOrZero(placeableMo2987measureBRTryo02), placeableMo2987measureBRTryo04.getWidth(), TextFieldImplKt.widthOrZero(placeableMo2987measureBRTryo03), TextFieldImplKt.widthOrZero(placeableMo2987measureBRTryo05), j10);
                int iM1210calculateHeightO3s9Psw = TextFieldKt.m1210calculateHeightO3s9Psw(placeableMo2987measureBRTryo04.getHeight(), placeableMo2987measureBRTryo03 != null, iMax, TextFieldImplKt.heightOrZero(placeableMo2987measureBRTryo0), TextFieldImplKt.heightOrZero(placeableMo2987measureBRTryo02), TextFieldImplKt.heightOrZero(placeableMo2987measureBRTryo05), j10, measure.getDensity(), this.paddingValues);
                return MeasureScope.CC.p(measure, iM1211calculateWidthVsPV1Ek, iM1210calculateHeightO3s9Psw, null, new TextFieldMeasurePolicy$measure$1(placeableMo2987measureBRTryo03, iMo290roundToPx0680j_4, height, iM1211calculateWidthVsPV1Ek, iM1210calculateHeightO3s9Psw, placeableMo2987measureBRTryo04, placeableMo2987measureBRTryo05, placeableMo2987measureBRTryo0, placeableMo2987measureBRTryo02, this, iMax, iMo290roundToPx0680j_43, measure), 4, null);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public int minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i10) {
        t.i(intrinsicMeasureScope, "<this>");
        t.i(measurables, "measurables");
        return intrinsicHeight(intrinsicMeasureScope, measurables, i10, C09581.INSTANCE);
    }
    ...
    public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> measurables, int i10) {
        t.i(intrinsicMeasureScope, "<this>");
        t.i(measurables, "measurables");
        return intrinsicWidth(measurables, i10, C09591.INSTANCE);
    }
}
