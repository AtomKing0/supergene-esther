...
final class BackdropScaffoldKt$BackdropScaffold$1$1$swipeable$1 extends v implements l<SemanticsPropertyReceiver, k0> {
    ...
    static final class AnonymousClass1 extends v implements a<Boolean> {
        ...
        static final class C00851 extends kotlin.coroutines.jvm.internal.l implements p<o0, d<? super k0>, Object> {
            final /* synthetic */ BackdropScaffoldState $scaffoldState;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00851(BackdropScaffoldState backdropScaffoldState, d<? super C00851> dVar) {
                super(2, dVar);
            ...
            public final d<k0> create(@Nullable Object obj, @NotNull d<?> dVar) {
                return new C00851(this.$scaffoldState, dVar);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                if (i10 == 0) {
                    ...
                    this.label = 1;
                    if (backdropScaffoldState.reveal(this) == objE) {
                        return objE;
                    }
                } else {
                    if (i10 != 1) {
            ...
            public final Object mo4invoke(@NotNull o0 o0Var, @Nullable d<? super k0> dVar) {
                return ((C00851) create(o0Var, dVar)).invokeSuspend(k0.f35197a);
            }
        }
        ...
        public final Boolean invoke() {
            if (this.$scaffoldState.getConfirmStateChange$material_release().invoke(BackdropValue.Revealed).booleanValue()) {
                k.d(this.$scope, null, null, new C00851(this.$scaffoldState, null), 3, null);
            }
            return Boolean.TRUE;
        }
    }
