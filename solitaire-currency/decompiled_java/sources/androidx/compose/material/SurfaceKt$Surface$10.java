...
final class SurfaceKt$Surface$10 extends v implements p<Composer, Integer, k0> {
    ...
    SurfaceKt$Surface$10(Modifier modifier, Shape shape, long j10, float f10, int i10, BorderStroke borderStroke, float f11, boolean z10, MutableInteractionSource mutableInteractionSource, boolean z11, l<? super Boolean, k0> lVar, p<? super Composer, ? super Integer, k0> pVar, int i11) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i10) {
        ...
        Modifier modifierM617toggleableO2vRcR0 = ToggleableKt.m617toggleableO2vRcR0(SurfaceKt.m1153surface8ww4TTg(TouchTargetKt.minimumTouchTargetSize(this.$modifier), this.$shape, SurfaceKt.m1154surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$checked, this.$interactionSource, RippleKt.m1237rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, Role.m3227boximpl(Role.Companion.m3238getSwitcho7Vup1c()), this.$onCheckedChange);
        ...
        q<SkippableUpdater<ComposeUiNode>, Composer, Integer, k0> qVarMaterializerOf = LayoutKt.materializerOf(modifierM617toggleableO2vRcR0);
