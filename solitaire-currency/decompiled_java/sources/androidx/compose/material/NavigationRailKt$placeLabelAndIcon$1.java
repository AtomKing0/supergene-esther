...
final class NavigationRailKt$placeLabelAndIcon$1 extends v implements l<Placeable.PlacementScope, k0> {
    ...
    NavigationRailKt$placeLabelAndIcon$1(float f10, Placeable placeable, int i10, int i11, int i12, Placeable placeable2, int i13, int i14) {
        super(1);
