...
final class AlertDialogKt$AlertDialogContent$1$1$2$1 extends v implements p<Composer, Integer, k0> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ p<Composer, Integer, k0> $text;

    /* JADX INFO: renamed from: androidx.compose.material.AlertDialogKt$AlertDialogContent$1$1$2$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: AlertDialog.kt */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    AlertDialogKt$AlertDialogContent$1$1$2$1(p<? super Composer, ? super Integer, k0> pVar, int i10) {
        super(2);
        this.$text = pVar;
        this.$$dirty = i10;
    }
