...
final class ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1 extends v implements p<Composer, Integer, k0> {
    ...
    ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1(FabPlacement fabPlacement, p<? super Composer, ? super Integer, k0> pVar, int i10) {
        super(2);
