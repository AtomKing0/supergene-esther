...
final class LayoutNodeWrapper$speculativeHit$1 extends v implements h9.a<k0> {
    ...
    LayoutNodeWrapper$speculativeHit$1(LayoutNodeWrapper layoutNodeWrapper, LayoutNodeEntity layoutNodeEntity, LayoutNodeWrapper.HitTestSource hitTestSource, long j10, HitTestResult hitTestResult, boolean z10, boolean z11, float f10) {
        super(0);
    ...
    public final void invoke2() {
        this.this$0.m3121speculativeHitJHbHoSQ(this.$this_speculativeHit.getNext(), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
