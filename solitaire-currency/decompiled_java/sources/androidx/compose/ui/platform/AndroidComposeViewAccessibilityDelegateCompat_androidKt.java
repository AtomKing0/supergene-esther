...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    public static final boolean accessibilityEquals(AccessibilityAction<?> accessibilityAction, Object obj) {
        ...
        if (!kotlin.jvm.internal.t.d(accessibilityAction.getLabel(), accessibilityAction2.getLabel())) {
            return false;
        }
    ...
    public static final boolean excludeLineAndPageGranularities(SemanticsNode semanticsNode) {
        ...
        if (isTextField(semanticsNode) && !kotlin.jvm.internal.t.d(SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig$ui_release(), SemanticsProperties.INSTANCE.getFocused()), Boolean.TRUE)) {
            return true;
        }
        LayoutNode layoutNodeFindClosestParentNode = findClosestParentNode(semanticsNode.getLayoutNode$ui_release(), AndroidComposeViewAccessibilityDelegateCompat_androidKt$excludeLineAndPageGranularities$ancestor$1.INSTANCE);
        if (layoutNodeFindClosestParentNode != null) {
            ...
            if (!((outerSemantics == null || (semanticsConfigurationCollapsedSemanticsConfiguration = outerSemantics.collapsedSemanticsConfiguration()) == null) ? false : kotlin.jvm.internal.t.d(SemanticsConfigurationKt.getOrNull(semanticsConfigurationCollapsedSemanticsConfiguration, SemanticsProperties.INSTANCE.getFocused()), Boolean.TRUE))) {
                return true;
            }
        }
        return false;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final LayoutNode findClosestParentNode(LayoutNode layoutNode, h9.l<? super LayoutNode, Boolean> lVar) {
    ...
    public static final Map<Integer, SemanticsNodeWithAdjustedBounds> getAllUncoveredSemanticsNodesToMap(@NotNull SemanticsOwner semanticsOwner) {
        kotlin.jvm.internal.t.i(semanticsOwner, "<this>");
        ...
        if (!region.isEmpty() || semanticsNode2.getId() == semanticsNode.getId()) {
            if (!z11 || semanticsNode2.isFake$ui_release()) {
                ...
                if (semanticsNode2.isFake$ui_release()) {
                    ...
                    map.put(Integer.valueOf(id), new SemanticsNodeWithAdjustedBounds(semanticsNode2, RectHelper_androidKt.toAndroidRect(z10 ? parent.getBoundsInRoot() : new androidx.compose.ui.geometry.Rect(0.0f, 0.0f, 10.0f, 10.0f))));
                    return;
                }
                if (id == -1) {
