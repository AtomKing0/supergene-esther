...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    static {
        ...
        Black = fontWeight9;
        values = v.n(fontWeight, fontWeight2, fontWeight3, fontWeight4, fontWeight5, fontWeight6, fontWeight7, fontWeight8, fontWeight9);
    }
    ...
    public int compareTo(@NotNull FontWeight other) {
        t.i(other, "other");
        return t.k(this.weight, other.weight);
    }
