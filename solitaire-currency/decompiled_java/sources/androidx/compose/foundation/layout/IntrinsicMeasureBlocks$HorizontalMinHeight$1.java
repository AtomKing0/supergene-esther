...
final class IntrinsicMeasureBlocks$HorizontalMinHeight$1 extends v implements q<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    /* JADX INFO: renamed from: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinHeight$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: RowColumnImpl.kt */
    ...
    /* JADX INFO: renamed from: androidx.compose.foundation.layout.IntrinsicMeasureBlocks$HorizontalMinHeight$1$2, reason: invalid class name */
    /* JADX INFO: compiled from: RowColumnImpl.kt */
    ...
    public final Integer invoke(@NotNull List<? extends IntrinsicMeasurable> measurables, int i10, int i11) {
        ...
        return Integer.valueOf(RowColumnImplKt.intrinsicSize(measurables, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, i10, i11, LayoutOrientation.Horizontal, LayoutOrientation.Vertical));
    }
}
