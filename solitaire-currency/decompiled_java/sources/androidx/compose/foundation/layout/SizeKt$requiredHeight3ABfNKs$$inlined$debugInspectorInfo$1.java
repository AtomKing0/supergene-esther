...
public final class SizeKt$requiredHeight3ABfNKs$$inlined$debugInspectorInfo$1 extends v implements h9.l<InspectorInfo, k0> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Dp.m3671boximpl(this.$height$inlined));
    }
}
