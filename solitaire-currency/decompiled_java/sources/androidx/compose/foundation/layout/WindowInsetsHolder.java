...
public final class WindowInsetsHolder {
    ...
    public static final class Companion {
        ...
        public final ValueInsets valueInsetsIgnoringVisibility(WindowInsetsCompat windowInsetsCompat, int i10, String str) {
            ...
            if (windowInsetsCompat == null || (insetsIgnoringVisibility = windowInsetsCompat.getInsetsIgnoringVisibility(i10)) == null) {
                insetsIgnoringVisibility = Insets.NONE;
            }
            t.h(insetsIgnoringVisibility, "windowInsets?.getInsetsI…e) ?: AndroidXInsets.NONE");
    ...
    public final void update(@NotNull WindowInsetsCompat windowInsets, int i10) {
        ...
        t.h(windowInsets, "if (testInsets) {\n      …   windowInsets\n        }");
        ...
        if (i10 == 0) {
            ...
            t.h(insetsIgnoringVisibility, "insets.getInsetsIgnoring…aptionBar()\n            )");
            ...
            t.h(insetsIgnoringVisibility2, "insets.getInsetsIgnoring…ationBars()\n            )");
            ...
            t.h(insetsIgnoringVisibility3, "insets.getInsetsIgnoring…tatusBars()\n            )");
            ...
            t.h(insetsIgnoringVisibility4, "insets.getInsetsIgnoring…ystemBars()\n            )");
            ...
            t.h(insetsIgnoringVisibility5, "insets.getInsetsIgnoring…leElement()\n            )");
            ...
            if (displayCutout != null) {
                ...
                t.h(waterfallInsets, "cutout.waterfallInsets");
    ...
    private WindowInsetsHolder(WindowInsetsCompat windowInsetsCompat, View view) {
        ...
        t.h(waterfallInsets, "insets?.displayCutout?.w…ts ?: AndroidXInsets.NONE");
        ValueInsets ValueInsets = WindowInsets_androidKt.ValueInsets(waterfallInsets, com.ironsource.mediationsdk.d.f13326g);
