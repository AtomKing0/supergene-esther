...
public final class PaddingKt$paddingVpY3zN4$$inlined$debugInspectorInfo$1 extends v implements h9.l<InspectorInfo, k0> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("horizontal", Dp.m3671boximpl(this.$horizontal$inlined));
        inspectorInfo.getProperties().set("vertical", Dp.m3671boximpl(this.$vertical$inlined));
    }
}
