...
final class ClickableKt$combinedClickable$4$delayPressInteraction$1 extends v implements h9.a<Boolean> {
    ...
    ClickableKt$combinedClickable$4$delayPressInteraction$1(MutableState<Boolean> mutableState, h9.a<Boolean> aVar) {
        super(0);
