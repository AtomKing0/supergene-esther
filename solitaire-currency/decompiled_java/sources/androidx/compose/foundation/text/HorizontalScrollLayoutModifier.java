...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    @NotNull
    public final HorizontalScrollLayoutModifier copy(@NotNull TextFieldScrollerPosition scrollerPosition, int i10, @NotNull TransformedText transformedText, @NotNull a<TextLayoutResultProxy> textLayoutResultProvider) {
        t.i(scrollerPosition, "scrollerPosition");
        t.i(transformedText, "transformedText");
        t.i(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public MeasureResult mo23measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        Placeable placeableMo2987measureBRTryo0 = measurable.mo2987measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m3640getMaxHeightimpl(j10)) < Constraints.m3641getMaxWidthimpl(j10) ? j10 : Constraints.m3632copyZbe2FdA$default(j10, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        int iMin = Math.min(placeableMo2987measureBRTryo0.getWidth(), Constraints.m3641getMaxWidthimpl(j10));
        return MeasureScope.CC.p(measure, iMin, placeableMo2987measureBRTryo0.getHeight(), null, new HorizontalScrollLayoutModifier$measure$1(measure, this, placeableMo2987measureBRTryo0, iMin), 4, null);
    }
