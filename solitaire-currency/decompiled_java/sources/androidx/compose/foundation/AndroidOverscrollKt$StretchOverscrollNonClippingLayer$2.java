...
final class AndroidOverscrollKt$StretchOverscrollNonClippingLayer$2 extends v implements h9.q<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        return m164invoke3p2s80s(measureScope, measurable, constraints.m3647unboximpl());
    }

    @NotNull
    /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
    public final MeasureResult m164invoke3p2s80s(@NotNull MeasureScope layout, @NotNull Measurable measurable, long j10) {
        t.i(layout, "$this$layout");
        ...
        return MeasureScope.CC.p(layout, placeableMo2987measureBRTryo0.getWidth() + iMo290roundToPx0680j_4, placeableMo2987measureBRTryo0.getHeight() + iMo290roundToPx0680j_4, null, new AnonymousClass1(placeableMo2987measureBRTryo0, iMo290roundToPx0680j_4), 4, null);
    }
}
