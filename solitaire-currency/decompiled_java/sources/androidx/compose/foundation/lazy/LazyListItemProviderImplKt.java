...
public final class LazyListItemProviderImplKt {
    ...
    static final class AnonymousClass1 extends l implements p<o0, d<? super k0>, Object> {
        ...
        /* JADX INFO: renamed from: androidx.compose.foundation.lazy.LazyListItemProviderImplKt$rememberItemProvider$1$1, reason: invalid class name and collision with other inner class name */
        /* JADX INFO: compiled from: LazyListItemProviderImpl.kt */
        static final class C00551 extends v implements h9.a<i> {
            final /* synthetic */ LazyListState $state;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00551(LazyListState lazyListState) {
                super(0);
            ...
            public final i invoke() {
                return LazyListItemProviderImplKt.calculateNearestItemsRange(this.$state.getFirstVisibleItemIndex());
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(LazyListState lazyListState, MutableState<i> mutableState, d<? super AnonymousClass1> dVar) {
            super(2, dVar);
            this.$state = lazyListState;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                u.b(obj);
                h hVarSnapshotFlow = SnapshotStateKt.snapshotFlow(new C00551(this.$state));
                final MutableState<i> mutableState = this.$nearestItemsRangeState;
                s9.i<i> iVar = new s9.i<i>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt.rememberItemProvider.1.2
                    @Override // s9.i
    ...
    @NotNull
    public static final Map<Object, Integer> generateKeyToIndexMap(@NotNull i range, @NotNull IntervalList<LazyListIntervalContent> list) {
        t.i(range, "range");
        t.i(list, "list");
        int iB = range.b();
        if (!(iB >= 0)) {
        ...
        list.forEach(iB, iMin, new LazyListItemProviderImplKt$generateKeyToIndexMap$1$1(iB, iMin, map));
        return map;
    }
    ...
    @ExperimentalFoundationApi
    @NotNull
    public static final LazyListItemProvider rememberItemProvider(@NotNull LazyListState state, @NotNull h9.l<? super LazyListScope, k0> content, @Nullable Composer composer, int i10) {
        t.i(state, "state");
        t.i(content, "content");
        ...
        if (zChanged2 || objRememberedValue2 == Composer.Companion.getEmpty()) {
            objRememberedValue2 = new LazyListItemProviderImpl(SnapshotStateKt.derivedStateOf(new LazyListItemProviderImplKt$rememberItemProvider$2$1(stateRememberUpdatedState, mutableState)));
