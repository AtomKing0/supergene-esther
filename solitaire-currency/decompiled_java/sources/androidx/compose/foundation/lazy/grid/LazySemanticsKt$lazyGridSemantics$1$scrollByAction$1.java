...
final class LazySemanticsKt$lazyGridSemantics$1$scrollByAction$1 extends v implements p<Float, Float, Boolean> {
    ...
    static final class AnonymousClass1 extends l implements p<o0, d<? super k0>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                this.label = 1;
                if (ScrollExtensionsKt.animateScrollBy$default(lazyGridState, f10, null, this, 2, null) == objE) {
                    return objE;
                }
            } else {
                if (i10 != 1) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    LazySemanticsKt$lazyGridSemantics$1$scrollByAction$1(boolean z10, o0 o0Var, LazyGridState lazyGridState) {
        super(2);
        this.$isVertical = z10;
