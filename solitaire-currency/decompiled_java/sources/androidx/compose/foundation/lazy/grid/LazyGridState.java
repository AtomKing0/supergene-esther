...
public final class LazyGridState implements ScrollableState {
    ...
    /* JADX INFO: compiled from: LazyGridState.kt */
    @f(c = "androidx.compose.foundation.lazy.grid.LazyGridState", f = "LazyGridState.kt", l = {263, 264}, m = "scroll")
    ...
    public static /* synthetic */ Object animateScrollToItem$default(LazyGridState lazyGridState, int i10, int i11, z8.d dVar, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = 0;
        }
    ...
    private final void notifyPrefetch(float f10) {
        ...
        if (this.prefetchingEnabled) {
            ...
            if (!layoutInfo.getVisibleItemsInfo().isEmpty()) {
                ...
                if (z10) {
                    LazyGridItemInfo lazyGridItemInfo = (LazyGridItemInfo) d0.t0(layoutInfo.getVisibleItemsInfo());
                    row = (isVertical$foundation_release() ? lazyGridItemInfo.getRow() : lazyGridItemInfo.getColumn()) + 1;
                    index = ((LazyGridItemInfo) d0.t0(layoutInfo.getVisibleItemsInfo())).getIndex() + 1;
                } else {
                    LazyGridItemInfo lazyGridItemInfo2 = (LazyGridItemInfo) d0.i0(layoutInfo.getVisibleItemsInfo());
                    row = (isVertical$foundation_release() ? lazyGridItemInfo2.getRow() : lazyGridItemInfo2.getColumn()) - 1;
                    index = ((LazyGridItemInfo) d0.i0(layoutInfo.getVisibleItemsInfo())).getIndex() - 1;
                }
                if (row != this.lineToPrefetch) {
                    if (index >= 0 && index < layoutInfo.getTotalItemsCount()) {
                        ...
                        List<s<Integer, Constraints>> listInvoke = getPrefetchInfoRetriever$foundation_release().invoke(LineIndex.m591boximpl(LineIndex.m593constructorimpl(row)));
                        int size2 = listInvoke.size();
                        for (int i11 = 0; i11 < size2; i11++) {
                            s<Integer, Constraints> sVar = listInvoke.get(i11);
                            this.currentLinePrefetchHandles.add(lazyLayoutPrefetchState.m609schedulePrefetch0kLqBqw(sVar.c().intValue(), sVar.d().m3647unboximpl()));
                        }
                    }
                }
            }
    ...
    public static /* synthetic */ Object scrollToItem$default(LazyGridState lazyGridState, int i10, int i11, z8.d dVar, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = 0;
        }
    ...
    public final Object animateScrollToItem(int i10, int i11, @NotNull z8.d<? super k0> dVar) {
        Object objDoSmoothScrollToItem = LazyGridScrollingKt.doSmoothScrollToItem(this, i10, i11, getSlotsPerLine$foundation_release(), dVar);
    ...
    public final void applyMeasureResult$foundation_release(@NotNull LazyGridMeasureResult result) {
        ...
        this.canScrollBackward = ((firstVisibleLine != null ? firstVisibleLine.m588getIndexhA7yfN8() : 0) == 0 && result.getFirstVisibleLineScrollOffset() == 0) ? false : true;
    ...
    public final int getFirstVisibleItemIndex() {
        return this.scrollPosition.m579getIndexVZbfaAc();
    }
    ...
    @NotNull
    public final h9.l<LineIndex, List<s<Integer, Constraints>>> getPrefetchInfoRetriever$foundation_release() {
        return (h9.l) this.prefetchInfoRetriever$delegate.getValue();
    }
    ...
    */
    public java.lang.Object scroll(@org.jetbrains.annotations.NotNull androidx.compose.foundation.MutatePriority r6, @org.jetbrains.annotations.NotNull h9.p<? super androidx.compose.foundation.gestures.ScrollScope, ? super z8.d<? super v8.k0>, ? extends java.lang.Object> r7, @org.jetbrains.annotations.NotNull z8.d<? super v8.k0> r8) {
        ...
        L6c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridState.scroll(androidx.compose.foundation.MutatePriority, h9.p, z8.d):java.lang.Object");
    }
    ...
    public final void setPrefetchInfoRetriever$foundation_release(@NotNull h9.l<? super LineIndex, ? extends List<s<Integer, Constraints>>> lVar) {
        t.i(lVar, "<set-?>");
    ...
    public final void snapToItemIndexInternal$foundation_release(int i10, int i11) {
        this.scrollPosition.m580requestPositionyO3Fmg4(ItemIndex.m541constructorimpl(i10), i11);
    ...
    public LazyGridState(int i10, int i11) {
        ...
        this.prefetchInfoRetriever$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(LazyGridState$prefetchInfoRetriever$2.INSTANCE, null, 2, null);
