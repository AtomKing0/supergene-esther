...
final class LazyListItemPlacementAnimator$getAnimatedOffset$1 extends l implements p<o0, d<? super k0>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            IntOffset intOffsetM3782boximpl = IntOffset.m3782boximpl(this.$item.m528getTargetOffsetnOccac());
            this.label = 1;
    ...
    public final Object mo4invoke(@NotNull o0 o0Var, @Nullable d<? super k0> dVar) {
        return ((LazyListItemPlacementAnimator$getAnimatedOffset$1) create(o0Var, dVar)).invokeSuspend(k0.f35197a);
    }
}
