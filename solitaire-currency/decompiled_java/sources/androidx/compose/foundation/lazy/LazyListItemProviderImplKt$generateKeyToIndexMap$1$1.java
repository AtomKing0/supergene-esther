...
final class LazyListItemProviderImplKt$generateKeyToIndexMap$1$1 extends v implements l<IntervalList.Interval<LazyListIntervalContent>, k0> {
    ...
    @Override // h9.l
    public /* bridge */ /* synthetic */ k0 invoke(IntervalList.Interval<LazyListIntervalContent> interval) {
        invoke2(interval);
        return k0.f35197a;
    }
