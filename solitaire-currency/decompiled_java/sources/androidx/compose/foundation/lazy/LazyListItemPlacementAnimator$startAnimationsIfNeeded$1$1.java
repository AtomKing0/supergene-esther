...
final class LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1 extends l implements p<o0, d<? super k0>, Object> {
    final /* synthetic */ FiniteAnimationSpec<IntOffset> $animationSpec;
    final /* synthetic */ PlaceableInfo $placeableInfo;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1(PlaceableInfo placeableInfo, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, d<? super LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i10 == 0) {
                ...
                IntOffset intOffsetM3782boximpl = IntOffset.m3782boximpl(this.$placeableInfo.m528getTargetOffsetnOccac());
                this.label = 1;
    ...
    public final Object mo4invoke(@NotNull o0 o0Var, @Nullable d<? super k0> dVar) {
        return ((LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1) create(o0Var, dVar)).invokeSuspend(k0.f35197a);
    }
}
