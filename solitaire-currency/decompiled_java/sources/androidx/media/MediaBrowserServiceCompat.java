...
public abstract class MediaBrowserServiceCompat extends Service {
        ...
        public BrowserRoot onGetRoot(String str, int i10, Bundle bundle) {
            ...
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (token != null) {
                    ...
                    BundleCompat.putBinder(extras, MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVarC == null ? null : bVarC.asBinder());
                } else {
        ...
        void setSessionTokenOnHandler(MediaSessionCompat.Token token) {
            if (!this.mRootExtrasList.isEmpty()) {
                ...
                if (bVarC != null) {
                    ...
                    while (it.hasNext()) {
                        BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVarC.asBinder());
                    }
                }
    ...
    private class ServiceBinderImpl {
        ...
        public void getMediaItem(final String str, final b.b bVar, final ServiceCallbacks serviceCallbacks) {
        ...
        public void search(final String str, final Bundle bundle, final b.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final b.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
    ...
    void handleMessageInternal(Message message) {
        ...
        switch (message.what) {
            ...
            case 4:
                ...
                break;
            case 5:
                this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (b.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                break;
            case 6:
            ...
            case 8:
                ...
                this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (b.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                break;
            case 9:
                Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                MediaSessionCompat.a(bundle5);
                this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (b.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                break;
            default:
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final b.b bVar) {
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final b.b bVar) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final b.b bVar) {
