...
public class Preference implements Comparable<Preference> {
    ...
    void dispatchRestoreInstanceState(@NonNull Bundle bundle) {
    ...
    void dispatchSaveInstanceState(@NonNull Bundle bundle) {
        if (hasKey()) {
            this.mBaseMethodCalled = false;
    ...
    final void setOnPreferenceChangeInternalListener(@Nullable OnPreferenceChangeInternalListener onPreferenceChangeInternalListener) {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    protected void onAttachedToHierarchy(@NonNull PreferenceManager preferenceManager, long j10) {
        this.mId = j10;
        this.mHasId = true;
        try {
