    ...
    */
    ...
    String toString(String str) {
        ...
        for (int i10 = 0; i10 < this.mTransitions.size(); i10++) {
            ...
            sb.append(string);
            sb.append("\n");
            sb.append(this.mTransitions.get(i10).toString(str + "  "));
            string = sb.toString();
        }
        return string;
    }
    ...
    public Transition mo3936clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo3936clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i10 = 0; i10 < size; i10++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i10).mo3936clone());
        }
