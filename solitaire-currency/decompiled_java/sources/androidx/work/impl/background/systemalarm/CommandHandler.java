...
public class CommandHandler implements ExecutionListener {
    ...
    static Intent createExecutionCompletedIntent(@NonNull Context context, @NonNull WorkGenerationalId workGenerationalId, boolean z10) {
        Intent intent = new Intent(context, (Class<?>) SystemAlarmService.class);
    ...
    private void handleConstraintsChanged(@NonNull Intent intent, int i10, @NonNull SystemAlarmDispatcher systemAlarmDispatcher) {
        ...
        new ConstraintsCommandHandler(this.mContext, this.mClock, i10, systemAlarmDispatcher).handleConstraintsChanged();
    }
    ...
    private void handleExecutionCompleted(@NonNull Intent intent, int i10) {
        ...
        onExecuted(workGenerationalId, z10);
    }
    ...
    @WorkerThread
    void onHandleIntent(@NonNull Intent intent, int i10, @NonNull SystemAlarmDispatcher systemAlarmDispatcher) {
