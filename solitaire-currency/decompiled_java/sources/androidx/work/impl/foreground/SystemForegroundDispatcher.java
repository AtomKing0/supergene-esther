...
public class SystemForegroundDispatcher implements OnConstraintsStateChangedListener, ExecutionListener {
    ...
    final Map<WorkGenerationalId, b2> mTrackedWorkSpecs;
    ...
    void onDestroy() {
        ...
        synchronized (this.mLock) {
            Iterator<b2> it = this.mTrackedWorkSpecs.values().iterator();
            while (it.hasNext()) {
                it.next().cancel(null);
            }
        }
    ...
    public void onExecuted(@NonNull WorkGenerationalId workGenerationalId, boolean z10) {
        ...
        synchronized (this.mLock) {
            b2 b2VarRemove = this.mWorkSpecById.remove(workGenerationalId) != null ? this.mTrackedWorkSpecs.remove(workGenerationalId) : null;
            if (b2VarRemove != null) {
                b2VarRemove.cancel(null);
            }
        }
