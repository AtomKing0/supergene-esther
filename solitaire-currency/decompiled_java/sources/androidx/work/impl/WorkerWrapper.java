...
public class WorkerWrapper implements Runnable {
    ...
    public /* synthetic */ void lambda$runWorker$0(m mVar) {
    ...
    private void runWorker() {
        ...
        try {
            ...
            final m<Void> future = workForegroundRunnable.getFuture();
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.k
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1795a.lambda$runWorker$0(future);
                }
