...
public final class ProcessUtils {
    ...
    static {
        ...
        t.h(strTagWithPrefix, "tagWithPrefix(\"ProcessUtils\")");
    ...
    public static final boolean isDefaultProcess(@NotNull Context context, @NotNull Configuration configuration) {
        ...
        return !(defaultProcessName == null || defaultProcessName.length() == 0) ? t.d(processName, configuration.getDefaultProcessName()) : t.d(processName, context.getApplicationInfo().processName);
    }
}
