...
public abstract class ListenableWorker {
    ...
    @NonNull
    public final m<Void> setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public m<Void> setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract m<Result> startWork();
