...
public abstract class KeyCycleOscillator {
    ...
    private static class IntDoubleSort {
        ...
        static void sort(int[] iArr, float[] fArr, int i10, int i11) {
    ...
    private static class IntFloatFloatSort {
        ...
        static void sort(int[] iArr, float[] fArr, float[] fArr2, int i10, int i11) {
            int[] iArr2 = new int[iArr.length + 10];
            iArr2[0] = i11;
            iArr2[1] = i10;
            int i12 = 2;
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            str = str + v8.i.f15837d + it.next().mPosition + " , " + decimalFormat.format(r3.mValue) + "] ";
        }
        return str;
    }
