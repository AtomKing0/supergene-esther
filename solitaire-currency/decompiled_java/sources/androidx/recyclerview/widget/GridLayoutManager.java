        ...
        while (i27 < i19) {
            ...
            if (this.mOrientation == 1) {
                if (isLayoutRTL()) {
                    ...
                    decoratedMeasurementInOther3 = i15;
            ...
            layoutDecoratedWithMargins(view4, decoratedMeasurementInOther2, i16, decoratedMeasurementInOther, decoratedMeasurementInOther3);
            if (layoutParams2.isItemRemoved() || layoutParams2.isItemChanged()) {
                layoutChunkResult.mIgnoreConsumed = true;
            }
            layoutChunkResult.mFocusable |= view4.hasFocusable();
            i27++;
            i15 = decoratedMeasurementInOther3;
