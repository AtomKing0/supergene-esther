                ...
                if (bits2 == 2) {
                    ...
                    if (bits4 == 3) {
                        while (parsableBitArray.getBytePosition() < bytePosition3) {
                            bytesAsString = parsableBitArray.readBytesAsString(parsableBitArray.readBits(8), e.f25138a);
                    ...
                    bytesAsString2 = parsableBitArray.readBytesAsString(bits3, e.f25138a);
                }
