...
public final class SubripParser implements SubtitleParser {
    ...
    */
    ...
    private Charset detectUtfCharset(ParsableByteArray parsableByteArray) {
        ...
        return utfCharsetFromBom != null ? utfCharsetFromBom : e.f25140c;
    }
            ...
            if (line2.length() != 0) {
                ...
                if (matcher.matches()) {
                    ...
                    if (j10 == C.TIME_UNSET || timecode >= j10) {
                        consumer3 = consumer;
                        consumer3.accept(new CuesWithTiming(y.r(buildCue(spannedFromHtml, str3)), timecode, timecode2 - timecode));
                    } else {
                        if (arrayList != null) {
                            arrayList.add(new CuesWithTiming(y.r(buildCue(spannedFromHtml, str3)), timecode, timecode2 - timecode));
                        }
                        consumer3 = consumer;
                    }
                    consumer4 = consumer3;
