        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (unsignedByte == 134) {
                ...
                for (int i11 = 0; i11 < unsignedByte2; i11++) {
                    ...
                    arrayList.add(new Format.Builder().setSampleMimeType(str).setLanguage(string).setAccessibilityChannel(i10).setInitializationData(z10 ? CodecSpecificDataUtil.buildCea708InitializationData((unsignedByte4 & 64) != 0) : null).build());
                }
            }
