...
public final class ThumbRating extends Rating {
    ...
    @UnstableApi
    @Deprecated
    public static final Bundleable.Creator<ThumbRating> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.a3
    ...
    public int hashCode() {
        return e5.k.b(Boolean.valueOf(this.rated), Boolean.valueOf(this.isThumbsUp));
    }
