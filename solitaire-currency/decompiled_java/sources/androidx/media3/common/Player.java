...
public interface Player {
    ...
    public static final class Commands implements Bundleable {
        ...
        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<Commands> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.f0
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<PositionInfo> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.h0
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            return e5.k.b(this.windowUid, Integer.valueOf(this.mediaItemIndex), this.mediaItem, this.periodUid, Integer.valueOf(this.periodIndex), Long.valueOf(this.positionMs), Long.valueOf(this.contentPositionMs), Integer.valueOf(this.adGroupIndex), Integer.valueOf(this.adIndexInAdGroup));
        }
