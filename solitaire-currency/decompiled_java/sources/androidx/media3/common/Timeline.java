...
public abstract class Timeline implements Bundleable {
    ...
    @UnstableApi
    @Deprecated
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.d3
    ...
    public static final class Period implements Bundleable {
        ...
        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<Period> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.e3
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
    ...
    public static final class RemotableTimeline extends Timeline {
        private final com.google.common.collect.y<Period> periods;
        private final int[] shuffledWindowIndices;
        private final int[] windowIndicesInShuffled;
        private final com.google.common.collect.y<Window> windows;

        public RemotableTimeline(com.google.common.collect.y<Window> yVar, com.google.common.collect.y<Period> yVar2, int[] iArr) {
            Assertions.checkArgument(yVar.size() == iArr.length);
            this.windows = yVar;
            this.periods = yVar2;
    ...
    public static final class Window implements Bundleable {
        ...
        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<Window> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.f3
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
    ...
    public static Timeline fromBundle(Bundle bundle) {
        com.google.common.collect.y yVarFromBundleListRetriever = fromBundleListRetriever(new e5.g() { // from class: androidx.media3.common.b3
            @Override // e5.g
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj);
            }
        }, BundleUtil.getBinder(bundle, FIELD_WINDOWS));
        com.google.common.collect.y yVarFromBundleListRetriever2 = fromBundleListRetriever(new e5.g() { // from class: androidx.media3.common.c3
            @Override // e5.g
            public final Object apply(Object obj) {
        ...
        if (intArray == null) {
            intArray = generateUnshuffledIndices(yVarFromBundleListRetriever.size());
        }
        return new RemotableTimeline(yVarFromBundleListRetriever, yVarFromBundleListRetriever2, intArray);
    }

    private static <T> com.google.common.collect.y<T> fromBundleListRetriever(e5.g<Bundle, T> gVar, @Nullable IBinder iBinder) {
        return iBinder == null ? com.google.common.collect.y.q() : BundleCollectionUtil.fromBundleList(gVar, BundleListRetriever.getList(iBinder));
    }
    ...
    public final Timeline copyWithSingleWindow(int i10) {
        ...
        while (true) {
            ...
            if (i11 > i12) {
                ...
                return new RemotableTimeline(com.google.common.collect.y.r(window), aVarK.k(), new int[]{0});
            }
