...
final class CanvasSubtitleOutput extends View implements SubtitleView.Output {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        while (i11 < size) {
            ...
            this.painters.get(i11).draw(cue, this.style, fResolveTextSize, SubtitleViewUtils.resolveTextSize(cue.textSizeType, cue.textSize, height, i10), this.bottomPaddingFraction, canvas, paddingLeft, paddingTop, width, i12);
            i11++;
            size = size;
            i10 = i10;
            paddingBottom = i12;
