...
final class ReplacingCuesResolver implements CuesResolver {
    ...
    */
    ...
    public y<Cue> getCuesAtTimeUs(long j10) {
        ...
        return (j11 == C.TIME_UNSET || j10 < j11) ? cuesWithTiming.cues : y.q();
    }
    ...
    public long getNextCueChangeTimeUs(long j10) {
        ...
        long j12 = ((CuesWithTiming) g0.d(this.cuesWithTimingList)).endTimeUs;
    ...
    public long getPreviousCueChangeTimeUs(long j10) {
        ...
        CuesWithTiming cuesWithTiming2 = (CuesWithTiming) g0.d(this.cuesWithTimingList);
