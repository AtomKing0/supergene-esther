...
public class ImageRenderer extends BaseRenderer {
    ...
    private boolean canCreateDecoderForFormat(Format format) {
        ...
        return iSupportsFormat == k2.c(4) || iSupportsFormat == k2.c(3);
    }
    ...
    private Bitmap cropTileFromImageGrid(int i10) {
        ...
        return Bitmap.createBitmap(this.outputBitmap, (i10 % format.tileCountVertical) * width, (i10 / format.tileCountHorizontal) * height, width, height);
    }
