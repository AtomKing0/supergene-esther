...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.e0
            @Override // java.lang.Runnable
            public final void run() {
                this.f1500a.lambda$onLengthKnown$2();
            }
        });
    }
    ...
    public void lambda$seekMap$1(SeekMap seekMap) {
        ...
        if (seekMap.getDurationUs() == C.TIME_UNSET && this.durationUs != C.TIME_UNSET) {
        ...
        boolean z10 = !this.isLengthKnown && seekMap.getDurationUs() == C.TIME_UNSET;
        this.isLive = z10;
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.f0
            @Override // java.lang.Runnable
            public final void run() {
                this.f1503a.lambda$seekMap$1(seekMap);
            }
        });
    }
