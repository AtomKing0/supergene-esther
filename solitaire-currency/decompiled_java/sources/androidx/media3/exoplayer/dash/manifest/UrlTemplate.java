...
public final class UrlTemplate {
            ...
            if (iIndexOf == -1) {
                ...
                if (strSubstring2.equals(REPRESENTATION)) {
                    ...
                    if (iIndexOf3 != -1) {
                        ...
                        if (!strSubstring.endsWith("d") && !strSubstring.endsWith(ViewHierarchyNode.JsonKeys.X) && !strSubstring.endsWith("X")) {
    ...
    public String buildUri(String str, long j10, int i10, long j11) {
        ...
        for (int i11 = 0; i11 < this.identifiers.size(); i11++) {
            sb.append(this.urlPieces.get(i11));
            if (this.identifiers.get(i11).intValue() == 1) {
                sb.append(str);
            } else if (this.identifiers.get(i11).intValue() == 2) {
                sb.append(String.format(Locale.US, this.identifierFormatTags.get(i11), Long.valueOf(j10)));
            } else if (this.identifiers.get(i11).intValue() == 3) {
                sb.append(String.format(Locale.US, this.identifierFormatTags.get(i11), Integer.valueOf(i10)));
            } else if (this.identifiers.get(i11).intValue() == 4) {
                sb.append(String.format(Locale.US, this.identifierFormatTags.get(i11), Long.valueOf(j11)));
            }
        }
