...
public final class RegionKt {
    ...
    /* JADX INFO: compiled from: Region.kt */
    public static final class AnonymousClass1 implements Iterator<Rect>, i9.a {
    ...
    public static final void forEach(@NotNull Region region, @NotNull h9.l<? super Rect, v8.k0> lVar) {
        RegionIterator regionIterator = new RegionIterator(region);
        while (true) {
            Rect rect = new Rect();
