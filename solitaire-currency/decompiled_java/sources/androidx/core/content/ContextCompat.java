...
public class ContextCompat {
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            map.put(BluetoothManager.class, r8.f14657d);
            map.put(DisplayManager.class, v8.h.f15785d);
            ...
            map.put(DownloadManager.class, com.vungle.ads.internal.presenter.o.DOWNLOAD);
            ...
            map.put(StorageManager.class, v8.a.f15683j);
            ...
            map.put(WifiManager.class, r8.f14655b);
