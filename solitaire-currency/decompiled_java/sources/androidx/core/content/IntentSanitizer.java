...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.z
        ...
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.a0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.b0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.c0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.d0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.e0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.f0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.g0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return androidx.core.util.j.a(this, predicate);
            }
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.s
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.j.a(this, predicate);
                }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new q(str));
        }
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.x
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.j.a(this, predicate);
                }
        ...
        public Builder allowDataWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.v
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.j.a(this, predicate);
                }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.y
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.j.a(this, predicate);
                }
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.w
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return androidx.core.util.j.a(this, predicate);
                }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.t
                @Override // androidx.core.util.Predicate
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.o
                    @Override // androidx.core.util.Predicate
    ...
    */
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.j
    ...
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.k
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
